# OpenAI Webhooks - Express Example

Minimal example of receiving OpenAI webhooks with signature verification.
...
3. Add your OpenAI webhook signing secret to `.env`:
