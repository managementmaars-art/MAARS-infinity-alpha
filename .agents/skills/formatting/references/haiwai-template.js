// =============================================================================
// Haiwai Unicorn (海外独角兽) Brand Document Template (docx-js)
// Extracted from: haiwai-unicorn/haiwai-brand-doc/SKILL.md as a reference template.
//
// Brand: 海外独角兽 / Haiwai Unicorn
// Brand Color: #736de9 (purple)
...
const BRAND_COLOR = "736de9";
const BRAND_MID   = "b8b4f4";
const BODY_FONT   = "楷体";
...
const logoBuffer = fs.readFileSync(path.join(SKILL_DIR, "assets", "logo_header.jpeg"));
      ...
      default: new Header({
        children: [
          new Paragraph({
            ...
            children: [
              new TextRun("\t"),
              new ImageRun({ type: "jpeg", data: logoBuffer, transformation: { width: 90, height: 88 },
                altText: { title: "海外独角兽", description: "海外独角兽 Logo", name: "logo" } })
            ],
