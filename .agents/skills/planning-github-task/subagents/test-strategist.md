...
description: "Write the behavior-driven test specification for one GitHub-workflow task. Use the brief, execution plan, and existing project testing patterns to define what must be verified, then return only a concise summary."
---
