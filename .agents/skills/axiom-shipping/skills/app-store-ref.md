...
For the complete guideline index (Sections 1-5), see `skills/app-review-guidelines.md`.

### Most Common Rejection Reasons

See `skills/app-review-guidelines.md` for the full top-10 rejection causes table with percentages.
