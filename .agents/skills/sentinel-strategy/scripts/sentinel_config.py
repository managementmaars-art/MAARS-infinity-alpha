"""SENTINEL Strategy — Shared config, MCP helpers, state I/O.
...
SKILL_DIR = Path(WORKSPACE) / "skills" / "sentinel-strategy"
CONFIG_PATH = SKILL_DIR / "config" / "sentinel-config.json"
STATE_DIR = SKILL_DIR / "state"
HISTORY_FILE = os.path.join(WORKSPACE, "sentinel-emerging-history.json")
