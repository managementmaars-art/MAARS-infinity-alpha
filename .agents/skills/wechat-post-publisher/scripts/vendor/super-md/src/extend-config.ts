...
export function loadExtendConfig(): Partial<ExtendConfig> {
  const paths = [
    path.join(process.cwd(), ".super-publisher", "super-markdown-to-html", "EXTEND.md"),
    path.join(
      process.env.XDG_CONFIG_HOME || path.join(homedir(), ".config"),
      "super-publisher", "super-markdown-to-html", "EXTEND.md"
    ),
    path.join(homedir(), ".super-publisher", "super-markdown-to-html", "EXTEND.md"),
  ];
