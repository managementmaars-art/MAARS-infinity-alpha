...
- Target skill: `skills/ai/content/alicloud-ai-content-aimiaobi/`.
...
4) Save request summary, response summary, and raw output under `output/alicloud-ai-content-aimiaobi-test/`.
...
- Evidence files exist in `output/alicloud-ai-content-aimiaobi-test/` with timestamp and parameters.
