...
- Target skill: `skills/ai/image/alicloud-ai-image-zimage-turbo/`.
...
4) Save request summary, response summary, and raw output under `output/alicloud-ai-image-zimage-turbo-test/`.
...
- Evidence files exist in `output/alicloud-ai-image-zimage-turbo-test/` with timestamp and parameters.
