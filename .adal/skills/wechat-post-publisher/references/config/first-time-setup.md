...
description: First-time setup flow for wechat-post-publisher preferences
---
...
options:
  - label: "Project (Recommended)"
    description: ".super-publisher/ (this project only)"
  - label: "User"
    description: "~/.super-publisher/ (all projects)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.super-publisher/wechat-post-publisher/EXTEND.md` | Current project |
| User | `~/.super-publisher/wechat-post-publisher/EXTEND.md` | All projects |
