...
Association types, configuration, STI, delegated types, and detailed reference.

## Table of Contents

- [1. Associations Overview](#1-associations-overview)
- [2. Types of Associations](#2-types-of-associations)
- [3. Choosing an Association](#3-choosing-an-association)
- [4. Advanced Associations](#4-advanced-associations)
- [5. Single Table Inheritance (STI)](#5-single-table-inheritance-sti)
- [6. Delegated Types](#6-delegated-types)
- [7. Tips, Tricks, and Warnings](#7-tips-tricks-and-warnings)
- [8. Association References](#8-association-references)
