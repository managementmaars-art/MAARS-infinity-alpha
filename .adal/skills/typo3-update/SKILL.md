...
name: typo3-update
description: >-
  TYPO3 v14 development guide: version constraints, core APIs, extension patterns, and
  upgrade workflows. Use when working with update, upgrade, v14, migration, lts,
  TYPO3 core.
