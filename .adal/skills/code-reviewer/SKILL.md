...
- After a major project step has been completed (e.g., "I've finished implementing the user authentication system")
- To validate work against the plan and identify deviations
