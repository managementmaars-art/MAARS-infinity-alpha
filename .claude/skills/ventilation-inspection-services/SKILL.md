---
name: ventilation-inspection-services
description: Conduct ventilation inspection services including exhaust fan assessment, kitchen hood performance testing, makeup air evaluation, and code compliance reporting.
---

## Overview
Conduct ventilation inspection services including exhaust fan assessment, kitchen hood performance testing, makeup air evaluation, and code compliance reporting.

## Core Framework
- Analyze requirements and constraints specific to ventilation-inspection-services
...
## Key Prompts
- "Initiate ventilation-inspection-services workflow for [context]"
- "Analyze current state of ventilation-inspection-services and identify gaps"
- "Generate recommendations for ventilation-inspection-services optimization"
- "Create detailed plan for ventilation-inspection-services execution"
