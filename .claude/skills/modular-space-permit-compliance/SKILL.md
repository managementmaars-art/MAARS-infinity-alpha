---
name: modular-space-permit-compliance
description: Manage modular space permit compliance including building permits, fire marshal approvals, electrical inspections, and occupancy certificates.
---

## Overview
Manage modular space permit compliance including building permits, fire marshal approvals, electrical inspections, and occupancy certificates.

## Core Framework
- Analyze requirements and constraints specific to modular-space-permit-compliance
...
## Key Prompts
- "Initiate modular-space-permit-compliance workflow for [context]"
- "Analyze current state of modular-space-permit-compliance and identify gaps"
- "Generate recommendations for modular-space-permit-compliance optimization"
- "Create detailed plan for modular-space-permit-compliance execution"
