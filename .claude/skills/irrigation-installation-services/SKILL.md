---
name: irrigation-installation-services
description: Manage irrigation installation and service including system design, installation, backflow preventer testing, and smart controller programming.
---

## Overview
Manage irrigation installation and service including system design, installation, backflow preventer testing, and smart controller programming.

## Core Framework
- Analyze requirements and constraints specific to irrigation-installation-services
...
## Key Prompts
- "Initiate irrigation-installation-services workflow for [context]"
- "Analyze current state of irrigation-installation-services and identify gaps"
- "Generate recommendations for irrigation-installation-services optimization"
- "Create detailed plan for irrigation-installation-services execution"
