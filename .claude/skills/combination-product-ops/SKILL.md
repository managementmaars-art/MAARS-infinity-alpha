---
name: combination-product-ops
description: Manage combination product programs including drug-device primary mode assignment, FDA jurisdiction coordination, and cGMP compliance alignment.
---

## Overview
Manage combination product programs including drug-device primary mode assignment, FDA jurisdiction coordination, and cGMP compliance alignment.

## Core Framework
- Analyze requirements and constraints specific to combination-product-ops
...
## Key Prompts
- "Initiate combination-product-ops workflow for [context]"
- "Analyze current state of combination-product-ops and identify gaps"
- "Generate recommendations for combination-product-ops optimization"
- "Create detailed plan for combination-product-ops execution"
