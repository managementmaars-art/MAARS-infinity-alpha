...
description: Apply protective coating systems including epoxy, polyurethane, zinc-rich primers, coatings for immersion service, and abrasion-resistant systems.
---

## Overview
Apply protective coating systems including epoxy, polyurethane, zinc-rich primers, coatings for immersion service, and abrasion-resistant systems.

## Core Framework
- Analyze requirements and constraints specific to protective-coating-application
...
## Key Prompts
- "Initiate protective-coating-application workflow for [context]"
- "Analyze current state of protective-coating-application and identify gaps"
- "Generate recommendations for protective-coating-application optimization"
- "Create detailed plan for protective-coating-application execution"
