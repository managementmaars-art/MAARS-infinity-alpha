...
description: Manage fire alarm system integration programs including BACnet connectivity, mass notification, and high-rise system installation.
---

## Overview
Manage fire alarm system integration programs including BACnet connectivity, mass notification, and high-rise system installation.

## Core Framework
- Analyze requirements and constraints specific to fire-alarm-integration
...
## Key Prompts
- "Initiate fire-alarm-integration workflow for [context]"
- "Analyze current state of fire-alarm-integration and identify gaps"
- "Generate recommendations for fire-alarm-integration optimization"
- "Create detailed plan for fire-alarm-integration execution"
