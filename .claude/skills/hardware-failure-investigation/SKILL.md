---
name: hardware-failure-investigation
description: Investigate lifting hardware failures including fracture analysis, overload assessment, corrosion evaluation, and corrective action recommendations.
---

## Overview
Investigate lifting hardware failures including fracture analysis, overload assessment, corrosion evaluation, and corrective action recommendations.

## Core Framework
- Analyze requirements and constraints specific to hardware-failure-investigation
...
## Key Prompts
- "Initiate hardware-failure-investigation workflow for [context]"
- "Analyze current state of hardware-failure-investigation and identify gaps"
- "Generate recommendations for hardware-failure-investigation optimization"
- "Create detailed plan for hardware-failure-investigation execution"
