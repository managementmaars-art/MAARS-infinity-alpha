---
name: mining-equipment-service
description: Manage mining equipment field service operations including exchange component programs, predictive maintenance, and site support contracts.
---

## Overview
Manage mining equipment field service operations including exchange component programs, predictive maintenance, and site support contracts.

## Core Framework
- Analyze requirements and constraints specific to mining-equipment-service
...
## Key Prompts
- "Initiate mining-equipment-service workflow for [context]"
- "Analyze current state of mining-equipment-service and identify gaps"
- "Generate recommendations for mining-equipment-service optimization"
- "Create detailed plan for mining-equipment-service execution"
