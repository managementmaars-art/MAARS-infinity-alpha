---
name: power-equipment-service
description: Manage power generation equipment service programs including hot section inspections, major overhauls, parts exchange, and performance testing.
---

## Overview
Manage power generation equipment service programs including hot section inspections, major overhauls, parts exchange, and performance testing.

## Core Framework
- Analyze requirements and constraints specific to power-equipment-service
...
## Key Prompts
- "Initiate power-equipment-service workflow for [context]"
- "Analyze current state of power-equipment-service and identify gaps"
- "Generate recommendations for power-equipment-service optimization"
- "Create detailed plan for power-equipment-service execution"
