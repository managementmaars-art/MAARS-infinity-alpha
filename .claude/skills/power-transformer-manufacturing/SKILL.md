...
description: Manage large power transformer manufacturing including HV winding, insulation systems, core assembly, and type testing per IEC 60076.
---

## Overview
Manage large power transformer manufacturing including HV winding, insulation systems, core assembly, and type testing per IEC 60076.

## Core Framework
- Analyze requirements and constraints specific to power-transformer-manufacturing
...
## Key Prompts
- "Initiate power-transformer-manufacturing workflow for [context]"
- "Analyze current state of power-transformer-manufacturing and identify gaps"
- "Generate recommendations for power-transformer-manufacturing optimization"
- "Create detailed plan for power-transformer-manufacturing execution"
