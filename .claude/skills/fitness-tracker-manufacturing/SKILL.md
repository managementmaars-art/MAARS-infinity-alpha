---
name: fitness-tracker-manufacturing
description: Manage fitness tracker manufacturing including optical heart rate sensor assembly, IMU integration, battery management, and wrist band fitting.
---

## Overview
Manage fitness tracker manufacturing including optical heart rate sensor assembly, IMU integration, battery management, and wrist band fitting.

## Core Framework
- Analyze requirements and constraints specific to fitness-tracker-manufacturing
...
## Key Prompts
- "Initiate fitness-tracker-manufacturing workflow for [context]"
- "Analyze current state of fitness-tracker-manufacturing and identify gaps"
- "Generate recommendations for fitness-tracker-manufacturing optimization"
- "Create detailed plan for fitness-tracker-manufacturing execution"
