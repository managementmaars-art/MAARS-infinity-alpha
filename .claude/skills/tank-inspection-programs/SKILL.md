---
name: tank-inspection-programs
description: Manage storage tank inspection programs including API 653 assessments, floor scanning, shell thickness measurement, and corrosion rate analysis.
---

## Overview
Manage storage tank inspection programs including API 653 assessments, floor scanning, shell thickness measurement, and corrosion rate analysis.

## Core Framework
- Analyze requirements and constraints specific to tank-inspection-programs
...
## Key Prompts
- "Initiate tank-inspection-programs workflow for [context]"
- "Analyze current state of tank-inspection-programs and identify gaps"
- "Generate recommendations for tank-inspection-programs optimization"
- "Create detailed plan for tank-inspection-programs execution"
