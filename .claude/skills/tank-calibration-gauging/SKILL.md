---
name: tank-calibration-gauging
description: Calibrate storage tanks for custody transfer including strapping surveys, capacity tables, and weights and measures certification programs.
---

## Overview
Calibrate storage tanks for custody transfer including strapping surveys, capacity tables, and weights and measures certification programs.

## Core Framework
- Analyze requirements and constraints specific to tank-calibration-gauging
...
## Key Prompts
- "Initiate tank-calibration-gauging workflow for [context]"
- "Analyze current state of tank-calibration-gauging and identify gaps"
- "Generate recommendations for tank-calibration-gauging optimization"
- "Create detailed plan for tank-calibration-gauging execution"
