...
description: Support philanthropic planning including donor-advised funds, private foundations, and charitable giving strategies.
---

## Overview
Support philanthropic planning including donor-advised funds, private foundations, and charitable giving strategies.

## Core Framework
- Analyze requirements and constraints specific to philanthropy-advisory
...
## Key Prompts
- "Initiate philanthropy-advisory workflow for [context]"
- "Analyze current state of philanthropy-advisory and identify gaps"
- "Generate recommendations for philanthropy-advisory optimization"
- "Create detailed plan for philanthropy-advisory execution"
