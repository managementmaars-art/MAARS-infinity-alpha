---
name: offshore-rope-access-ops
description: Execute offshore rope access operations on platforms and vessels including corrosion inspection, coating repair, and structural survey work.
---

## Overview
Execute offshore rope access operations on platforms and vessels including corrosion inspection, coating repair, and structural survey work.

## Core Framework
- Analyze requirements and constraints specific to offshore-rope-access-ops
...
## Key Prompts
- "Initiate offshore-rope-access-ops workflow for [context]"
- "Analyze current state of offshore-rope-access-ops and identify gaps"
- "Generate recommendations for offshore-rope-access-ops optimization"
- "Create detailed plan for offshore-rope-access-ops execution"
