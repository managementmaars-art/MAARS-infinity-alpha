---
name: packaging-paper-sales
description: Manage packaging paper sales programs including containerboard, kraft paper, and specialty paper market development and pricing.
---

## Overview
Manage packaging paper sales programs including containerboard, kraft paper, and specialty paper market development and pricing.

## Core Framework
- Analyze requirements and constraints specific to packaging-paper-sales
...
## Key Prompts
- "Initiate packaging-paper-sales workflow for [context]"
- "Analyze current state of packaging-paper-sales and identify gaps"
- "Generate recommendations for packaging-paper-sales optimization"
- "Create detailed plan for packaging-paper-sales execution"
