...
description: Manage commercial floor care services including strip-and-wax, carpet extraction, hard floor grinding, and protective coating application programs.
---

## Overview
Manage commercial floor care services including strip-and-wax, carpet extraction, hard floor grinding, and protective coating application programs.

## Core Framework
- Analyze requirements and constraints specific to floor-care-services
...
## Key Prompts
- "Initiate floor-care-services workflow for [context]"
- "Analyze current state of floor-care-services and identify gaps"
- "Generate recommendations for floor-care-services optimization"
- "Create detailed plan for floor-care-services execution"
