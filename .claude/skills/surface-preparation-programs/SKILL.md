---
name: surface-preparation-programs
description: Manage surface preparation programs for bonding including mechanical abrasion, chemical cleaning, plasma treatment, and primer application.
---

## Overview
Manage surface preparation programs for bonding including mechanical abrasion, chemical cleaning, plasma treatment, and primer application.

## Core Framework
- Analyze requirements and constraints specific to surface-preparation-programs
...
## Key Prompts
- "Initiate surface-preparation-programs workflow for [context]"
- "Analyze current state of surface-preparation-programs and identify gaps"
- "Generate recommendations for surface-preparation-programs optimization"
- "Create detailed plan for surface-preparation-programs execution"
