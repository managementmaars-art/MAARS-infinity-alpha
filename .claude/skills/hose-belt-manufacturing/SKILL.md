...
description: Manufacture industrial hose and belting products including mandrel building, vulcanization, testing, and pressure certification.
---

## Overview
Manufacture industrial hose and belting products including mandrel building, vulcanization, testing, and pressure certification.

## Core Framework
- Analyze requirements and constraints specific to hose-belt-manufacturing
...
## Key Prompts
- "Initiate hose-belt-manufacturing workflow for [context]"
- "Analyze current state of hose-belt-manufacturing and identify gaps"
- "Generate recommendations for hose-belt-manufacturing optimization"
- "Create detailed plan for hose-belt-manufacturing execution"
