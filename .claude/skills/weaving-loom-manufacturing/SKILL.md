---
name: weaving-loom-manufacturing
description: Build weaving looms including rapier, air-jet, and projectile designs with shedding mechanisms, weft insertion timing, and cloth fell position control.
---

## Overview
Build weaving looms including rapier, air-jet, and projectile designs with shedding mechanisms, weft insertion timing, and cloth fell position control.

## Core Framework
- Analyze requirements and constraints specific to weaving-loom-manufacturing
...
## Key Prompts
- "Initiate weaving-loom-manufacturing workflow for [context]"
- "Analyze current state of weaving-loom-manufacturing and identify gaps"
- "Generate recommendations for weaving-loom-manufacturing optimization"
- "Create detailed plan for weaving-loom-manufacturing execution"
