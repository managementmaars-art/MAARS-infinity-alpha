---
name: power-cable-manufacturing-ops
description: Build power cables including conductor stranding, insulation extrusion, screen application, armoring, and routine electrical testing for utility and industrial use.
---

## Overview
Build power cables including conductor stranding, insulation extrusion, screen application, armoring, and routine electrical testing for utility and industrial use.

## Core Framework
- Analyze requirements and constraints specific to power-cable-manufacturing-ops
...
## Key Prompts
- "Initiate power-cable-manufacturing-ops workflow for [context]"
- "Analyze current state of power-cable-manufacturing-ops and identify gaps"
- "Generate recommendations for power-cable-manufacturing-ops optimization"
- "Create detailed plan for power-cable-manufacturing-ops execution"
