---
name: bearing-product-engineering
description: Engineer precision bearing products including radial, thrust, and angular contact designs with tolerance stacking and load capacity calculations.
---

## Overview
Engineer precision bearing products including radial, thrust, and angular contact designs with tolerance stacking and load capacity calculations.

## Core Framework
- Analyze requirements and constraints specific to bearing-product-engineering
...
## Key Prompts
- "Initiate bearing-product-engineering workflow for [context]"
- "Analyze current state of bearing-product-engineering and identify gaps"
- "Generate recommendations for bearing-product-engineering optimization"
- "Create detailed plan for bearing-product-engineering execution"
