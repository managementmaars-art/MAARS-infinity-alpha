...
description: Manufacture hydraulic cylinders including tube honing, piston rod grinding, seal groove machining, and leak testing operations.
---

## Overview
Manufacture hydraulic cylinders including tube honing, piston rod grinding, seal groove machining, and leak testing operations.

## Core Framework
- Analyze requirements and constraints specific to hydraulic-cylinder-manufacturing
...
## Key Prompts
- "Initiate hydraulic-cylinder-manufacturing workflow for [context]"
- "Analyze current state of hydraulic-cylinder-manufacturing and identify gaps"
- "Generate recommendations for hydraulic-cylinder-manufacturing optimization"
- "Create detailed plan for hydraulic-cylinder-manufacturing execution"
