---
name: tissue-manufacturing-ops
description: Operate tissue manufacturing including TAD and conventional tissue machines, converting lines, and consumer packaging operations.
---

## Overview
Operate tissue manufacturing including TAD and conventional tissue machines, converting lines, and consumer packaging operations.

## Core Framework
- Analyze requirements and constraints specific to tissue-manufacturing-ops
...
## Key Prompts
- "Initiate tissue-manufacturing-ops workflow for [context]"
- "Analyze current state of tissue-manufacturing-ops and identify gaps"
- "Generate recommendations for tissue-manufacturing-ops optimization"
- "Create detailed plan for tissue-manufacturing-ops execution"
