---
name: port-security-operations
description: Manage port security operations including ISPS compliance, access control systems, container inspection programs, and maritime security committee management.
---

## Overview
Manage port security operations including ISPS compliance, access control systems, container inspection programs, and maritime security committee management.

## Core Framework
- Analyze requirements and constraints specific to port-security-operations
...
## Key Prompts
- "Initiate port-security-operations workflow for [context]"
- "Analyze current state of port-security-operations and identify gaps"
- "Generate recommendations for port-security-operations optimization"
- "Create detailed plan for port-security-operations execution"
