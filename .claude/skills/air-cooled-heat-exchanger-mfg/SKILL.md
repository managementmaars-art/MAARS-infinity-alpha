---
name: air-cooled-heat-exchanger-mfg
description: Design and manufacture air-cooled heat exchangers including bundle geometry, fan selection, plenum design, noise control features, and thermal performance validation.
---

## Overview
Design and manufacture air-cooled heat exchangers including bundle geometry, fan selection, plenum design, noise control features, and thermal performance validation.

## Core Framework
- Analyze requirements and constraints specific to air-cooled-heat-exchanger-mfg
...
## Key Prompts
- "Initiate air-cooled-heat-exchanger-mfg workflow for [context]"
- "Analyze current state of air-cooled-heat-exchanger-mfg and identify gaps"
- "Generate recommendations for air-cooled-heat-exchanger-mfg optimization"
- "Create detailed plan for air-cooled-heat-exchanger-mfg execution"
