---
name: carbon-fiber-composite-manufacturing
description: Operate carbon fiber composite production including prepreg layup, autoclave curing, out-of-autoclave processes, and mechanical property testing.
---

## Overview
Operate carbon fiber composite production including prepreg layup, autoclave curing, out-of-autoclave processes, and mechanical property testing.

## Core Framework
- Analyze requirements and constraints specific to carbon-fiber-composite-manufacturing
...
## Key Prompts
- "Initiate carbon-fiber-composite-manufacturing workflow for [context]"
- "Analyze current state of carbon-fiber-composite-manufacturing and identify gaps"
- "Generate recommendations for carbon-fiber-composite-manufacturing optimization"
- "Create detailed plan for carbon-fiber-composite-manufacturing execution"
