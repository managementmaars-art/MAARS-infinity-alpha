---
name: paper-energy-management
description: Manage paper mill energy programs including steam system optimization, power cogeneration, fuel switching, and energy cost reduction.
---

## Overview
Manage paper mill energy programs including steam system optimization, power cogeneration, fuel switching, and energy cost reduction.

## Core Framework
- Analyze requirements and constraints specific to paper-energy-management
...
## Key Prompts
- "Initiate paper-energy-management workflow for [context]"
- "Analyze current state of paper-energy-management and identify gaps"
- "Generate recommendations for paper-energy-management optimization"
- "Create detailed plan for paper-energy-management execution"
