---
name: rental-contractor-support-ops
description: Provide rental contractor support operations including jobsite service calls, emergency after-hours response, and on-site fuel delivery programs.
---

## Overview
Provide rental contractor support operations including jobsite service calls, emergency after-hours response, and on-site fuel delivery programs.

## Core Framework
- Analyze requirements and constraints specific to rental-contractor-support-ops
...
## Key Prompts
- "Initiate rental-contractor-support-ops workflow for [context]"
- "Analyze current state of rental-contractor-support-ops and identify gaps"
- "Generate recommendations for rental-contractor-support-ops optimization"
- "Create detailed plan for rental-contractor-support-ops execution"
