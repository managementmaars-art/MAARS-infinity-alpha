---
name: scaffold-estimating-ops
description: Develop scaffold project estimates including material calculation, labor hours, special equipment allowance, and contract pricing strategies.
---

## Overview
Develop scaffold project estimates including material calculation, labor hours, special equipment allowance, and contract pricing strategies.

## Core Framework
- Analyze requirements and constraints specific to scaffold-estimating-ops
...
## Key Prompts
- "Initiate scaffold-estimating-ops workflow for [context]"
- "Analyze current state of scaffold-estimating-ops and identify gaps"
- "Generate recommendations for scaffold-estimating-ops optimization"
- "Create detailed plan for scaffold-estimating-ops execution"
