---
name: frl-unit-management
description: Manage filter-regulator-lubricator units including element replacement schedules, pressure setting verification, and oil level monitoring.
---

## Overview
Manage filter-regulator-lubricator units including element replacement schedules, pressure setting verification, and oil level monitoring.

## Core Framework
- Analyze requirements and constraints specific to frl-unit-management
...
## Key Prompts
- "Initiate frl-unit-management workflow for [context]"
- "Analyze current state of frl-unit-management and identify gaps"
- "Generate recommendations for frl-unit-management optimization"
- "Create detailed plan for frl-unit-management execution"
