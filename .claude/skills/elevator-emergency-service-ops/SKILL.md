---
name: elevator-emergency-service-ops
description: Operate elevator emergency service programs including 24/7 callback response, entrapment rescue protocols, and emergency dispatch coordination.
---

## Overview
Operate elevator emergency service programs including 24/7 callback response, entrapment rescue protocols, and emergency dispatch coordination.

## Core Framework
- Analyze requirements and constraints specific to elevator-emergency-service-ops
...
## Key Prompts
- "Initiate elevator-emergency-service-ops workflow for [context]"
- "Analyze current state of elevator-emergency-service-ops and identify gaps"
- "Generate recommendations for elevator-emergency-service-ops optimization"
- "Create detailed plan for elevator-emergency-service-ops execution"
