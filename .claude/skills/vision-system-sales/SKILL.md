---
name: vision-system-sales
description: Manage machine vision system sales through systems integrators and direct OEM channels including demo programs and technical support.
---

## Overview
Manage machine vision system sales through systems integrators and direct OEM channels including demo programs and technical support.

## Core Framework
- Analyze requirements and constraints specific to vision-system-sales
...
## Key Prompts
- "Initiate vision-system-sales workflow for [context]"
- "Analyze current state of vision-system-sales and identify gaps"
- "Generate recommendations for vision-system-sales optimization"
- "Create detailed plan for vision-system-sales execution"
