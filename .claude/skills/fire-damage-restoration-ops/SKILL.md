---
name: fire-damage-restoration-ops
description: Manage fire damage restoration operations including emergency board-up, smoke odor removal, structural drying, contents cleaning, and reconstruction.
---

## Overview
Manage fire damage restoration operations including emergency board-up, smoke odor removal, structural drying, contents cleaning, and reconstruction.

## Core Framework
- Analyze requirements and constraints specific to fire-damage-restoration-ops
...
## Key Prompts
- "Initiate fire-damage-restoration-ops workflow for [context]"
- "Analyze current state of fire-damage-restoration-ops and identify gaps"
- "Generate recommendations for fire-damage-restoration-ops optimization"
- "Create detailed plan for fire-damage-restoration-ops execution"
