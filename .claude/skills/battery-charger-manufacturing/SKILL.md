---
name: battery-charger-manufacturing
description: Manufacture industrial battery chargers including high-frequency topology assembly, CC/CV charging algorithm integration, and equalizer circuit fabrication.
---

## Overview
Manufacture industrial battery chargers including high-frequency topology assembly, CC/CV charging algorithm integration, and equalizer circuit fabrication.

## Core Framework
- Analyze requirements and constraints specific to battery-charger-manufacturing
...
## Key Prompts
- "Initiate battery-charger-manufacturing workflow for [context]"
- "Analyze current state of battery-charger-manufacturing and identify gaps"
- "Generate recommendations for battery-charger-manufacturing optimization"
- "Create detailed plan for battery-charger-manufacturing execution"
