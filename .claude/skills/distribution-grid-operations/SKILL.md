---
name: distribution-grid-operations
description: Manage electric distribution grid operations including switching order management, fault isolation, restoration planning, and reliability tracking.
---

## Overview
Manage electric distribution grid operations including switching order management, fault isolation, restoration planning, and reliability tracking.

## Core Framework
- Analyze requirements and constraints specific to distribution-grid-operations
...
## Key Prompts
- "Initiate distribution-grid-operations workflow for [context]"
- "Analyze current state of distribution-grid-operations and identify gaps"
- "Generate recommendations for distribution-grid-operations optimization"
- "Create detailed plan for distribution-grid-operations execution"
