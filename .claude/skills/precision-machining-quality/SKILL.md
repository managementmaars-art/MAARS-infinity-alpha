---
name: precision-machining-quality
description: Manage precision machining quality programs including CMM inspection programs, GD&T verification, SPC control charts, and customer FAI documentation.
---

## Overview
Manage precision machining quality programs including CMM inspection programs, GD&T verification, SPC control charts, and customer FAI documentation.

## Core Framework
- Analyze requirements and constraints specific to precision-machining-quality
...
## Key Prompts
- "Initiate precision-machining-quality workflow for [context]"
- "Analyze current state of precision-machining-quality and identify gaps"
- "Generate recommendations for precision-machining-quality optimization"
- "Create detailed plan for precision-machining-quality execution"
