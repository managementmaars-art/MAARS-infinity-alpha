---
name: photonics-rd-management
description: Manage photonics research and development programs including PhC waveguides, integrated photonics, and quantum photonics projects.
---

## Overview
Manage photonics research and development programs including PhC waveguides, integrated photonics, and quantum photonics projects.

## Core Framework
- Analyze requirements and constraints specific to photonics-rd-management
...
## Key Prompts
- "Initiate photonics-rd-management workflow for [context]"
- "Analyze current state of photonics-rd-management and identify gaps"
- "Generate recommendations for photonics-rd-management optimization"
- "Create detailed plan for photonics-rd-management execution"
