---
name: effluent-monitoring-reporting
description: Manage effluent monitoring and reporting programs including sampling schedules, analytical methods, DMR preparation, and permit exceedance response.
---

## Overview
Manage effluent monitoring and reporting programs including sampling schedules, analytical methods, DMR preparation, and permit exceedance response.

## Core Framework
- Analyze requirements and constraints specific to effluent-monitoring-reporting
...
## Key Prompts
- "Initiate effluent-monitoring-reporting workflow for [context]"
- "Analyze current state of effluent-monitoring-reporting and identify gaps"
- "Generate recommendations for effluent-monitoring-reporting optimization"
- "Create detailed plan for effluent-monitoring-reporting execution"
