---
name: steel-coating-line-operations
description: Operate steel coating lines including galvanizing bath management, annealing furnace control, temper rolling, and zinc weight compliance.
---

## Overview
Operate steel coating lines including galvanizing bath management, annealing furnace control, temper rolling, and zinc weight compliance.

## Core Framework
- Analyze requirements and constraints specific to steel-coating-line-operations
...
## Key Prompts
- "Initiate steel-coating-line-operations workflow for [context]"
- "Analyze current state of steel-coating-line-operations and identify gaps"
- "Generate recommendations for steel-coating-line-operations optimization"
- "Create detailed plan for steel-coating-line-operations execution"
