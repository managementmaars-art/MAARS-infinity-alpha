---
name: dosing-pump-manufacturing
description: Manufacture dosing and metering pumps including diaphragm design, stroke adjustment mechanisms, flow verification calibration, and chemical compatibility programs.
---

## Overview
Manufacture dosing and metering pumps including diaphragm design, stroke adjustment mechanisms, flow verification calibration, and chemical compatibility programs.

## Core Framework
- Analyze requirements and constraints specific to dosing-pump-manufacturing
...
## Key Prompts
- "Initiate dosing-pump-manufacturing workflow for [context]"
- "Analyze current state of dosing-pump-manufacturing and identify gaps"
- "Generate recommendations for dosing-pump-manufacturing optimization"
- "Create detailed plan for dosing-pump-manufacturing execution"
