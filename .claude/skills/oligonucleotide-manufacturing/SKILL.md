---
name: oligonucleotide-manufacturing
description: Manage oligonucleotide API production including synthesizer scheduling, purification operations, lyophilization management, and sequence verification.
---

## Overview
Manage oligonucleotide API production including synthesizer scheduling, purification operations, lyophilization management, and sequence verification.

## Core Framework
- Analyze requirements and constraints specific to oligonucleotide-manufacturing
...
## Key Prompts
- "Initiate oligonucleotide-manufacturing workflow for [context]"
- "Analyze current state of oligonucleotide-manufacturing and identify gaps"
- "Generate recommendations for oligonucleotide-manufacturing optimization"
- "Create detailed plan for oligonucleotide-manufacturing execution"
