---
name: catastrophe-response-operations
description: Manage catastrophe response operations including large loss teams, equipment deployment, subcontractor networks, and client communication.
---

## Overview
Manage catastrophe response operations including large loss teams, equipment deployment, subcontractor networks, and client communication.

## Core Framework
- Analyze requirements and constraints specific to catastrophe-response-operations
...
## Key Prompts
- "Initiate catastrophe-response-operations workflow for [context]"
- "Analyze current state of catastrophe-response-operations and identify gaps"
- "Generate recommendations for catastrophe-response-operations optimization"
- "Create detailed plan for catastrophe-response-operations execution"
