---
name: adas-sensor-manufacturing
description: Manufacture ADAS sensors including radar, camera, LiDAR, and ultrasonic systems with functional safety validation and automotive qualification.
---

## Overview
Manufacture ADAS sensors including radar, camera, LiDAR, and ultrasonic systems with functional safety validation and automotive qualification.

## Core Framework
- Analyze requirements and constraints specific to adas-sensor-manufacturing
...
## Key Prompts
- "Initiate adas-sensor-manufacturing workflow for [context]"
- "Analyze current state of adas-sensor-manufacturing and identify gaps"
- "Generate recommendations for adas-sensor-manufacturing optimization"
- "Create detailed plan for adas-sensor-manufacturing execution"
