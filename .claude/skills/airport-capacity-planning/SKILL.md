---
name: airport-capacity-planning
description: Develop airport capacity plans including slot management, gate utilization modeling, apron capacity analysis, and terminal expansion coordination.
---

## Overview
Develop airport capacity plans including slot management, gate utilization modeling, apron capacity analysis, and terminal expansion coordination.

## Core Framework
- Analyze requirements and constraints specific to airport-capacity-planning
...
## Key Prompts
- "Initiate airport-capacity-planning workflow for [context]"
- "Analyze current state of airport-capacity-planning and identify gaps"
- "Generate recommendations for airport-capacity-planning optimization"
- "Create detailed plan for airport-capacity-planning execution"
