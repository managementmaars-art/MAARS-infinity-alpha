---
name: seed-research-trials-mgmt
description: Manage seed research and development trial programs including plot location selection, data collection protocols, and performance data analysis.
---

## Overview
Manage seed research and development trial programs including plot location selection, data collection protocols, and performance data analysis.

## Core Framework
- Analyze requirements and constraints specific to seed-research-trials-mgmt
...
## Key Prompts
- "Initiate seed-research-trials-mgmt workflow for [context]"
- "Analyze current state of seed-research-trials-mgmt and identify gaps"
- "Generate recommendations for seed-research-trials-mgmt optimization"
- "Create detailed plan for seed-research-trials-mgmt execution"
