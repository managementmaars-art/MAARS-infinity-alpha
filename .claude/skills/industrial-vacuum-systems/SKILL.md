...
description: Operate industrial vacuum systems including central vacuum, pneumatic conveying, and HEPA-filtered vacuums for material recovery and housekeeping.
---

## Overview
Operate industrial vacuum systems including central vacuum, pneumatic conveying, and HEPA-filtered vacuums for material recovery and housekeeping.

## Core Framework
- Analyze requirements and constraints specific to industrial-vacuum-systems
...
## Key Prompts
- "Initiate industrial-vacuum-systems workflow for [context]"
- "Analyze current state of industrial-vacuum-systems and identify gaps"
- "Generate recommendations for industrial-vacuum-systems optimization"
- "Create detailed plan for industrial-vacuum-systems execution"
