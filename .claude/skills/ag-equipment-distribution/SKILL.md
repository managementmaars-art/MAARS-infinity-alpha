---
name: ag-equipment-distribution
description: Manage agricultural equipment distribution networks including dealer development, territory management, and equipment display programs.
---

## Overview
Manage agricultural equipment distribution networks including dealer development, territory management, and equipment display programs.

## Core Framework
- Analyze requirements and constraints specific to ag-equipment-distribution
...
## Key Prompts
- "Initiate ag-equipment-distribution workflow for [context]"
- "Analyze current state of ag-equipment-distribution and identify gaps"
- "Generate recommendations for ag-equipment-distribution optimization"
- "Create detailed plan for ag-equipment-distribution execution"
