---
name: gear-application-support
description: Provide gear application engineering support including power rating calculations, service factor selection, and installation guidance.
---

## Overview
Provide gear application engineering support including power rating calculations, service factor selection, and installation guidance.

## Core Framework
- Analyze requirements and constraints specific to gear-application-support
...
## Key Prompts
- "Initiate gear-application-support workflow for [context]"
- "Analyze current state of gear-application-support and identify gaps"
- "Generate recommendations for gear-application-support optimization"
- "Create detailed plan for gear-application-support execution"
