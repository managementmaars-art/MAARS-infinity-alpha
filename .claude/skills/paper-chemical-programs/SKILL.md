---
name: paper-chemical-programs
description: Manage paper mill chemical programs including retention aids, sizing agents, strength additives, and biocide programs.
---

## Overview
Manage paper mill chemical programs including retention aids, sizing agents, strength additives, and biocide programs.

## Core Framework
- Analyze requirements and constraints specific to paper-chemical-programs
...
## Key Prompts
- "Initiate paper-chemical-programs workflow for [context]"
- "Analyze current state of paper-chemical-programs and identify gaps"
- "Generate recommendations for paper-chemical-programs optimization"
- "Create detailed plan for paper-chemical-programs execution"
