---
name: lel-detection-systems
description: Deploy lower explosive limit detection systems including catalytic bead and infrared sensors for flammable gas area classification compliance.
---

## Overview
Deploy lower explosive limit detection systems including catalytic bead and infrared sensors for flammable gas area classification compliance.

## Core Framework
- Analyze requirements and constraints specific to lel-detection-systems
...
## Key Prompts
- "Initiate lel-detection-systems workflow for [context]"
- "Analyze current state of lel-detection-systems and identify gaps"
- "Generate recommendations for lel-detection-systems optimization"
- "Create detailed plan for lel-detection-systems execution"
