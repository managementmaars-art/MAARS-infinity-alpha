---
name: precision-sheet-metal-fab-ops
description: Operate precision sheet metal fabrication including tolerancing, hardware insertion, powder coat coordination, and mil-spec requirements.
---

## Overview
Operate precision sheet metal fabrication including tolerancing, hardware insertion, powder coat coordination, and mil-spec requirements.

## Core Framework
- Analyze requirements and constraints specific to precision-sheet-metal-fab-ops
...
## Key Prompts
- "Initiate precision-sheet-metal-fab-ops workflow for [context]"
- "Analyze current state of precision-sheet-metal-fab-ops and identify gaps"
- "Generate recommendations for precision-sheet-metal-fab-ops optimization"
- "Create detailed plan for precision-sheet-metal-fab-ops execution"
