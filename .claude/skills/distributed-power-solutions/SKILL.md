---
name: distributed-power-solutions
description: Manage distributed power generation solution programs including CHP systems, microgrid integration, and containerized power units.
---

## Overview
Manage distributed power generation solution programs including CHP systems, microgrid integration, and containerized power units.

## Core Framework
- Analyze requirements and constraints specific to distributed-power-solutions
...
## Key Prompts
- "Initiate distributed-power-solutions workflow for [context]"
- "Analyze current state of distributed-power-solutions and identify gaps"
- "Generate recommendations for distributed-power-solutions optimization"
- "Create detailed plan for distributed-power-solutions execution"
