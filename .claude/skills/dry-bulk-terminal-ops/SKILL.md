---
name: dry-bulk-terminal-ops
description: Manage dry bulk terminal operations including vessel discharge scheduling, stockpile management, conveyor systems, and dust suppression compliance.
---

## Overview
Manage dry bulk terminal operations including vessel discharge scheduling, stockpile management, conveyor systems, and dust suppression compliance.

## Core Framework
- Analyze requirements and constraints specific to dry-bulk-terminal-ops
...
## Key Prompts
- "Initiate dry-bulk-terminal-ops workflow for [context]"
- "Analyze current state of dry-bulk-terminal-ops and identify gaps"
- "Generate recommendations for dry-bulk-terminal-ops optimization"
- "Create detailed plan for dry-bulk-terminal-ops execution"
