---
name: digital-scanning-services
description: Operate document scanning and digitization services including high-volume scanning, OCR processing, metadata indexing, and delivery formats.
---

## Overview
Operate document scanning and digitization services including high-volume scanning, OCR processing, metadata indexing, and delivery formats.

## Core Framework
- Analyze requirements and constraints specific to digital-scanning-services
...
## Key Prompts
- "Initiate digital-scanning-services workflow for [context]"
- "Analyze current state of digital-scanning-services and identify gaps"
- "Generate recommendations for digital-scanning-services optimization"
- "Create detailed plan for digital-scanning-services execution"
