---
name: sign-installation-services
description: Manage sign installation services including lift equipment, electrical connections, anchor systems, site surveys, and safety compliance.
---

## Overview
Manage sign installation services including lift equipment, electrical connections, anchor systems, site surveys, and safety compliance.

## Core Framework
- Analyze requirements and constraints specific to sign-installation-services
...
## Key Prompts
- "Initiate sign-installation-services workflow for [context]"
- "Analyze current state of sign-installation-services and identify gaps"
- "Generate recommendations for sign-installation-services optimization"
- "Create detailed plan for sign-installation-services execution"
