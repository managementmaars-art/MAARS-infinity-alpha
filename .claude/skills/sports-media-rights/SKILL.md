---
name: sports-media-rights
description: Manage sports media rights including broadcast agreements, streaming distribution, content syndication, and rights fee negotiations.
---

## Overview
Manage sports media rights including broadcast agreements, streaming distribution, content syndication, and rights fee negotiations.

## Core Framework
- Analyze requirements and constraints specific to sports-media-rights
...
## Key Prompts
- "Initiate sports-media-rights workflow for [context]"
- "Analyze current state of sports-media-rights and identify gaps"
- "Generate recommendations for sports-media-rights optimization"
- "Create detailed plan for sports-media-rights execution"
