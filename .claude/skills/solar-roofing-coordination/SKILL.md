---
name: solar-roofing-coordination
description: Coordinate solar and roofing integration including penetration details, structural loading, flashing systems, and multi-trade scheduling.
---

## Overview
Coordinate solar and roofing integration including penetration details, structural loading, flashing systems, and multi-trade scheduling.

## Core Framework
- Analyze requirements and constraints specific to solar-roofing-coordination
...
## Key Prompts
- "Initiate solar-roofing-coordination workflow for [context]"
- "Analyze current state of solar-roofing-coordination and identify gaps"
- "Generate recommendations for solar-roofing-coordination optimization"
- "Create detailed plan for solar-roofing-coordination execution"
