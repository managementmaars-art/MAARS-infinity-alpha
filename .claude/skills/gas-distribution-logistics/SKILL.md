---
name: gas-distribution-logistics
description: Manage industrial gas distribution logistics including cylinder fleet management, bulk delivery routing, and HAZMAT compliance.
---

## Overview
Manage industrial gas distribution logistics including cylinder fleet management, bulk delivery routing, and HAZMAT compliance.

## Core Framework
- Analyze requirements and constraints specific to gas-distribution-logistics
...
## Key Prompts
- "Initiate gas-distribution-logistics workflow for [context]"
- "Analyze current state of gas-distribution-logistics and identify gaps"
- "Generate recommendations for gas-distribution-logistics optimization"
- "Create detailed plan for gas-distribution-logistics execution"
