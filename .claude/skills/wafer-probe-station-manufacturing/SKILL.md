---
name: wafer-probe-station-manufacturing
description: Produce wafer probe stations including chuck manufacturing, positioner assembly, microscope integration, and thermal stage fabrication.
---

## Overview
Produce wafer probe stations including chuck manufacturing, positioner assembly, microscope integration, and thermal stage fabrication.

## Core Framework
- Analyze requirements and constraints specific to wafer-probe-station-manufacturing
...
## Key Prompts
- "Initiate wafer-probe-station-manufacturing workflow for [context]"
- "Analyze current state of wafer-probe-station-manufacturing and identify gaps"
- "Generate recommendations for wafer-probe-station-manufacturing optimization"
- "Create detailed plan for wafer-probe-station-manufacturing execution"
