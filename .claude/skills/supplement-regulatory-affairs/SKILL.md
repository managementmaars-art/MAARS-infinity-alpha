---
name: supplement-regulatory-affairs
description: Navigate dietary supplement regulatory compliance including DSHEA, NDI notifications, structure-function claims, and FDA label requirements.
---

## Overview
Navigate dietary supplement regulatory compliance including DSHEA, NDI notifications, structure-function claims, and FDA label requirements.

## Core Framework
- Analyze requirements and constraints specific to supplement-regulatory-affairs
...
## Key Prompts
- "Initiate supplement-regulatory-affairs workflow for [context]"
- "Analyze current state of supplement-regulatory-affairs and identify gaps"
- "Generate recommendations for supplement-regulatory-affairs optimization"
- "Create detailed plan for supplement-regulatory-affairs execution"
