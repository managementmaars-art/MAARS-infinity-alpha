---
name: analytical-scale-manufacturing
description: Produce analytical and precision scales including load cell calibration, vibration isolation integration, draft shield assembly, and OIML certification.
---

## Overview
Produce analytical and precision scales including load cell calibration, vibration isolation integration, draft shield assembly, and OIML certification.

## Core Framework
- Analyze requirements and constraints specific to analytical-scale-manufacturing
...
## Key Prompts
- "Initiate analytical-scale-manufacturing workflow for [context]"
- "Analyze current state of analytical-scale-manufacturing and identify gaps"
- "Generate recommendations for analytical-scale-manufacturing optimization"
- "Create detailed plan for analytical-scale-manufacturing execution"
