---
name: structural-engineering-ops
description: Coordinate structural engineering operations including analysis workflows, drawing production, peer review, and code compliance documentation.
---

## Overview
Coordinate structural engineering operations including analysis workflows, drawing production, peer review, and code compliance documentation.

## Core Framework
- Analyze requirements and constraints specific to structural-engineering-ops
...
## Key Prompts
- "Initiate structural-engineering-ops workflow for [context]"
- "Analyze current state of structural-engineering-ops and identify gaps"
- "Generate recommendations for structural-engineering-ops optimization"
- "Create detailed plan for structural-engineering-ops execution"
