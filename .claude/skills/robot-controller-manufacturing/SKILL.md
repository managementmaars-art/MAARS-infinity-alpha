---
name: robot-controller-manufacturing
description: Manufacture robot controllers including teach pendant assembly, safety I/O board fabrication, trajectory generation processor integration, and cycle time validation.
---

## Overview
Manufacture robot controllers including teach pendant assembly, safety I/O board fabrication, trajectory generation processor integration, and cycle time validation.

## Core Framework
- Analyze requirements and constraints specific to robot-controller-manufacturing
...
## Key Prompts
- "Initiate robot-controller-manufacturing workflow for [context]"
- "Analyze current state of robot-controller-manufacturing and identify gaps"
- "Generate recommendations for robot-controller-manufacturing optimization"
- "Create detailed plan for robot-controller-manufacturing execution"
