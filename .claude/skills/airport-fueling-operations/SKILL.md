---
name: airport-fueling-operations
description: Operate airport aircraft fueling services including fuel farm management, hydrant system maintenance, into-plane fueling operations, and quality control.
---

## Overview
Operate airport aircraft fueling services including fuel farm management, hydrant system maintenance, into-plane fueling operations, and quality control.

## Core Framework
- Analyze requirements and constraints specific to airport-fueling-operations
...
## Key Prompts
- "Initiate airport-fueling-operations workflow for [context]"
- "Analyze current state of airport-fueling-operations and identify gaps"
- "Generate recommendations for airport-fueling-operations optimization"
- "Create detailed plan for airport-fueling-operations execution"
