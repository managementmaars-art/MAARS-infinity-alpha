...
description: Maintain DEA-compliant controlled substance tracking including EPCS, inventory reconciliation, and diversion monitoring.
---

## Overview
Maintain DEA-compliant controlled substance tracking including EPCS, inventory reconciliation, and diversion monitoring.

## Core Framework
- Analyze requirements and constraints specific to controlled-substance-tracking
...
## Key Prompts
- "Initiate controlled-substance-tracking workflow for [context]"
- "Analyze current state of controlled-substance-tracking and identify gaps"
- "Generate recommendations for controlled-substance-tracking optimization"
- "Create detailed plan for controlled-substance-tracking execution"
