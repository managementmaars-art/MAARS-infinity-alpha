---
name: parametric-insurance-programs
description: Design and operate parametric insurance programs including trigger definition, index data sourcing, and automated payout execution.
---

## Overview
Design and operate parametric insurance programs including trigger definition, index data sourcing, and automated payout execution.

## Core Framework
- Analyze requirements and constraints specific to parametric-insurance-programs
...
## Key Prompts
- "Initiate parametric-insurance-programs workflow for [context]"
- "Analyze current state of parametric-insurance-programs and identify gaps"
- "Generate recommendations for parametric-insurance-programs optimization"
- "Create detailed plan for parametric-insurance-programs execution"
