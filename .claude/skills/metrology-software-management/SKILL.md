---
name: metrology-software-management
description: Manage metrology software programs including CAD model alignment, GD&T evaluation, and inspection report generation.
---

## Overview
Manage metrology software programs including CAD model alignment, GD&T evaluation, and inspection report generation.

## Core Framework
- Analyze requirements and constraints specific to metrology-software-management
...
## Key Prompts
- "Initiate metrology-software-management workflow for [context]"
- "Analyze current state of metrology-software-management and identify gaps"
- "Generate recommendations for metrology-software-management optimization"
- "Create detailed plan for metrology-software-management execution"
