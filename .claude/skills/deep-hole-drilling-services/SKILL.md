---
name: deep-hole-drilling-services
description: Operate deep hole drilling services including gun drilling, BTA drilling, tool selection, chip management, and straightness verification.
---

## Overview
Operate deep hole drilling services including gun drilling, BTA drilling, tool selection, chip management, and straightness verification.

## Core Framework
- Analyze requirements and constraints specific to deep-hole-drilling-services
...
## Key Prompts
- "Initiate deep-hole-drilling-services workflow for [context]"
- "Analyze current state of deep-hole-drilling-services and identify gaps"
- "Generate recommendations for deep-hole-drilling-services optimization"
- "Create detailed plan for deep-hole-drilling-services execution"
