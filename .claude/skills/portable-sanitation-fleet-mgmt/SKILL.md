---
name: portable-sanitation-fleet-mgmt
description: Manage portable sanitation fleet including unit inventory, maintenance scheduling, refurbishment programs, and utilization optimization.
---

## Overview
Manage portable sanitation fleet including unit inventory, maintenance scheduling, refurbishment programs, and utilization optimization.

## Core Framework
- Analyze requirements and constraints specific to portable-sanitation-fleet-mgmt
...
## Key Prompts
- "Initiate portable-sanitation-fleet-mgmt workflow for [context]"
- "Analyze current state of portable-sanitation-fleet-mgmt and identify gaps"
- "Generate recommendations for portable-sanitation-fleet-mgmt optimization"
- "Create detailed plan for portable-sanitation-fleet-mgmt execution"
