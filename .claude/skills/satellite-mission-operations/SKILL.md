...
description: Execute satellite mission operations including orbit maintenance maneuvers, payload scheduling, anomaly resolution, and end-of-life planning.
---

## Overview
Execute satellite mission operations including orbit maintenance maneuvers, payload scheduling, anomaly resolution, and end-of-life planning.

## Core Framework
- Analyze requirements and constraints specific to satellite-mission-operations
...
## Key Prompts
- "Initiate satellite-mission-operations workflow for [context]"
- "Analyze current state of satellite-mission-operations and identify gaps"
- "Generate recommendations for satellite-mission-operations optimization"
- "Create detailed plan for satellite-mission-operations execution"
