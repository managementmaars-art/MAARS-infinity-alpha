---
name: hardness-tester-manufacturing
description: Manufacture hardness testing instruments including Rockwell, Vickers, and Brinell tester frame fabrication and load cell calibration.
---

## Overview
Manufacture hardness testing instruments including Rockwell, Vickers, and Brinell tester frame fabrication and load cell calibration.

## Core Framework
- Analyze requirements and constraints specific to hardness-tester-manufacturing
...
## Key Prompts
- "Initiate hardness-tester-manufacturing workflow for [context]"
- "Analyze current state of hardness-tester-manufacturing and identify gaps"
- "Generate recommendations for hardness-tester-manufacturing optimization"
- "Create detailed plan for hardness-tester-manufacturing execution"
