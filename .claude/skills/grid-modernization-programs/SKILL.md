---
name: grid-modernization-programs
description: Lead grid modernization initiatives including AMI deployment, volt-VAR optimization, distribution automation, and grid resilience investments.
---

## Overview
Lead grid modernization initiatives including AMI deployment, volt-VAR optimization, distribution automation, and grid resilience investments.

## Core Framework
- Analyze requirements and constraints specific to grid-modernization-programs
...
## Key Prompts
- "Initiate grid-modernization-programs workflow for [context]"
- "Analyze current state of grid-modernization-programs and identify gaps"
- "Generate recommendations for grid-modernization-programs optimization"
- "Create detailed plan for grid-modernization-programs execution"
