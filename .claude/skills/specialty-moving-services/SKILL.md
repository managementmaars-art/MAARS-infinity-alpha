---
name: specialty-moving-services
description: Provide specialty moving services including piano moving, art and antique handling, laboratory equipment, server room relocation, and vault moves.
---

## Overview
Provide specialty moving services including piano moving, art and antique handling, laboratory equipment, server room relocation, and vault moves.

## Core Framework
- Analyze requirements and constraints specific to specialty-moving-services
...
## Key Prompts
- "Initiate specialty-moving-services workflow for [context]"
- "Analyze current state of specialty-moving-services and identify gaps"
- "Generate recommendations for specialty-moving-services optimization"
- "Create detailed plan for specialty-moving-services execution"
