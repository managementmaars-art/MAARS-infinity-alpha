---
name: supplement-supply-chain
description: Manage supplement supply chains including ingredient sourcing, API procurement, botanical extraction coordination, and inventory management.
---

## Overview
Manage supplement supply chains including ingredient sourcing, API procurement, botanical extraction coordination, and inventory management.

## Core Framework
- Analyze requirements and constraints specific to supplement-supply-chain
...
## Key Prompts
- "Initiate supplement-supply-chain workflow for [context]"
- "Analyze current state of supplement-supply-chain and identify gaps"
- "Generate recommendations for supplement-supply-chain optimization"
- "Create detailed plan for supplement-supply-chain execution"
