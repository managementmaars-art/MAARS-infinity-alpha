---
name: generator-manufacturing-ops
description: Manage generator manufacturing including alternator winding, prime mover integration, governor systems, and load bank testing.
---

## Overview
Manage generator manufacturing including alternator winding, prime mover integration, governor systems, and load bank testing.

## Core Framework
- Analyze requirements and constraints specific to generator-manufacturing-ops
...
## Key Prompts
- "Initiate generator-manufacturing-ops workflow for [context]"
- "Analyze current state of generator-manufacturing-ops and identify gaps"
- "Generate recommendations for generator-manufacturing-ops optimization"
- "Create detailed plan for generator-manufacturing-ops execution"
