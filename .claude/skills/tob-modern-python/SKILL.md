...
description: Trail of Bits: modern Python security — secure coding patterns, dependency risks, SAST integration
---

# Tob Modern Python — MAARS Security Reference

## Overview
Trail of Bits: modern Python security — secure coding patterns, dependency risks, SAST integration
