---
name: hard-drive-destruction-services
description: Provide hard drive and electronic media destruction services including degaussing, physical shredding, and NIST-compliant data sanitization documentation.
---

## Overview
Provide hard drive and electronic media destruction services including degaussing, physical shredding, and NIST-compliant data sanitization documentation.

## Core Framework
- Analyze requirements and constraints specific to hard-drive-destruction-services
...
## Key Prompts
- "Initiate hard-drive-destruction-services workflow for [context]"
- "Analyze current state of hard-drive-destruction-services and identify gaps"
- "Generate recommendations for hard-drive-destruction-services optimization"
- "Create detailed plan for hard-drive-destruction-services execution"
