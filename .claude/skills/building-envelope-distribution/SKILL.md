---
name: building-envelope-distribution
description: Distribute building envelope products including housewrap, flashings, caulks, sealants, weather barriers, and drainage planes.
---

## Overview
Distribute building envelope products including housewrap, flashings, caulks, sealants, weather barriers, and drainage planes.

## Core Framework
- Analyze requirements and constraints specific to building-envelope-distribution
...
## Key Prompts
- "Initiate building-envelope-distribution workflow for [context]"
- "Analyze current state of building-envelope-distribution and identify gaps"
- "Generate recommendations for building-envelope-distribution optimization"
- "Create detailed plan for building-envelope-distribution execution"
