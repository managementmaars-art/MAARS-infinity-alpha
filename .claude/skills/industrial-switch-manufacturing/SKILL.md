---
name: industrial-switch-manufacturing
description: Produce managed industrial Ethernet switches including ruggedized port assembly, ring redundancy firmware integration, and harsh environment certification.
---

## Overview
Produce managed industrial Ethernet switches including ruggedized port assembly, ring redundancy firmware integration, and harsh environment certification.

## Core Framework
- Analyze requirements and constraints specific to industrial-switch-manufacturing
...
## Key Prompts
- "Initiate industrial-switch-manufacturing workflow for [context]"
- "Analyze current state of industrial-switch-manufacturing and identify gaps"
- "Generate recommendations for industrial-switch-manufacturing optimization"
- "Create detailed plan for industrial-switch-manufacturing execution"
