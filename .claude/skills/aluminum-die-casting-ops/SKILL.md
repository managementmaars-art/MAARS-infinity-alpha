---
name: aluminum-die-casting-ops
description: Operate aluminum die casting services including alloy chemistry control, porosity reduction programs, and heat treat coordination.
---

## Overview
Operate aluminum die casting services including alloy chemistry control, porosity reduction programs, and heat treat coordination.

## Core Framework
- Analyze requirements and constraints specific to aluminum-die-casting-ops
...
## Key Prompts
- "Initiate aluminum-die-casting-ops workflow for [context]"
- "Analyze current state of aluminum-die-casting-ops and identify gaps"
- "Generate recommendations for aluminum-die-casting-ops optimization"
- "Create detailed plan for aluminum-die-casting-ops execution"
