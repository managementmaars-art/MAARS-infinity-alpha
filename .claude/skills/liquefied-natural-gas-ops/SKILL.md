---
name: liquefied-natural-gas-ops
description: Manage LNG facility operations including liquefaction plant management, storage tank operations, regasification scheduling, and truck loading.
---

## Overview
Manage LNG facility operations including liquefaction plant management, storage tank operations, regasification scheduling, and truck loading.

## Core Framework
- Analyze requirements and constraints specific to liquefied-natural-gas-ops
...
## Key Prompts
- "Initiate liquefied-natural-gas-ops workflow for [context]"
- "Analyze current state of liquefied-natural-gas-ops and identify gaps"
- "Generate recommendations for liquefied-natural-gas-ops optimization"
- "Create detailed plan for liquefied-natural-gas-ops execution"
