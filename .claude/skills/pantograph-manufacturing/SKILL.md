---
name: pantograph-manufacturing
description: Build railway pantographs including collector head assembly, spring stiffness calibration, carbon insert bonding, pantograph dynamics testing, and contact force measurement.
---

## Overview
Build railway pantographs including collector head assembly, spring stiffness calibration, carbon insert bonding, pantograph dynamics testing, and contact force measurement.

## Core Framework
- Analyze requirements and constraints specific to pantograph-manufacturing
...
## Key Prompts
- "Initiate pantograph-manufacturing workflow for [context]"
- "Analyze current state of pantograph-manufacturing and identify gaps"
- "Generate recommendations for pantograph-manufacturing optimization"
- "Create detailed plan for pantograph-manufacturing execution"
