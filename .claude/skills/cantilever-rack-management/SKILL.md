---
name: cantilever-rack-management
description: Manage cantilever rack systems for long load storage including arm capacity ratings, column bracing, and row protection requirements.
---

## Overview
Manage cantilever rack systems for long load storage including arm capacity ratings, column bracing, and row protection requirements.

## Core Framework
- Analyze requirements and constraints specific to cantilever-rack-management
...
## Key Prompts
- "Initiate cantilever-rack-management workflow for [context]"
- "Analyze current state of cantilever-rack-management and identify gaps"
- "Generate recommendations for cantilever-rack-management optimization"
- "Create detailed plan for cantilever-rack-management execution"
