---
name: roofing-sales-program-management
description: Develop roofing sales programs including canvassing, storm chasing strategy, referral programs, financing options, and CRM management.
---

## Overview
Develop roofing sales programs including canvassing, storm chasing strategy, referral programs, financing options, and CRM management.

## Core Framework
- Analyze requirements and constraints specific to roofing-sales-program-management
...
## Key Prompts
- "Initiate roofing-sales-program-management workflow for [context]"
- "Analyze current state of roofing-sales-program-management and identify gaps"
- "Generate recommendations for roofing-sales-program-management optimization"
- "Create detailed plan for roofing-sales-program-management execution"
