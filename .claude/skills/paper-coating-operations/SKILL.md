---
name: paper-coating-operations
description: Manage paper coating operations including coating color preparation, blade and curtain coater management, and gloss/brightness compliance.
---

## Overview
Manage paper coating operations including coating color preparation, blade and curtain coater management, and gloss/brightness compliance.

## Core Framework
- Analyze requirements and constraints specific to paper-coating-operations
...
## Key Prompts
- "Initiate paper-coating-operations workflow for [context]"
- "Analyze current state of paper-coating-operations and identify gaps"
- "Generate recommendations for paper-coating-operations optimization"
- "Create detailed plan for paper-coating-operations execution"
