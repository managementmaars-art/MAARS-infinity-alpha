...
description: Manage UV disinfection system programs including lamp module manufacturing, dose validation, and bioassay performance verification.
---

## Overview
Manage UV disinfection system programs including lamp module manufacturing, dose validation, and bioassay performance verification.

## Core Framework
- Analyze requirements and constraints specific to uv-disinfection-systems
...
## Key Prompts
- "Initiate uv-disinfection-systems workflow for [context]"
- "Analyze current state of uv-disinfection-systems and identify gaps"
- "Generate recommendations for uv-disinfection-systems optimization"
- "Create detailed plan for uv-disinfection-systems execution"
