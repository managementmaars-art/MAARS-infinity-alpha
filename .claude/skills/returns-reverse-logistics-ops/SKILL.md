---
name: returns-reverse-logistics-ops
description: Operate returns and reverse logistics programs including returns authorization, inspection, refurbishment, restocking, and disposition management.
---

## Overview
Operate returns and reverse logistics programs including returns authorization, inspection, refurbishment, restocking, and disposition management.

## Core Framework
- Analyze requirements and constraints specific to returns-reverse-logistics-ops
...
## Key Prompts
- "Initiate returns-reverse-logistics-ops workflow for [context]"
- "Analyze current state of returns-reverse-logistics-ops and identify gaps"
- "Generate recommendations for returns-reverse-logistics-ops optimization"
- "Create detailed plan for returns-reverse-logistics-ops execution"
