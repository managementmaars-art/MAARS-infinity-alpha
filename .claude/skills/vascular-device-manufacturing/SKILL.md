---
name: vascular-device-manufacturing
description: Manufacture vascular devices including stents, balloons, and catheters with laser cutting, electropolishing, hydrophilic coating, and burst pressure testing.
---

## Overview
Manufacture vascular devices including stents, balloons, and catheters with laser cutting, electropolishing, hydrophilic coating, and burst pressure testing.

## Core Framework
- Analyze requirements and constraints specific to vascular-device-manufacturing
...
## Key Prompts
- "Initiate vascular-device-manufacturing workflow for [context]"
- "Analyze current state of vascular-device-manufacturing and identify gaps"
- "Generate recommendations for vascular-device-manufacturing optimization"
- "Create detailed plan for vascular-device-manufacturing execution"
