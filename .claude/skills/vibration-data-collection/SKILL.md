---
name: vibration-data-collection
description: Collect vibration data using portable analyzers and online systems with route-based programs, trigger conditions, and trend data management.
---

## Overview
Collect vibration data using portable analyzers and online systems with route-based programs, trigger conditions, and trend data management.

## Core Framework
- Analyze requirements and constraints specific to vibration-data-collection
...
## Key Prompts
- "Initiate vibration-data-collection workflow for [context]"
- "Analyze current state of vibration-data-collection and identify gaps"
- "Generate recommendations for vibration-data-collection optimization"
- "Create detailed plan for vibration-data-collection execution"
