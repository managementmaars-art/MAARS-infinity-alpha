---
name: port-environmental-compliance
description: Manage port environmental compliance including cold ironing programs, air emission inventories, stormwater SWPPP management, and spill response.
---

## Overview
Manage port environmental compliance including cold ironing programs, air emission inventories, stormwater SWPPP management, and spill response.

## Core Framework
- Analyze requirements and constraints specific to port-environmental-compliance
...
## Key Prompts
- "Initiate port-environmental-compliance workflow for [context]"
- "Analyze current state of port-environmental-compliance and identify gaps"
- "Generate recommendations for port-environmental-compliance optimization"
- "Create detailed plan for port-environmental-compliance execution"
