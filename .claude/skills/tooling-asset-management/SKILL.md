---
name: tooling-asset-management
description: Manage tooling assets including ownership tracking, PM programs, storage, shipping coordination, and end-of-life disposition.
---

## Overview
Manage tooling assets including ownership tracking, PM programs, storage, shipping coordination, and end-of-life disposition.

## Core Framework
- Analyze requirements and constraints specific to tooling-asset-management
...
## Key Prompts
- "Initiate tooling-asset-management workflow for [context]"
- "Analyze current state of tooling-asset-management and identify gaps"
- "Generate recommendations for tooling-asset-management optimization"
- "Create detailed plan for tooling-asset-management execution"
