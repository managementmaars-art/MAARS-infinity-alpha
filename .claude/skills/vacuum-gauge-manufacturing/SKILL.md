---
name: vacuum-gauge-manufacturing
description: Produce vacuum measurement gauges including Pirani, ion gauge, capacitance manometer assembly and calibration workflows.
---

## Overview
Produce vacuum measurement gauges including Pirani, ion gauge, capacitance manometer assembly and calibration workflows.

## Core Framework
- Analyze requirements and constraints specific to vacuum-gauge-manufacturing
...
## Key Prompts
- "Initiate vacuum-gauge-manufacturing workflow for [context]"
- "Analyze current state of vacuum-gauge-manufacturing and identify gaps"
- "Generate recommendations for vacuum-gauge-manufacturing optimization"
- "Create detailed plan for vacuum-gauge-manufacturing execution"
