---
name: surface-metrology-programs
description: Manage surface metrology programs including profilometry, interferometry, and texture measurement for machined components.
---

## Overview
Manage surface metrology programs including profilometry, interferometry, and texture measurement for machined components.

## Core Framework
- Analyze requirements and constraints specific to surface-metrology-programs
...
## Key Prompts
- "Initiate surface-metrology-programs workflow for [context]"
- "Analyze current state of surface-metrology-programs and identify gaps"
- "Generate recommendations for surface-metrology-programs optimization"
- "Create detailed plan for surface-metrology-programs execution"
