---
name: dairy-separation-standardization
description: Manage dairy separation and standardization operations including fat content targeting, cream balance management, and protein fortification programs.
---

## Overview
Manage dairy separation and standardization operations including fat content targeting, cream balance management, and protein fortification programs.

## Core Framework
- Analyze requirements and constraints specific to dairy-separation-standardization
...
## Key Prompts
- "Initiate dairy-separation-standardization workflow for [context]"
- "Analyze current state of dairy-separation-standardization and identify gaps"
- "Generate recommendations for dairy-separation-standardization optimization"
- "Create detailed plan for dairy-separation-standardization execution"
