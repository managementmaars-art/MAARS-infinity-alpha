---
name: injection-molding-scheduling
description: Schedule injection molding production including press loading by tonnage, material changeover sequencing, and cavity balancing optimization.
---

## Overview
Schedule injection molding production including press loading by tonnage, material changeover sequencing, and cavity balancing optimization.

## Core Framework
- Analyze requirements and constraints specific to injection-molding-scheduling
...
## Key Prompts
- "Initiate injection-molding-scheduling workflow for [context]"
- "Analyze current state of injection-molding-scheduling and identify gaps"
- "Generate recommendations for injection-molding-scheduling optimization"
- "Create detailed plan for injection-molding-scheduling execution"
