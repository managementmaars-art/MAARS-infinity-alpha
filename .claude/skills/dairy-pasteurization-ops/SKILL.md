---
name: dairy-pasteurization-ops
description: Operate dairy pasteurization systems including HTST and UHT process management, temperature chart validation, and regulatory compliance documentation.
---

## Overview
Operate dairy pasteurization systems including HTST and UHT process management, temperature chart validation, and regulatory compliance documentation.

## Core Framework
- Analyze requirements and constraints specific to dairy-pasteurization-ops
...
## Key Prompts
- "Initiate dairy-pasteurization-ops workflow for [context]"
- "Analyze current state of dairy-pasteurization-ops and identify gaps"
- "Generate recommendations for dairy-pasteurization-ops optimization"
- "Create detailed plan for dairy-pasteurization-ops execution"
