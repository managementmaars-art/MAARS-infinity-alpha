---
name: gear-hobbing-operations
description: Operate gear hobbing processes including hob selection, feed and speed optimization, tooth accuracy measurement, and tooling management.
---

## Overview
Operate gear hobbing processes including hob selection, feed and speed optimization, tooth accuracy measurement, and tooling management.

## Core Framework
- Analyze requirements and constraints specific to gear-hobbing-operations
...
## Key Prompts
- "Initiate gear-hobbing-operations workflow for [context]"
- "Analyze current state of gear-hobbing-operations and identify gaps"
- "Generate recommendations for gear-hobbing-operations optimization"
- "Create detailed plan for gear-hobbing-operations execution"
