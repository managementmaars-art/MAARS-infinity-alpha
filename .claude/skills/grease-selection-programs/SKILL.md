---
name: grease-selection-programs
description: Select greases for machinery applications including thickener type, consistency, extreme pressure additives, and temperature range requirements.
---

## Overview
Select greases for machinery applications including thickener type, consistency, extreme pressure additives, and temperature range requirements.

## Core Framework
- Analyze requirements and constraints specific to grease-selection-programs
...
## Key Prompts
- "Initiate grease-selection-programs workflow for [context]"
- "Analyze current state of grease-selection-programs and identify gaps"
- "Generate recommendations for grease-selection-programs optimization"
- "Create detailed plan for grease-selection-programs execution"
