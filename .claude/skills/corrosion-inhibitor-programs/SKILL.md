---
name: corrosion-inhibitor-programs
description: Manage corrosion inhibitor programs including chemical selection, injection rate optimization, residual monitoring, and performance reporting.
---

## Overview
Manage corrosion inhibitor programs including chemical selection, injection rate optimization, residual monitoring, and performance reporting.

## Core Framework
- Analyze requirements and constraints specific to corrosion-inhibitor-programs
...
## Key Prompts
- "Initiate corrosion-inhibitor-programs workflow for [context]"
- "Analyze current state of corrosion-inhibitor-programs and identify gaps"
- "Generate recommendations for corrosion-inhibitor-programs optimization"
- "Create detailed plan for corrosion-inhibitor-programs execution"
