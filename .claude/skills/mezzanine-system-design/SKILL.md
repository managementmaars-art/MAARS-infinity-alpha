---
name: mezzanine-system-design
description: Design mezzanine structures including structural calculations, floor loading, column placement, safety netting, and stair access configuration.
---

## Overview
Design mezzanine structures including structural calculations, floor loading, column placement, safety netting, and stair access configuration.

## Core Framework
- Analyze requirements and constraints specific to mezzanine-system-design
...
## Key Prompts
- "Initiate mezzanine-system-design workflow for [context]"
- "Analyze current state of mezzanine-system-design and identify gaps"
- "Generate recommendations for mezzanine-system-design optimization"
- "Create detailed plan for mezzanine-system-design execution"
