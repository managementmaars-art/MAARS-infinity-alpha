---
name: agri-drone-operations
description: Coordinate agricultural drone operations including flight planning, crop scouting missions, spray applications, and FAA compliance.
---

## Overview
Coordinate agricultural drone operations including flight planning, crop scouting missions, spray applications, and FAA compliance.

## Core Framework
- Analyze requirements and constraints specific to agri-drone-operations
...
## Key Prompts
- "Initiate agri-drone-operations workflow for [context]"
- "Analyze current state of agri-drone-operations and identify gaps"
- "Generate recommendations for agri-drone-operations optimization"
- "Create detailed plan for agri-drone-operations execution"
