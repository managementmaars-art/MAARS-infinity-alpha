---
name: vision-system-maintenance
description: Maintain machine vision systems including lens cleaning protocols, illuminator replacement, calibration verification, and software updates.
---

## Overview
Maintain machine vision systems including lens cleaning protocols, illuminator replacement, calibration verification, and software updates.

## Core Framework
- Analyze requirements and constraints specific to vision-system-maintenance
...
## Key Prompts
- "Initiate vision-system-maintenance workflow for [context]"
- "Analyze current state of vision-system-maintenance and identify gaps"
- "Generate recommendations for vision-system-maintenance optimization"
- "Create detailed plan for vision-system-maintenance execution"
