---
name: industrial-laundry-ops
description: Operate industrial laundry services including workwear contamination management, detergent programs, and garment tracking for hazardous material handling.
---

## Overview
Operate industrial laundry services including workwear contamination management, detergent programs, and garment tracking for hazardous material handling.

## Core Framework
- Analyze requirements and constraints specific to industrial-laundry-ops
...
## Key Prompts
- "Initiate industrial-laundry-ops workflow for [context]"
- "Analyze current state of industrial-laundry-ops and identify gaps"
- "Generate recommendations for industrial-laundry-ops optimization"
- "Create detailed plan for industrial-laundry-ops execution"
