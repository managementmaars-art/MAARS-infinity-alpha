---
name: tob-sharp-edges
description: Trail of Bits: sharp edges — identify dangerous language features and API misuse patterns
---

# Tob Sharp Edges — MAARS Security Reference

## Overview
Trail of Bits: sharp edges — identify dangerous language features and API misuse patterns
