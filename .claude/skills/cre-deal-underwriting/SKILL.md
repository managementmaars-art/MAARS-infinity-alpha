---
name: cre-deal-underwriting
description: Underwrite commercial real estate acquisitions including pro forma modeling, cap rate analysis, and debt sizing.
---

## Overview
Underwrite commercial real estate acquisitions including pro forma modeling, cap rate analysis, and debt sizing.

## Core Framework
- Analyze requirements and constraints specific to cre-deal-underwriting
...
## Key Prompts
- "Initiate cre-deal-underwriting workflow for [context]"
- "Analyze current state of cre-deal-underwriting and identify gaps"
- "Generate recommendations for cre-deal-underwriting optimization"
- "Create detailed plan for cre-deal-underwriting execution"
