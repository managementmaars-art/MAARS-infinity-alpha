---
name: network-analyzer-calibration
description: Calibrate and operate network analyzers for S-parameter measurement, impedance characterization, and antenna tuning in RF design validation.
---

## Overview
Calibrate and operate network analyzers for S-parameter measurement, impedance characterization, and antenna tuning in RF design validation.

## Core Framework
- Analyze requirements and constraints specific to network-analyzer-calibration
...
## Key Prompts
- "Initiate network-analyzer-calibration workflow for [context]"
- "Analyze current state of network-analyzer-calibration and identify gaps"
- "Generate recommendations for network-analyzer-calibration optimization"
- "Create detailed plan for network-analyzer-calibration execution"
