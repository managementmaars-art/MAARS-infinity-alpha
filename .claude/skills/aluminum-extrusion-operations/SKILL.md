...
description: Operate aluminum extrusion operations including billet heating management, die qualification, press force optimization, and age hardening scheduling.
---

## Overview
Operate aluminum extrusion operations including billet heating management, die qualification, press force optimization, and age hardening scheduling.

## Core Framework
- Analyze requirements and constraints specific to aluminum-extrusion-operations
...
## Key Prompts
- "Initiate aluminum-extrusion-operations workflow for [context]"
- "Analyze current state of aluminum-extrusion-operations and identify gaps"
- "Generate recommendations for aluminum-extrusion-operations optimization"
- "Create detailed plan for aluminum-extrusion-operations execution"
