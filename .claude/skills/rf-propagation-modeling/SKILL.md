---
name: rf-propagation-modeling
description: Model RF propagation for radar and communication systems including terrain diffraction, atmospheric refraction, and multipath analysis.
---

## Overview
Model RF propagation for radar and communication systems including terrain diffraction, atmospheric refraction, and multipath analysis.

## Core Framework
- Analyze requirements and constraints specific to rf-propagation-modeling
...
## Key Prompts
- "Initiate rf-propagation-modeling workflow for [context]"
- "Analyze current state of rf-propagation-modeling and identify gaps"
- "Generate recommendations for rf-propagation-modeling optimization"
- "Create detailed plan for rf-propagation-modeling execution"
