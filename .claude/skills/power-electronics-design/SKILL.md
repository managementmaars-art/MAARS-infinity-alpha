...
description: Develop power electronics designs including switching topology selection, thermal management, EMI filtering, and control loop compensation.
---

## Overview
Develop power electronics designs including switching topology selection, thermal management, EMI filtering, and control loop compensation.

## Core Framework
- Analyze requirements and constraints specific to power-electronics-design
...
## Key Prompts
- "Initiate power-electronics-design workflow for [context]"
- "Analyze current state of power-electronics-design and identify gaps"
- "Generate recommendations for power-electronics-design optimization"
- "Create detailed plan for power-electronics-design execution"
