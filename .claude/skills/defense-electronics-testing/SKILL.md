---
name: defense-electronics-testing
description: Execute defense electronics testing programs including MIL-STD-810 environmental testing, EMI/EMC compliance, and qualification test planning.
---

## Overview
Execute defense electronics testing programs including MIL-STD-810 environmental testing, EMI/EMC compliance, and qualification test planning.

## Core Framework
- Analyze requirements and constraints specific to defense-electronics-testing
...
## Key Prompts
- "Initiate defense-electronics-testing workflow for [context]"
- "Analyze current state of defense-electronics-testing and identify gaps"
- "Generate recommendations for defense-electronics-testing optimization"
- "Create detailed plan for defense-electronics-testing execution"
