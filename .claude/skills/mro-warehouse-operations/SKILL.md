---
name: mro-warehouse-operations
description: Operate MRO warehouse operations including receiving, putaway, pick-pack-ship, will-call counter, and returns processing workflows.
---

## Overview
Operate MRO warehouse operations including receiving, putaway, pick-pack-ship, will-call counter, and returns processing workflows.

## Core Framework
- Analyze requirements and constraints specific to mro-warehouse-operations
...
## Key Prompts
- "Initiate mro-warehouse-operations workflow for [context]"
- "Analyze current state of mro-warehouse-operations and identify gaps"
- "Generate recommendations for mro-warehouse-operations optimization"
- "Create detailed plan for mro-warehouse-operations execution"
