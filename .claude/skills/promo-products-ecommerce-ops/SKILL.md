---
name: promo-products-ecommerce-ops
description: Operate promotional products ecommerce including online stores, product configurators, workflow automation, and fulfillment integration.
---

## Overview
Operate promotional products ecommerce including online stores, product configurators, workflow automation, and fulfillment integration.

## Core Framework
- Analyze requirements and constraints specific to promo-products-ecommerce-ops
...
## Key Prompts
- "Initiate promo-products-ecommerce-ops workflow for [context]"
- "Analyze current state of promo-products-ecommerce-ops and identify gaps"
- "Generate recommendations for promo-products-ecommerce-ops optimization"
- "Create detailed plan for promo-products-ecommerce-ops execution"
