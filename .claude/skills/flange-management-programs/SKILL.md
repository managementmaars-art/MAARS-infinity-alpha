---
name: flange-management-programs
description: Manage flange assembly programs including bolt torque specifications, gasket seating stress calculations, and controlled tightening documentation.
---

## Overview
Manage flange assembly programs including bolt torque specifications, gasket seating stress calculations, and controlled tightening documentation.

## Core Framework
- Analyze requirements and constraints specific to flange-management-programs
...
## Key Prompts
- "Initiate flange-management-programs workflow for [context]"
- "Analyze current state of flange-management-programs and identify gaps"
- "Generate recommendations for flange-management-programs optimization"
- "Create detailed plan for flange-management-programs execution"
