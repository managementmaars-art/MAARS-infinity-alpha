---
name: ems-quality-management
description: Manage EMS quality programs including IPC-A-610 workmanship standards, first article inspection, and customer quality system audits.
---

## Overview
Manage EMS quality programs including IPC-A-610 workmanship standards, first article inspection, and customer quality system audits.

## Core Framework
- Analyze requirements and constraints specific to ems-quality-management
...
## Key Prompts
- "Initiate ems-quality-management workflow for [context]"
- "Analyze current state of ems-quality-management and identify gaps"
- "Generate recommendations for ems-quality-management optimization"
- "Create detailed plan for ems-quality-management execution"
