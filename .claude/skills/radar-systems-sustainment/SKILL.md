---
name: radar-systems-sustainment
description: Sustain radar and electronic warfare systems including obsolescence management, software updates, and depot repair programs.
---

## Overview
Sustain radar and electronic warfare systems including obsolescence management, software updates, and depot repair programs.

## Core Framework
- Analyze requirements and constraints specific to radar-systems-sustainment
...
## Key Prompts
- "Initiate radar-systems-sustainment workflow for [context]"
- "Analyze current state of radar-systems-sustainment and identify gaps"
- "Generate recommendations for radar-systems-sustainment optimization"
- "Create detailed plan for radar-systems-sustainment execution"
