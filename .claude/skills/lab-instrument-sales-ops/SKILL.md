---
name: lab-instrument-sales-ops
description: Manage laboratory instrument sales operations including distributor channel, direct sales, demo fleet, and service contract programs.
---

## Overview
Manage laboratory instrument sales operations including distributor channel, direct sales, demo fleet, and service contract programs.

## Core Framework
- Analyze requirements and constraints specific to lab-instrument-sales-ops
...
## Key Prompts
- "Initiate lab-instrument-sales-ops workflow for [context]"
- "Analyze current state of lab-instrument-sales-ops and identify gaps"
- "Generate recommendations for lab-instrument-sales-ops optimization"
- "Create detailed plan for lab-instrument-sales-ops execution"
