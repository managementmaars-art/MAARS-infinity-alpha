---
name: public-space-management
description: Oversee public space operations including park programming, plaza maintenance contracts, events permitting, and user experience monitoring.
---

## Overview
Oversee public space operations including park programming, plaza maintenance contracts, events permitting, and user experience monitoring.

## Core Framework
- Analyze requirements and constraints specific to public-space-management
...
## Key Prompts
- "Initiate public-space-management workflow for [context]"
- "Analyze current state of public-space-management and identify gaps"
- "Generate recommendations for public-space-management optimization"
- "Create detailed plan for public-space-management execution"
