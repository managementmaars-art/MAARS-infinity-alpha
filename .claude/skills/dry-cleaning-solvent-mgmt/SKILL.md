---
name: dry-cleaning-solvent-mgmt
description: Manage dry cleaning solvent programs including perc alternative selection, still operation, solvent recovery, and environmental compliance reporting.
---

## Overview
Manage dry cleaning solvent programs including perc alternative selection, still operation, solvent recovery, and environmental compliance reporting.

## Core Framework
- Analyze requirements and constraints specific to dry-cleaning-solvent-mgmt
...
## Key Prompts
- "Initiate dry-cleaning-solvent-mgmt workflow for [context]"
- "Analyze current state of dry-cleaning-solvent-mgmt and identify gaps"
- "Generate recommendations for dry-cleaning-solvent-mgmt optimization"
- "Create detailed plan for dry-cleaning-solvent-mgmt execution"
