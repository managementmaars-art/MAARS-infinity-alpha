...
description: Manage ductwork and air distribution manufacturing including spiral duct fabrication, diffuser production, and SMACNA standard compliance.
---

## Overview
Manage ductwork and air distribution manufacturing including spiral duct fabrication, diffuser production, and SMACNA standard compliance.

## Core Framework
- Analyze requirements and constraints specific to ductwork-air-distribution
...
## Key Prompts
- "Initiate ductwork-air-distribution workflow for [context]"
- "Analyze current state of ductwork-air-distribution and identify gaps"
- "Generate recommendations for ductwork-air-distribution optimization"
- "Create detailed plan for ductwork-air-distribution execution"
