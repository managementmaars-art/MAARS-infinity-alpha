---
name: industrial-power-supply-mfg
description: Produce industrial power supplies including switch-mode topology design, EMC filter assembly, hold-up time testing, and MTBF verification.
---

## Overview
Produce industrial power supplies including switch-mode topology design, EMC filter assembly, hold-up time testing, and MTBF verification.

## Core Framework
- Analyze requirements and constraints specific to industrial-power-supply-mfg
...
## Key Prompts
- "Initiate industrial-power-supply-mfg workflow for [context]"
- "Analyze current state of industrial-power-supply-mfg and identify gaps"
- "Generate recommendations for industrial-power-supply-mfg optimization"
- "Create detailed plan for industrial-power-supply-mfg execution"
