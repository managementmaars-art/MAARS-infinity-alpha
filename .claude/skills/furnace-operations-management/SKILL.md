---
name: furnace-operations-management
description: Manage heat treatment furnace operations including load scheduling, temperature uniformity surveys, and equipment qualification per AMS2750.
---

## Overview
Manage heat treatment furnace operations including load scheduling, temperature uniformity surveys, and equipment qualification per AMS2750.

## Core Framework
- Analyze requirements and constraints specific to furnace-operations-management
...
## Key Prompts
- "Initiate furnace-operations-management workflow for [context]"
- "Analyze current state of furnace-operations-management and identify gaps"
- "Generate recommendations for furnace-operations-management optimization"
- "Create detailed plan for furnace-operations-management execution"
