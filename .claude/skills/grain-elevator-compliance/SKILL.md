---
name: grain-elevator-compliance
description: Navigate grain elevator regulatory compliance including state licensing, USDA inspection programs, commodity exchange rules, and environmental permits.
---

## Overview
Navigate grain elevator regulatory compliance including state licensing, USDA inspection programs, commodity exchange rules, and environmental permits.

## Core Framework
- Analyze requirements and constraints specific to grain-elevator-compliance
...
## Key Prompts
- "Initiate grain-elevator-compliance workflow for [context]"
- "Analyze current state of grain-elevator-compliance and identify gaps"
- "Generate recommendations for grain-elevator-compliance optimization"
- "Create detailed plan for grain-elevator-compliance execution"
