---
name: edge-computing-ops
description: Operate edge computing systems for industrial IoT including hardware selection, container orchestration, local analytics, and remote management.
---

## Overview
Operate edge computing systems for industrial IoT including hardware selection, container orchestration, local analytics, and remote management.

## Core Framework
- Analyze requirements and constraints specific to edge-computing-ops
...
## Key Prompts
- "Initiate edge-computing-ops workflow for [context]"
- "Analyze current state of edge-computing-ops and identify gaps"
- "Generate recommendations for edge-computing-ops optimization"
- "Create detailed plan for edge-computing-ops execution"
