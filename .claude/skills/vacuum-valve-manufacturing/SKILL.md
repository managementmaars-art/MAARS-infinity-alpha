---
name: vacuum-valve-manufacturing
description: Produce vacuum isolation and control valves including gate valve assembly, bellows seal fabrication, and leak rate certification.
---

## Overview
Produce vacuum isolation and control valves including gate valve assembly, bellows seal fabrication, and leak rate certification.

## Core Framework
- Analyze requirements and constraints specific to vacuum-valve-manufacturing
...
## Key Prompts
- "Initiate vacuum-valve-manufacturing workflow for [context]"
- "Analyze current state of vacuum-valve-manufacturing and identify gaps"
- "Generate recommendations for vacuum-valve-manufacturing optimization"
- "Create detailed plan for vacuum-valve-manufacturing execution"
