---
name: critical-lift-management
description: Manage critical lift programs including tandem lift coordination, near-capacity lift procedures, and third-party engineering review requirements.
---

## Overview
Manage critical lift programs including tandem lift coordination, near-capacity lift procedures, and third-party engineering review requirements.

## Core Framework
- Analyze requirements and constraints specific to critical-lift-management
...
## Key Prompts
- "Initiate critical-lift-management workflow for [context]"
- "Analyze current state of critical-lift-management and identify gaps"
- "Generate recommendations for critical-lift-management optimization"
- "Create detailed plan for critical-lift-management execution"
