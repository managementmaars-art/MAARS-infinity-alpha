...
description: Maintain semiconductor fab equipment including preventive maintenance scheduling, spare parts management, and tool qualification.
---

## Overview
Maintain semiconductor fab equipment including preventive maintenance scheduling, spare parts management, and tool qualification.

## Core Framework
- Analyze requirements and constraints specific to semiconductor-equipment-maintenance
...
## Key Prompts
- "Initiate semiconductor-equipment-maintenance workflow for [context]"
- "Analyze current state of semiconductor-equipment-maintenance and identify gaps"
- "Generate recommendations for semiconductor-equipment-maintenance optimization"
- "Create detailed plan for semiconductor-equipment-maintenance execution"
