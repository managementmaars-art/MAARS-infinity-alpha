...
description: Manage hazardous waste programs including waste characterization, manifest documentation, approved disposal facility coordination, and RCRA compliance.
---

## Overview
Manage hazardous waste programs including waste characterization, manifest documentation, approved disposal facility coordination, and RCRA compliance.

## Core Framework
- Analyze requirements and constraints specific to hazardous-waste-management
...
## Key Prompts
- "Initiate hazardous-waste-management workflow for [context]"
- "Analyze current state of hazardous-waste-management and identify gaps"
- "Generate recommendations for hazardous-waste-management optimization"
- "Create detailed plan for hazardous-waste-management execution"
