...
description: Conduct thermal simulations using CFD and FEA tools for electronics cooling design validation, hotspot identification, and design optimization.
---

## Overview
Conduct thermal simulations using CFD and FEA tools for electronics cooling design validation, hotspot identification, and design optimization.

## Core Framework
- Analyze requirements and constraints specific to thermal-simulation-analysis
...
## Key Prompts
- "Initiate thermal-simulation-analysis workflow for [context]"
- "Analyze current state of thermal-simulation-analysis and identify gaps"
- "Generate recommendations for thermal-simulation-analysis optimization"
- "Create detailed plan for thermal-simulation-analysis execution"
