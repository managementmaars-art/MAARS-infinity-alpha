---
name: earth-observation-data-ops
description: Operate earth observation data services including image acquisition tasking, processing pipelines, and geospatial product delivery.
---

## Overview
Operate earth observation data services including image acquisition tasking, processing pipelines, and geospatial product delivery.

## Core Framework
- Analyze requirements and constraints specific to earth-observation-data-ops
...
## Key Prompts
- "Initiate earth-observation-data-ops workflow for [context]"
- "Analyze current state of earth-observation-data-ops and identify gaps"
- "Generate recommendations for earth-observation-data-ops optimization"
- "Create detailed plan for earth-observation-data-ops execution"
