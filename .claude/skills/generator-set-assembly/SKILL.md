---
name: generator-set-assembly
description: Manage generator set assembly operations including base frame fabrication, engine-alternator coupling, enclosure mounting, and load bank testing.
---

## Overview
Manage generator set assembly operations including base frame fabrication, engine-alternator coupling, enclosure mounting, and load bank testing.

## Core Framework
- Analyze requirements and constraints specific to generator-set-assembly
...
## Key Prompts
- "Initiate generator-set-assembly workflow for [context]"
- "Analyze current state of generator-set-assembly and identify gaps"
- "Generate recommendations for generator-set-assembly optimization"
- "Create detailed plan for generator-set-assembly execution"
