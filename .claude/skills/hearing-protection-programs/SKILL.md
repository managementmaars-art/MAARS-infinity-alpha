---
name: hearing-protection-programs
description: Manage industrial hearing protection programs including noise level survey integration, NRR selection guidance, and audiometric testing coordination.
---

## Overview
Manage industrial hearing protection programs including noise level survey integration, NRR selection guidance, and audiometric testing coordination.

## Core Framework
- Analyze requirements and constraints specific to hearing-protection-programs
...
## Key Prompts
- "Initiate hearing-protection-programs workflow for [context]"
- "Analyze current state of hearing-protection-programs and identify gaps"
- "Generate recommendations for hearing-protection-programs optimization"
- "Create detailed plan for hearing-protection-programs execution"
