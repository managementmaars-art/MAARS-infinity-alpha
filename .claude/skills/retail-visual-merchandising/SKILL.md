---
name: retail-visual-merchandising
description: Design and execute visual merchandising programs including planogram compliance, fixture layouts, and window display management.
---

## Overview
Design and execute visual merchandising programs including planogram compliance, fixture layouts, and window display management.

## Core Framework
- Analyze requirements and constraints specific to retail-visual-merchandising
...
## Key Prompts
- "Initiate retail-visual-merchandising workflow for [context]"
- "Analyze current state of retail-visual-merchandising and identify gaps"
- "Generate recommendations for retail-visual-merchandising optimization"
- "Create detailed plan for retail-visual-merchandising execution"
