---
name: mechanical-seal-programs
description: Manage mechanical seal programs for rotating equipment including seal selection, installation procedures, flush plan implementation, and failure analysis.
---

## Overview
Manage mechanical seal programs for rotating equipment including seal selection, installation procedures, flush plan implementation, and failure analysis.

## Core Framework
- Analyze requirements and constraints specific to mechanical-seal-programs
...
## Key Prompts
- "Initiate mechanical-seal-programs workflow for [context]"
- "Analyze current state of mechanical-seal-programs and identify gaps"
- "Generate recommendations for mechanical-seal-programs optimization"
- "Create detailed plan for mechanical-seal-programs execution"
