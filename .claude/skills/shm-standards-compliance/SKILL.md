---
name: shm-standards-compliance
description: Navigate SHM standards and guidelines including IABMAS, ISHMII practices, and regulatory requirements for monitored infrastructure assets.
---

## Overview
Navigate SHM standards and guidelines including IABMAS, ISHMII practices, and regulatory requirements for monitored infrastructure assets.

## Core Framework
- Analyze requirements and constraints specific to shm-standards-compliance
...
## Key Prompts
- "Initiate shm-standards-compliance workflow for [context]"
- "Analyze current state of shm-standards-compliance and identify gaps"
- "Generate recommendations for shm-standards-compliance optimization"
- "Create detailed plan for shm-standards-compliance execution"
