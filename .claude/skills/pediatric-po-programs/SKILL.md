---
name: pediatric-po-programs
description: Manage pediatric prosthetics and orthotics programs including growth accommodation, school coordination, and developmental milestone tracking.
---

## Overview
Manage pediatric prosthetics and orthotics programs including growth accommodation, school coordination, and developmental milestone tracking.

## Core Framework
- Analyze requirements and constraints specific to pediatric-po-programs
...
## Key Prompts
- "Initiate pediatric-po-programs workflow for [context]"
- "Analyze current state of pediatric-po-programs and identify gaps"
- "Generate recommendations for pediatric-po-programs optimization"
- "Create detailed plan for pediatric-po-programs execution"
