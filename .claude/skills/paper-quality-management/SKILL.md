---
name: paper-quality-management
description: Manage paper quality programs including brightness, smoothness, tensile strength, and formation testing with customer specification compliance.
---

## Overview
Manage paper quality programs including brightness, smoothness, tensile strength, and formation testing with customer specification compliance.

## Core Framework
- Analyze requirements and constraints specific to paper-quality-management
...
## Key Prompts
- "Initiate paper-quality-management workflow for [context]"
- "Analyze current state of paper-quality-management and identify gaps"
- "Generate recommendations for paper-quality-management optimization"
- "Create detailed plan for paper-quality-management execution"
