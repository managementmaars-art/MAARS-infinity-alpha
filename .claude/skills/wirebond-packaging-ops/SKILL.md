---
name: wirebond-packaging-ops
description: Manage wire bond packaging operations including die attach, gold and copper wire bonding, encapsulation, and electrical test coordination.
---

## Overview
Manage wire bond packaging operations including die attach, gold and copper wire bonding, encapsulation, and electrical test coordination.

## Core Framework
- Analyze requirements and constraints specific to wirebond-packaging-ops
...
## Key Prompts
- "Initiate wirebond-packaging-ops workflow for [context]"
- "Analyze current state of wirebond-packaging-ops and identify gaps"
- "Generate recommendations for wirebond-packaging-ops optimization"
- "Create detailed plan for wirebond-packaging-ops execution"
