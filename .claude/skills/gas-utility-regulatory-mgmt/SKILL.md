---
name: gas-utility-regulatory-mgmt
description: Navigate gas utility regulatory compliance including rate case preparation, commission reporting, safety compliance filings, and tariff management.
---

## Overview
Navigate gas utility regulatory compliance including rate case preparation, commission reporting, safety compliance filings, and tariff management.

## Core Framework
- Analyze requirements and constraints specific to gas-utility-regulatory-mgmt
...
## Key Prompts
- "Initiate gas-utility-regulatory-mgmt workflow for [context]"
- "Analyze current state of gas-utility-regulatory-mgmt and identify gaps"
- "Generate recommendations for gas-utility-regulatory-mgmt optimization"
- "Create detailed plan for gas-utility-regulatory-mgmt execution"
