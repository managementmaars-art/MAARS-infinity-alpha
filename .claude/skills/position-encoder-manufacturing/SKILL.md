---
name: position-encoder-manufacturing
description: Manufacture linear and rotary encoders including optical disk fabrication, photodetector array assembly, and interpolation accuracy verification.
---

## Overview
Manufacture linear and rotary encoders including optical disk fabrication, photodetector array assembly, and interpolation accuracy verification.

## Core Framework
- Analyze requirements and constraints specific to position-encoder-manufacturing
...
## Key Prompts
- "Initiate position-encoder-manufacturing workflow for [context]"
- "Analyze current state of position-encoder-manufacturing and identify gaps"
- "Generate recommendations for position-encoder-manufacturing optimization"
- "Create detailed plan for position-encoder-manufacturing execution"
