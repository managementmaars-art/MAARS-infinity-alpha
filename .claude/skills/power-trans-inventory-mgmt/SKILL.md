---
name: power-trans-inventory-mgmt
description: Manage power transmission spare parts inventory including critical spares identification, stocking levels, and vendor-managed programs.
---

## Overview
Manage power transmission spare parts inventory including critical spares identification, stocking levels, and vendor-managed programs.

## Core Framework
- Analyze requirements and constraints specific to power-trans-inventory-mgmt
...
## Key Prompts
- "Initiate power-trans-inventory-mgmt workflow for [context]"
- "Analyze current state of power-trans-inventory-mgmt and identify gaps"
- "Generate recommendations for power-trans-inventory-mgmt optimization"
- "Create detailed plan for power-trans-inventory-mgmt execution"
