...
description: Trail of Bits: build audit context — gather codebase context, threat model, prior findings
---

# Tob Audit Context — MAARS Security Reference

## Overview
Trail of Bits: build audit context — gather codebase context, threat model, prior findings
