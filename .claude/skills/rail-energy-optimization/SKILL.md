---
name: rail-energy-optimization
description: Optimize energy consumption for rail operations including regenerative braking energy recovery, eco-driving programs, and idle reduction strategies.
---

## Overview
Optimize energy consumption for rail operations including regenerative braking energy recovery, eco-driving programs, and idle reduction strategies.

## Core Framework
- Analyze requirements and constraints specific to rail-energy-optimization
...
## Key Prompts
- "Initiate rail-energy-optimization workflow for [context]"
- "Analyze current state of rail-energy-optimization and identify gaps"
- "Generate recommendations for rail-energy-optimization optimization"
- "Create detailed plan for rail-energy-optimization execution"
