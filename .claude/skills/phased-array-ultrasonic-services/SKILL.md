---
name: phased-array-ultrasonic-services
description: Operate phased array UT services including probe selection, sectorial scan programming, calibration procedures, weld inspection, and corrosion mapping.
---

## Overview
Operate phased array UT services including probe selection, sectorial scan programming, calibration procedures, weld inspection, and corrosion mapping.

## Core Framework
- Analyze requirements and constraints specific to phased-array-ultrasonic-services
...
## Key Prompts
- "Initiate phased-array-ultrasonic-services workflow for [context]"
- "Analyze current state of phased-array-ultrasonic-services and identify gaps"
- "Generate recommendations for phased-array-ultrasonic-services optimization"
- "Create detailed plan for phased-array-ultrasonic-services execution"
