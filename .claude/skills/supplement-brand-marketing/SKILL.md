---
name: supplement-brand-marketing
description: Manage nutritional supplement brand programs including clinical study marketing, retailer shelf programs, and DTC subscription sales.
---

## Overview
Manage nutritional supplement brand programs including clinical study marketing, retailer shelf programs, and DTC subscription sales.

## Core Framework
- Analyze requirements and constraints specific to supplement-brand-marketing
...
## Key Prompts
- "Initiate supplement-brand-marketing workflow for [context]"
- "Analyze current state of supplement-brand-marketing and identify gaps"
- "Generate recommendations for supplement-brand-marketing optimization"
- "Create detailed plan for supplement-brand-marketing execution"
