---
name: hydrometallurgy-plant-ops
description: Manage hydrometallurgical plant operations including heap leach irrigation scheduling, SX-EW circuit management, and solution chemistry control.
---

## Overview
Manage hydrometallurgical plant operations including heap leach irrigation scheduling, SX-EW circuit management, and solution chemistry control.

## Core Framework
- Analyze requirements and constraints specific to hydrometallurgy-plant-ops
...
## Key Prompts
- "Initiate hydrometallurgy-plant-ops workflow for [context]"
- "Analyze current state of hydrometallurgy-plant-ops and identify gaps"
- "Generate recommendations for hydrometallurgy-plant-ops optimization"
- "Create detailed plan for hydrometallurgy-plant-ops execution"
