...
description: Provide biohazard decontamination services including crime scene cleanup, hoarding remediation, and infectious disease decontamination with proper PPE and disposal.
---

## Overview
Provide biohazard decontamination services including crime scene cleanup, hoarding remediation, and infectious disease decontamination with proper PPE and disposal.

## Core Framework
- Analyze requirements and constraints specific to biohazard-decontamination
...
## Key Prompts
- "Initiate biohazard-decontamination workflow for [context]"
- "Analyze current state of biohazard-decontamination and identify gaps"
- "Generate recommendations for biohazard-decontamination optimization"
- "Create detailed plan for biohazard-decontamination execution"
