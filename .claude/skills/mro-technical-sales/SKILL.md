---
name: mro-technical-sales
description: Support MRO technical sales including product application engineering, cross-sell and up-sell programs, and national account management.
---

## Overview
Support MRO technical sales including product application engineering, cross-sell and up-sell programs, and national account management.

## Core Framework
- Analyze requirements and constraints specific to mro-technical-sales
...
## Key Prompts
- "Initiate mro-technical-sales workflow for [context]"
- "Analyze current state of mro-technical-sales and identify gaps"
- "Generate recommendations for mro-technical-sales optimization"
- "Create detailed plan for mro-technical-sales execution"
