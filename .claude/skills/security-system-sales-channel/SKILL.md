---
name: security-system-sales-channel
description: Manage security system sales through security dealers, systems integrators, and national installation company programs.
---

## Overview
Manage security system sales through security dealers, systems integrators, and national installation company programs.

## Core Framework
- Analyze requirements and constraints specific to security-system-sales-channel
...
## Key Prompts
- "Initiate security-system-sales-channel workflow for [context]"
- "Analyze current state of security-system-sales-channel and identify gaps"
- "Generate recommendations for security-system-sales-channel optimization"
- "Create detailed plan for security-system-sales-channel execution"
