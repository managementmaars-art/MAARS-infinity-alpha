---
name: commercial-pool-service-ops
description: Manage commercial pool and aquatics facility maintenance including health department compliance, operator certification, and daily chemical testing.
---

## Overview
Manage commercial pool and aquatics facility maintenance including health department compliance, operator certification, and daily chemical testing.

## Core Framework
- Analyze requirements and constraints specific to commercial-pool-service-ops
...
## Key Prompts
- "Initiate commercial-pool-service-ops workflow for [context]"
- "Analyze current state of commercial-pool-service-ops and identify gaps"
- "Generate recommendations for commercial-pool-service-ops optimization"
- "Create detailed plan for commercial-pool-service-ops execution"
