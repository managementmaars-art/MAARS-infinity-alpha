---
name: restaurant-liquidation-services
description: Provide restaurant liquidation services including buyouts, on-site sales, consignment programs, and estate settlement coordination.
---

## Overview
Provide restaurant liquidation services including buyouts, on-site sales, consignment programs, and estate settlement coordination.

## Core Framework
- Analyze requirements and constraints specific to restaurant-liquidation-services
...
## Key Prompts
- "Initiate restaurant-liquidation-services workflow for [context]"
- "Analyze current state of restaurant-liquidation-services and identify gaps"
- "Generate recommendations for restaurant-liquidation-services optimization"
- "Create detailed plan for restaurant-liquidation-services execution"
