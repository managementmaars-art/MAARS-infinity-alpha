---
name: regenerative-drive-manufacturing
description: Manufacture regenerative variable speed drives including active front end assembly, energy feedback integration, and four-quadrant operation testing.
---

## Overview
Manufacture regenerative variable speed drives including active front end assembly, energy feedback integration, and four-quadrant operation testing.

## Core Framework
- Analyze requirements and constraints specific to regenerative-drive-manufacturing
...
## Key Prompts
- "Initiate regenerative-drive-manufacturing workflow for [context]"
- "Analyze current state of regenerative-drive-manufacturing and identify gaps"
- "Generate recommendations for regenerative-drive-manufacturing optimization"
- "Create detailed plan for regenerative-drive-manufacturing execution"
