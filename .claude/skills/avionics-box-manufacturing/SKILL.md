---
name: avionics-box-manufacturing
description: Build avionics LRUs including chassis machining, PCB population, conformal coating, EMI shielding installation, and DO-160 environmental qualification.
---

## Overview
Build avionics LRUs including chassis machining, PCB population, conformal coating, EMI shielding installation, and DO-160 environmental qualification.

## Core Framework
- Analyze requirements and constraints specific to avionics-box-manufacturing
...
## Key Prompts
- "Initiate avionics-box-manufacturing workflow for [context]"
- "Analyze current state of avionics-box-manufacturing and identify gaps"
- "Generate recommendations for avionics-box-manufacturing optimization"
- "Create detailed plan for avionics-box-manufacturing execution"
