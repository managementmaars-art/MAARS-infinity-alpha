...
description: Operate chemical pulp mills including digester management, washing and screening operations, bleaching sequence control, and black liquor recovery.
---

## Overview
Operate chemical pulp mills including digester management, washing and screening operations, bleaching sequence control, and black liquor recovery.

## Core Framework
- Analyze requirements and constraints specific to pulp-mill-operations
...
## Key Prompts
- "Initiate pulp-mill-operations workflow for [context]"
- "Analyze current state of pulp-mill-operations and identify gaps"
- "Generate recommendations for pulp-mill-operations optimization"
- "Create detailed plan for pulp-mill-operations execution"
