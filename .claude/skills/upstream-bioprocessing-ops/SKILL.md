---
name: upstream-bioprocessing-ops
description: Operate upstream bioprocessing including seed train management, bioreactor feeding strategy, dissolved oxygen control, and harvest trigger decisions.
---

## Overview
Operate upstream bioprocessing including seed train management, bioreactor feeding strategy, dissolved oxygen control, and harvest trigger decisions.

## Core Framework
- Analyze requirements and constraints specific to upstream-bioprocessing-ops
...
## Key Prompts
- "Initiate upstream-bioprocessing-ops workflow for [context]"
- "Analyze current state of upstream-bioprocessing-ops and identify gaps"
- "Generate recommendations for upstream-bioprocessing-ops optimization"
- "Create detailed plan for upstream-bioprocessing-ops execution"
