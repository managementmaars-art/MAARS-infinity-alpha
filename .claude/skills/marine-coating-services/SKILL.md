...
description: Manage marine coating services including drydock coordination, antifouling application, and underwater hull maintenance programs.
---

## Overview
Manage marine coating services including drydock coordination, antifouling application, and underwater hull maintenance programs.

## Core Framework
- Analyze requirements and constraints specific to marine-coating-services
...
## Key Prompts
- "Initiate marine-coating-services workflow for [context]"
- "Analyze current state of marine-coating-services and identify gaps"
- "Generate recommendations for marine-coating-services optimization"
- "Create detailed plan for marine-coating-services execution"
