---
name: fuel-cell-safety-management
description: Manage fuel cell safety programs including hydrogen leak detection, purge system design, FMEA, and functional safety standard compliance.
---

## Overview
Manage fuel cell safety programs including hydrogen leak detection, purge system design, FMEA, and functional safety standard compliance.

## Core Framework
- Analyze requirements and constraints specific to fuel-cell-safety-management
...
## Key Prompts
- "Initiate fuel-cell-safety-management workflow for [context]"
- "Analyze current state of fuel-cell-safety-management and identify gaps"
- "Generate recommendations for fuel-cell-safety-management optimization"
- "Create detailed plan for fuel-cell-safety-management execution"
