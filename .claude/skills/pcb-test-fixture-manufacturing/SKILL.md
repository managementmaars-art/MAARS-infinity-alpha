---
name: pcb-test-fixture-manufacturing
description: Manufacture PCB in-circuit test fixtures including bed-of-nails design, spring probe selection, and fixture verification procedures.
---

## Overview
Manufacture PCB in-circuit test fixtures including bed-of-nails design, spring probe selection, and fixture verification procedures.

## Core Framework
- Analyze requirements and constraints specific to pcb-test-fixture-manufacturing
...
## Key Prompts
- "Initiate pcb-test-fixture-manufacturing workflow for [context]"
- "Analyze current state of pcb-test-fixture-manufacturing and identify gaps"
- "Generate recommendations for pcb-test-fixture-manufacturing optimization"
- "Create detailed plan for pcb-test-fixture-manufacturing execution"
