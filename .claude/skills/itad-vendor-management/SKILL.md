---
name: itad-vendor-management
description: Manage ITAD vendor programs including downstream vendor audits, certification requirements, material flow tracking, and liability management.
---

## Overview
Manage ITAD vendor programs including downstream vendor audits, certification requirements, material flow tracking, and liability management.

## Core Framework
- Analyze requirements and constraints specific to itad-vendor-management
...
## Key Prompts
- "Initiate itad-vendor-management workflow for [context]"
- "Analyze current state of itad-vendor-management and identify gaps"
- "Generate recommendations for itad-vendor-management optimization"
- "Create detailed plan for itad-vendor-management execution"
