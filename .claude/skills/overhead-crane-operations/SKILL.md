---
name: overhead-crane-operations
description: Manage overhead crane operations including operator qualification, pre-use inspections, lift planning, and ASME B30.2 standards compliance.
---

## Overview
Manage overhead crane operations including operator qualification, pre-use inspections, lift planning, and ASME B30.2 standards compliance.

## Core Framework
- Analyze requirements and constraints specific to overhead-crane-operations
...
## Key Prompts
- "Initiate overhead-crane-operations workflow for [context]"
- "Analyze current state of overhead-crane-operations and identify gaps"
- "Generate recommendations for overhead-crane-operations optimization"
- "Create detailed plan for overhead-crane-operations execution"
