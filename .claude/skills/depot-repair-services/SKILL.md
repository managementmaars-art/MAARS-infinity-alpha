---
name: depot-repair-services
description: Manage depot-level electronics repair services including failure analysis, parts provisioning, repair procedures, and return-to-supply documentation.
---

## Overview
Manage depot-level electronics repair services including failure analysis, parts provisioning, repair procedures, and return-to-supply documentation.

## Core Framework
- Analyze requirements and constraints specific to depot-repair-services
...
## Key Prompts
- "Initiate depot-repair-services workflow for [context]"
- "Analyze current state of depot-repair-services and identify gaps"
- "Generate recommendations for depot-repair-services optimization"
- "Create detailed plan for depot-repair-services execution"
