---
name: rope-access-equipment-mgmt
description: Manage rope access equipment including harness inspection, rope life tracking, descender service, and anchorage device certification programs.
---

## Overview
Manage rope access equipment including harness inspection, rope life tracking, descender service, and anchorage device certification programs.

## Core Framework
- Analyze requirements and constraints specific to rope-access-equipment-mgmt
...
## Key Prompts
- "Initiate rope-access-equipment-mgmt workflow for [context]"
- "Analyze current state of rope-access-equipment-mgmt and identify gaps"
- "Generate recommendations for rope-access-equipment-mgmt optimization"
- "Create detailed plan for rope-access-equipment-mgmt execution"
