---
name: automated-microscopy-system-mfg
description: Produce automated microscopy platforms including motorized stage assembly, autofocus system integration, and fluorescence illumination calibration.
---

## Overview
Produce automated microscopy platforms including motorized stage assembly, autofocus system integration, and fluorescence illumination calibration.

## Core Framework
- Analyze requirements and constraints specific to automated-microscopy-system-mfg
...
## Key Prompts
- "Initiate automated-microscopy-system-mfg workflow for [context]"
- "Analyze current state of automated-microscopy-system-mfg and identify gaps"
- "Generate recommendations for automated-microscopy-system-mfg optimization"
- "Create detailed plan for automated-microscopy-system-mfg execution"
