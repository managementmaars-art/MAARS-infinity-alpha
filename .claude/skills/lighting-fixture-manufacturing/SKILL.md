...
description: Manage lighting fixture manufacturing including housing fabrication, reflector forming, driver mounting, and UL 1598 compliance.
---

## Overview
Manage lighting fixture manufacturing including housing fabrication, reflector forming, driver mounting, and UL 1598 compliance.

## Core Framework
- Analyze requirements and constraints specific to lighting-fixture-manufacturing
...
## Key Prompts
- "Initiate lighting-fixture-manufacturing workflow for [context]"
- "Analyze current state of lighting-fixture-manufacturing and identify gaps"
- "Generate recommendations for lighting-fixture-manufacturing optimization"
- "Create detailed plan for lighting-fixture-manufacturing execution"
