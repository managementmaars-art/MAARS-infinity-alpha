---
name: cosmetics-ecommerce-ops
description: Operate cosmetics e-commerce programs including shoppable content, virtual try-on, subscription beauty boxes, and returns management.
---

## Overview
Operate cosmetics e-commerce programs including shoppable content, virtual try-on, subscription beauty boxes, and returns management.

## Core Framework
- Analyze requirements and constraints specific to cosmetics-ecommerce-ops
...
## Key Prompts
- "Initiate cosmetics-ecommerce-ops workflow for [context]"
- "Analyze current state of cosmetics-ecommerce-ops and identify gaps"
- "Generate recommendations for cosmetics-ecommerce-ops optimization"
- "Create detailed plan for cosmetics-ecommerce-ops execution"
