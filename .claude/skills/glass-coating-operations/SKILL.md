---
name: glass-coating-operations
description: Operate glass coating lines including CVD and PVD coating processes, optical property verification, and substrate handling.
---

## Overview
Operate glass coating lines including CVD and PVD coating processes, optical property verification, and substrate handling.

## Core Framework
- Analyze requirements and constraints specific to glass-coating-operations
...
## Key Prompts
- "Initiate glass-coating-operations workflow for [context]"
- "Analyze current state of glass-coating-operations and identify gaps"
- "Generate recommendations for glass-coating-operations optimization"
- "Create detailed plan for glass-coating-operations execution"
