---
name: metal-roofing-installation-ops
description: Operate metal roofing installation services including standing seam, metal tile, retrofit systems, and manufacturer certification programs.
---

## Overview
Operate metal roofing installation services including standing seam, metal tile, retrofit systems, and manufacturer certification programs.

## Core Framework
- Analyze requirements and constraints specific to metal-roofing-installation-ops
...
## Key Prompts
- "Initiate metal-roofing-installation-ops workflow for [context]"
- "Analyze current state of metal-roofing-installation-ops and identify gaps"
- "Generate recommendations for metal-roofing-installation-ops optimization"
- "Create detailed plan for metal-roofing-installation-ops execution"
