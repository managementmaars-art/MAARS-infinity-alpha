---
name: vfd-drive-manufacturing
description: Manage variable frequency drive manufacturing operations including IGBT module mounting, bus bar assembly, gate driver testing, and functional verification.
---

## Overview
Manage variable frequency drive manufacturing operations including IGBT module mounting, bus bar assembly, gate driver testing, and functional verification.

## Core Framework
- Analyze requirements and constraints specific to vfd-drive-manufacturing
...
## Key Prompts
- "Initiate vfd-drive-manufacturing workflow for [context]"
- "Analyze current state of vfd-drive-manufacturing and identify gaps"
- "Generate recommendations for vfd-drive-manufacturing optimization"
- "Create detailed plan for vfd-drive-manufacturing execution"
