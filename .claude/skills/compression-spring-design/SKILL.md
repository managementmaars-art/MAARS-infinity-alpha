---
name: compression-spring-design
description: Design compression springs including wire diameter, coil diameter, free length, and spring rate calculation with fatigue life analysis.
---

## Overview
Design compression springs including wire diameter, coil diameter, free length, and spring rate calculation with fatigue life analysis.

## Core Framework
- Analyze requirements and constraints specific to compression-spring-design
...
## Key Prompts
- "Initiate compression-spring-design workflow for [context]"
- "Analyze current state of compression-spring-design and identify gaps"
- "Generate recommendations for compression-spring-design optimization"
- "Create detailed plan for compression-spring-design execution"
