...
description: Manage hospitality procurement including FF&E sourcing, OS&E purchasing, vendor contracts, and sustainability certifications.
---

## Overview
Manage hospitality procurement including FF&E sourcing, OS&E purchasing, vendor contracts, and sustainability certifications.

## Core Framework
- Analyze requirements and constraints specific to hospitality-procurement
...
## Key Prompts
- "Initiate hospitality-procurement workflow for [context]"
- "Analyze current state of hospitality-procurement and identify gaps"
- "Generate recommendations for hospitality-procurement optimization"
- "Create detailed plan for hospitality-procurement execution"
