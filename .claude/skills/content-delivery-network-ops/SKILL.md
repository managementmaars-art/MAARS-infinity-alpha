---
name: content-delivery-network-ops
description: Operate CDN infrastructure for streaming media including edge node management, cache hit ratio optimization, and origin shield configuration.
---

## Overview
Operate CDN infrastructure for streaming media including edge node management, cache hit ratio optimization, and origin shield configuration.

## Core Framework
- Analyze requirements and constraints specific to content-delivery-network-ops
...
## Key Prompts
- "Initiate content-delivery-network-ops workflow for [context]"
- "Analyze current state of content-delivery-network-ops and identify gaps"
- "Generate recommendations for content-delivery-network-ops optimization"
- "Create detailed plan for content-delivery-network-ops execution"
