---
name: tire-manufacturing-ops
description: Manage tire manufacturing operations including component building, curing, uniformity testing, and final inspection.
---

## Overview
Manage tire manufacturing operations including component building, curing, uniformity testing, and final inspection.

## Core Framework
- Analyze requirements and constraints specific to tire-manufacturing-ops
...
## Key Prompts
- "Initiate tire-manufacturing-ops workflow for [context]"
- "Analyze current state of tire-manufacturing-ops and identify gaps"
- "Generate recommendations for tire-manufacturing-ops optimization"
- "Create detailed plan for tire-manufacturing-ops execution"
