---
name: self-storage-portfolio-management
description: Manage self-storage facility portfolios including performance benchmarking, operator relationships, acquisition underwriting, and value-add programs.
---

## Overview
Manage self-storage facility portfolios including performance benchmarking, operator relationships, acquisition underwriting, and value-add programs.

## Core Framework
- Analyze requirements and constraints specific to self-storage-portfolio-management
...
## Key Prompts
- "Initiate self-storage-portfolio-management workflow for [context]"
- "Analyze current state of self-storage-portfolio-management and identify gaps"
- "Generate recommendations for self-storage-portfolio-management optimization"
- "Create detailed plan for self-storage-portfolio-management execution"
