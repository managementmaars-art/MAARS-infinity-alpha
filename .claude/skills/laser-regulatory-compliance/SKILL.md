---
name: laser-regulatory-compliance
description: Navigate laser regulatory compliance including FDA CDRH requirements, IEC 60825 laser product standards, and CE technical documentation.
---

## Overview
Navigate laser regulatory compliance including FDA CDRH requirements, IEC 60825 laser product standards, and CE technical documentation.

## Core Framework
- Analyze requirements and constraints specific to laser-regulatory-compliance
...
## Key Prompts
- "Initiate laser-regulatory-compliance workflow for [context]"
- "Analyze current state of laser-regulatory-compliance and identify gaps"
- "Generate recommendations for laser-regulatory-compliance optimization"
- "Create detailed plan for laser-regulatory-compliance execution"
