---
name: machining-coolant-management
description: Manage machining coolant systems including concentration monitoring, tramp oil removal, bacteria control, and disposal compliance.
---

## Overview
Manage machining coolant systems including concentration monitoring, tramp oil removal, bacteria control, and disposal compliance.

## Core Framework
- Analyze requirements and constraints specific to machining-coolant-management
...
## Key Prompts
- "Initiate machining-coolant-management workflow for [context]"
- "Analyze current state of machining-coolant-management and identify gaps"
- "Generate recommendations for machining-coolant-management optimization"
- "Create detailed plan for machining-coolant-management execution"
