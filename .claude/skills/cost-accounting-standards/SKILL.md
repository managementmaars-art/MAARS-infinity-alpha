---
name: cost-accounting-standards
description: Maintain CAS compliance including disclosure statements, cost allocation methodologies, and DCAA audit readiness.
---

## Overview
Maintain CAS compliance including disclosure statements, cost allocation methodologies, and DCAA audit readiness.

## Core Framework
- Analyze requirements and constraints specific to cost-accounting-standards
...
## Key Prompts
- "Initiate cost-accounting-standards workflow for [context]"
- "Analyze current state of cost-accounting-standards and identify gaps"
- "Generate recommendations for cost-accounting-standards optimization"
- "Create detailed plan for cost-accounting-standards execution"
