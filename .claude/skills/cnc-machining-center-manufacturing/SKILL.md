---
name: cnc-machining-center-manufacturing
description: Manufacture CNC machining centers including machine bed casting, linear guide assembly, spindle integration, and geometric accuracy verification.
---

## Overview
Manufacture CNC machining centers including machine bed casting, linear guide assembly, spindle integration, and geometric accuracy verification.

## Core Framework
- Analyze requirements and constraints specific to cnc-machining-center-manufacturing
...
## Key Prompts
- "Initiate cnc-machining-center-manufacturing workflow for [context]"
- "Analyze current state of cnc-machining-center-manufacturing and identify gaps"
- "Generate recommendations for cnc-machining-center-manufacturing optimization"
- "Create detailed plan for cnc-machining-center-manufacturing execution"
