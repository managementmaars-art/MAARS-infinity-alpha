---
name: clinical-depot-operations
description: Operate global clinical depot networks including import/export compliance, temperature excursion management, and site resupply automation.
---

## Overview
Operate global clinical depot networks including import/export compliance, temperature excursion management, and site resupply automation.

## Core Framework
- Analyze requirements and constraints specific to clinical-depot-operations
...
## Key Prompts
- "Initiate clinical-depot-operations workflow for [context]"
- "Analyze current state of clinical-depot-operations and identify gaps"
- "Generate recommendations for clinical-depot-operations optimization"
- "Create detailed plan for clinical-depot-operations execution"
