---
name: surge-protection-programs
description: Design surge protection programs including SPD selection, cascading coordination, and installation requirements for facility and equipment protection.
---

## Overview
Design surge protection programs including SPD selection, cascading coordination, and installation requirements for facility and equipment protection.

## Core Framework
- Analyze requirements and constraints specific to surge-protection-programs
...
## Key Prompts
- "Initiate surge-protection-programs workflow for [context]"
- "Analyze current state of surge-protection-programs and identify gaps"
- "Generate recommendations for surge-protection-programs optimization"
- "Create detailed plan for surge-protection-programs execution"
