---
name: ink-substrate-compatibility
description: Manage ink-substrate compatibility programs including adhesion testing, printability evaluation, and press trial coordination.
---

## Overview
Manage ink-substrate compatibility programs including adhesion testing, printability evaluation, and press trial coordination.

## Core Framework
- Analyze requirements and constraints specific to ink-substrate-compatibility
...
## Key Prompts
- "Initiate ink-substrate-compatibility workflow for [context]"
- "Analyze current state of ink-substrate-compatibility and identify gaps"
- "Generate recommendations for ink-substrate-compatibility optimization"
- "Create detailed plan for ink-substrate-compatibility execution"
