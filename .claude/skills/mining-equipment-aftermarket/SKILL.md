---
name: mining-equipment-aftermarket
description: Manage mining equipment aftermarket operations including GET programs, wear parts distribution, and component rebuild services.
---

## Overview
Manage mining equipment aftermarket operations including GET programs, wear parts distribution, and component rebuild services.

## Core Framework
- Analyze requirements and constraints specific to mining-equipment-aftermarket
...
## Key Prompts
- "Initiate mining-equipment-aftermarket workflow for [context]"
- "Analyze current state of mining-equipment-aftermarket and identify gaps"
- "Generate recommendations for mining-equipment-aftermarket optimization"
- "Create detailed plan for mining-equipment-aftermarket execution"
