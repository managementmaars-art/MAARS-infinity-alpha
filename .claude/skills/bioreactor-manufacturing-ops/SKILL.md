---
name: bioreactor-manufacturing-ops
description: Manufacture bioreactors including stirred tank, wave, and hollow fiber designs with vessel fabrication, sensor integration, and GMP cleaning validation.
---

## Overview
Manufacture bioreactors including stirred tank, wave, and hollow fiber designs with vessel fabrication, sensor integration, and GMP cleaning validation.

## Core Framework
- Analyze requirements and constraints specific to bioreactor-manufacturing-ops
...
## Key Prompts
- "Initiate bioreactor-manufacturing-ops workflow for [context]"
- "Analyze current state of bioreactor-manufacturing-ops and identify gaps"
- "Generate recommendations for bioreactor-manufacturing-ops optimization"
- "Create detailed plan for bioreactor-manufacturing-ops execution"
