---
name: geophysical-survey-services
description: Conduct geophysical survey programs including GPR, seismic refraction, electrical resistivity, and magnetic surveys for subsurface characterization.
---

## Overview
Conduct geophysical survey programs including GPR, seismic refraction, electrical resistivity, and magnetic surveys for subsurface characterization.

## Core Framework
- Analyze requirements and constraints specific to geophysical-survey-services
...
## Key Prompts
- "Initiate geophysical-survey-services workflow for [context]"
- "Analyze current state of geophysical-survey-services and identify gaps"
- "Generate recommendations for geophysical-survey-services optimization"
- "Create detailed plan for geophysical-survey-services execution"
