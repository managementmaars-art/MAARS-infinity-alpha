---
name: laser-shearography-services
description: Operate laser shearography inspection services including loading method selection, sensitivity calibration, disbond detection, composite inspection, and report generation.
---

## Overview
Operate laser shearography inspection services including loading method selection, sensitivity calibration, disbond detection, composite inspection, and report generation.

## Core Framework
- Analyze requirements and constraints specific to laser-shearography-services
...
## Key Prompts
- "Initiate laser-shearography-services workflow for [context]"
- "Analyze current state of laser-shearography-services and identify gaps"
- "Generate recommendations for laser-shearography-services optimization"
- "Create detailed plan for laser-shearography-services execution"
