---
name: garment-inspection-spotting
description: Execute garment inspection and spotting workflows including fabric identification, stain treatment chemistry, and pre-spotting procedures.
---

## Overview
Execute garment inspection and spotting workflows including fabric identification, stain treatment chemistry, and pre-spotting procedures.

## Core Framework
- Analyze requirements and constraints specific to garment-inspection-spotting
...
## Key Prompts
- "Initiate garment-inspection-spotting workflow for [context]"
- "Analyze current state of garment-inspection-spotting and identify gaps"
- "Generate recommendations for garment-inspection-spotting optimization"
- "Create detailed plan for garment-inspection-spotting execution"
