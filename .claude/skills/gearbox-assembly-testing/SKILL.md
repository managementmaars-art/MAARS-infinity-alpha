---
name: gearbox-assembly-testing
description: Assemble and test gearboxes including backlash adjustment, bearing preload setting, leak testing, and functional run-in procedures.
---

## Overview
Assemble and test gearboxes including backlash adjustment, bearing preload setting, leak testing, and functional run-in procedures.

## Core Framework
- Analyze requirements and constraints specific to gearbox-assembly-testing
...
## Key Prompts
- "Initiate gearbox-assembly-testing workflow for [context]"
- "Analyze current state of gearbox-assembly-testing and identify gaps"
- "Generate recommendations for gearbox-assembly-testing optimization"
- "Create detailed plan for gearbox-assembly-testing execution"
