---
name: vet-equipment-service-ops
description: Manage veterinary equipment service operations including preventive maintenance, repair depot, and field service engineer programs.
---

## Overview
Manage veterinary equipment service operations including preventive maintenance, repair depot, and field service engineer programs.

## Core Framework
- Analyze requirements and constraints specific to vet-equipment-service-ops
...
## Key Prompts
- "Initiate vet-equipment-service-ops workflow for [context]"
- "Analyze current state of vet-equipment-service-ops and identify gaps"
- "Generate recommendations for vet-equipment-service-ops optimization"
- "Create detailed plan for vet-equipment-service-ops execution"
