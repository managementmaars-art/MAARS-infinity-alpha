---
name: rehab-equipment-distribution
description: Manage rehabilitation equipment distribution through DME dealer networks, hospital supply contracts, and HME specialty channels.
---

## Overview
Manage rehabilitation equipment distribution through DME dealer networks, hospital supply contracts, and HME specialty channels.

## Core Framework
- Analyze requirements and constraints specific to rehab-equipment-distribution
...
## Key Prompts
- "Initiate rehab-equipment-distribution workflow for [context]"
- "Analyze current state of rehab-equipment-distribution and identify gaps"
- "Generate recommendations for rehab-equipment-distribution optimization"
- "Create detailed plan for rehab-equipment-distribution execution"
