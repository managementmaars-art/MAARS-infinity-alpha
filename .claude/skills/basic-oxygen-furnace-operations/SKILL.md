---
name: basic-oxygen-furnace-operations
description: Operate basic oxygen furnace steelmaking including hot metal scheduling, lance blowing practice, and slag management programs.
---

## Overview
Operate basic oxygen furnace steelmaking including hot metal scheduling, lance blowing practice, and slag management programs.

## Core Framework
- Analyze requirements and constraints specific to basic-oxygen-furnace-operations
...
## Key Prompts
- "Initiate basic-oxygen-furnace-operations workflow for [context]"
- "Analyze current state of basic-oxygen-furnace-operations and identify gaps"
- "Generate recommendations for basic-oxygen-furnace-operations optimization"
- "Create detailed plan for basic-oxygen-furnace-operations execution"
