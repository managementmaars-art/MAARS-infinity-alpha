---
name: chemical-process-safety-mgmt
description: Implement process safety management programs including PHA facilitation, MOC procedures, LOPA analysis, and PSI documentation.
---

## Overview
Implement process safety management programs including PHA facilitation, MOC procedures, LOPA analysis, and PSI documentation.

## Core Framework
- Analyze requirements and constraints specific to chemical-process-safety-mgmt
...
## Key Prompts
- "Initiate chemical-process-safety-mgmt workflow for [context]"
- "Analyze current state of chemical-process-safety-mgmt and identify gaps"
- "Generate recommendations for chemical-process-safety-mgmt optimization"
- "Create detailed plan for chemical-process-safety-mgmt execution"
