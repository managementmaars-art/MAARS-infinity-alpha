---
name: private-banking-credit
description: Structure and monitor private banking credit facilities including Lombard loans, mortgages, and securities-backed lending.
---

## Overview
Structure and monitor private banking credit facilities including Lombard loans, mortgages, and securities-backed lending.

## Core Framework
- Analyze requirements and constraints specific to private-banking-credit
...
## Key Prompts
- "Initiate private-banking-credit workflow for [context]"
- "Analyze current state of private-banking-credit and identify gaps"
- "Generate recommendations for private-banking-credit optimization"
- "Create detailed plan for private-banking-credit execution"
