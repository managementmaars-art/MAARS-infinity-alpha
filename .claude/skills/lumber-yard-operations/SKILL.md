---
name: lumber-yard-operations
description: Manage lumber yard operations including inventory receiving, grading, remanufacturing, contractor sales, and delivery fleet management.
---

## Overview
Manage lumber yard operations including inventory receiving, grading, remanufacturing, contractor sales, and delivery fleet management.

## Core Framework
- Analyze requirements and constraints specific to lumber-yard-operations
...
## Key Prompts
- "Initiate lumber-yard-operations workflow for [context]"
- "Analyze current state of lumber-yard-operations and identify gaps"
- "Generate recommendations for lumber-yard-operations optimization"
- "Create detailed plan for lumber-yard-operations execution"
