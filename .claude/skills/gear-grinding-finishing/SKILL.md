---
name: gear-grinding-finishing
description: Execute gear grinding and finishing operations including profile grinding, thread grinding, superfinishing, and gear accuracy inspection.
---

## Overview
Execute gear grinding and finishing operations including profile grinding, thread grinding, superfinishing, and gear accuracy inspection.

## Core Framework
- Analyze requirements and constraints specific to gear-grinding-finishing
...
## Key Prompts
- "Initiate gear-grinding-finishing workflow for [context]"
- "Analyze current state of gear-grinding-finishing and identify gaps"
- "Generate recommendations for gear-grinding-finishing optimization"
- "Create detailed plan for gear-grinding-finishing execution"
