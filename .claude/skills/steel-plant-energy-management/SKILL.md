---
name: steel-plant-energy-management
description: Manage energy consumption across steel plant operations including byproduct gas utilization, power demand optimization, and steam balance management.
---

## Overview
Manage energy consumption across steel plant operations including byproduct gas utilization, power demand optimization, and steam balance management.

## Core Framework
- Analyze requirements and constraints specific to steel-plant-energy-management
...
## Key Prompts
- "Initiate steel-plant-energy-management workflow for [context]"
- "Analyze current state of steel-plant-energy-management and identify gaps"
- "Generate recommendations for steel-plant-energy-management optimization"
- "Create detailed plan for steel-plant-energy-management execution"
