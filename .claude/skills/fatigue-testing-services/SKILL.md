---
name: fatigue-testing-services
description: Operate fatigue testing laboratories including load frame setup, SN curve development, fracture mechanics testing, fatigue crack growth programs, and specimen preparation.
---

## Overview
Operate fatigue testing laboratories including load frame setup, SN curve development, fracture mechanics testing, fatigue crack growth programs, and specimen preparation.

## Core Framework
- Analyze requirements and constraints specific to fatigue-testing-services
...
## Key Prompts
- "Initiate fatigue-testing-services workflow for [context]"
- "Analyze current state of fatigue-testing-services and identify gaps"
- "Generate recommendations for fatigue-testing-services optimization"
- "Create detailed plan for fatigue-testing-services execution"
