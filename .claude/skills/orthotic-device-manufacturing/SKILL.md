---
name: orthotic-device-manufacturing
description: Manage orthotic device manufacturing including custom AFO fabrication, prefabricated stocking, and spinal orthosis production.
---

## Overview
Manage orthotic device manufacturing including custom AFO fabrication, prefabricated stocking, and spinal orthosis production.

## Core Framework
- Analyze requirements and constraints specific to orthotic-device-manufacturing
...
## Key Prompts
- "Initiate orthotic-device-manufacturing workflow for [context]"
- "Analyze current state of orthotic-device-manufacturing and identify gaps"
- "Generate recommendations for orthotic-device-manufacturing optimization"
- "Create detailed plan for orthotic-device-manufacturing execution"
