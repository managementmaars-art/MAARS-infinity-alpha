---
name: gasket-selection-programs
description: Select gaskets including spiral wound, kammprofile, sheet, and ring type joints for flange standards, operating conditions, and leak tightness.
---

## Overview
Select gaskets including spiral wound, kammprofile, sheet, and ring type joints for flange standards, operating conditions, and leak tightness.

## Core Framework
- Analyze requirements and constraints specific to gasket-selection-programs
...
## Key Prompts
- "Initiate gasket-selection-programs workflow for [context]"
- "Analyze current state of gasket-selection-programs and identify gaps"
- "Generate recommendations for gasket-selection-programs optimization"
- "Create detailed plan for gasket-selection-programs execution"
