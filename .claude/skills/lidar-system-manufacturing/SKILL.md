---
name: lidar-system-manufacturing
description: Build LiDAR systems including pulsed and FMCW architectures, scan mechanism integration, time-of-flight electronics, and range accuracy calibration.
---

## Overview
Build LiDAR systems including pulsed and FMCW architectures, scan mechanism integration, time-of-flight electronics, and range accuracy calibration.

## Core Framework
- Analyze requirements and constraints specific to lidar-system-manufacturing
...
## Key Prompts
- "Initiate lidar-system-manufacturing workflow for [context]"
- "Analyze current state of lidar-system-manufacturing and identify gaps"
- "Generate recommendations for lidar-system-manufacturing optimization"
- "Create detailed plan for lidar-system-manufacturing execution"
