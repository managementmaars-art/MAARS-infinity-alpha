---
name: smart-thermostat-manufacturing
description: Manage smart thermostat manufacturing including sensor assembly, display integration, wireless radio testing, and ENERGY STAR compliance.
---

## Overview
Manage smart thermostat manufacturing including sensor assembly, display integration, wireless radio testing, and ENERGY STAR compliance.

## Core Framework
- Analyze requirements and constraints specific to smart-thermostat-manufacturing
...
## Key Prompts
- "Initiate smart-thermostat-manufacturing workflow for [context]"
- "Analyze current state of smart-thermostat-manufacturing and identify gaps"
- "Generate recommendations for smart-thermostat-manufacturing optimization"
- "Create detailed plan for smart-thermostat-manufacturing execution"
