---
name: insulation-installation-ops
description: Manage insulation installation operations including pipe insulation, equipment lagging, penetration sealing, and weather barrier application.
---

## Overview
Manage insulation installation operations including pipe insulation, equipment lagging, penetration sealing, and weather barrier application.

## Core Framework
- Analyze requirements and constraints specific to insulation-installation-ops
...
## Key Prompts
- "Initiate insulation-installation-ops workflow for [context]"
- "Analyze current state of insulation-installation-ops and identify gaps"
- "Generate recommendations for insulation-installation-ops optimization"
- "Create detailed plan for insulation-installation-ops execution"
