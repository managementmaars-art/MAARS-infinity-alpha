---
name: cement-kiln-operations
description: Operate cement rotary kilns including preheater management, clinker burning zone control, fuel substitution programs, and refractory inspection scheduling.
---

## Overview
Operate cement rotary kilns including preheater management, clinker burning zone control, fuel substitution programs, and refractory inspection scheduling.

## Core Framework
- Analyze requirements and constraints specific to cement-kiln-operations
...
## Key Prompts
- "Initiate cement-kiln-operations workflow for [context]"
- "Analyze current state of cement-kiln-operations and identify gaps"
- "Generate recommendations for cement-kiln-operations optimization"
- "Create detailed plan for cement-kiln-operations execution"
