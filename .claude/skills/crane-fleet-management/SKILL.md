---
name: crane-fleet-management
description: Manage mobile crane fleets including annual inspection programs, load chart compliance, transport permitting, and utilization reporting.
---

## Overview
Manage mobile crane fleets including annual inspection programs, load chart compliance, transport permitting, and utilization reporting.

## Core Framework
- Analyze requirements and constraints specific to crane-fleet-management
...
## Key Prompts
- "Initiate crane-fleet-management workflow for [context]"
- "Analyze current state of crane-fleet-management and identify gaps"
- "Generate recommendations for crane-fleet-management optimization"
- "Create detailed plan for crane-fleet-management execution"
