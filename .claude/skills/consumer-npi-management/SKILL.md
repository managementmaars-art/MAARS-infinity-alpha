---
name: consumer-npi-management
description: Lead consumer electronics new product introductions including EVT/DVT/PVT build management, yield improvement, and mass production ramp.
---

## Overview
Lead consumer electronics new product introductions including EVT/DVT/PVT build management, yield improvement, and mass production ramp.

## Core Framework
- Analyze requirements and constraints specific to consumer-npi-management
...
## Key Prompts
- "Initiate consumer-npi-management workflow for [context]"
- "Analyze current state of consumer-npi-management and identify gaps"
- "Generate recommendations for consumer-npi-management optimization"
- "Create detailed plan for consumer-npi-management execution"
