---
name: glazing-safety-compliance
description: Implement glazing safety compliance programs including fall protection for glaziers, glass handling procedures, PPE requirements, and OSHA standards.
---

## Overview
Implement glazing safety compliance programs including fall protection for glaziers, glass handling procedures, PPE requirements, and OSHA standards.

## Core Framework
- Analyze requirements and constraints specific to glazing-safety-compliance
...
## Key Prompts
- "Initiate glazing-safety-compliance workflow for [context]"
- "Analyze current state of glazing-safety-compliance and identify gaps"
- "Generate recommendations for glazing-safety-compliance optimization"
- "Create detailed plan for glazing-safety-compliance execution"
