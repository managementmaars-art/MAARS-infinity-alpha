---
name: mrna-manufacturing-operations
description: Operate mRNA production including IVT reaction management, LNP formulation operations, encapsulation efficiency testing, and cold chain management.
---

## Overview
Operate mRNA production including IVT reaction management, LNP formulation operations, encapsulation efficiency testing, and cold chain management.

## Core Framework
- Analyze requirements and constraints specific to mrna-manufacturing-operations
...
## Key Prompts
- "Initiate mrna-manufacturing-operations workflow for [context]"
- "Analyze current state of mrna-manufacturing-operations and identify gaps"
- "Generate recommendations for mrna-manufacturing-operations optimization"
- "Create detailed plan for mrna-manufacturing-operations execution"
