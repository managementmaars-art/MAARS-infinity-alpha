---
name: delta-robot-manufacturing
description: Manufacture delta parallel robots including carbon fiber arm fabrication, universal joint assembly, and high-speed pick accuracy qualification.
---

## Overview
Manufacture delta parallel robots including carbon fiber arm fabrication, universal joint assembly, and high-speed pick accuracy qualification.

## Core Framework
- Analyze requirements and constraints specific to delta-robot-manufacturing
...
## Key Prompts
- "Initiate delta-robot-manufacturing workflow for [context]"
- "Analyze current state of delta-robot-manufacturing and identify gaps"
- "Generate recommendations for delta-robot-manufacturing optimization"
- "Create detailed plan for delta-robot-manufacturing execution"
