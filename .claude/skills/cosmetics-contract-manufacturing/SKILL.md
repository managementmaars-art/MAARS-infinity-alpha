---
name: cosmetics-contract-manufacturing
description: Manage cosmetics contract manufacturing relationships including specification transfer, quality audits, and co-development programs.
---

## Overview
Manage cosmetics contract manufacturing relationships including specification transfer, quality audits, and co-development programs.

## Core Framework
- Analyze requirements and constraints specific to cosmetics-contract-manufacturing
...
## Key Prompts
- "Initiate cosmetics-contract-manufacturing workflow for [context]"
- "Analyze current state of cosmetics-contract-manufacturing and identify gaps"
- "Generate recommendations for cosmetics-contract-manufacturing optimization"
- "Create detailed plan for cosmetics-contract-manufacturing execution"
