---
name: transformer-condition-monitoring
description: Implement transformer condition monitoring programs including online DGA, bushing monitoring, and thermal imaging surveys.
---

## Overview
Implement transformer condition monitoring programs including online DGA, bushing monitoring, and thermal imaging surveys.

## Core Framework
- Analyze requirements and constraints specific to transformer-condition-monitoring
...
## Key Prompts
- "Initiate transformer-condition-monitoring workflow for [context]"
- "Analyze current state of transformer-condition-monitoring and identify gaps"
- "Generate recommendations for transformer-condition-monitoring optimization"
- "Create detailed plan for transformer-condition-monitoring execution"
