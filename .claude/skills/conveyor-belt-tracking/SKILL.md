---
name: conveyor-belt-tracking
description: Manage conveyor belt tracking including crowned pulley adjustment, training idler installation, and belt edge monitoring systems.
---

## Overview
Manage conveyor belt tracking including crowned pulley adjustment, training idler installation, and belt edge monitoring systems.

## Core Framework
- Analyze requirements and constraints specific to conveyor-belt-tracking
...
## Key Prompts
- "Initiate conveyor-belt-tracking workflow for [context]"
- "Analyze current state of conveyor-belt-tracking and identify gaps"
- "Generate recommendations for conveyor-belt-tracking optimization"
- "Create detailed plan for conveyor-belt-tracking execution"
