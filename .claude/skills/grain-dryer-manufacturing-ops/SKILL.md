---
name: grain-dryer-manufacturing-ops
description: Build grain dryers including mixed-flow, cross-flow, and tower designs with burner assemblies, airflow testing, and energy efficiency certification.
---

## Overview
Build grain dryers including mixed-flow, cross-flow, and tower designs with burner assemblies, airflow testing, and energy efficiency certification.

## Core Framework
- Analyze requirements and constraints specific to grain-dryer-manufacturing-ops
...
## Key Prompts
- "Initiate grain-dryer-manufacturing-ops workflow for [context]"
- "Analyze current state of grain-dryer-manufacturing-ops and identify gaps"
- "Generate recommendations for grain-dryer-manufacturing-ops optimization"
- "Create detailed plan for grain-dryer-manufacturing-ops execution"
