---
name: power-transmission-system-design
description: Design power transmission systems including belt drives, chain drives, gear drives, and couplings with service factor and efficiency analysis.
---

## Overview
Design power transmission systems including belt drives, chain drives, gear drives, and couplings with service factor and efficiency analysis.

## Core Framework
- Analyze requirements and constraints specific to power-transmission-system-design
...
## Key Prompts
- "Initiate power-transmission-system-design workflow for [context]"
- "Analyze current state of power-transmission-system-design and identify gaps"
- "Generate recommendations for power-transmission-system-design optimization"
- "Create detailed plan for power-transmission-system-design execution"
