...
description: Manage intrusion detection system manufacturing including PIR sensor assembly, control panel production, and UL 681 compliance.
---

## Overview
Manage intrusion detection system manufacturing including PIR sensor assembly, control panel production, and UL 681 compliance.

## Core Framework
- Analyze requirements and constraints specific to intrusion-detection-systems
...
## Key Prompts
- "Initiate intrusion-detection-systems workflow for [context]"
- "Analyze current state of intrusion-detection-systems and identify gaps"
- "Generate recommendations for intrusion-detection-systems optimization"
- "Create detailed plan for intrusion-detection-systems execution"
