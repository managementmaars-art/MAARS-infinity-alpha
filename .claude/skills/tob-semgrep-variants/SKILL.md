---
name: tob-semgrep-variants
description: Trail of Bits: Semgrep variant analysis — find similar vulnerabilities across codebases
---

# Tob Semgrep Variants — MAARS Security Reference

## Overview
Trail of Bits: Semgrep variant analysis — find similar vulnerabilities across codebases
