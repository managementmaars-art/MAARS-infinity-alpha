...
description: Manage container terminal operations including vessel berthing, crane productivity, yard block management, and truck appointment systems.
---

## Overview
Manage container terminal operations including vessel berthing, crane productivity, yard block management, and truck appointment systems.

## Core Framework
- Analyze requirements and constraints specific to container-terminal-operations
...
## Key Prompts
- "Initiate container-terminal-operations workflow for [context]"
- "Analyze current state of container-terminal-operations and identify gaps"
- "Generate recommendations for container-terminal-operations optimization"
- "Create detailed plan for container-terminal-operations execution"
