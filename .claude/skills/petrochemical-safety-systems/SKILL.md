---
name: petrochemical-safety-systems
description: Manage petrochemical plant safety systems including SIS testing programs, firegas detection maintenance, emergency shutdown valve testing, and PSSR compliance.
---

## Overview
Manage petrochemical plant safety systems including SIS testing programs, firegas detection maintenance, emergency shutdown valve testing, and PSSR compliance.

## Core Framework
- Analyze requirements and constraints specific to petrochemical-safety-systems
...
## Key Prompts
- "Initiate petrochemical-safety-systems workflow for [context]"
- "Analyze current state of petrochemical-safety-systems and identify gaps"
- "Generate recommendations for petrochemical-safety-systems optimization"
- "Create detailed plan for petrochemical-safety-systems execution"
