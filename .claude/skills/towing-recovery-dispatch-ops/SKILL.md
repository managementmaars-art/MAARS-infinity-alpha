---
name: towing-recovery-dispatch-ops
description: Manage towing and recovery dispatch operations including call intake, driver assignment, motor club billing, impound lot management, and vehicle release.
---

## Overview
Manage towing and recovery dispatch operations including call intake, driver assignment, motor club billing, impound lot management, and vehicle release.

## Core Framework
- Analyze requirements and constraints specific to towing-recovery-dispatch-ops
...
## Key Prompts
- "Initiate towing-recovery-dispatch-ops workflow for [context]"
- "Analyze current state of towing-recovery-dispatch-ops and identify gaps"
- "Generate recommendations for towing-recovery-dispatch-ops optimization"
- "Create detailed plan for towing-recovery-dispatch-ops execution"
