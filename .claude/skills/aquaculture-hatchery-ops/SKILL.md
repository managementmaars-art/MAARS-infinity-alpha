---
name: aquaculture-hatchery-ops
description: Manage fish hatchery operations including broodstock management, spawning protocols, larval rearing, and fry/fingerling distribution programs.
---

## Overview
Manage fish hatchery operations including broodstock management, spawning protocols, larval rearing, and fry/fingerling distribution programs.

## Core Framework
- Analyze requirements and constraints specific to aquaculture-hatchery-ops
...
## Key Prompts
- "Initiate aquaculture-hatchery-ops workflow for [context]"
- "Analyze current state of aquaculture-hatchery-ops and identify gaps"
- "Generate recommendations for aquaculture-hatchery-ops optimization"
- "Create detailed plan for aquaculture-hatchery-ops execution"
