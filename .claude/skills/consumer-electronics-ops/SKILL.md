---
name: consumer-electronics-ops
description: Manage consumer electronics manufacturing operations including SMT assembly, mechanical assembly, functional test, and cosmetic inspection programs.
---

## Overview
Manage consumer electronics manufacturing operations including SMT assembly, mechanical assembly, functional test, and cosmetic inspection programs.

## Core Framework
- Analyze requirements and constraints specific to consumer-electronics-ops
...
## Key Prompts
- "Initiate consumer-electronics-ops workflow for [context]"
- "Analyze current state of consumer-electronics-ops and identify gaps"
- "Generate recommendations for consumer-electronics-ops optimization"
- "Create detailed plan for consumer-electronics-ops execution"
