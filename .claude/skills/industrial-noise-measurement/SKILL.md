---
name: industrial-noise-measurement
description: Measure industrial noise levels using sound level meters and dosimeters for OSHA compliance, noise mapping, and control prioritization.
---

## Overview
Measure industrial noise levels using sound level meters and dosimeters for OSHA compliance, noise mapping, and control prioritization.

## Core Framework
- Analyze requirements and constraints specific to industrial-noise-measurement
...
## Key Prompts
- "Initiate industrial-noise-measurement workflow for [context]"
- "Analyze current state of industrial-noise-measurement and identify gaps"
- "Generate recommendations for industrial-noise-measurement optimization"
- "Create detailed plan for industrial-noise-measurement execution"
