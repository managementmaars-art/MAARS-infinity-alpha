---
name: garment-program-compliance
description: Manage garment program compliance including OSHA flame-resistant standards, hi-vis requirements, garment inspection, and replacement protocols.
---

## Overview
Manage garment program compliance including OSHA flame-resistant standards, hi-vis requirements, garment inspection, and replacement protocols.

## Core Framework
- Analyze requirements and constraints specific to garment-program-compliance
...
## Key Prompts
- "Initiate garment-program-compliance workflow for [context]"
- "Analyze current state of garment-program-compliance and identify gaps"
- "Generate recommendations for garment-program-compliance optimization"
- "Create detailed plan for garment-program-compliance execution"
