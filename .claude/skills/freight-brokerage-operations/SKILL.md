---
name: freight-brokerage-operations
description: Operate freight brokerage operations including carrier sourcing, load matching, rate negotiation, and carrier performance management.
---

## Overview
Operate freight brokerage operations including carrier sourcing, load matching, rate negotiation, and carrier performance management.

## Core Framework
- Analyze requirements and constraints specific to freight-brokerage-operations
...
## Key Prompts
- "Initiate freight-brokerage-operations workflow for [context]"
- "Analyze current state of freight-brokerage-operations and identify gaps"
- "Generate recommendations for freight-brokerage-operations optimization"
- "Create detailed plan for freight-brokerage-operations execution"
