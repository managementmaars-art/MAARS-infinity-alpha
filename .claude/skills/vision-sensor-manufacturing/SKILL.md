---
name: vision-sensor-manufacturing
description: Produce smart vision sensors including CMOS imager assembly, embedded processor integration, and field-of-view calibration workflows.
---

## Overview
Produce smart vision sensors including CMOS imager assembly, embedded processor integration, and field-of-view calibration workflows.

## Core Framework
- Analyze requirements and constraints specific to vision-sensor-manufacturing
...
## Key Prompts
- "Initiate vision-sensor-manufacturing workflow for [context]"
- "Analyze current state of vision-sensor-manufacturing and identify gaps"
- "Generate recommendations for vision-sensor-manufacturing optimization"
- "Create detailed plan for vision-sensor-manufacturing execution"
