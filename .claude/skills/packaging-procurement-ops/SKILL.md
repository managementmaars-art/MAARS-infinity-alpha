---
name: packaging-procurement-ops
description: Manage packaging procurement including supplier sourcing, tooling ownership, cost negotiation, and supplier performance management.
---

## Overview
Manage packaging procurement including supplier sourcing, tooling ownership, cost negotiation, and supplier performance management.

## Core Framework
- Analyze requirements and constraints specific to packaging-procurement-ops
...
## Key Prompts
- "Initiate packaging-procurement-ops workflow for [context]"
- "Analyze current state of packaging-procurement-ops and identify gaps"
- "Generate recommendations for packaging-procurement-ops optimization"
- "Create detailed plan for packaging-procurement-ops execution"
