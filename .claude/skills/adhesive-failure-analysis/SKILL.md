---
name: adhesive-failure-analysis
description: Investigate adhesive bond failures including locus of failure determination, surface contamination analysis, and process root cause investigation.
---

## Overview
Investigate adhesive bond failures including locus of failure determination, surface contamination analysis, and process root cause investigation.

## Core Framework
- Analyze requirements and constraints specific to adhesive-failure-analysis
...
## Key Prompts
- "Initiate adhesive-failure-analysis workflow for [context]"
- "Analyze current state of adhesive-failure-analysis and identify gaps"
- "Generate recommendations for adhesive-failure-analysis optimization"
- "Create detailed plan for adhesive-failure-analysis execution"
