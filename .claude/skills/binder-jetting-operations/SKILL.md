---
name: binder-jetting-operations
description: Operate binder jetting systems including powder bed preparation, binder saturation, sintering cycle management, and dimensional inspection.
---

## Overview
Operate binder jetting systems including powder bed preparation, binder saturation, sintering cycle management, and dimensional inspection.

## Core Framework
- Analyze requirements and constraints specific to binder-jetting-operations
...
## Key Prompts
- "Initiate binder-jetting-operations workflow for [context]"
- "Analyze current state of binder-jetting-operations and identify gaps"
- "Generate recommendations for binder-jetting-operations optimization"
- "Create detailed plan for binder-jetting-operations execution"
