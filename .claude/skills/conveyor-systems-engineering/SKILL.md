---
name: conveyor-systems-engineering
description: Engineer conveyor systems including belt conveyor design, chain conveyor specification, load analysis, and power calculation.
---

## Overview
Engineer conveyor systems including belt conveyor design, chain conveyor specification, load analysis, and power calculation.

## Core Framework
- Analyze requirements and constraints specific to conveyor-systems-engineering
...
## Key Prompts
- "Initiate conveyor-systems-engineering workflow for [context]"
- "Analyze current state of conveyor-systems-engineering and identify gaps"
- "Generate recommendations for conveyor-systems-engineering optimization"
- "Create detailed plan for conveyor-systems-engineering execution"
