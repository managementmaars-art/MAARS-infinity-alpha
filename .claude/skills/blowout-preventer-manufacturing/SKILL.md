---
name: blowout-preventer-manufacturing
description: Manage blowout preventer manufacturing operations including ram assembly, elastomer qualification, and API 16A load testing.
---

## Overview
Manage blowout preventer manufacturing operations including ram assembly, elastomer qualification, and API 16A load testing.

## Core Framework
- Analyze requirements and constraints specific to blowout-preventer-manufacturing
...
## Key Prompts
- "Initiate blowout-preventer-manufacturing workflow for [context]"
- "Analyze current state of blowout-preventer-manufacturing and identify gaps"
- "Generate recommendations for blowout-preventer-manufacturing optimization"
- "Create detailed plan for blowout-preventer-manufacturing execution"
