---
name: filtration-media-development
description: Develop filtration media including fibrous, membrane, granular, and depth filtration materials with particle retention characterization.
---

## Overview
Develop filtration media including fibrous, membrane, granular, and depth filtration materials with particle retention characterization.

## Core Framework
- Analyze requirements and constraints specific to filtration-media-development
...
## Key Prompts
- "Initiate filtration-media-development workflow for [context]"
- "Analyze current state of filtration-media-development and identify gaps"
- "Generate recommendations for filtration-media-development optimization"
- "Create detailed plan for filtration-media-development execution"
