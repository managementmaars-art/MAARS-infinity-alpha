...
description: Plan urban mobility solutions including multimodal corridor design, demand modeling, and transit-oriented development analysis.
---

## Overview
Plan urban mobility solutions including multimodal corridor design, demand modeling, and transit-oriented development analysis.

## Core Framework
- Analyze requirements and constraints specific to urban-mobility-planning
...
## Key Prompts
- "Initiate urban-mobility-planning workflow for [context]"
- "Analyze current state of urban-mobility-planning and identify gaps"
- "Generate recommendations for urban-mobility-planning optimization"
- "Create detailed plan for urban-mobility-planning execution"
