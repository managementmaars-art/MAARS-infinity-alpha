---
name: residential-pest-control-ops
description: Operate residential pest control operations including general pest, rodent control, termite treatment, bed bugs, and recurring service programs.
---

## Overview
Operate residential pest control operations including general pest, rodent control, termite treatment, bed bugs, and recurring service programs.

## Core Framework
- Analyze requirements and constraints specific to residential-pest-control-ops
...
## Key Prompts
- "Initiate residential-pest-control-ops workflow for [context]"
- "Analyze current state of residential-pest-control-ops and identify gaps"
- "Generate recommendations for residential-pest-control-ops optimization"
- "Create detailed plan for residential-pest-control-ops execution"
