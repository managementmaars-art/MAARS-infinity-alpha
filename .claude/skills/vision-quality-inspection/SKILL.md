...
description: Implement vision-based quality inspection including surface defect detection, dimensional measurement, and label verification systems.
---

## Overview
Implement vision-based quality inspection including surface defect detection, dimensional measurement, and label verification systems.

## Core Framework
- Analyze requirements and constraints specific to vision-quality-inspection
...
## Key Prompts
- "Initiate vision-quality-inspection workflow for [context]"
- "Analyze current state of vision-quality-inspection and identify gaps"
- "Generate recommendations for vision-quality-inspection optimization"
- "Create detailed plan for vision-quality-inspection execution"
