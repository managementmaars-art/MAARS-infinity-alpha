---
name: recovery-boiler-operations
description: Operate recovery boilers for kraft mills including smelt dissolving, black liquor firing management, and recovery boiler inspection scheduling.
---

## Overview
Operate recovery boilers for kraft mills including smelt dissolving, black liquor firing management, and recovery boiler inspection scheduling.

## Core Framework
- Analyze requirements and constraints specific to recovery-boiler-operations
...
## Key Prompts
- "Initiate recovery-boiler-operations workflow for [context]"
- "Analyze current state of recovery-boiler-operations and identify gaps"
- "Generate recommendations for recovery-boiler-operations optimization"
- "Create detailed plan for recovery-boiler-operations execution"
