---
name: quench-system-operations
description: Operate quenching systems including oil, water, polymer, and press quench operations with agitation control and quench severity measurement.
---

## Overview
Operate quenching systems including oil, water, polymer, and press quench operations with agitation control and quench severity measurement.

## Core Framework
- Analyze requirements and constraints specific to quench-system-operations
...
## Key Prompts
- "Initiate quench-system-operations workflow for [context]"
- "Analyze current state of quench-system-operations and identify gaps"
- "Generate recommendations for quench-system-operations optimization"
- "Create detailed plan for quench-system-operations execution"
