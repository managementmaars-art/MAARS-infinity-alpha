---
name: calibration-lab-equipment-mfg
description: Produce calibration laboratory reference standards including dead weight testers, precision resistance decades, and voltage reference sources.
---

## Overview
Produce calibration laboratory reference standards including dead weight testers, precision resistance decades, and voltage reference sources.

## Core Framework
- Analyze requirements and constraints specific to calibration-lab-equipment-mfg
...
## Key Prompts
- "Initiate calibration-lab-equipment-mfg workflow for [context]"
- "Analyze current state of calibration-lab-equipment-mfg and identify gaps"
- "Generate recommendations for calibration-lab-equipment-mfg optimization"
- "Create detailed plan for calibration-lab-equipment-mfg execution"
