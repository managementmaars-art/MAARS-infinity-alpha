---
name: biosolids-management
description: Manage biosolids processing and beneficial reuse programs including land application permits, composting, and Class A/B compliance.
---

## Overview
Manage biosolids processing and beneficial reuse programs including land application permits, composting, and Class A/B compliance.

## Core Framework
- Analyze requirements and constraints specific to biosolids-management
...
## Key Prompts
- "Initiate biosolids-management workflow for [context]"
- "Analyze current state of biosolids-management and identify gaps"
- "Generate recommendations for biosolids-management optimization"
- "Create detailed plan for biosolids-management execution"
