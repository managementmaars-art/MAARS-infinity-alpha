---
name: barcode-ocr-verification
description: Manage barcode and OCR vision verification systems including print quality grading, 2D code reading, and traceability integration.
---

## Overview
Manage barcode and OCR vision verification systems including print quality grading, 2D code reading, and traceability integration.

## Core Framework
- Analyze requirements and constraints specific to barcode-ocr-verification
...
## Key Prompts
- "Initiate barcode-ocr-verification workflow for [context]"
- "Analyze current state of barcode-ocr-verification and identify gaps"
- "Generate recommendations for barcode-ocr-verification optimization"
- "Create detailed plan for barcode-ocr-verification execution"
