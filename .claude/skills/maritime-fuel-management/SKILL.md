---
name: maritime-fuel-management
description: Manage marine fuel operations including bunker procurement, fuel quality testing, consumption monitoring, and emissions compliance.
---

## Overview
Manage marine fuel operations including bunker procurement, fuel quality testing, consumption monitoring, and emissions compliance.

## Core Framework
- Analyze requirements and constraints specific to maritime-fuel-management
...
## Key Prompts
- "Initiate maritime-fuel-management workflow for [context]"
- "Analyze current state of maritime-fuel-management and identify gaps"
- "Generate recommendations for maritime-fuel-management optimization"
- "Create detailed plan for maritime-fuel-management execution"
