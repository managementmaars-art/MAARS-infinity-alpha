---
name: pharmaceutical-solvent-recovery
description: Manage pharmaceutical solvent recovery operations including distillation scheduling, solvent quality testing, and material balance reconciliation.
---

## Overview
Manage pharmaceutical solvent recovery operations including distillation scheduling, solvent quality testing, and material balance reconciliation.

## Core Framework
- Analyze requirements and constraints specific to pharmaceutical-solvent-recovery
...
## Key Prompts
- "Initiate pharmaceutical-solvent-recovery workflow for [context]"
- "Analyze current state of pharmaceutical-solvent-recovery and identify gaps"
- "Generate recommendations for pharmaceutical-solvent-recovery optimization"
- "Create detailed plan for pharmaceutical-solvent-recovery execution"
