---
name: spectrum-analyzer-ops
description: Operate spectrum analyzers for RF signal characterization including spurious emissions measurement, phase noise, and adjacent channel power.
---

## Overview
Operate spectrum analyzers for RF signal characterization including spurious emissions measurement, phase noise, and adjacent channel power.

## Core Framework
- Analyze requirements and constraints specific to spectrum-analyzer-ops
...
## Key Prompts
- "Initiate spectrum-analyzer-ops workflow for [context]"
- "Analyze current state of spectrum-analyzer-ops and identify gaps"
- "Generate recommendations for spectrum-analyzer-ops optimization"
- "Create detailed plan for spectrum-analyzer-ops execution"
