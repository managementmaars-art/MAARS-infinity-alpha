---
name: tob-threat-model
description: Trail of Bits: threat modeling — STRIDE, attack trees, data flow analysis, mitigation strategies
---

# Tob Threat Model — MAARS Security Reference

## Overview
Trail of Bits: threat modeling — STRIDE, attack trees, data flow analysis, mitigation strategies
