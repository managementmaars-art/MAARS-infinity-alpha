---
name: asbestos-lead-testing-services
description: Provide asbestos and lead-based paint testing services including bulk sampling, XRF screening, clearance testing, and abatement project oversight.
---

## Overview
Provide asbestos and lead-based paint testing services including bulk sampling, XRF screening, clearance testing, and abatement project oversight.

## Core Framework
- Analyze requirements and constraints specific to asbestos-lead-testing-services
...
## Key Prompts
- "Initiate asbestos-lead-testing-services workflow for [context]"
- "Analyze current state of asbestos-lead-testing-services and identify gaps"
- "Generate recommendations for asbestos-lead-testing-services optimization"
- "Create detailed plan for asbestos-lead-testing-services execution"
