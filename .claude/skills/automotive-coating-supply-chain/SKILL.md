---
name: automotive-coating-supply-chain
description: Manage automotive coating supply chains including pigment procurement, resin sourcing, batch traceability, and safety stock management.
---

## Overview
Manage automotive coating supply chains including pigment procurement, resin sourcing, batch traceability, and safety stock management.

## Core Framework
- Analyze requirements and constraints specific to automotive-coating-supply-chain
...
## Key Prompts
- "Initiate automotive-coating-supply-chain workflow for [context]"
- "Analyze current state of automotive-coating-supply-chain and identify gaps"
- "Generate recommendations for automotive-coating-supply-chain optimization"
- "Create detailed plan for automotive-coating-supply-chain execution"
