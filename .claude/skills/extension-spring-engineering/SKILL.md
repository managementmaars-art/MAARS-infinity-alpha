---
name: extension-spring-engineering
description: Engineer extension springs including initial tension, hook stress analysis, and extended length specification for tension application requirements.
---

## Overview
Engineer extension springs including initial tension, hook stress analysis, and extended length specification for tension application requirements.

## Core Framework
- Analyze requirements and constraints specific to extension-spring-engineering
...
## Key Prompts
- "Initiate extension-spring-engineering workflow for [context]"
- "Analyze current state of extension-spring-engineering and identify gaps"
- "Generate recommendations for extension-spring-engineering optimization"
- "Create detailed plan for extension-spring-engineering execution"
