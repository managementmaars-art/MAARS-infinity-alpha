...
description: Trail of Bits: variant analysis — systematically find all instances of a bug class in a codebase
---

# Tob Variant Analysis — MAARS Security Reference

## Overview
Trail of Bits: variant analysis — systematically find all instances of a bug class in a codebase
