---
name: iiot-cybersecurity-ops
description: Manage IIoT cybersecurity programs including OT network segmentation, device identity management, patch management, and anomaly detection.
---

## Overview
Manage IIoT cybersecurity programs including OT network segmentation, device identity management, patch management, and anomaly detection.

## Core Framework
- Analyze requirements and constraints specific to iiot-cybersecurity-ops
...
## Key Prompts
- "Initiate iiot-cybersecurity-ops workflow for [context]"
- "Analyze current state of iiot-cybersecurity-ops and identify gaps"
- "Generate recommendations for iiot-cybersecurity-ops optimization"
- "Create detailed plan for iiot-cybersecurity-ops execution"
