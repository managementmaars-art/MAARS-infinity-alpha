---
name: product-noise-testing
description: Conduct product noise testing including anechoic chamber measurements, sound quality analysis, and psychoacoustic metric calculation.
---

## Overview
Conduct product noise testing including anechoic chamber measurements, sound quality analysis, and psychoacoustic metric calculation.

## Core Framework
- Analyze requirements and constraints specific to product-noise-testing
...
## Key Prompts
- "Initiate product-noise-testing workflow for [context]"
- "Analyze current state of product-noise-testing and identify gaps"
- "Generate recommendations for product-noise-testing optimization"
- "Create detailed plan for product-noise-testing execution"
