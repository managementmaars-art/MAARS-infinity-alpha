---
name: aluminum-pot-line-management
description: Manage aluminum pot line operations including pot shutdown and restart programs, collector bar maintenance, and cell performance optimization.
---

## Overview
Manage aluminum pot line operations including pot shutdown and restart programs, collector bar maintenance, and cell performance optimization.

## Core Framework
- Analyze requirements and constraints specific to aluminum-pot-line-management
...
## Key Prompts
- "Initiate aluminum-pot-line-management workflow for [context]"
- "Analyze current state of aluminum-pot-line-management and identify gaps"
- "Generate recommendations for aluminum-pot-line-management optimization"
- "Create detailed plan for aluminum-pot-line-management execution"
