---
name: solar-inverter-manufacturing
description: Manufacture solar PV inverters including MPPT algorithm firmware integration, isolation transformer assembly, and grid-tie interconnection certification.
---

## Overview
Manufacture solar PV inverters including MPPT algorithm firmware integration, isolation transformer assembly, and grid-tie interconnection certification.

## Core Framework
- Analyze requirements and constraints specific to solar-inverter-manufacturing
...
## Key Prompts
- "Initiate solar-inverter-manufacturing workflow for [context]"
- "Analyze current state of solar-inverter-manufacturing and identify gaps"
- "Generate recommendations for solar-inverter-manufacturing optimization"
- "Create detailed plan for solar-inverter-manufacturing execution"
