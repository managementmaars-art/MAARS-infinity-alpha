---
name: gas-turbine-manufacturing
description: Manage gas turbine manufacturing operations including compressor blade assembly, combustor fabrication, turbine section, and dynamic balancing.
---

## Overview
Manage gas turbine manufacturing operations including compressor blade assembly, combustor fabrication, turbine section, and dynamic balancing.

## Core Framework
- Analyze requirements and constraints specific to gas-turbine-manufacturing
...
## Key Prompts
- "Initiate gas-turbine-manufacturing workflow for [context]"
- "Analyze current state of gas-turbine-manufacturing and identify gaps"
- "Generate recommendations for gas-turbine-manufacturing optimization"
- "Create detailed plan for gas-turbine-manufacturing execution"
