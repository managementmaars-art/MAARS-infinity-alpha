---
name: floor-coating-installation
description: Install industrial floor coatings including epoxy, polyurethane, and MMA systems, surface preparation, joint filling, and cure management.
---

## Overview
Install industrial floor coatings including epoxy, polyurethane, and MMA systems, surface preparation, joint filling, and cure management.

## Core Framework
- Analyze requirements and constraints specific to floor-coating-installation
...
## Key Prompts
- "Initiate floor-coating-installation workflow for [context]"
- "Analyze current state of floor-coating-installation and identify gaps"
- "Generate recommendations for floor-coating-installation optimization"
- "Create detailed plan for floor-coating-installation execution"
