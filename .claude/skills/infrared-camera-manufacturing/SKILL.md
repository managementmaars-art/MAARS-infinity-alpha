---
name: infrared-camera-manufacturing
description: Manufacture infrared cameras including detector array hybridization, dewar assembly, read-out IC integration, calibration, and thermal sensitivity testing.
---

## Overview
Manufacture infrared cameras including detector array hybridization, dewar assembly, read-out IC integration, calibration, and thermal sensitivity testing.

## Core Framework
- Analyze requirements and constraints specific to infrared-camera-manufacturing
...
## Key Prompts
- "Initiate infrared-camera-manufacturing workflow for [context]"
- "Analyze current state of infrared-camera-manufacturing and identify gaps"
- "Generate recommendations for infrared-camera-manufacturing optimization"
- "Create detailed plan for infrared-camera-manufacturing execution"
