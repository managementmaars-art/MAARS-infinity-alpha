---
name: lighting-product-development
description: Develop lighting products from concept through commercialization including optical design, thermal simulation, and DLC qualification.
---

## Overview
Develop lighting products from concept through commercialization including optical design, thermal simulation, and DLC qualification.

## Core Framework
- Analyze requirements and constraints specific to lighting-product-development
...
## Key Prompts
- "Initiate lighting-product-development workflow for [context]"
- "Analyze current state of lighting-product-development and identify gaps"
- "Generate recommendations for lighting-product-development optimization"
- "Create detailed plan for lighting-product-development execution"
