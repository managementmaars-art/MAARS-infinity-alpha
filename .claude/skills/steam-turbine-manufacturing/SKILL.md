---
name: steam-turbine-manufacturing
description: Manage steam turbine manufacturing including rotor forging, blade machining, casing assembly, and performance testing programs.
---

## Overview
Manage steam turbine manufacturing including rotor forging, blade machining, casing assembly, and performance testing programs.

## Core Framework
- Analyze requirements and constraints specific to steam-turbine-manufacturing
...
## Key Prompts
- "Initiate steam-turbine-manufacturing workflow for [context]"
- "Analyze current state of steam-turbine-manufacturing and identify gaps"
- "Generate recommendations for steam-turbine-manufacturing optimization"
- "Create detailed plan for steam-turbine-manufacturing execution"
