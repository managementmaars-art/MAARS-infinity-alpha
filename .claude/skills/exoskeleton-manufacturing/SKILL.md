---
name: exoskeleton-manufacturing
description: Produce industrial exoskeleton devices including actuator assembly, ergonomic frame fabrication, control algorithm integration, and biomechanical testing.
---

## Overview
Produce industrial exoskeleton devices including actuator assembly, ergonomic frame fabrication, control algorithm integration, and biomechanical testing.

## Core Framework
- Analyze requirements and constraints specific to exoskeleton-manufacturing
...
## Key Prompts
- "Initiate exoskeleton-manufacturing workflow for [context]"
- "Analyze current state of exoskeleton-manufacturing and identify gaps"
- "Generate recommendations for exoskeleton-manufacturing optimization"
- "Create detailed plan for exoskeleton-manufacturing execution"
