---
name: aluminum-distribution-ops
description: Operate aluminum distribution including extrusions, sheet and plate, bar and rod, tread plate, and finished products sales and processing.
---

## Overview
Operate aluminum distribution including extrusions, sheet and plate, bar and rod, tread plate, and finished products sales and processing.

## Core Framework
- Analyze requirements and constraints specific to aluminum-distribution-ops
...
## Key Prompts
- "Initiate aluminum-distribution-ops workflow for [context]"
- "Analyze current state of aluminum-distribution-ops and identify gaps"
- "Generate recommendations for aluminum-distribution-ops optimization"
- "Create detailed plan for aluminum-distribution-ops execution"
