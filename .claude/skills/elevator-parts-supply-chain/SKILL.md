---
name: elevator-parts-supply-chain
description: Manage elevator parts supply chain including OEM and compatible parts procurement, inventory management, and emergency parts availability.
---

## Overview
Manage elevator parts supply chain including OEM and compatible parts procurement, inventory management, and emergency parts availability.

## Core Framework
- Analyze requirements and constraints specific to elevator-parts-supply-chain
...
## Key Prompts
- "Initiate elevator-parts-supply-chain workflow for [context]"
- "Analyze current state of elevator-parts-supply-chain and identify gaps"
- "Generate recommendations for elevator-parts-supply-chain optimization"
- "Create detailed plan for elevator-parts-supply-chain execution"
