---
name: specialty-gas-regulatory-compliance
description: Navigate specialty gas regulatory compliance including DOT cylinder qualification, hazmat shipping requirements, and compressed gas safety standards.
---

## Overview
Navigate specialty gas regulatory compliance including DOT cylinder qualification, hazmat shipping requirements, and compressed gas safety standards.

## Core Framework
- Analyze requirements and constraints specific to specialty-gas-regulatory-compliance
...
## Key Prompts
- "Initiate specialty-gas-regulatory-compliance workflow for [context]"
- "Analyze current state of specialty-gas-regulatory-compliance and identify gaps"
- "Generate recommendations for specialty-gas-regulatory-compliance optimization"
- "Create detailed plan for specialty-gas-regulatory-compliance execution"
