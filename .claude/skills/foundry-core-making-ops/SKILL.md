---
name: foundry-core-making-ops
description: Manage foundry core making operations including cold box and warm box core shooter management, core dip operations, and dimensional compliance.
---

## Overview
Manage foundry core making operations including cold box and warm box core shooter management, core dip operations, and dimensional compliance.

## Core Framework
- Analyze requirements and constraints specific to foundry-core-making-ops
...
## Key Prompts
- "Initiate foundry-core-making-ops workflow for [context]"
- "Analyze current state of foundry-core-making-ops and identify gaps"
- "Generate recommendations for foundry-core-making-ops optimization"
- "Create detailed plan for foundry-core-making-ops execution"
