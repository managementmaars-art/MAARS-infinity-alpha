---
name: event-safety-security-ops
description: Plan and execute event safety and security programs including crowd management, emergency response, and venue security coordination.
---

## Overview
Plan and execute event safety and security programs including crowd management, emergency response, and venue security coordination.

## Core Framework
- Analyze requirements and constraints specific to event-safety-security-ops
...
## Key Prompts
- "Initiate event-safety-security-ops workflow for [context]"
- "Analyze current state of event-safety-security-ops and identify gaps"
- "Generate recommendations for event-safety-security-ops optimization"
- "Create detailed plan for event-safety-security-ops execution"
