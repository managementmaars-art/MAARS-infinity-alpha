...
description: Manage emergency and exit lighting systems including battery backup compliance, UL 924 listing, code compliance, and test management.
---

## Overview
Manage emergency and exit lighting systems including battery backup compliance, UL 924 listing, code compliance, and test management.

## Core Framework
- Analyze requirements and constraints specific to emergency-lighting-systems
...
## Key Prompts
- "Initiate emergency-lighting-systems workflow for [context]"
- "Analyze current state of emergency-lighting-systems and identify gaps"
- "Generate recommendations for emergency-lighting-systems optimization"
- "Create detailed plan for emergency-lighting-systems execution"
