---
name: ion-exchange-resin-production
description: Manage ion exchange resin production including polymerization, functionalization, bead size control, and capacity testing.
---

## Overview
Manage ion exchange resin production including polymerization, functionalization, bead size control, and capacity testing.

## Core Framework
- Analyze requirements and constraints specific to ion-exchange-resin-production
...
## Key Prompts
- "Initiate ion-exchange-resin-production workflow for [context]"
- "Analyze current state of ion-exchange-resin-production and identify gaps"
- "Generate recommendations for ion-exchange-resin-production optimization"
- "Create detailed plan for ion-exchange-resin-production execution"
