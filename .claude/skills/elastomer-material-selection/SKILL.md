---
name: elastomer-material-selection
description: Select elastomer materials including NBR, EPDM, FKM, CR, and ACM types for media compatibility, temperature range, and mechanical property requirements.
---

## Overview
Select elastomer materials including NBR, EPDM, FKM, CR, and ACM types for media compatibility, temperature range, and mechanical property requirements.

## Core Framework
- Analyze requirements and constraints specific to elastomer-material-selection
...
## Key Prompts
- "Initiate elastomer-material-selection workflow for [context]"
- "Analyze current state of elastomer-material-selection and identify gaps"
- "Generate recommendations for elastomer-material-selection optimization"
- "Create detailed plan for elastomer-material-selection execution"
