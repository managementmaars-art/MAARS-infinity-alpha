---
name: maritime-propulsion-system-mfg
description: Build maritime propulsion systems including propeller casting, shaft machining, sterntube assembly, controllable pitch mechanism, and cavitation tunnel testing.
---

## Overview
Build maritime propulsion systems including propeller casting, shaft machining, sterntube assembly, controllable pitch mechanism, and cavitation tunnel testing.

## Core Framework
- Analyze requirements and constraints specific to maritime-propulsion-system-mfg
...
## Key Prompts
- "Initiate maritime-propulsion-system-mfg workflow for [context]"
- "Analyze current state of maritime-propulsion-system-mfg and identify gaps"
- "Generate recommendations for maritime-propulsion-system-mfg optimization"
- "Create detailed plan for maritime-propulsion-system-mfg execution"
