---
name: energy-storage-development
description: Develop battery energy storage projects including site selection, interconnection strategy, revenue stacking analysis, and EPC procurement.
---

## Overview
Develop battery energy storage projects including site selection, interconnection strategy, revenue stacking analysis, and EPC procurement.

## Core Framework
- Analyze requirements and constraints specific to energy-storage-development
...
## Key Prompts
- "Initiate energy-storage-development workflow for [context]"
- "Analyze current state of energy-storage-development and identify gaps"
- "Generate recommendations for energy-storage-development optimization"
- "Create detailed plan for energy-storage-development execution"
