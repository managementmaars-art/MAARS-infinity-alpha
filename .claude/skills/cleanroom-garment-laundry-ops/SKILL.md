---
name: cleanroom-garment-laundry-ops
description: Operate cleanroom garment laundering services including ISO classification compliance, particle count testing, and garment tracking systems.
---

## Overview
Operate cleanroom garment laundering services including ISO classification compliance, particle count testing, and garment tracking systems.

## Core Framework
- Analyze requirements and constraints specific to cleanroom-garment-laundry-ops
...
## Key Prompts
- "Initiate cleanroom-garment-laundry-ops workflow for [context]"
- "Analyze current state of cleanroom-garment-laundry-ops and identify gaps"
- "Generate recommendations for cleanroom-garment-laundry-ops optimization"
- "Create detailed plan for cleanroom-garment-laundry-ops execution"
