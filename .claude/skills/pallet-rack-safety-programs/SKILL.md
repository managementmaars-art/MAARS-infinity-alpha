---
name: pallet-rack-safety-programs
description: Manage pallet rack safety programs including load rating display, damage inspection protocols, repair approval, and seismic anchorage compliance.
---

## Overview
Manage pallet rack safety programs including load rating display, damage inspection protocols, repair approval, and seismic anchorage compliance.

## Core Framework
- Analyze requirements and constraints specific to pallet-rack-safety-programs
...
## Key Prompts
- "Initiate pallet-rack-safety-programs workflow for [context]"
- "Analyze current state of pallet-rack-safety-programs and identify gaps"
- "Generate recommendations for pallet-rack-safety-programs optimization"
- "Create detailed plan for pallet-rack-safety-programs execution"
