---
name: transformer-raw-materials
description: Manage transformer raw material sourcing including grain-oriented silicon steel, copper, insulation materials, and tankage fabrication.
---

## Overview
Manage transformer raw material sourcing including grain-oriented silicon steel, copper, insulation materials, and tankage fabrication.

## Core Framework
- Analyze requirements and constraints specific to transformer-raw-materials
...
## Key Prompts
- "Initiate transformer-raw-materials workflow for [context]"
- "Analyze current state of transformer-raw-materials and identify gaps"
- "Generate recommendations for transformer-raw-materials optimization"
- "Create detailed plan for transformer-raw-materials execution"
