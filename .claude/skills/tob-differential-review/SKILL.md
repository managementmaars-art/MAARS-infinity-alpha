...
description: Trail of Bits: differential code review — compare versions, highlight security-relevant changes
---

# Tob Differential Review — MAARS Security Reference

## Overview
Trail of Bits: differential code review — compare versions, highlight security-relevant changes
