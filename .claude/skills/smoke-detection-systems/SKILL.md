---
name: smoke-detection-systems
description: Design smoke detection systems including ionization, photoelectric, aspirating, and video smoke detection for facility protection.
---

## Overview
Design smoke detection systems including ionization, photoelectric, aspirating, and video smoke detection for facility protection.

## Core Framework
- Analyze requirements and constraints specific to smoke-detection-systems
...
## Key Prompts
- "Initiate smoke-detection-systems workflow for [context]"
- "Analyze current state of smoke-detection-systems and identify gaps"
- "Generate recommendations for smoke-detection-systems optimization"
- "Create detailed plan for smoke-detection-systems execution"
