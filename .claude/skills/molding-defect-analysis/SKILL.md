---
name: molding-defect-analysis
description: Analyze injection molding defects including weld lines, sink marks, warpage, and short shots with systematic root cause and corrective action.
---

## Overview
Analyze injection molding defects including weld lines, sink marks, warpage, and short shots with systematic root cause and corrective action.

## Core Framework
- Analyze requirements and constraints specific to molding-defect-analysis
...
## Key Prompts
- "Initiate molding-defect-analysis workflow for [context]"
- "Analyze current state of molding-defect-analysis and identify gaps"
- "Generate recommendations for molding-defect-analysis optimization"
- "Create detailed plan for molding-defect-analysis execution"
