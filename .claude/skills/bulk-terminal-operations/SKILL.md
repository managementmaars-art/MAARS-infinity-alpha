---
name: bulk-terminal-operations
description: Operate bulk cargo terminals including shiploading and unloading equipment management, stockpile management, and conveyor system maintenance.
---

## Overview
Operate bulk cargo terminals including shiploading and unloading equipment management, stockpile management, and conveyor system maintenance.

## Core Framework
- Analyze requirements and constraints specific to bulk-terminal-operations
...
## Key Prompts
- "Initiate bulk-terminal-operations workflow for [context]"
- "Analyze current state of bulk-terminal-operations and identify gaps"
- "Generate recommendations for bulk-terminal-operations optimization"
- "Create detailed plan for bulk-terminal-operations execution"
