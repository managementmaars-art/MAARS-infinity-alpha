---
name: overhead-conveyor-systems
description: Design and manage overhead conveyor systems including power-and-free systems, monorail systems, and automotive assembly applications.
---

## Overview
Design and manage overhead conveyor systems including power-and-free systems, monorail systems, and automotive assembly applications.

## Core Framework
- Analyze requirements and constraints specific to overhead-conveyor-systems
...
## Key Prompts
- "Initiate overhead-conveyor-systems workflow for [context]"
- "Analyze current state of overhead-conveyor-systems and identify gaps"
- "Generate recommendations for overhead-conveyor-systems optimization"
- "Create detailed plan for overhead-conveyor-systems execution"
