---
name: epoxy-floor-coating-services
description: Operate epoxy and floor coating services including surface preparation, coating application, decorative systems, and commercial floor maintenance programs.
---

## Overview
Operate epoxy and floor coating services including surface preparation, coating application, decorative systems, and commercial floor maintenance programs.

## Core Framework
- Analyze requirements and constraints specific to epoxy-floor-coating-services
...
## Key Prompts
- "Initiate epoxy-floor-coating-services workflow for [context]"
- "Analyze current state of epoxy-floor-coating-services and identify gaps"
- "Generate recommendations for epoxy-floor-coating-services optimization"
- "Create detailed plan for epoxy-floor-coating-services execution"
