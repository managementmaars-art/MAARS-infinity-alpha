---
name: anodizing-operations
description: Manage anodizing services including sulfuric, hard coat, and chromic acid anodize processes with seal quality and oxide thickness control.
---

## Overview
Manage anodizing services including sulfuric, hard coat, and chromic acid anodize processes with seal quality and oxide thickness control.

## Core Framework
- Analyze requirements and constraints specific to anodizing-operations
...
## Key Prompts
- "Initiate anodizing-operations workflow for [context]"
- "Analyze current state of anodizing-operations and identify gaps"
- "Generate recommendations for anodizing-operations optimization"
- "Create detailed plan for anodizing-operations execution"
