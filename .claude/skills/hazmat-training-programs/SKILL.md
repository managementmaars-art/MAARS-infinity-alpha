---
name: hazmat-training-programs
description: Deliver hazmat training programs including RCRA generator training, DOT hazmat employee training, and first responder awareness level training.
---

## Overview
Deliver hazmat training programs including RCRA generator training, DOT hazmat employee training, and first responder awareness level training.

## Core Framework
- Analyze requirements and constraints specific to hazmat-training-programs
...
## Key Prompts
- "Initiate hazmat-training-programs workflow for [context]"
- "Analyze current state of hazmat-training-programs and identify gaps"
- "Generate recommendations for hazmat-training-programs optimization"
- "Create detailed plan for hazmat-training-programs execution"
