---
name: hazardous-waste-collection-ops
description: Manage hazardous waste collection operations including generator site visits, drum consolidation, DOT packaging, and transporter coordination.
---

## Overview
Manage hazardous waste collection operations including generator site visits, drum consolidation, DOT packaging, and transporter coordination.

## Core Framework
- Analyze requirements and constraints specific to hazardous-waste-collection-ops
...
## Key Prompts
- "Initiate hazardous-waste-collection-ops workflow for [context]"
- "Analyze current state of hazardous-waste-collection-ops and identify gaps"
- "Generate recommendations for hazardous-waste-collection-ops optimization"
- "Create detailed plan for hazardous-waste-collection-ops execution"
