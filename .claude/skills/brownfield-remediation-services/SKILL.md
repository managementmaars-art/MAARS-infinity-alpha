---
name: brownfield-remediation-services
description: Deliver brownfield remediation services including site investigation, remedy selection, regulatory liaison, cost-to-close analysis, and closure reporting.
---

## Overview
Deliver brownfield remediation services including site investigation, remedy selection, regulatory liaison, cost-to-close analysis, and closure reporting.

## Core Framework
- Analyze requirements and constraints specific to brownfield-remediation-services
...
## Key Prompts
- "Initiate brownfield-remediation-services workflow for [context]"
- "Analyze current state of brownfield-remediation-services and identify gaps"
- "Generate recommendations for brownfield-remediation-services optimization"
- "Create detailed plan for brownfield-remediation-services execution"
