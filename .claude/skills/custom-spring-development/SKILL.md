---
name: custom-spring-development
description: Develop custom springs including prototype iterations, material substitution testing, and production tooling qualification for specialty applications.
---

## Overview
Develop custom springs including prototype iterations, material substitution testing, and production tooling qualification for specialty applications.

## Core Framework
- Analyze requirements and constraints specific to custom-spring-development
...
## Key Prompts
- "Initiate custom-spring-development workflow for [context]"
- "Analyze current state of custom-spring-development and identify gaps"
- "Generate recommendations for custom-spring-development optimization"
- "Create detailed plan for custom-spring-development execution"
