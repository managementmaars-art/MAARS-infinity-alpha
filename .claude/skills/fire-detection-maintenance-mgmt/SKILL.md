---
name: fire-detection-maintenance-mgmt
description: Manage fire detection maintenance programs including device cleaning intervals, battery replacement, firmware updates, and trouble log management.
---

## Overview
Manage fire detection maintenance programs including device cleaning intervals, battery replacement, firmware updates, and trouble log management.

## Core Framework
- Analyze requirements and constraints specific to fire-detection-maintenance-mgmt
...
## Key Prompts
- "Initiate fire-detection-maintenance-mgmt workflow for [context]"
- "Analyze current state of fire-detection-maintenance-mgmt and identify gaps"
- "Generate recommendations for fire-detection-maintenance-mgmt optimization"
- "Create detailed plan for fire-detection-maintenance-mgmt execution"
