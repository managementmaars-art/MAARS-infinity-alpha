---
name: fund-administration-pe
description: Administer private equity fund operations including capital calls, distributions, NAV calculations, and LP statement generation.
---

## Overview
Administer private equity fund operations including capital calls, distributions, NAV calculations, and LP statement generation.

## Core Framework
- Analyze requirements and constraints specific to fund-administration-pe
...
## Key Prompts
- "Initiate fund-administration-pe workflow for [context]"
- "Analyze current state of fund-administration-pe and identify gaps"
- "Generate recommendations for fund-administration-pe optimization"
- "Create detailed plan for fund-administration-pe execution"
