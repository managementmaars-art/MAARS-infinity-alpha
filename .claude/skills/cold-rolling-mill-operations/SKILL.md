---
name: cold-rolling-mill-operations
description: Manage cold rolling operations including tension leveling, rolling reduction scheduling, surface finish control, and shape correction programs.
---

## Overview
Manage cold rolling operations including tension leveling, rolling reduction scheduling, surface finish control, and shape correction programs.

## Core Framework
- Analyze requirements and constraints specific to cold-rolling-mill-operations
...
## Key Prompts
- "Initiate cold-rolling-mill-operations workflow for [context]"
- "Analyze current state of cold-rolling-mill-operations and identify gaps"
- "Generate recommendations for cold-rolling-mill-operations optimization"
- "Create detailed plan for cold-rolling-mill-operations execution"
