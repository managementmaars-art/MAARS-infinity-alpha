---
name: portable-sanitation-national-accounts
description: Develop portable sanitation national account programs including multi-site pricing, service level agreements, and centralized billing.
---

## Overview
Develop portable sanitation national account programs including multi-site pricing, service level agreements, and centralized billing.

## Core Framework
- Analyze requirements and constraints specific to portable-sanitation-national-accounts
...
## Key Prompts
- "Initiate portable-sanitation-national-accounts workflow for [context]"
- "Analyze current state of portable-sanitation-national-accounts and identify gaps"
- "Generate recommendations for portable-sanitation-national-accounts optimization"
- "Create detailed plan for portable-sanitation-national-accounts execution"
