...
description: Manage cell therapy production including leukapheresis coordination, T-cell activation, viral transduction, and product release testing workflows.
---

## Overview
Manage cell therapy production including leukapheresis coordination, T-cell activation, viral transduction, and product release testing workflows.

## Core Framework
- Analyze requirements and constraints specific to cell-therapy-manufacturing
...
## Key Prompts
- "Initiate cell-therapy-manufacturing workflow for [context]"
- "Analyze current state of cell-therapy-manufacturing and identify gaps"
- "Generate recommendations for cell-therapy-manufacturing optimization"
- "Create detailed plan for cell-therapy-manufacturing execution"
