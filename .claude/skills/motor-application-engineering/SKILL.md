---
name: motor-application-engineering
description: Provide motor application engineering support including frame selection, efficiency class, VFD compatibility, and thermal derating analysis.
---

## Overview
Provide motor application engineering support including frame selection, efficiency class, VFD compatibility, and thermal derating analysis.

## Core Framework
- Analyze requirements and constraints specific to motor-application-engineering
...
## Key Prompts
- "Initiate motor-application-engineering workflow for [context]"
- "Analyze current state of motor-application-engineering and identify gaps"
- "Generate recommendations for motor-application-engineering optimization"
- "Create detailed plan for motor-application-engineering execution"
