---
name: optics-manufacturing-ops
description: Manage precision optics manufacturing including grinding, polishing, coating, and interferometric testing for optical components.
---

## Overview
Manage precision optics manufacturing including grinding, polishing, coating, and interferometric testing for optical components.

## Core Framework
- Analyze requirements and constraints specific to optics-manufacturing-ops
...
## Key Prompts
- "Initiate optics-manufacturing-ops workflow for [context]"
- "Analyze current state of optics-manufacturing-ops and identify gaps"
- "Generate recommendations for optics-manufacturing-ops optimization"
- "Create detailed plan for optics-manufacturing-ops execution"
