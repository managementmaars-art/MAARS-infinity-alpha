---
name: polypropylene-plant-operations
description: Operate polypropylene production units including bulk slurry loop reactor management, catalyst feed systems, and product grade change execution.
---

## Overview
Operate polypropylene production units including bulk slurry loop reactor management, catalyst feed systems, and product grade change execution.

## Core Framework
- Analyze requirements and constraints specific to polypropylene-plant-operations
...
## Key Prompts
- "Initiate polypropylene-plant-operations workflow for [context]"
- "Analyze current state of polypropylene-plant-operations and identify gaps"
- "Generate recommendations for polypropylene-plant-operations optimization"
- "Create detailed plan for polypropylene-plant-operations execution"
