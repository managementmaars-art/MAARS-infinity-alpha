---
name: gauge-management-programs
description: Manage gauge and tooling inspection programs including gauge R&R, calibration tracking, and controlled gauge distribution.
---

## Overview
Manage gauge and tooling inspection programs including gauge R&R, calibration tracking, and controlled gauge distribution.

## Core Framework
- Analyze requirements and constraints specific to gauge-management-programs
...
## Key Prompts
- "Initiate gauge-management-programs workflow for [context]"
- "Analyze current state of gauge-management-programs and identify gaps"
- "Generate recommendations for gauge-management-programs optimization"
- "Create detailed plan for gauge-management-programs execution"
