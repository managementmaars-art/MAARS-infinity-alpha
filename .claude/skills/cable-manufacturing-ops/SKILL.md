---
name: cable-manufacturing-ops
description: Manage cable manufacturing operations including extrusion line setup, stranding processes, armoring, and electrical test procedures.
---

## Overview
Manage cable manufacturing operations including extrusion line setup, stranding processes, armoring, and electrical test procedures.

## Core Framework
- Analyze requirements and constraints specific to cable-manufacturing-ops
...
## Key Prompts
- "Initiate cable-manufacturing-ops workflow for [context]"
- "Analyze current state of cable-manufacturing-ops and identify gaps"
- "Generate recommendations for cable-manufacturing-ops optimization"
- "Create detailed plan for cable-manufacturing-ops execution"
