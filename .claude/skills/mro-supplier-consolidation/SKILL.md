---
name: mro-supplier-consolidation
description: Execute MRO supplier consolidation programs including spend analysis, supplier rationalization, contract negotiation, and performance tracking.
---

## Overview
Execute MRO supplier consolidation programs including spend analysis, supplier rationalization, contract negotiation, and performance tracking.

## Core Framework
- Analyze requirements and constraints specific to mro-supplier-consolidation
...
## Key Prompts
- "Initiate mro-supplier-consolidation workflow for [context]"
- "Analyze current state of mro-supplier-consolidation and identify gaps"
- "Generate recommendations for mro-supplier-consolidation optimization"
- "Create detailed plan for mro-supplier-consolidation execution"
