---
name: linear-actuator-integration
description: Integrate linear actuators including electric cylinders, rodless actuators, and linear modules into automated machine designs.
---

## Overview
Integrate linear actuators including electric cylinders, rodless actuators, and linear modules into automated machine designs.

## Core Framework
- Analyze requirements and constraints specific to linear-actuator-integration
...
## Key Prompts
- "Initiate linear-actuator-integration workflow for [context]"
- "Analyze current state of linear-actuator-integration and identify gaps"
- "Generate recommendations for linear-actuator-integration optimization"
- "Create detailed plan for linear-actuator-integration execution"
