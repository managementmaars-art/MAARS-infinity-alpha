---
name: ceramic-glaze-development
description: Develop ceramic glaze formulations including colorant chemistry, flow testing, kiln atmosphere optimization, and production scale-up.
---

## Overview
Develop ceramic glaze formulations including colorant chemistry, flow testing, kiln atmosphere optimization, and production scale-up.

## Core Framework
- Analyze requirements and constraints specific to ceramic-glaze-development
...
## Key Prompts
- "Initiate ceramic-glaze-development workflow for [context]"
- "Analyze current state of ceramic-glaze-development and identify gaps"
- "Generate recommendations for ceramic-glaze-development optimization"
- "Create detailed plan for ceramic-glaze-development execution"
