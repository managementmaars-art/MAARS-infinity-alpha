---
name: forest-road-management
description: Manage forest road networks including design, construction standards, maintenance scheduling, and stormwater compliance.
---

## Overview
Manage forest road networks including design, construction standards, maintenance scheduling, and stormwater compliance.

## Core Framework
- Analyze requirements and constraints specific to forest-road-management
...
## Key Prompts
- "Initiate forest-road-management workflow for [context]"
- "Analyze current state of forest-road-management and identify gaps"
- "Generate recommendations for forest-road-management optimization"
- "Create detailed plan for forest-road-management execution"
