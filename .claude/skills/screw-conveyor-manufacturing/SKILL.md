---
name: screw-conveyor-manufacturing
description: Manufacture screw conveyors including flight design, trough selection, hanger bearing management, variable pitch configurations, and enclosed conveyor sanitary design.
---

## Overview
Manufacture screw conveyors including flight design, trough selection, hanger bearing management, variable pitch configurations, and enclosed conveyor sanitary design.

## Core Framework
- Analyze requirements and constraints specific to screw-conveyor-manufacturing
...
## Key Prompts
- "Initiate screw-conveyor-manufacturing workflow for [context]"
- "Analyze current state of screw-conveyor-manufacturing and identify gaps"
- "Generate recommendations for screw-conveyor-manufacturing optimization"
- "Create detailed plan for screw-conveyor-manufacturing execution"
