---
name: cathodic-protection-engineering
description: Engineer cathodic protection systems including galvanic anode design, impressed current systems, interference testing, and criteria verification.
---

## Overview
Engineer cathodic protection systems including galvanic anode design, impressed current systems, interference testing, and criteria verification.

## Core Framework
- Analyze requirements and constraints specific to cathodic-protection-engineering
...
## Key Prompts
- "Initiate cathodic-protection-engineering workflow for [context]"
- "Analyze current state of cathodic-protection-engineering and identify gaps"
- "Generate recommendations for cathodic-protection-engineering optimization"
- "Create detailed plan for cathodic-protection-engineering execution"
