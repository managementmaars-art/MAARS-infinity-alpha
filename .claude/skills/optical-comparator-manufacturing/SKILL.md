---
name: optical-comparator-manufacturing
description: Manufacture optical comparators including projection lens assembly, illumination system fabrication, and overlay accuracy qualification.
---

## Overview
Manufacture optical comparators including projection lens assembly, illumination system fabrication, and overlay accuracy qualification.

## Core Framework
- Analyze requirements and constraints specific to optical-comparator-manufacturing
...
## Key Prompts
- "Initiate optical-comparator-manufacturing workflow for [context]"
- "Analyze current state of optical-comparator-manufacturing and identify gaps"
- "Generate recommendations for optical-comparator-manufacturing optimization"
- "Create detailed plan for optical-comparator-manufacturing execution"
