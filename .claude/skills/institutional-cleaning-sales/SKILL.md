---
name: institutional-cleaning-sales
description: Manage institutional and industrial cleaning sales including jan-san distributor programs, GPO contracts, and technical demonstrations.
---

## Overview
Manage institutional and industrial cleaning sales including jan-san distributor programs, GPO contracts, and technical demonstrations.

## Core Framework
- Analyze requirements and constraints specific to institutional-cleaning-sales
...
## Key Prompts
- "Initiate institutional-cleaning-sales workflow for [context]"
- "Analyze current state of institutional-cleaning-sales and identify gaps"
- "Generate recommendations for institutional-cleaning-sales optimization"
- "Create detailed plan for institutional-cleaning-sales execution"
