---
name: leather-goods-logistics
description: Manage leather goods logistics including duty drawback, customs classification, bonded warehouse, and DDP delivery program management.
---

## Overview
Manage leather goods logistics including duty drawback, customs classification, bonded warehouse, and DDP delivery program management.

## Core Framework
- Analyze requirements and constraints specific to leather-goods-logistics
...
## Key Prompts
- "Initiate leather-goods-logistics workflow for [context]"
- "Analyze current state of leather-goods-logistics and identify gaps"
- "Generate recommendations for leather-goods-logistics optimization"
- "Create detailed plan for leather-goods-logistics execution"
