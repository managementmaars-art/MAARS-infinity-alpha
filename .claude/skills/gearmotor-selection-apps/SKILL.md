---
name: gearmotor-selection-apps
description: Select and apply gearmotors including planetary, parallel shaft, and bevel-helical types for torque, speed, and mounting requirements.
---

## Overview
Select and apply gearmotors including planetary, parallel shaft, and bevel-helical types for torque, speed, and mounting requirements.

## Core Framework
- Analyze requirements and constraints specific to gearmotor-selection-apps
...
## Key Prompts
- "Initiate gearmotor-selection-apps workflow for [context]"
- "Analyze current state of gearmotor-selection-apps and identify gaps"
- "Generate recommendations for gearmotor-selection-apps optimization"
- "Create detailed plan for gearmotor-selection-apps execution"
