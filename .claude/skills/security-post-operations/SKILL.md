---
name: security-post-operations
description: Manage security guard post operations including access control procedures, patrol scheduling, incident report documentation, and post order compliance.
---

## Overview
Manage security guard post operations including access control procedures, patrol scheduling, incident report documentation, and post order compliance.

## Core Framework
- Analyze requirements and constraints specific to security-post-operations
...
## Key Prompts
- "Initiate security-post-operations workflow for [context]"
- "Analyze current state of security-post-operations and identify gaps"
- "Generate recommendations for security-post-operations optimization"
- "Create detailed plan for security-post-operations execution"
