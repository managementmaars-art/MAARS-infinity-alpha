---
name: mooring-chain-operations
description: Manage offshore mooring chain operations including fatigue monitoring, corrosion protection, inspection campaigns, and replacement planning.
---

## Overview
Manage offshore mooring chain operations including fatigue monitoring, corrosion protection, inspection campaigns, and replacement planning.

## Core Framework
- Analyze requirements and constraints specific to mooring-chain-operations
...
## Key Prompts
- "Initiate mooring-chain-operations workflow for [context]"
- "Analyze current state of mooring-chain-operations and identify gaps"
- "Generate recommendations for mooring-chain-operations optimization"
- "Create detailed plan for mooring-chain-operations execution"
