---
name: separator-coalescer-ops
description: Operate separator and coalescer systems for oil-water separation, gas-liquid separation, and aerosol removal in process and utility applications.
---

## Overview
Operate separator and coalescer systems for oil-water separation, gas-liquid separation, and aerosol removal in process and utility applications.

## Core Framework
- Analyze requirements and constraints specific to separator-coalescer-ops
...
## Key Prompts
- "Initiate separator-coalescer-ops workflow for [context]"
- "Analyze current state of separator-coalescer-ops and identify gaps"
- "Generate recommendations for separator-coalescer-ops optimization"
- "Create detailed plan for separator-coalescer-ops execution"
