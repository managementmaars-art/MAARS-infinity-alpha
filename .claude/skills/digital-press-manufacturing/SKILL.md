---
name: digital-press-manufacturing
description: Build digital printing presses including electrophotographic and inkjet engines, media handling, RIP integration, and color gamut qualification for commercial print.
---

## Overview
Build digital printing presses including electrophotographic and inkjet engines, media handling, RIP integration, and color gamut qualification for commercial print.

## Core Framework
- Analyze requirements and constraints specific to digital-press-manufacturing
...
## Key Prompts
- "Initiate digital-press-manufacturing workflow for [context]"
- "Analyze current state of digital-press-manufacturing and identify gaps"
- "Generate recommendations for digital-press-manufacturing optimization"
- "Create detailed plan for digital-press-manufacturing execution"
