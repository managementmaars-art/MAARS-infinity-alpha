---
name: coupling-selection-engineering
description: Select and engineer shaft couplings including flexible, rigid, fluid, and disc types for torque capacity, misalignment, and vibration damping.
---

## Overview
Select and engineer shaft couplings including flexible, rigid, fluid, and disc types for torque capacity, misalignment, and vibration damping.

## Core Framework
- Analyze requirements and constraints specific to coupling-selection-engineering
...
## Key Prompts
- "Initiate coupling-selection-engineering workflow for [context]"
- "Analyze current state of coupling-selection-engineering and identify gaps"
- "Generate recommendations for coupling-selection-engineering optimization"
- "Create detailed plan for coupling-selection-engineering execution"
