---
name: plc-manufacturing-ops
description: Manufacture programmable logic controllers including CPU module fabrication, I/O card assembly, backplane manufacturing, and firmware qualification.
---

## Overview
Manufacture programmable logic controllers including CPU module fabrication, I/O card assembly, backplane manufacturing, and firmware qualification.

## Core Framework
- Analyze requirements and constraints specific to plc-manufacturing-ops
...
## Key Prompts
- "Initiate plc-manufacturing-ops workflow for [context]"
- "Analyze current state of plc-manufacturing-ops and identify gaps"
- "Generate recommendations for plc-manufacturing-ops optimization"
- "Create detailed plan for plc-manufacturing-ops execution"
