---
name: pool-water-testing-programs
description: Manage pool water testing programs including in-store water analysis, mobile testing, chemical recommendations, and educational programs.
---

## Overview
Manage pool water testing programs including in-store water analysis, mobile testing, chemical recommendations, and educational programs.

## Core Framework
- Analyze requirements and constraints specific to pool-water-testing-programs
...
## Key Prompts
- "Initiate pool-water-testing-programs workflow for [context]"
- "Analyze current state of pool-water-testing-programs and identify gaps"
- "Generate recommendations for pool-water-testing-programs optimization"
- "Create detailed plan for pool-water-testing-programs execution"
