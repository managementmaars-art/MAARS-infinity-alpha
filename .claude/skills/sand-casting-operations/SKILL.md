---
name: sand-casting-operations
description: Operate sand casting facilities including no-bake sand system management, pattern maintenance, gating design review, and yield optimization.
---

## Overview
Operate sand casting facilities including no-bake sand system management, pattern maintenance, gating design review, and yield optimization.

## Core Framework
- Analyze requirements and constraints specific to sand-casting-operations
...
## Key Prompts
- "Initiate sand-casting-operations workflow for [context]"
- "Analyze current state of sand-casting-operations and identify gaps"
- "Generate recommendations for sand-casting-operations optimization"
- "Create detailed plan for sand-casting-operations execution"
