---
name: auto-parts-warehouse-ops
description: Operate automotive aftermarket parts warehouses including bin location management, will-call counter service, and next-day delivery fulfillment.
---

## Overview
Operate automotive aftermarket parts warehouses including bin location management, will-call counter service, and next-day delivery fulfillment.

## Core Framework
- Analyze requirements and constraints specific to auto-parts-warehouse-ops
...
## Key Prompts
- "Initiate auto-parts-warehouse-ops workflow for [context]"
- "Analyze current state of auto-parts-warehouse-ops and identify gaps"
- "Generate recommendations for auto-parts-warehouse-ops optimization"
- "Create detailed plan for auto-parts-warehouse-ops execution"
