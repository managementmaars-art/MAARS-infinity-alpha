---
name: conformal-coating-operations
description: Manage conformal coating operations including material selection, selective coating programming, cure verification, and film thickness measurement.
---

## Overview
Manage conformal coating operations including material selection, selective coating programming, cure verification, and film thickness measurement.

## Core Framework
- Analyze requirements and constraints specific to conformal-coating-operations
...
## Key Prompts
- "Initiate conformal-coating-operations workflow for [context]"
- "Analyze current state of conformal-coating-operations and identify gaps"
- "Generate recommendations for conformal-coating-operations optimization"
- "Create detailed plan for conformal-coating-operations execution"
