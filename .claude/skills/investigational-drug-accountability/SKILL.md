---
name: investigational-drug-accountability
description: Manage investigational drug accountability systems including dispensation tracking, return reconciliation, and destruction documentation.
---

## Overview
Manage investigational drug accountability systems including dispensation tracking, return reconciliation, and destruction documentation.

## Core Framework
- Analyze requirements and constraints specific to investigational-drug-accountability
...
## Key Prompts
- "Initiate investigational-drug-accountability workflow for [context]"
- "Analyze current state of investigational-drug-accountability and identify gaps"
- "Generate recommendations for investigational-drug-accountability optimization"
- "Create detailed plan for investigational-drug-accountability execution"
