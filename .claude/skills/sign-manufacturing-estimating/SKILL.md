---
name: sign-manufacturing-estimating
description: Develop sign manufacturing estimates including materials, fabrication labor, electrical components, installation, and permit costs.
---

## Overview
Develop sign manufacturing estimates including materials, fabrication labor, electrical components, installation, and permit costs.

## Core Framework
- Analyze requirements and constraints specific to sign-manufacturing-estimating
...
## Key Prompts
- "Initiate sign-manufacturing-estimating workflow for [context]"
- "Analyze current state of sign-manufacturing-estimating and identify gaps"
- "Generate recommendations for sign-manufacturing-estimating optimization"
- "Create detailed plan for sign-manufacturing-estimating execution"
