---
name: composites-raw-material-mgmt
description: Manage composite raw materials including prepreg procurement, resin systems, core materials, and out-time/shelf-life tracking.
---

## Overview
Manage composite raw materials including prepreg procurement, resin systems, core materials, and out-time/shelf-life tracking.

## Core Framework
- Analyze requirements and constraints specific to composites-raw-material-mgmt
...
## Key Prompts
- "Initiate composites-raw-material-mgmt workflow for [context]"
- "Analyze current state of composites-raw-material-mgmt and identify gaps"
- "Generate recommendations for composites-raw-material-mgmt optimization"
- "Create detailed plan for composites-raw-material-mgmt execution"
