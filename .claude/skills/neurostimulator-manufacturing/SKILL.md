---
name: neurostimulator-manufacturing
description: Build neurostimulators including deep brain and spinal cord stimulators with lead fabrication, electrode coating, connector assembly, and impedance testing.
---

## Overview
Build neurostimulators including deep brain and spinal cord stimulators with lead fabrication, electrode coating, connector assembly, and impedance testing.

## Core Framework
- Analyze requirements and constraints specific to neurostimulator-manufacturing
...
## Key Prompts
- "Initiate neurostimulator-manufacturing workflow for [context]"
- "Analyze current state of neurostimulator-manufacturing and identify gaps"
- "Generate recommendations for neurostimulator-manufacturing optimization"
- "Create detailed plan for neurostimulator-manufacturing execution"
