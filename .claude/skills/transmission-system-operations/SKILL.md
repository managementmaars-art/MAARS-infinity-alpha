---
name: transmission-system-operations
description: Operate high-voltage transmission systems including load flow management, reactive power control, stability monitoring, and outage coordination.
---

## Overview
Operate high-voltage transmission systems including load flow management, reactive power control, stability monitoring, and outage coordination.

## Core Framework
- Analyze requirements and constraints specific to transmission-system-operations
...
## Key Prompts
- "Initiate transmission-system-operations workflow for [context]"
- "Analyze current state of transmission-system-operations and identify gaps"
- "Generate recommendations for transmission-system-operations optimization"
- "Create detailed plan for transmission-system-operations execution"
