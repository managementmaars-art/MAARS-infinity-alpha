---
name: rope-access-rescue-planning
description: Plan rope access rescue procedures including rescue kit configuration, evacuation route identification, and emergency response drills.
---

## Overview
Plan rope access rescue procedures including rescue kit configuration, evacuation route identification, and emergency response drills.

## Core Framework
- Analyze requirements and constraints specific to rope-access-rescue-planning
...
## Key Prompts
- "Initiate rope-access-rescue-planning workflow for [context]"
- "Analyze current state of rope-access-rescue-planning and identify gaps"
- "Generate recommendations for rope-access-rescue-planning optimization"
- "Create detailed plan for rope-access-rescue-planning execution"
