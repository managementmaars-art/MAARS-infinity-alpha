---
name: tob-vuln-classes
description: Trail of Bits: vulnerability classes — reentrancy, integer overflow, access control, logic bugs
---

# Tob Vuln Classes — MAARS Security Reference

## Overview
Trail of Bits: vulnerability classes — reentrancy, integer overflow, access control, logic bugs
