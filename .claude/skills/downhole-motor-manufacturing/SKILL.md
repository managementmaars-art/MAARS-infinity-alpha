---
name: downhole-motor-manufacturing
description: Build positive displacement downhole motors including power section molding, bearing pack assembly, bit box qualification, and flow-torque performance mapping.
---

## Overview
Build positive displacement downhole motors including power section molding, bearing pack assembly, bit box qualification, and flow-torque performance mapping.

## Core Framework
- Analyze requirements and constraints specific to downhole-motor-manufacturing
...
## Key Prompts
- "Initiate downhole-motor-manufacturing workflow for [context]"
- "Analyze current state of downhole-motor-manufacturing and identify gaps"
- "Generate recommendations for downhole-motor-manufacturing optimization"
- "Create detailed plan for downhole-motor-manufacturing execution"
