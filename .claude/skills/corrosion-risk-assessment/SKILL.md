---
name: corrosion-risk-assessment
description: Conduct corrosion risk assessments including material selection reviews, environment characterization, and corrosion rate prediction modeling.
---

## Overview
Conduct corrosion risk assessments including material selection reviews, environment characterization, and corrosion rate prediction modeling.

## Core Framework
- Analyze requirements and constraints specific to corrosion-risk-assessment
...
## Key Prompts
- "Initiate corrosion-risk-assessment workflow for [context]"
- "Analyze current state of corrosion-risk-assessment and identify gaps"
- "Generate recommendations for corrosion-risk-assessment optimization"
- "Create detailed plan for corrosion-risk-assessment execution"
