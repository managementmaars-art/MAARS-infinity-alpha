...
description: Develop construction cost estimates including quantity takeoffs, unit cost databases, GC markup modeling, and value engineering.
---

## Overview
Develop construction cost estimates including quantity takeoffs, unit cost databases, GC markup modeling, and value engineering.

## Core Framework
- Analyze requirements and constraints specific to construction-cost-estimating
...
## Key Prompts
- "Initiate construction-cost-estimating workflow for [context]"
- "Analyze current state of construction-cost-estimating and identify gaps"
- "Generate recommendations for construction-cost-estimating optimization"
- "Create detailed plan for construction-cost-estimating execution"
