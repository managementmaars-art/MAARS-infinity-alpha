---
name: ecommerce-fulfillment-center-ops
description: Operate ecommerce fulfillment centers including receiving, putaway, pick-pack-ship, returns processing, and multi-channel order management.
---

## Overview
Operate ecommerce fulfillment centers including receiving, putaway, pick-pack-ship, returns processing, and multi-channel order management.

## Core Framework
- Analyze requirements and constraints specific to ecommerce-fulfillment-center-ops
...
## Key Prompts
- "Initiate ecommerce-fulfillment-center-ops workflow for [context]"
- "Analyze current state of ecommerce-fulfillment-center-ops and identify gaps"
- "Generate recommendations for ecommerce-fulfillment-center-ops optimization"
- "Create detailed plan for ecommerce-fulfillment-center-ops execution"
