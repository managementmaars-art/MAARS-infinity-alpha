---
name: gis-urban-analytics
description: Deploy GIS analytics for urban planning including spatial equity analysis, service coverage mapping, and demographic change modeling.
---

## Overview
Deploy GIS analytics for urban planning including spatial equity analysis, service coverage mapping, and demographic change modeling.

## Core Framework
- Analyze requirements and constraints specific to gis-urban-analytics
...
## Key Prompts
- "Initiate gis-urban-analytics workflow for [context]"
- "Analyze current state of gis-urban-analytics and identify gaps"
- "Generate recommendations for gis-urban-analytics optimization"
- "Create detailed plan for gis-urban-analytics execution"
