---
name: structural-fabrication-ops
description: Manage structural steel fabrication operations including fit-up sequencing, overhead crane utilization, and dimensional verification programs.
---

## Overview
Manage structural steel fabrication operations including fit-up sequencing, overhead crane utilization, and dimensional verification programs.

## Core Framework
- Analyze requirements and constraints specific to structural-fabrication-ops
...
## Key Prompts
- "Initiate structural-fabrication-ops workflow for [context]"
- "Analyze current state of structural-fabrication-ops and identify gaps"
- "Generate recommendations for structural-fabrication-ops optimization"
- "Create detailed plan for structural-fabrication-ops execution"
