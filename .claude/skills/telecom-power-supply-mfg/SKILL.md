---
name: telecom-power-supply-mfg
description: Manufacture telecom power supplies including DC-DC converter assembly, battery backup integration, and NEBS/ETSI environmental compliance testing.
---

## Overview
Manufacture telecom power supplies including DC-DC converter assembly, battery backup integration, and NEBS/ETSI environmental compliance testing.

## Core Framework
- Analyze requirements and constraints specific to telecom-power-supply-mfg
...
## Key Prompts
- "Initiate telecom-power-supply-mfg workflow for [context]"
- "Analyze current state of telecom-power-supply-mfg and identify gaps"
- "Generate recommendations for telecom-power-supply-mfg optimization"
- "Create detailed plan for telecom-power-supply-mfg execution"
