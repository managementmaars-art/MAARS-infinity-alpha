---
name: marine-coating-application-ops
description: Manage marine coating application services including hull antifouling, topside finishes, tank coatings, and offshore structure maintenance.
---

## Overview
Manage marine coating application services including hull antifouling, topside finishes, tank coatings, and offshore structure maintenance.

## Core Framework
- Analyze requirements and constraints specific to marine-coating-application-ops
...
## Key Prompts
- "Initiate marine-coating-application-ops workflow for [context]"
- "Analyze current state of marine-coating-application-ops and identify gaps"
- "Generate recommendations for marine-coating-application-ops optimization"
- "Create detailed plan for marine-coating-application-ops execution"
