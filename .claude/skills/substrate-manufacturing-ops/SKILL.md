---
name: substrate-manufacturing-ops
description: Manage package substrate manufacturing including HDI laminate processing, via formation, copper plating, and fine-line patterning operations.
---

## Overview
Manage package substrate manufacturing including HDI laminate processing, via formation, copper plating, and fine-line patterning operations.

## Core Framework
- Analyze requirements and constraints specific to substrate-manufacturing-ops
...
## Key Prompts
- "Initiate substrate-manufacturing-ops workflow for [context]"
- "Analyze current state of substrate-manufacturing-ops and identify gaps"
- "Generate recommendations for substrate-manufacturing-ops optimization"
- "Create detailed plan for substrate-manufacturing-ops execution"
