---
name: fiber-coating-operations
description: Manage fiber coating operations including primary and secondary acrylate coating, colored ink application, and cure UV intensity monitoring.
---

## Overview
Manage fiber coating operations including primary and secondary acrylate coating, colored ink application, and cure UV intensity monitoring.

## Core Framework
- Analyze requirements and constraints specific to fiber-coating-operations
...
## Key Prompts
- "Initiate fiber-coating-operations workflow for [context]"
- "Analyze current state of fiber-coating-operations and identify gaps"
- "Generate recommendations for fiber-coating-operations optimization"
- "Create detailed plan for fiber-coating-operations execution"
