---
name: vibration-cbm-program-mgmt
description: Manage condition-based maintenance programs using vibration analysis including work order generation, repair effectiveness verification, and KPI reporting.
---

## Overview
Manage condition-based maintenance programs using vibration analysis including work order generation, repair effectiveness verification, and KPI reporting.

## Core Framework
- Analyze requirements and constraints specific to vibration-cbm-program-mgmt
...
## Key Prompts
- "Initiate vibration-cbm-program-mgmt workflow for [context]"
- "Analyze current state of vibration-cbm-program-mgmt and identify gaps"
- "Generate recommendations for vibration-cbm-program-mgmt optimization"
- "Create detailed plan for vibration-cbm-program-mgmt execution"
