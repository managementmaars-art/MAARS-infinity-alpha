---
name: fragrance-evaluation-programs
description: Run fragrance evaluation programs including panel recruitment, odor profiling, consumer preference testing, and hedonic scoring.
---

## Overview
Run fragrance evaluation programs including panel recruitment, odor profiling, consumer preference testing, and hedonic scoring.

## Core Framework
- Analyze requirements and constraints specific to fragrance-evaluation-programs
...
## Key Prompts
- "Initiate fragrance-evaluation-programs workflow for [context]"
- "Analyze current state of fragrance-evaluation-programs and identify gaps"
- "Generate recommendations for fragrance-evaluation-programs optimization"
- "Create detailed plan for fragrance-evaluation-programs execution"
