---
name: vibration-training-programs
description: Develop vibration analysis training programs including ISO Cat I through Cat IV certification paths, practical exercises, and competency assessment.
---

## Overview
Develop vibration analysis training programs including ISO Cat I through Cat IV certification paths, practical exercises, and competency assessment.

## Core Framework
- Analyze requirements and constraints specific to vibration-training-programs
...
## Key Prompts
- "Initiate vibration-training-programs workflow for [context]"
- "Analyze current state of vibration-training-programs and identify gaps"
- "Generate recommendations for vibration-training-programs optimization"
- "Create detailed plan for vibration-training-programs execution"
