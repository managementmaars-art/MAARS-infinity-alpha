---
name: launch-vehicle-coordination
description: Coordinate satellite launch vehicle services including manifest negotiation, payload adapter design, launch campaign management, and post-launch status.
---

## Overview
Coordinate satellite launch vehicle services including manifest negotiation, payload adapter design, launch campaign management, and post-launch status.

## Core Framework
- Analyze requirements and constraints specific to launch-vehicle-coordination
...
## Key Prompts
- "Initiate launch-vehicle-coordination workflow for [context]"
- "Analyze current state of launch-vehicle-coordination and identify gaps"
- "Generate recommendations for launch-vehicle-coordination optimization"
- "Create detailed plan for launch-vehicle-coordination execution"
