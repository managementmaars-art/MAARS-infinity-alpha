---
name: tool-die-shop-management
description: Manage tool and die shop operations including quoting, scheduling, toolmaker management, equipment utilization, and customer delivery.
---

## Overview
Manage tool and die shop operations including quoting, scheduling, toolmaker management, equipment utilization, and customer delivery.

## Core Framework
- Analyze requirements and constraints specific to tool-die-shop-management
...
## Key Prompts
- "Initiate tool-die-shop-management workflow for [context]"
- "Analyze current state of tool-die-shop-management and identify gaps"
- "Generate recommendations for tool-die-shop-management optimization"
- "Create detailed plan for tool-die-shop-management execution"
