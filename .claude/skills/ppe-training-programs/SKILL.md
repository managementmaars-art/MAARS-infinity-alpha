---
name: ppe-training-programs
description: Develop PPE training programs including fit testing, donning and doffing procedures, care and maintenance, and service life management.
---

## Overview
Develop PPE training programs including fit testing, donning and doffing procedures, care and maintenance, and service life management.

## Core Framework
- Analyze requirements and constraints specific to ppe-training-programs
...
## Key Prompts
- "Initiate ppe-training-programs workflow for [context]"
- "Analyze current state of ppe-training-programs and identify gaps"
- "Generate recommendations for ppe-training-programs optimization"
- "Create detailed plan for ppe-training-programs execution"
