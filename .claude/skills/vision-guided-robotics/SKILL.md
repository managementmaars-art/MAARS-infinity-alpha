...
description: Develop vision-guided robotic applications including bin picking, guidance correction, and assembly verification systems.
---

## Overview
Develop vision-guided robotic applications including bin picking, guidance correction, and assembly verification systems.

## Core Framework
- Analyze requirements and constraints specific to vision-guided-robotics
...
## Key Prompts
- "Initiate vision-guided-robotics workflow for [context]"
- "Analyze current state of vision-guided-robotics and identify gaps"
- "Generate recommendations for vision-guided-robotics optimization"
- "Create detailed plan for vision-guided-robotics execution"
