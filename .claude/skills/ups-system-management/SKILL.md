---
name: ups-system-management
description: Manage UPS system operations including battery testing schedules, bypass procedures, load management, and runtime verification.
---

## Overview
Manage UPS system operations including battery testing schedules, bypass procedures, load management, and runtime verification.

## Core Framework
- Analyze requirements and constraints specific to ups-system-management
...
## Key Prompts
- "Initiate ups-system-management workflow for [context]"
- "Analyze current state of ups-system-management and identify gaps"
- "Generate recommendations for ups-system-management optimization"
- "Create detailed plan for ups-system-management execution"
