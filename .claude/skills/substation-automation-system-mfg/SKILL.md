---
name: substation-automation-system-mfg
description: Produce substation automation systems including bay controller assembly, protection relay panel fabrication, and IEC 61850 station bus verification.
---

## Overview
Produce substation automation systems including bay controller assembly, protection relay panel fabrication, and IEC 61850 station bus verification.

## Core Framework
- Analyze requirements and constraints specific to substation-automation-system-mfg
...
## Key Prompts
- "Initiate substation-automation-system-mfg workflow for [context]"
- "Analyze current state of substation-automation-system-mfg and identify gaps"
- "Generate recommendations for substation-automation-system-mfg optimization"
- "Create detailed plan for substation-automation-system-mfg execution"
