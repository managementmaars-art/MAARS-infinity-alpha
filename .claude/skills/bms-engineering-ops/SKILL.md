---
name: bms-engineering-ops
description: Engineer battery management systems including cell balancing algorithms, state-of-charge estimation, thermal runaway detection, and communication protocols.
---

## Overview
Engineer battery management systems including cell balancing algorithms, state-of-charge estimation, thermal runaway detection, and communication protocols.

## Core Framework
- Analyze requirements and constraints specific to bms-engineering-ops
...
## Key Prompts
- "Initiate bms-engineering-ops workflow for [context]"
- "Analyze current state of bms-engineering-ops and identify gaps"
- "Generate recommendations for bms-engineering-ops optimization"
- "Create detailed plan for bms-engineering-ops execution"
