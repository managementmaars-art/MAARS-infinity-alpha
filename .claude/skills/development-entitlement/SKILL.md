---
name: development-entitlement
description: Manage entitlement processes including zoning applications, variance requests, environmental review, and public hearings.
---

## Overview
Manage entitlement processes including zoning applications, variance requests, environmental review, and public hearings.

## Core Framework
- Analyze requirements and constraints specific to development-entitlement
...
## Key Prompts
- "Initiate development-entitlement workflow for [context]"
- "Analyze current state of development-entitlement and identify gaps"
- "Generate recommendations for development-entitlement optimization"
- "Create detailed plan for development-entitlement execution"
