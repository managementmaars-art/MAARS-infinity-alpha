---
name: cpg-sustainability-ops
description: Manage CPG sustainability operations including packaging reduction targets, carbon footprint reporting, and sustainable sourcing programs.
---

## Overview
Manage CPG sustainability operations including packaging reduction targets, carbon footprint reporting, and sustainable sourcing programs.

## Core Framework
- Analyze requirements and constraints specific to cpg-sustainability-ops
...
## Key Prompts
- "Initiate cpg-sustainability-ops workflow for [context]"
- "Analyze current state of cpg-sustainability-ops and identify gaps"
- "Generate recommendations for cpg-sustainability-ops optimization"
- "Create detailed plan for cpg-sustainability-ops execution"
