---
name: investment-casting-operations
description: Manage investment casting operations including wax injection, shell building, dewaxing, mold firing, and dimensional inspection programs.
---

## Overview
Manage investment casting operations including wax injection, shell building, dewaxing, mold firing, and dimensional inspection programs.

## Core Framework
- Analyze requirements and constraints specific to investment-casting-operations
...
## Key Prompts
- "Initiate investment-casting-operations workflow for [context]"
- "Analyze current state of investment-casting-operations and identify gaps"
- "Generate recommendations for investment-casting-operations optimization"
- "Create detailed plan for investment-casting-operations execution"
