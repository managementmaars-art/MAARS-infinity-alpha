---
name: material-jetting-services
description: Operate material jetting service operations including multi-material builds, support material management, dimensional accuracy verification, and surface finish optimization.
---

## Overview
Operate material jetting service operations including multi-material builds, support material management, dimensional accuracy verification, and surface finish optimization.

## Core Framework
- Analyze requirements and constraints specific to material-jetting-services
...
## Key Prompts
- "Initiate material-jetting-services workflow for [context]"
- "Analyze current state of material-jetting-services and identify gaps"
- "Generate recommendations for material-jetting-services optimization"
- "Create detailed plan for material-jetting-services execution"
