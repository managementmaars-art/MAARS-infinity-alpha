---
name: welding-robot-operations
description: Manage welding robot operations including program development, weld parameter optimization, torch maintenance, and quality monitoring.
---

## Overview
Manage welding robot operations including program development, weld parameter optimization, torch maintenance, and quality monitoring.

## Core Framework
- Analyze requirements and constraints specific to welding-robot-operations
...
## Key Prompts
- "Initiate welding-robot-operations workflow for [context]"
- "Analyze current state of welding-robot-operations and identify gaps"
- "Generate recommendations for welding-robot-operations optimization"
- "Create detailed plan for welding-robot-operations execution"
