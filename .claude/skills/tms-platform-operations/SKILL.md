---
name: tms-platform-operations
description: Operate transportation management system platforms including carrier selection, load tendering, freight audit, and shipment visibility.
---

## Overview
Operate transportation management system platforms including carrier selection, load tendering, freight audit, and shipment visibility.

## Core Framework
- Analyze requirements and constraints specific to tms-platform-operations
...
## Key Prompts
- "Initiate tms-platform-operations workflow for [context]"
- "Analyze current state of tms-platform-operations and identify gaps"
- "Generate recommendations for tms-platform-operations optimization"
- "Create detailed plan for tms-platform-operations execution"
