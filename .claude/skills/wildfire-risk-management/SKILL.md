...
description: Assess and mitigate wildfire risk in forest operations including fuel treatment planning, prescribed burn management, and emergency response.
---

## Overview
Assess and mitigate wildfire risk in forest operations including fuel treatment planning, prescribed burn management, and emergency response.

## Core Framework
- Analyze requirements and constraints specific to wildfire-risk-management
...
## Key Prompts
- "Initiate wildfire-risk-management workflow for [context]"
- "Analyze current state of wildfire-risk-management and identify gaps"
- "Generate recommendations for wildfire-risk-management optimization"
- "Create detailed plan for wildfire-risk-management execution"
