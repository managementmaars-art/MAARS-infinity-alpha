---
name: waterjet-job-shop-ops
description: Manage waterjet cutting job shop operations including material scheduling, programming, abrasive management, and precision inspection.
---

## Overview
Manage waterjet cutting job shop operations including material scheduling, programming, abrasive management, and precision inspection.

## Core Framework
- Analyze requirements and constraints specific to waterjet-job-shop-ops
...
## Key Prompts
- "Initiate waterjet-job-shop-ops workflow for [context]"
- "Analyze current state of waterjet-job-shop-ops and identify gaps"
- "Generate recommendations for waterjet-job-shop-ops optimization"
- "Create detailed plan for waterjet-job-shop-ops execution"
