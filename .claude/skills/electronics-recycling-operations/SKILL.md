---
name: electronics-recycling-operations
description: Operate electronics recycling operations including collection, sorting, disassembly, component recovery, and downstream vendor management.
---

## Overview
Operate electronics recycling operations including collection, sorting, disassembly, component recovery, and downstream vendor management.

## Core Framework
- Analyze requirements and constraints specific to electronics-recycling-operations
...
## Key Prompts
- "Initiate electronics-recycling-operations workflow for [context]"
- "Analyze current state of electronics-recycling-operations and identify gaps"
- "Generate recommendations for electronics-recycling-operations optimization"
- "Create detailed plan for electronics-recycling-operations execution"
