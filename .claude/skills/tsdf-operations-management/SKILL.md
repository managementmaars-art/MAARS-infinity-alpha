---
name: tsdf-operations-management
description: Manage treatment, storage, and disposal facility operations including permit compliance, waste receipt procedures, and annual reporting.
---

## Overview
Manage treatment, storage, and disposal facility operations including permit compliance, waste receipt procedures, and annual reporting.

## Core Framework
- Analyze requirements and constraints specific to tsdf-operations-management
...
## Key Prompts
- "Initiate tsdf-operations-management workflow for [context]"
- "Analyze current state of tsdf-operations-management and identify gaps"
- "Generate recommendations for tsdf-operations-management optimization"
- "Create detailed plan for tsdf-operations-management execution"
