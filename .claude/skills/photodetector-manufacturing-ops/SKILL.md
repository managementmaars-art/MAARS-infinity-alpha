---
name: photodetector-manufacturing-ops
description: Produce photodetectors including InGaAs, Si, and APD devices with epitaxial growth, mesa etching, metallization, and responsivity characterization.
---

## Overview
Produce photodetectors including InGaAs, Si, and APD devices with epitaxial growth, mesa etching, metallization, and responsivity characterization.

## Core Framework
- Analyze requirements and constraints specific to photodetector-manufacturing-ops
...
## Key Prompts
- "Initiate photodetector-manufacturing-ops workflow for [context]"
- "Analyze current state of photodetector-manufacturing-ops and identify gaps"
- "Generate recommendations for photodetector-manufacturing-ops optimization"
- "Create detailed plan for photodetector-manufacturing-ops execution"
