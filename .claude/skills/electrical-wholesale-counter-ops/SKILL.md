---
name: electrical-wholesale-counter-ops
description: Operate electrical wholesale counter operations including contractor service, quote preparation, emergency order fulfillment, and technical assistance.
---

## Overview
Operate electrical wholesale counter operations including contractor service, quote preparation, emergency order fulfillment, and technical assistance.

## Core Framework
- Analyze requirements and constraints specific to electrical-wholesale-counter-ops
...
## Key Prompts
- "Initiate electrical-wholesale-counter-ops workflow for [context]"
- "Analyze current state of electrical-wholesale-counter-ops and identify gaps"
- "Generate recommendations for electrical-wholesale-counter-ops optimization"
- "Create detailed plan for electrical-wholesale-counter-ops execution"
