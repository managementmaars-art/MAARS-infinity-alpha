---
name: book-publishing-operations
description: Operate book publishing programs including title acquisition, production scheduling, distribution, and royalty management.
---

## Overview
Operate book publishing programs including title acquisition, production scheduling, distribution, and royalty management.

## Core Framework
- Analyze requirements and constraints specific to book-publishing-operations
...
## Key Prompts
- "Initiate book-publishing-operations workflow for [context]"
- "Analyze current state of book-publishing-operations and identify gaps"
- "Generate recommendations for book-publishing-operations optimization"
- "Create detailed plan for book-publishing-operations execution"
