---
name: laser-sales-distribution
description: Manage laser and photonics sales through direct and distribution channels including application lab demonstrations and technical support.
---

## Overview
Manage laser and photonics sales through direct and distribution channels including application lab demonstrations and technical support.

## Core Framework
- Analyze requirements and constraints specific to laser-sales-distribution
...
## Key Prompts
- "Initiate laser-sales-distribution workflow for [context]"
- "Analyze current state of laser-sales-distribution and identify gaps"
- "Generate recommendations for laser-sales-distribution optimization"
- "Create detailed plan for laser-sales-distribution execution"
