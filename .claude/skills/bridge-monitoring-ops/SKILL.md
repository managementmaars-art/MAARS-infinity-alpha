---
name: bridge-monitoring-ops
description: Operate bridge structural monitoring systems including live load assessment, fatigue accumulation tracking, and deterioration alert management.
---

## Overview
Operate bridge structural monitoring systems including live load assessment, fatigue accumulation tracking, and deterioration alert management.

## Core Framework
- Analyze requirements and constraints specific to bridge-monitoring-ops
...
## Key Prompts
- "Initiate bridge-monitoring-ops workflow for [context]"
- "Analyze current state of bridge-monitoring-ops and identify gaps"
- "Generate recommendations for bridge-monitoring-ops optimization"
- "Create detailed plan for bridge-monitoring-ops execution"
