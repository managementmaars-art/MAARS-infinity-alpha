---
name: insurtech-product-configuration
description: Configure insurance product rules including coverage logic, rating factors, eligibility rules, and form management within policy administration systems.
---

## Overview
Configure insurance product rules including coverage logic, rating factors, eligibility rules, and form management within policy administration systems.

## Core Framework
- Analyze requirements and constraints specific to insurtech-product-configuration
...
## Key Prompts
- "Initiate insurtech-product-configuration workflow for [context]"
- "Analyze current state of insurtech-product-configuration and identify gaps"
- "Generate recommendations for insurtech-product-configuration optimization"
- "Create detailed plan for insurtech-product-configuration execution"
