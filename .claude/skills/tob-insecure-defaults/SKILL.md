...
description: Trail of Bits: insecure defaults detection — find unsafe default configurations in code and infra
---

# Tob Insecure Defaults — MAARS Security Reference

## Overview
Trail of Bits: insecure defaults detection — find unsafe default configurations in code and infra
