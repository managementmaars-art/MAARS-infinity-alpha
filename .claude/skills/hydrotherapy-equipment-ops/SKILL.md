---
name: hydrotherapy-equipment-ops
description: Manage hydrotherapy equipment programs including aquatic therapy pools, whirlpool systems, and underwater treadmill manufacturing.
---

## Overview
Manage hydrotherapy equipment programs including aquatic therapy pools, whirlpool systems, and underwater treadmill manufacturing.

## Core Framework
- Analyze requirements and constraints specific to hydrotherapy-equipment-ops
...
## Key Prompts
- "Initiate hydrotherapy-equipment-ops workflow for [context]"
- "Analyze current state of hydrotherapy-equipment-ops and identify gaps"
- "Generate recommendations for hydrotherapy-equipment-ops optimization"
- "Create detailed plan for hydrotherapy-equipment-ops execution"
