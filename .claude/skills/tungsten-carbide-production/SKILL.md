---
name: tungsten-carbide-production
description: Produce tungsten carbide components including powder blending, pressing, liquid phase sintering, grinding, and hardness verification.
---

## Overview
Produce tungsten carbide components including powder blending, pressing, liquid phase sintering, grinding, and hardness verification.

## Core Framework
- Analyze requirements and constraints specific to tungsten-carbide-production
...
## Key Prompts
- "Initiate tungsten-carbide-production workflow for [context]"
- "Analyze current state of tungsten-carbide-production and identify gaps"
- "Generate recommendations for tungsten-carbide-production optimization"
- "Create detailed plan for tungsten-carbide-production execution"
