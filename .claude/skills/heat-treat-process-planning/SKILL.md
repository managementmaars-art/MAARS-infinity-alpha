---
name: heat-treat-process-planning
description: Develop heat treatment process plans including temperature cycle specification, atmosphere selection, and fixture design for customer parts.
---

## Overview
Develop heat treatment process plans including temperature cycle specification, atmosphere selection, and fixture design for customer parts.

## Core Framework
- Analyze requirements and constraints specific to heat-treat-process-planning
...
## Key Prompts
- "Initiate heat-treat-process-planning workflow for [context]"
- "Analyze current state of heat-treat-process-planning and identify gaps"
- "Generate recommendations for heat-treat-process-planning optimization"
- "Create detailed plan for heat-treat-process-planning execution"
