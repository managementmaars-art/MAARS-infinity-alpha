---
name: scada-water-systems
description: Operate SCADA systems for water utility monitoring including remote telemetry, alarm management, and cybersecurity protocols.
---

## Overview
Operate SCADA systems for water utility monitoring including remote telemetry, alarm management, and cybersecurity protocols.

## Core Framework
- Analyze requirements and constraints specific to scada-water-systems
...
## Key Prompts
- "Initiate scada-water-systems workflow for [context]"
- "Analyze current state of scada-water-systems and identify gaps"
- "Generate recommendations for scada-water-systems optimization"
- "Create detailed plan for scada-water-systems execution"
