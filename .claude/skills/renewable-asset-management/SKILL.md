...
description: Manage operating renewable energy assets including O&M contractor oversight, performance monitoring, revenue optimization, and investor reporting.
---

## Overview
Manage operating renewable energy assets including O&M contractor oversight, performance monitoring, revenue optimization, and investor reporting.

## Core Framework
- Analyze requirements and constraints specific to renewable-asset-management
...
## Key Prompts
- "Initiate renewable-asset-management workflow for [context]"
- "Analyze current state of renewable-asset-management and identify gaps"
- "Generate recommendations for renewable-asset-management optimization"
- "Create detailed plan for renewable-asset-management execution"
