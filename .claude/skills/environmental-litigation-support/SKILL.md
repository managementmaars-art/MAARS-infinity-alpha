---
name: environmental-litigation-support
description: Support environmental litigation including expert report preparation, cost allocation modeling, and natural resource damage assessments.
---

## Overview
Support environmental litigation including expert report preparation, cost allocation modeling, and natural resource damage assessments.

## Core Framework
- Analyze requirements and constraints specific to environmental-litigation-support
...
## Key Prompts
- "Initiate environmental-litigation-support workflow for [context]"
- "Analyze current state of environmental-litigation-support and identify gaps"
- "Generate recommendations for environmental-litigation-support optimization"
- "Create detailed plan for environmental-litigation-support execution"
