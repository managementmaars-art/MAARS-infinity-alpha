---
name: robot-roi-analysis
description: Develop robot ROI analysis programs including labor displacement modeling, throughput improvement quantification, and payback calculation.
---

## Overview
Develop robot ROI analysis programs including labor displacement modeling, throughput improvement quantification, and payback calculation.

## Core Framework
- Analyze requirements and constraints specific to robot-roi-analysis
...
## Key Prompts
- "Initiate robot-roi-analysis workflow for [context]"
- "Analyze current state of robot-roi-analysis and identify gaps"
- "Generate recommendations for robot-roi-analysis optimization"
- "Create detailed plan for robot-roi-analysis execution"
