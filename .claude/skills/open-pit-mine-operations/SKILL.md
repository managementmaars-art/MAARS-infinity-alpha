---
name: open-pit-mine-operations
description: Manage open pit mining operations including drill and blast design, fleet dispatch optimization, bench advancement planning, and waste dump management.
---

## Overview
Manage open pit mining operations including drill and blast design, fleet dispatch optimization, bench advancement planning, and waste dump management.

## Core Framework
- Analyze requirements and constraints specific to open-pit-mine-operations
...
## Key Prompts
- "Initiate open-pit-mine-operations workflow for [context]"
- "Analyze current state of open-pit-mine-operations and identify gaps"
- "Generate recommendations for open-pit-mine-operations optimization"
- "Create detailed plan for open-pit-mine-operations execution"
