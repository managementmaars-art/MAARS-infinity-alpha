---
name: hydropower-plant-operations
description: Operate hydroelectric power plant facilities including unit dispatch, penstock management, tailwater monitoring, and fish passage compliance.
---

## Overview
Operate hydroelectric power plant facilities including unit dispatch, penstock management, tailwater monitoring, and fish passage compliance.

## Core Framework
- Analyze requirements and constraints specific to hydropower-plant-operations
...
## Key Prompts
- "Initiate hydropower-plant-operations workflow for [context]"
- "Analyze current state of hydropower-plant-operations and identify gaps"
- "Generate recommendations for hydropower-plant-operations optimization"
- "Create detailed plan for hydropower-plant-operations execution"
