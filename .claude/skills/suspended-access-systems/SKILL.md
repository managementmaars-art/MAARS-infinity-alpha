---
name: suspended-access-systems
description: Manage suspended access and mast climbing systems including building facade maintenance, rigging design, and equipment certification.
---

## Overview
Manage suspended access and mast climbing systems including building facade maintenance, rigging design, and equipment certification.

## Core Framework
- Analyze requirements and constraints specific to suspended-access-systems
...
## Key Prompts
- "Initiate suspended-access-systems workflow for [context]"
- "Analyze current state of suspended-access-systems and identify gaps"
- "Generate recommendations for suspended-access-systems optimization"
- "Create detailed plan for suspended-access-systems execution"
