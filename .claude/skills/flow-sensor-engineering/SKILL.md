---
name: flow-sensor-engineering
description: Engineer flow sensors including electromagnetic, vortex, ultrasonic, and Coriolis types for fluid media, flow range, and accuracy requirements.
---

## Overview
Engineer flow sensors including electromagnetic, vortex, ultrasonic, and Coriolis types for fluid media, flow range, and accuracy requirements.

## Core Framework
- Analyze requirements and constraints specific to flow-sensor-engineering
...
## Key Prompts
- "Initiate flow-sensor-engineering workflow for [context]"
- "Analyze current state of flow-sensor-engineering and identify gaps"
- "Generate recommendations for flow-sensor-engineering optimization"
- "Create detailed plan for flow-sensor-engineering execution"
