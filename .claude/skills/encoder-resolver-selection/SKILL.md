---
name: encoder-resolver-selection
description: Select encoders and resolvers including incremental, absolute, optical, and magnetic types for position feedback accuracy and environment requirements.
---

## Overview
Select encoders and resolvers including incremental, absolute, optical, and magnetic types for position feedback accuracy and environment requirements.

## Core Framework
- Analyze requirements and constraints specific to encoder-resolver-selection
...
## Key Prompts
- "Initiate encoder-resolver-selection workflow for [context]"
- "Analyze current state of encoder-resolver-selection and identify gaps"
- "Generate recommendations for encoder-resolver-selection optimization"
- "Create detailed plan for encoder-resolver-selection execution"
