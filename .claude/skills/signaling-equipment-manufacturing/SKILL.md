---
name: signaling-equipment-manufacturing
description: Build railway signaling equipment including axle counters, track circuits, point machines, and balise transponders with SIL certification and EMC testing.
---

## Overview
Build railway signaling equipment including axle counters, track circuits, point machines, and balise transponders with SIL certification and EMC testing.

## Core Framework
- Analyze requirements and constraints specific to signaling-equipment-manufacturing
...
## Key Prompts
- "Initiate signaling-equipment-manufacturing workflow for [context]"
- "Analyze current state of signaling-equipment-manufacturing and identify gaps"
- "Generate recommendations for signaling-equipment-manufacturing optimization"
- "Create detailed plan for signaling-equipment-manufacturing execution"
