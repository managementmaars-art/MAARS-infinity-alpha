...
description: Manage waterjet cutting services including abrasive consumption, taper compensation, nozzle maintenance, and multi-material capability.
---

## Overview
Manage waterjet cutting services including abrasive consumption, taper compensation, nozzle maintenance, and multi-material capability.

## Core Framework
- Analyze requirements and constraints specific to waterjet-cutting-services
...
## Key Prompts
- "Initiate waterjet-cutting-services workflow for [context]"
- "Analyze current state of waterjet-cutting-services and identify gaps"
- "Generate recommendations for waterjet-cutting-services optimization"
- "Create detailed plan for waterjet-cutting-services execution"
