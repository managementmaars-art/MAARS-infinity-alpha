---
name: federal-subcontract-management
description: Manage federal subcontract flowdowns, small business subcontracting plans, and consent-to-subcontract processes.
---

## Overview
Manage federal subcontract flowdowns, small business subcontracting plans, and consent-to-subcontract processes.

## Core Framework
- Analyze requirements and constraints specific to federal-subcontract-management
...
## Key Prompts
- "Initiate federal-subcontract-management workflow for [context]"
- "Analyze current state of federal-subcontract-management and identify gaps"
- "Generate recommendations for federal-subcontract-management optimization"
- "Create detailed plan for federal-subcontract-management execution"
