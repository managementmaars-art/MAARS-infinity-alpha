---
name: cosmetics-retail-ops
description: Manage cosmetics retail operations including planogram compliance, tester management, gondola resets, and beauty advisor staffing.
---

## Overview
Manage cosmetics retail operations including planogram compliance, tester management, gondola resets, and beauty advisor staffing.

## Core Framework
- Analyze requirements and constraints specific to cosmetics-retail-ops
...
## Key Prompts
- "Initiate cosmetics-retail-ops workflow for [context]"
- "Analyze current state of cosmetics-retail-ops and identify gaps"
- "Generate recommendations for cosmetics-retail-ops optimization"
- "Create detailed plan for cosmetics-retail-ops execution"
