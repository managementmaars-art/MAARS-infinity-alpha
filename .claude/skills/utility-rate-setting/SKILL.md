---
name: utility-rate-setting
description: Develop water utility rate structures including cost-of-service studies, tiered pricing design, and affordability program integration.
---

## Overview
Develop water utility rate structures including cost-of-service studies, tiered pricing design, and affordability program integration.

## Core Framework
- Analyze requirements and constraints specific to utility-rate-setting
...
## Key Prompts
- "Initiate utility-rate-setting workflow for [context]"
- "Analyze current state of utility-rate-setting and identify gaps"
- "Generate recommendations for utility-rate-setting optimization"
- "Create detailed plan for utility-rate-setting execution"
