---
name: pharmacy-benefit-adjudication
description: Process pharmacy benefit claims through real-time adjudication, formulary checking, and plan accumulator management.
---

## Overview
Process pharmacy benefit claims through real-time adjudication, formulary checking, and plan accumulator management.

## Core Framework
- Analyze requirements and constraints specific to pharmacy-benefit-adjudication
...
## Key Prompts
- "Initiate pharmacy-benefit-adjudication workflow for [context]"
- "Analyze current state of pharmacy-benefit-adjudication and identify gaps"
- "Generate recommendations for pharmacy-benefit-adjudication optimization"
- "Create detailed plan for pharmacy-benefit-adjudication execution"
