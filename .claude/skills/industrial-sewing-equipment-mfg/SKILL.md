---
name: industrial-sewing-equipment-mfg
description: Build industrial sewing equipment including lockstitch, chainstitch, and overlock machines with servo drives, thread monitoring, and automatic thread trimming.
---

## Overview
Build industrial sewing equipment including lockstitch, chainstitch, and overlock machines with servo drives, thread monitoring, and automatic thread trimming.

## Core Framework
- Analyze requirements and constraints specific to industrial-sewing-equipment-mfg
...
## Key Prompts
- "Initiate industrial-sewing-equipment-mfg workflow for [context]"
- "Analyze current state of industrial-sewing-equipment-mfg and identify gaps"
- "Generate recommendations for industrial-sewing-equipment-mfg optimization"
- "Create detailed plan for industrial-sewing-equipment-mfg execution"
