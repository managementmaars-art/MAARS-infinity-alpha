---
name: clinical-supply-management
description: Manage clinical trial supply operations including IMP manufacturing, packaging, labeling, and depot distribution logistics.
---

## Overview
Manage clinical trial supply operations including IMP manufacturing, packaging, labeling, and depot distribution logistics.

## Core Framework
- Analyze requirements and constraints specific to clinical-supply-management
...
## Key Prompts
- "Initiate clinical-supply-management workflow for [context]"
- "Analyze current state of clinical-supply-management and identify gaps"
- "Generate recommendations for clinical-supply-management optimization"
- "Create detailed plan for clinical-supply-management execution"
