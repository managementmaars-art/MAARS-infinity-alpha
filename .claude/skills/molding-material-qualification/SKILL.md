---
name: molding-material-qualification
description: Qualify molding materials including resin lot testing, color matching, regrind ratio management, and moisture content verification programs.
---

## Overview
Qualify molding materials including resin lot testing, color matching, regrind ratio management, and moisture content verification programs.

## Core Framework
- Analyze requirements and constraints specific to molding-material-qualification
...
## Key Prompts
- "Initiate molding-material-qualification workflow for [context]"
- "Analyze current state of molding-material-qualification and identify gaps"
- "Generate recommendations for molding-material-qualification optimization"
- "Create detailed plan for molding-material-qualification execution"
