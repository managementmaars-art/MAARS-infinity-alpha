...
description: Manage fire sprinkler head manufacturing including fusible link assembly, orifice plating, UL listed production, and hydrostatic testing.
---

## Overview
Manage fire sprinkler head manufacturing including fusible link assembly, orifice plating, UL listed production, and hydrostatic testing.

## Core Framework
- Analyze requirements and constraints specific to fire-sprinkler-manufacturing
...
## Key Prompts
- "Initiate fire-sprinkler-manufacturing workflow for [context]"
- "Analyze current state of fire-sprinkler-manufacturing and identify gaps"
- "Generate recommendations for fire-sprinkler-manufacturing optimization"
- "Create detailed plan for fire-sprinkler-manufacturing execution"
