---
name: defense-program-management
description: Manage defense electronics program delivery including CDRL compliance, DID requirements, earned value management, and DCMA interface.
---

## Overview
Manage defense electronics program delivery including CDRL compliance, DID requirements, earned value management, and DCMA interface.

## Core Framework
- Analyze requirements and constraints specific to defense-program-management
...
## Key Prompts
- "Initiate defense-program-management workflow for [context]"
- "Analyze current state of defense-program-management and identify gaps"
- "Generate recommendations for defense-program-management optimization"
- "Create detailed plan for defense-program-management execution"
