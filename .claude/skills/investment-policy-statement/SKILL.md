...
description: Draft and maintain Investment Policy Statements aligned to client risk tolerance, time horizon, and return objectives.
---

## Overview
Draft and maintain Investment Policy Statements aligned to client risk tolerance, time horizon, and return objectives.

## Core Framework
- Analyze requirements and constraints specific to investment-policy-statement
...
## Key Prompts
- "Initiate investment-policy-statement workflow for [context]"
- "Analyze current state of investment-policy-statement and identify gaps"
- "Generate recommendations for investment-policy-statement optimization"
- "Create detailed plan for investment-policy-statement execution"
