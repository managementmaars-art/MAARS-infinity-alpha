---
name: packaging-regulatory-compliance
description: Navigate packaging regulatory compliance including FDA indirect food contact, California AB 906, and EU packaging regulation.
---

## Overview
Navigate packaging regulatory compliance including FDA indirect food contact, California AB 906, and EU packaging regulation.

## Core Framework
- Analyze requirements and constraints specific to packaging-regulatory-compliance
...
## Key Prompts
- "Initiate packaging-regulatory-compliance workflow for [context]"
- "Analyze current state of packaging-regulatory-compliance and identify gaps"
- "Generate recommendations for packaging-regulatory-compliance optimization"
- "Create detailed plan for packaging-regulatory-compliance execution"
