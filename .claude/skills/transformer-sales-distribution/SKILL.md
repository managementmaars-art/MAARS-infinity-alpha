---
name: transformer-sales-distribution
description: Manage transformer sales through utility, OEM, and distribution channels including rental fleet programs and project bid management.
---

## Overview
Manage transformer sales through utility, OEM, and distribution channels including rental fleet programs and project bid management.

## Core Framework
- Analyze requirements and constraints specific to transformer-sales-distribution
...
## Key Prompts
- "Initiate transformer-sales-distribution workflow for [context]"
- "Analyze current state of transformer-sales-distribution and identify gaps"
- "Generate recommendations for transformer-sales-distribution optimization"
- "Create detailed plan for transformer-sales-distribution execution"
