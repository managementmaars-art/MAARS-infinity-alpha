---
name: security-radar-systems
description: Deploy security perimeter radar systems including ground surveillance, drone detection, and coastal monitoring with target classification.
---

## Overview
Deploy security perimeter radar systems including ground surveillance, drone detection, and coastal monitoring with target classification.

## Core Framework
- Analyze requirements and constraints specific to security-radar-systems
...
## Key Prompts
- "Initiate security-radar-systems workflow for [context]"
- "Analyze current state of security-radar-systems and identify gaps"
- "Generate recommendations for security-radar-systems optimization"
- "Create detailed plan for security-radar-systems execution"
