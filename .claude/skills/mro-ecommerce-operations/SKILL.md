---
name: mro-ecommerce-operations
description: Manage MRO ecommerce operations including product content, search optimization, punchout catalog integration, and online order management.
---

## Overview
Manage MRO ecommerce operations including product content, search optimization, punchout catalog integration, and online order management.

## Core Framework
- Analyze requirements and constraints specific to mro-ecommerce-operations
...
## Key Prompts
- "Initiate mro-ecommerce-operations workflow for [context]"
- "Analyze current state of mro-ecommerce-operations and identify gaps"
- "Generate recommendations for mro-ecommerce-operations optimization"
- "Create detailed plan for mro-ecommerce-operations execution"
