---
name: cpg-innovation-pipeline
description: Manage CPG product innovation pipelines from ideation through stage-gate reviews, consumer testing, and commercialization.
---

## Overview
Manage CPG product innovation pipelines from ideation through stage-gate reviews, consumer testing, and commercialization.

## Core Framework
- Analyze requirements and constraints specific to cpg-innovation-pipeline
...
## Key Prompts
- "Initiate cpg-innovation-pipeline workflow for [context]"
- "Analyze current state of cpg-innovation-pipeline and identify gaps"
- "Generate recommendations for cpg-innovation-pipeline optimization"
- "Create detailed plan for cpg-innovation-pipeline execution"
