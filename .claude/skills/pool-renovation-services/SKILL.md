...
description: Manage pool renovation services including replastering, tile replacement, deck resurfacing, coping replacement, and equipment upgrades.
---

## Overview
Manage pool renovation services including replastering, tile replacement, deck resurfacing, coping replacement, and equipment upgrades.

## Core Framework
- Analyze requirements and constraints specific to pool-renovation-services
...
## Key Prompts
- "Initiate pool-renovation-services workflow for [context]"
- "Analyze current state of pool-renovation-services and identify gaps"
- "Generate recommendations for pool-renovation-services optimization"
- "Create detailed plan for pool-renovation-services execution"
