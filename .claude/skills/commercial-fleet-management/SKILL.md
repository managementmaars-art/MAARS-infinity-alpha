---
name: commercial-fleet-management
description: Manage commercial vehicle fleets including GPS tracking, driver performance monitoring, preventive maintenance scheduling, and fuel management.
---

## Overview
Manage commercial vehicle fleets including GPS tracking, driver performance monitoring, preventive maintenance scheduling, and fuel management.

## Core Framework
- Analyze requirements and constraints specific to commercial-fleet-management
...
## Key Prompts
- "Initiate commercial-fleet-management workflow for [context]"
- "Analyze current state of commercial-fleet-management and identify gaps"
- "Generate recommendations for commercial-fleet-management optimization"
- "Create detailed plan for commercial-fleet-management execution"
