---
name: consignment-shop-operations
description: Operate consignment shop operations including consignor intake, pricing, inventory display, split payout processing, and unsold item return management.
---

## Overview
Operate consignment shop operations including consignor intake, pricing, inventory display, split payout processing, and unsold item return management.

## Core Framework
- Analyze requirements and constraints specific to consignment-shop-operations
...
## Key Prompts
- "Initiate consignment-shop-operations workflow for [context]"
- "Analyze current state of consignment-shop-operations and identify gaps"
- "Generate recommendations for consignment-shop-operations optimization"
- "Create detailed plan for consignment-shop-operations execution"
