---
name: hydrogen-safety-management
description: Implement hydrogen safety programs including leak detection systems, hydrogen specific HAZOP, emergency response planning, and personnel training.
---

## Overview
Implement hydrogen safety programs including leak detection systems, hydrogen specific HAZOP, emergency response planning, and personnel training.

## Core Framework
- Analyze requirements and constraints specific to hydrogen-safety-management
...
## Key Prompts
- "Initiate hydrogen-safety-management workflow for [context]"
- "Analyze current state of hydrogen-safety-management and identify gaps"
- "Generate recommendations for hydrogen-safety-management optimization"
- "Create detailed plan for hydrogen-safety-management execution"
