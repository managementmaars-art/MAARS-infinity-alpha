---
name: data-center-change-management
description: Manage data center change control programs including MACD workflows, floor plan updates, power circuit documentation, and impact assessment.
---

## Overview
Manage data center change control programs including MACD workflows, floor plan updates, power circuit documentation, and impact assessment.

## Core Framework
- Analyze requirements and constraints specific to data-center-change-management
...
## Key Prompts
- "Initiate data-center-change-management workflow for [context]"
- "Analyze current state of data-center-change-management and identify gaps"
- "Generate recommendations for data-center-change-management optimization"
- "Create detailed plan for data-center-change-management execution"
