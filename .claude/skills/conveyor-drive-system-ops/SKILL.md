---
name: conveyor-drive-system-ops
description: Manage conveyor drive systems including head pulley lagging, gearmotor selection, variable speed drives, and backstop installation.
---

## Overview
Manage conveyor drive systems including head pulley lagging, gearmotor selection, variable speed drives, and backstop installation.

## Core Framework
- Analyze requirements and constraints specific to conveyor-drive-system-ops
...
## Key Prompts
- "Initiate conveyor-drive-system-ops workflow for [context]"
- "Analyze current state of conveyor-drive-system-ops and identify gaps"
- "Generate recommendations for conveyor-drive-system-ops optimization"
- "Create detailed plan for conveyor-drive-system-ops execution"
