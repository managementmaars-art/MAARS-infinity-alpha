---
name: city-budget-planning
description: Coordinate municipal budget planning including departmental request review, revenue forecasting, and council presentation preparation.
---

## Overview
Coordinate municipal budget planning including departmental request review, revenue forecasting, and council presentation preparation.

## Core Framework
- Analyze requirements and constraints specific to city-budget-planning
...
## Key Prompts
- "Initiate city-budget-planning workflow for [context]"
- "Analyze current state of city-budget-planning and identify gaps"
- "Generate recommendations for city-budget-planning optimization"
- "Create detailed plan for city-budget-planning execution"
