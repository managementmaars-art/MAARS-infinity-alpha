---
name: dental-imaging-systems
description: Manage dental imaging system programs including intraoral sensors, panoramic X-ray, and CBCT systems with regulatory clearance.
---

## Overview
Manage dental imaging system programs including intraoral sensors, panoramic X-ray, and CBCT systems with regulatory clearance.

## Core Framework
- Analyze requirements and constraints specific to dental-imaging-systems
...
## Key Prompts
- "Initiate dental-imaging-systems workflow for [context]"
- "Analyze current state of dental-imaging-systems and identify gaps"
- "Generate recommendations for dental-imaging-systems optimization"
- "Create detailed plan for dental-imaging-systems execution"
