---
name: lms-platform-administration
description: Administer learning management system platforms including course publishing, enrollment workflows, progress tracking, and integrations.
---

## Overview
Administer learning management system platforms including course publishing, enrollment workflows, progress tracking, and integrations.

## Core Framework
- Analyze requirements and constraints specific to lms-platform-administration
...
## Key Prompts
- "Initiate lms-platform-administration workflow for [context]"
- "Analyze current state of lms-platform-administration and identify gaps"
- "Generate recommendations for lms-platform-administration optimization"
- "Create detailed plan for lms-platform-administration execution"
