---
name: industrial-laundry-production
description: Operate industrial laundry production lines including wash formula programming, tunnel washer scheduling, and throughput optimization.
---

## Overview
Operate industrial laundry production lines including wash formula programming, tunnel washer scheduling, and throughput optimization.

## Core Framework
- Analyze requirements and constraints specific to industrial-laundry-production
...
## Key Prompts
- "Initiate industrial-laundry-production workflow for [context]"
- "Analyze current state of industrial-laundry-production and identify gaps"
- "Generate recommendations for industrial-laundry-production optimization"
- "Create detailed plan for industrial-laundry-production execution"
