---
name: hot-tub-spa-service-ops
description: Operate hot tub and spa service operations including delivery, setup, maintenance, repair, and retail accessory sales.
---

## Overview
Operate hot tub and spa service operations including delivery, setup, maintenance, repair, and retail accessory sales.

## Core Framework
- Analyze requirements and constraints specific to hot-tub-spa-service-ops
...
## Key Prompts
- "Initiate hot-tub-spa-service-ops workflow for [context]"
- "Analyze current state of hot-tub-spa-service-ops and identify gaps"
- "Generate recommendations for hot-tub-spa-service-ops optimization"
- "Create detailed plan for hot-tub-spa-service-ops execution"
