...
description: Navigate hazardous materials transportation compliance including DOT 49 CFR requirements, placard selection, and driver training programs.
---

## Overview
Navigate hazardous materials transportation compliance including DOT 49 CFR requirements, placard selection, and driver training programs.

## Core Framework
- Analyze requirements and constraints specific to hazmat-transport-compliance
...
## Key Prompts
- "Initiate hazmat-transport-compliance workflow for [context]"
- "Analyze current state of hazmat-transport-compliance and identify gaps"
- "Generate recommendations for hazmat-transport-compliance optimization"
- "Create detailed plan for hazmat-transport-compliance execution"
