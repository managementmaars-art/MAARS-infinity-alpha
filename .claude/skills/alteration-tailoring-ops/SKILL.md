---
name: alteration-tailoring-ops
description: Manage garment alteration and tailoring operations including work order intake, skilled labor scheduling, fitting appointment coordination, and quality inspection.
---

## Overview
Manage garment alteration and tailoring operations including work order intake, skilled labor scheduling, fitting appointment coordination, and quality inspection.

## Core Framework
- Analyze requirements and constraints specific to alteration-tailoring-ops
...
## Key Prompts
- "Initiate alteration-tailoring-ops workflow for [context]"
- "Analyze current state of alteration-tailoring-ops and identify gaps"
- "Generate recommendations for alteration-tailoring-ops optimization"
- "Create detailed plan for alteration-tailoring-ops execution"
