---
name: acoustic-enclosure-design
description: Design acoustic enclosures for machinery noise control including panel transmission loss, access door design, and ventilation noise treatment.
---

## Overview
Design acoustic enclosures for machinery noise control including panel transmission loss, access door design, and ventilation noise treatment.

## Core Framework
- Analyze requirements and constraints specific to acoustic-enclosure-design
...
## Key Prompts
- "Initiate acoustic-enclosure-design workflow for [context]"
- "Analyze current state of acoustic-enclosure-design and identify gaps"
- "Generate recommendations for acoustic-enclosure-design optimization"
- "Create detailed plan for acoustic-enclosure-design execution"
