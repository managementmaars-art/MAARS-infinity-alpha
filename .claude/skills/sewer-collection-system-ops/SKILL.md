---
name: sewer-collection-system-ops
description: Manage sewer collection system operations including lift station monitoring, I/I program management, FOG enforcement, and SSO response.
---

## Overview
Manage sewer collection system operations including lift station monitoring, I/I program management, FOG enforcement, and SSO response.

## Core Framework
- Analyze requirements and constraints specific to sewer-collection-system-ops
...
## Key Prompts
- "Initiate sewer-collection-system-ops workflow for [context]"
- "Analyze current state of sewer-collection-system-ops and identify gaps"
- "Generate recommendations for sewer-collection-system-ops optimization"
- "Create detailed plan for sewer-collection-system-ops execution"
