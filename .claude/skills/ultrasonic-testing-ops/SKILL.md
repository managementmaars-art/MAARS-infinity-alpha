---
name: ultrasonic-testing-ops
description: Conduct ultrasonic testing including pulse-echo, TOFD, and phased array techniques for weld inspection, thickness measurement, and flaw characterization.
---

## Overview
Conduct ultrasonic testing including pulse-echo, TOFD, and phased array techniques for weld inspection, thickness measurement, and flaw characterization.

## Core Framework
- Analyze requirements and constraints specific to ultrasonic-testing-ops
...
## Key Prompts
- "Initiate ultrasonic-testing-ops workflow for [context]"
- "Analyze current state of ultrasonic-testing-ops and identify gaps"
- "Generate recommendations for ultrasonic-testing-ops optimization"
- "Create detailed plan for ultrasonic-testing-ops execution"
