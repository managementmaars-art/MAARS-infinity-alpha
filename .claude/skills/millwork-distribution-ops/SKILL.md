---
name: millwork-distribution-ops
description: Operate millwork distribution including doors, windows, trim, cabinetry, and architectural millwork for residential and commercial markets.
---

## Overview
Operate millwork distribution including doors, windows, trim, cabinetry, and architectural millwork for residential and commercial markets.

## Core Framework
- Analyze requirements and constraints specific to millwork-distribution-ops
...
## Key Prompts
- "Initiate millwork-distribution-ops workflow for [context]"
- "Analyze current state of millwork-distribution-ops and identify gaps"
- "Generate recommendations for millwork-distribution-ops optimization"
- "Create detailed plan for millwork-distribution-ops execution"
