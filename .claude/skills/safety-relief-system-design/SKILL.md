---
name: safety-relief-system-design
description: Provide safety relief system design services including overpressure scenario analysis, relief device sizing, installation configuration review, and API standard compliance.
---

## Overview
Provide safety relief system design services including overpressure scenario analysis, relief device sizing, installation configuration review, and API standard compliance.

## Core Framework
- Analyze requirements and constraints specific to safety-relief-system-design
...
## Key Prompts
- "Initiate safety-relief-system-design workflow for [context]"
- "Analyze current state of safety-relief-system-design and identify gaps"
- "Generate recommendations for safety-relief-system-design optimization"
- "Create detailed plan for safety-relief-system-design execution"
