---
name: pipeline-equipment-manufacturing
description: Manage pipeline equipment manufacturing including pig launcher-receivers, check valves, control valves, and flange management programs.
---

## Overview
Manage pipeline equipment manufacturing including pig launcher-receivers, check valves, control valves, and flange management programs.

## Core Framework
- Analyze requirements and constraints specific to pipeline-equipment-manufacturing
...
## Key Prompts
- "Initiate pipeline-equipment-manufacturing workflow for [context]"
- "Analyze current state of pipeline-equipment-manufacturing and identify gaps"
- "Generate recommendations for pipeline-equipment-manufacturing optimization"
- "Create detailed plan for pipeline-equipment-manufacturing execution"
