---
name: mist-collector-systems
description: Operate mist collection systems for machining and grinding operations including coalescing filters, electrostatic precipitators, and media maintenance.
---

## Overview
Operate mist collection systems for machining and grinding operations including coalescing filters, electrostatic precipitators, and media maintenance.

## Core Framework
- Analyze requirements and constraints specific to mist-collector-systems
...
## Key Prompts
- "Initiate mist-collector-systems workflow for [context]"
- "Analyze current state of mist-collector-systems and identify gaps"
- "Generate recommendations for mist-collector-systems optimization"
- "Create detailed plan for mist-collector-systems execution"
