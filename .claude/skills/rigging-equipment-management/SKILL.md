---
name: rigging-equipment-management
description: Manage rigging equipment programs including wire rope slings, chain slings, web slings, and shackle inspection, certification, and retirement.
---

## Overview
Manage rigging equipment programs including wire rope slings, chain slings, web slings, and shackle inspection, certification, and retirement.

## Core Framework
- Analyze requirements and constraints specific to rigging-equipment-management
...
## Key Prompts
- "Initiate rigging-equipment-management workflow for [context]"
- "Analyze current state of rigging-equipment-management and identify gaps"
- "Generate recommendations for rigging-equipment-management optimization"
- "Create detailed plan for rigging-equipment-management execution"
