---
name: cell-assembly-ops
description: Operate battery cell assembly including jellyroll winding, pouch folding, can filling, electrolyte injection, and hermetic sealing processes.
---

## Overview
Operate battery cell assembly including jellyroll winding, pouch folding, can filling, electrolyte injection, and hermetic sealing processes.

## Core Framework
- Analyze requirements and constraints specific to cell-assembly-ops
...
## Key Prompts
- "Initiate cell-assembly-ops workflow for [context]"
- "Analyze current state of cell-assembly-ops and identify gaps"
- "Generate recommendations for cell-assembly-ops optimization"
- "Create detailed plan for cell-assembly-ops execution"
