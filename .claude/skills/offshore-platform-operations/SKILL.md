---
name: offshore-platform-operations
description: Operate offshore platform facilities including topsides management, marine riser monitoring, subsea system operations, and helicopter logistic coordination.
---

## Overview
Operate offshore platform facilities including topsides management, marine riser monitoring, subsea system operations, and helicopter logistic coordination.

## Core Framework
- Analyze requirements and constraints specific to offshore-platform-operations
...
## Key Prompts
- "Initiate offshore-platform-operations workflow for [context]"
- "Analyze current state of offshore-platform-operations and identify gaps"
- "Generate recommendations for offshore-platform-operations optimization"
- "Create detailed plan for offshore-platform-operations execution"
