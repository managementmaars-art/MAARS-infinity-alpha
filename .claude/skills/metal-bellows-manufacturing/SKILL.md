---
name: metal-bellows-manufacturing
description: Design and manufacture metal bellows including hydroformed and edge-welded types, cycle life prediction, spring rate management, and aerospace qualification programs.
---

## Overview
Design and manufacture metal bellows including hydroformed and edge-welded types, cycle life prediction, spring rate management, and aerospace qualification programs.

## Core Framework
- Analyze requirements and constraints specific to metal-bellows-manufacturing
...
## Key Prompts
- "Initiate metal-bellows-manufacturing workflow for [context]"
- "Analyze current state of metal-bellows-manufacturing and identify gaps"
- "Generate recommendations for metal-bellows-manufacturing optimization"
- "Create detailed plan for metal-bellows-manufacturing execution"
