---
name: wire-edm-technology-services
description: Operate wire EDM service centers including wire selection, power parameter management, taper cutting programs, and precision tolerance verification.
---

## Overview
Operate wire EDM service centers including wire selection, power parameter management, taper cutting programs, and precision tolerance verification.

## Core Framework
- Analyze requirements and constraints specific to wire-edm-technology-services
...
## Key Prompts
- "Initiate wire-edm-technology-services workflow for [context]"
- "Analyze current state of wire-edm-technology-services and identify gaps"
- "Generate recommendations for wire-edm-technology-services optimization"
- "Create detailed plan for wire-edm-technology-services execution"
