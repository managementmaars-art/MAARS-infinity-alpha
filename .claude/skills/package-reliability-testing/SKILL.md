---
name: package-reliability-testing
description: Execute package reliability testing including thermal cycling, moisture sensitivity, electrostatic discharge, and HTOL burn-in test programs.
---

## Overview
Execute package reliability testing including thermal cycling, moisture sensitivity, electrostatic discharge, and HTOL burn-in test programs.

## Core Framework
- Analyze requirements and constraints specific to package-reliability-testing
...
## Key Prompts
- "Initiate package-reliability-testing workflow for [context]"
- "Analyze current state of package-reliability-testing and identify gaps"
- "Generate recommendations for package-reliability-testing optimization"
- "Create detailed plan for package-reliability-testing execution"
