---
name: shackle-selection-programs
description: Select and manage shackles including anchor, chain, and screw pin types with working load limit verification and marking inspection programs.
---

## Overview
Select and manage shackles including anchor, chain, and screw pin types with working load limit verification and marking inspection programs.

## Core Framework
- Analyze requirements and constraints specific to shackle-selection-programs
...
## Key Prompts
- "Initiate shackle-selection-programs workflow for [context]"
- "Analyze current state of shackle-selection-programs and identify gaps"
- "Generate recommendations for shackle-selection-programs optimization"
- "Create detailed plan for shackle-selection-programs execution"
