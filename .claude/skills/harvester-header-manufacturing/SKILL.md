---
name: harvester-header-manufacturing
description: Produce harvester headers including cutter bars, draper systems, reel assemblies, and crop lifters with synchronization testing and wear part qualification.
---

## Overview
Produce harvester headers including cutter bars, draper systems, reel assemblies, and crop lifters with synchronization testing and wear part qualification.

## Core Framework
- Analyze requirements and constraints specific to harvester-header-manufacturing
...
## Key Prompts
- "Initiate harvester-header-manufacturing workflow for [context]"
- "Analyze current state of harvester-header-manufacturing and identify gaps"
- "Generate recommendations for harvester-header-manufacturing optimization"
- "Create detailed plan for harvester-header-manufacturing execution"
