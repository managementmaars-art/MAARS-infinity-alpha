---
name: ball-screw-system-design
description: Design ball screw drive systems including lead selection, preload specification, support bearing configuration, and critical speed analysis.
---

## Overview
Design ball screw drive systems including lead selection, preload specification, support bearing configuration, and critical speed analysis.

## Core Framework
- Analyze requirements and constraints specific to ball-screw-system-design
...
## Key Prompts
- "Initiate ball-screw-system-design workflow for [context]"
- "Analyze current state of ball-screw-system-design and identify gaps"
- "Generate recommendations for ball-screw-system-design optimization"
- "Create detailed plan for ball-screw-system-design execution"
