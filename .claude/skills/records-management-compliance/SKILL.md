---
name: records-management-compliance
description: Manage records compliance programs including retention schedule development, legal hold management, and regulatory compliance documentation.
---

## Overview
Manage records compliance programs including retention schedule development, legal hold management, and regulatory compliance documentation.

## Core Framework
- Analyze requirements and constraints specific to records-management-compliance
...
## Key Prompts
- "Initiate records-management-compliance workflow for [context]"
- "Analyze current state of records-management-compliance and identify gaps"
- "Generate recommendations for records-management-compliance optimization"
- "Create detailed plan for records-management-compliance execution"
