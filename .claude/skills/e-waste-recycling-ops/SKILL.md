---
name: e-waste-recycling-ops
description: Manage e-waste recycling operations including device depopulation, shredding, metal recovery, and R2 or e-Stewards certification.
---

## Overview
Manage e-waste recycling operations including device depopulation, shredding, metal recovery, and R2 or e-Stewards certification.

## Core Framework
- Analyze requirements and constraints specific to e-waste-recycling-ops
...
## Key Prompts
- "Initiate e-waste-recycling-ops workflow for [context]"
- "Analyze current state of e-waste-recycling-ops and identify gaps"
- "Generate recommendations for e-waste-recycling-ops optimization"
- "Create detailed plan for e-waste-recycling-ops execution"
