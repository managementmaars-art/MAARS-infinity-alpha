---
name: sanitaryware-production
description: Operate sanitaryware production lines including slip casting, drying, glaze application, kiln loading, and defect sorting.
---

## Overview
Operate sanitaryware production lines including slip casting, drying, glaze application, kiln loading, and defect sorting.

## Core Framework
- Analyze requirements and constraints specific to sanitaryware-production
...
## Key Prompts
- "Initiate sanitaryware-production workflow for [context]"
- "Analyze current state of sanitaryware-production and identify gaps"
- "Generate recommendations for sanitaryware-production optimization"
- "Create detailed plan for sanitaryware-production execution"
