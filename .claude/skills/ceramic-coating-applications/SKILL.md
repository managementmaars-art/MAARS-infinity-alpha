---
name: ceramic-coating-applications
description: Apply ceramic coatings including spray-applied and sol-gel derived types for heat resistance, chemical protection, and dielectric properties.
---

## Overview
Apply ceramic coatings including spray-applied and sol-gel derived types for heat resistance, chemical protection, and dielectric properties.

## Core Framework
- Analyze requirements and constraints specific to ceramic-coating-applications
...
## Key Prompts
- "Initiate ceramic-coating-applications workflow for [context]"
- "Analyze current state of ceramic-coating-applications and identify gaps"
- "Generate recommendations for ceramic-coating-applications optimization"
- "Create detailed plan for ceramic-coating-applications execution"
