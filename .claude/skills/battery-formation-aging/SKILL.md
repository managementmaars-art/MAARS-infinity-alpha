---
name: battery-formation-aging
description: Manage battery formation and aging operations including charge-discharge cycling protocols, self-discharge measurement, and capacity grading.
---

## Overview
Manage battery formation and aging operations including charge-discharge cycling protocols, self-discharge measurement, and capacity grading.

## Core Framework
- Analyze requirements and constraints specific to battery-formation-aging
...
## Key Prompts
- "Initiate battery-formation-aging workflow for [context]"
- "Analyze current state of battery-formation-aging and identify gaps"
- "Generate recommendations for battery-formation-aging optimization"
- "Create detailed plan for battery-formation-aging execution"
