---
name: histopathology-lab-operations
description: Operate histopathology laboratories including tissue processing scheduling, staining protocol management, and digital pathology slide management.
---

## Overview
Operate histopathology laboratories including tissue processing scheduling, staining protocol management, and digital pathology slide management.

## Core Framework
- Analyze requirements and constraints specific to histopathology-lab-operations
...
## Key Prompts
- "Initiate histopathology-lab-operations workflow for [context]"
- "Analyze current state of histopathology-lab-operations and identify gaps"
- "Generate recommendations for histopathology-lab-operations optimization"
- "Create detailed plan for histopathology-lab-operations execution"
