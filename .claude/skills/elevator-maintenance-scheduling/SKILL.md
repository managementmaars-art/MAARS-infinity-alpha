---
name: elevator-maintenance-scheduling
description: Schedule elevator and escalator maintenance including compliance inspections, PM frequency, customer notification, and violation response.
---

## Overview
Schedule elevator and escalator maintenance including compliance inspections, PM frequency, customer notification, and violation response.

## Core Framework
- Analyze requirements and constraints specific to elevator-maintenance-scheduling
...
## Key Prompts
- "Initiate elevator-maintenance-scheduling workflow for [context]"
- "Analyze current state of elevator-maintenance-scheduling and identify gaps"
- "Generate recommendations for elevator-maintenance-scheduling optimization"
- "Create detailed plan for elevator-maintenance-scheduling execution"
