...
description: Automate employee onboarding workflows including document collection, background check coordination, system provisioning, and day-one readiness.
---

## Overview
Automate employee onboarding workflows including document collection, background check coordination, system provisioning, and day-one readiness.

## Core Framework
- Analyze requirements and constraints specific to onboarding-automation
...
## Key Prompts
- "Initiate onboarding-automation workflow for [context]"
- "Analyze current state of onboarding-automation and identify gaps"
- "Generate recommendations for onboarding-automation optimization"
- "Create detailed plan for onboarding-automation execution"
