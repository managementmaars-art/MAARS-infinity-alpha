...
description: Manage cybersecurity incident response including containment playbooks, forensic coordination, stakeholder communication, and post-incident review.
---

## Overview
Manage cybersecurity incident response including containment playbooks, forensic coordination, stakeholder communication, and post-incident review.

## Core Framework
- Analyze requirements and constraints specific to incident-response-management
...
## Key Prompts
- "Initiate incident-response-management workflow for [context]"
- "Analyze current state of incident-response-management and identify gaps"
- "Generate recommendations for incident-response-management optimization"
- "Create detailed plan for incident-response-management execution"
