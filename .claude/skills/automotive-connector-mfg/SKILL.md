---
name: automotive-connector-mfg
description: Manufacture automotive connectors including terminal stamping, insert molding, housing assembly, and IP67/69K weatherseal testing.
---

## Overview
Manufacture automotive connectors including terminal stamping, insert molding, housing assembly, and IP67/69K weatherseal testing.

## Core Framework
- Analyze requirements and constraints specific to automotive-connector-mfg
...
## Key Prompts
- "Initiate automotive-connector-mfg workflow for [context]"
- "Analyze current state of automotive-connector-mfg and identify gaps"
- "Generate recommendations for automotive-connector-mfg optimization"
- "Create detailed plan for automotive-connector-mfg execution"
