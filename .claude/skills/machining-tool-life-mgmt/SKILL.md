---
name: machining-tool-life-mgmt
description: Manage cutting tool life programs including tool change intervals, insert indexing records, tool condition monitoring, and cost-per-part optimization.
---

## Overview
Manage cutting tool life programs including tool change intervals, insert indexing records, tool condition monitoring, and cost-per-part optimization.

## Core Framework
- Analyze requirements and constraints specific to machining-tool-life-mgmt
...
## Key Prompts
- "Initiate machining-tool-life-mgmt workflow for [context]"
- "Analyze current state of machining-tool-life-mgmt and identify gaps"
- "Generate recommendations for machining-tool-life-mgmt optimization"
- "Create detailed plan for machining-tool-life-mgmt execution"
