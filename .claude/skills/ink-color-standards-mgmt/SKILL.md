---
name: ink-color-standards-mgmt
description: Maintain ink color standards programs including Pantone matching, spectral data management, and proof approval workflows.
---

## Overview
Maintain ink color standards programs including Pantone matching, spectral data management, and proof approval workflows.

## Core Framework
- Analyze requirements and constraints specific to ink-color-standards-mgmt
...
## Key Prompts
- "Initiate ink-color-standards-mgmt workflow for [context]"
- "Analyze current state of ink-color-standards-mgmt and identify gaps"
- "Generate recommendations for ink-color-standards-mgmt optimization"
- "Create detailed plan for ink-color-standards-mgmt execution"
