---
name: weather-station-manufacturing
description: Manufacture weather stations including anemometers, pyranometers, rain gauges, and data loggers with WMO calibration standards and telemetry integration.
---

## Overview
Manufacture weather stations including anemometers, pyranometers, rain gauges, and data loggers with WMO calibration standards and telemetry integration.

## Core Framework
- Analyze requirements and constraints specific to weather-station-manufacturing
...
## Key Prompts
- "Initiate weather-station-manufacturing workflow for [context]"
- "Analyze current state of weather-station-manufacturing and identify gaps"
- "Generate recommendations for weather-station-manufacturing optimization"
- "Create detailed plan for weather-station-manufacturing execution"
