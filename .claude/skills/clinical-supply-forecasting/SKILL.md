---
name: clinical-supply-forecasting
description: Generate clinical supply forecasts using enrollment projection models, dropout rate assumptions, and safety stock calculation methodologies.
---

## Overview
Generate clinical supply forecasts using enrollment projection models, dropout rate assumptions, and safety stock calculation methodologies.

## Core Framework
- Analyze requirements and constraints specific to clinical-supply-forecasting
...
## Key Prompts
- "Initiate clinical-supply-forecasting workflow for [context]"
- "Analyze current state of clinical-supply-forecasting and identify gaps"
- "Generate recommendations for clinical-supply-forecasting optimization"
- "Create detailed plan for clinical-supply-forecasting execution"
