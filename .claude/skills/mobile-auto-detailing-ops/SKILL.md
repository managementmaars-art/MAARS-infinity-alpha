---
name: mobile-auto-detailing-ops
description: Manage mobile auto detailing operations including route scheduling, chemical supply management, van fleet maintenance, and quality control programs.
---

## Overview
Manage mobile auto detailing operations including route scheduling, chemical supply management, van fleet maintenance, and quality control programs.

## Core Framework
- Analyze requirements and constraints specific to mobile-auto-detailing-ops
...
## Key Prompts
- "Initiate mobile-auto-detailing-ops workflow for [context]"
- "Analyze current state of mobile-auto-detailing-ops and identify gaps"
- "Generate recommendations for mobile-auto-detailing-ops optimization"
- "Create detailed plan for mobile-auto-detailing-ops execution"
