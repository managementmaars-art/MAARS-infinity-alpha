...
description: Coordinate omnichannel retail fulfillment including BOPIS, ship-from-store, curbside pickup, and inventory reservation logic.
---

## Overview
Coordinate omnichannel retail fulfillment including BOPIS, ship-from-store, curbside pickup, and inventory reservation logic.

## Core Framework
- Analyze requirements and constraints specific to retail-omnichannel-fulfillment
...
## Key Prompts
- "Initiate retail-omnichannel-fulfillment workflow for [context]"
- "Analyze current state of retail-omnichannel-fulfillment and identify gaps"
- "Generate recommendations for retail-omnichannel-fulfillment optimization"
- "Create detailed plan for retail-omnichannel-fulfillment execution"
