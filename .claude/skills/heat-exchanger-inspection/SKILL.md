...
description: Execute heat exchanger inspection programs including eddy current testing, hydroblast cleaning, re-tubing, and fitness-for-service assessment.
---

## Overview
Execute heat exchanger inspection programs including eddy current testing, hydroblast cleaning, re-tubing, and fitness-for-service assessment.

## Core Framework
- Analyze requirements and constraints specific to heat-exchanger-inspection
...
## Key Prompts
- "Initiate heat-exchanger-inspection workflow for [context]"
- "Analyze current state of heat-exchanger-inspection and identify gaps"
- "Generate recommendations for heat-exchanger-inspection optimization"
- "Create detailed plan for heat-exchanger-inspection execution"
