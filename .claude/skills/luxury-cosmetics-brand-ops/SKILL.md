---
name: luxury-cosmetics-brand-ops
description: Operate luxury cosmetics brand programs including counter management, beauty advisor training, gift-with-purchase promotions, and department store relationships.
---

## Overview
Operate luxury cosmetics brand programs including counter management, beauty advisor training, gift-with-purchase promotions, and department store relationships.

## Core Framework
- Analyze requirements and constraints specific to luxury-cosmetics-brand-ops
...
## Key Prompts
- "Initiate luxury-cosmetics-brand-ops workflow for [context]"
- "Analyze current state of luxury-cosmetics-brand-ops and identify gaps"
- "Generate recommendations for luxury-cosmetics-brand-ops optimization"
- "Create detailed plan for luxury-cosmetics-brand-ops execution"
