...
description: Trail of Bits: testing handbook — security testing methodology, test design, coverage strategies
---

# Tob Testing Handbook — MAARS Security Reference

## Overview
Trail of Bits: testing handbook — security testing methodology, test design, coverage strategies
