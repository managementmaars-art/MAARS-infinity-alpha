---
name: press-brake-operations
description: Operate press brake forming including CNC back gauge programming, tooling selection, springback compensation, and angle verification.
---

## Overview
Operate press brake forming including CNC back gauge programming, tooling selection, springback compensation, and angle verification.

## Core Framework
- Analyze requirements and constraints specific to press-brake-operations
...
## Key Prompts
- "Initiate press-brake-operations workflow for [context]"
- "Analyze current state of press-brake-operations and identify gaps"
- "Generate recommendations for press-brake-operations optimization"
- "Create detailed plan for press-brake-operations execution"
