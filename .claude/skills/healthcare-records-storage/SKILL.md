---
name: healthcare-records-storage
description: Manage healthcare records storage including HIPAA compliance, medical records retention, ROI services, and PHI security protocols.
---

## Overview
Manage healthcare records storage including HIPAA compliance, medical records retention, ROI services, and PHI security protocols.

## Core Framework
- Analyze requirements and constraints specific to healthcare-records-storage
...
## Key Prompts
- "Initiate healthcare-records-storage workflow for [context]"
- "Analyze current state of healthcare-records-storage and identify gaps"
- "Generate recommendations for healthcare-records-storage optimization"
- "Create detailed plan for healthcare-records-storage execution"
