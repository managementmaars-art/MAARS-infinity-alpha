---
name: specialty-fab-quoting-platform
description: Operate specialty fabrication quoting platforms including instant quoting, DFM feedback, lead time management, and customer portal integration.
---

## Overview
Operate specialty fabrication quoting platforms including instant quoting, DFM feedback, lead time management, and customer portal integration.

## Core Framework
- Analyze requirements and constraints specific to specialty-fab-quoting-platform
...
## Key Prompts
- "Initiate specialty-fab-quoting-platform workflow for [context]"
- "Analyze current state of specialty-fab-quoting-platform and identify gaps"
- "Generate recommendations for specialty-fab-quoting-platform optimization"
- "Create detailed plan for specialty-fab-quoting-platform execution"
