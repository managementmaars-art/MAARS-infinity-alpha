---
name: rigging-hardware-testing
description: Conduct rigging hardware proof testing including load application procedures, elongation measurement, and documentation for certification.
---

## Overview
Conduct rigging hardware proof testing including load application procedures, elongation measurement, and documentation for certification.

## Core Framework
- Analyze requirements and constraints specific to rigging-hardware-testing
...
## Key Prompts
- "Initiate rigging-hardware-testing workflow for [context]"
- "Analyze current state of rigging-hardware-testing and identify gaps"
- "Generate recommendations for rigging-hardware-testing optimization"
- "Create detailed plan for rigging-hardware-testing execution"
