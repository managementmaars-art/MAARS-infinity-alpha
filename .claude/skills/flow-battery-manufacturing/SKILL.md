---
name: flow-battery-manufacturing
description: Manufacture flow battery systems including vanadium redox and zinc-bromine types, electrolyte management, stack design, power conversion integration, and long-duration storage.
---

## Overview
Manufacture flow battery systems including vanadium redox and zinc-bromine types, electrolyte management, stack design, power conversion integration, and long-duration storage.

## Core Framework
- Analyze requirements and constraints specific to flow-battery-manufacturing
...
## Key Prompts
- "Initiate flow-battery-manufacturing workflow for [context]"
- "Analyze current state of flow-battery-manufacturing and identify gaps"
- "Generate recommendations for flow-battery-manufacturing optimization"
- "Create detailed plan for flow-battery-manufacturing execution"
