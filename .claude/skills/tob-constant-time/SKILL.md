---
name: tob-constant-time
description: Trail of Bits: constant-time analysis — detect timing side-channels in cryptographic code
---

# Tob Constant Time — MAARS Security Reference

## Overview
Trail of Bits: constant-time analysis — detect timing side-channels in cryptographic code
