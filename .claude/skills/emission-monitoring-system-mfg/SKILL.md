---
name: emission-monitoring-system-mfg
description: Manufacture continuous emission monitoring systems including gas analyzers, flow meters, data acquisition units, and EPA RATA certification support.
---

## Overview
Manufacture continuous emission monitoring systems including gas analyzers, flow meters, data acquisition units, and EPA RATA certification support.

## Core Framework
- Analyze requirements and constraints specific to emission-monitoring-system-mfg
...
## Key Prompts
- "Initiate emission-monitoring-system-mfg workflow for [context]"
- "Analyze current state of emission-monitoring-system-mfg and identify gaps"
- "Generate recommendations for emission-monitoring-system-mfg optimization"
- "Create detailed plan for emission-monitoring-system-mfg execution"
