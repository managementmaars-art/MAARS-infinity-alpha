---
name: glass-defect-analysis
description: Analyze glass defects using microscopy, chemistry, and process correlation to drive yield improvement programs.
---

## Overview
Analyze glass defects using microscopy, chemistry, and process correlation to drive yield improvement programs.

## Core Framework
- Analyze requirements and constraints specific to glass-defect-analysis
...
## Key Prompts
- "Initiate glass-defect-analysis workflow for [context]"
- "Analyze current state of glass-defect-analysis and identify gaps"
- "Generate recommendations for glass-defect-analysis optimization"
- "Create detailed plan for glass-defect-analysis execution"
