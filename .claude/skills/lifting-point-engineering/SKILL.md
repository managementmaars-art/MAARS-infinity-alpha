---
name: lifting-point-engineering
description: Engineer lifting point selections for machinery and equipment including load path analysis, structural adequacy verification, and proof testing.
---

## Overview
Engineer lifting point selections for machinery and equipment including load path analysis, structural adequacy verification, and proof testing.

## Core Framework
- Analyze requirements and constraints specific to lifting-point-engineering
...
## Key Prompts
- "Initiate lifting-point-engineering workflow for [context]"
- "Analyze current state of lifting-point-engineering and identify gaps"
- "Generate recommendations for lifting-point-engineering optimization"
- "Create detailed plan for lifting-point-engineering execution"
