---
name: landscape-installation-services
description: Manage landscape installation services including planting design, hardscape construction, irrigation installation, and project delivery.
---

## Overview
Manage landscape installation services including planting design, hardscape construction, irrigation installation, and project delivery.

## Core Framework
- Analyze requirements and constraints specific to landscape-installation-services
...
## Key Prompts
- "Initiate landscape-installation-services workflow for [context]"
- "Analyze current state of landscape-installation-services and identify gaps"
- "Generate recommendations for landscape-installation-services optimization"
- "Create detailed plan for landscape-installation-services execution"
