...
description: Manage MRO inventory including vending machine restocking, consignment programs, min-max replenishment, and obsolescence reduction.
---

## Overview
Manage MRO inventory including vending machine restocking, consignment programs, min-max replenishment, and obsolescence reduction.

## Core Framework
- Analyze requirements and constraints specific to mro-inventory-management
...
## Key Prompts
- "Initiate mro-inventory-management workflow for [context]"
- "Analyze current state of mro-inventory-management and identify gaps"
- "Generate recommendations for mro-inventory-management optimization"
- "Create detailed plan for mro-inventory-management execution"
