---
name: roofing-inspection-services
description: Provide roofing inspection services including infrared thermal imaging, core sampling, condition reporting, and remaining service life estimates.
---

## Overview
Provide roofing inspection services including infrared thermal imaging, core sampling, condition reporting, and remaining service life estimates.

## Core Framework
- Analyze requirements and constraints specific to roofing-inspection-services
...
## Key Prompts
- "Initiate roofing-inspection-services workflow for [context]"
- "Analyze current state of roofing-inspection-services and identify gaps"
- "Generate recommendations for roofing-inspection-services optimization"
- "Create detailed plan for roofing-inspection-services execution"
