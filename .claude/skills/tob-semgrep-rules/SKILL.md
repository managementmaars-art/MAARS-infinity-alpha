---
name: tob-semgrep-rules
description: Trail of Bits: write Semgrep rules — custom static analysis rules for security vulnerability detection
---

# Tob Semgrep Rules — MAARS Security Reference

## Overview
Trail of Bits: write Semgrep rules — custom static analysis rules for security vulnerability detection
