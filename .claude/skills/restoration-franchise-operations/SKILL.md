---
name: restoration-franchise-operations
description: Manage restoration franchise operations including territory management, certification requirements, marketing programs, and quality standards.
---

## Overview
Manage restoration franchise operations including territory management, certification requirements, marketing programs, and quality standards.

## Core Framework
- Analyze requirements and constraints specific to restoration-franchise-operations
...
## Key Prompts
- "Initiate restoration-franchise-operations workflow for [context]"
- "Analyze current state of restoration-franchise-operations and identify gaps"
- "Generate recommendations for restoration-franchise-operations optimization"
- "Create detailed plan for restoration-franchise-operations execution"
