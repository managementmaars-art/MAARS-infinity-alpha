---
name: thermal-spray-coating-ops
description: Operate thermal spray coating services including HVOF, arc spray, and plasma spray applications for wear and corrosion protection.
---

## Overview
Operate thermal spray coating services including HVOF, arc spray, and plasma spray applications for wear and corrosion protection.

## Core Framework
- Analyze requirements and constraints specific to thermal-spray-coating-ops
...
## Key Prompts
- "Initiate thermal-spray-coating-ops workflow for [context]"
- "Analyze current state of thermal-spray-coating-ops and identify gaps"
- "Generate recommendations for thermal-spray-coating-ops optimization"
- "Create detailed plan for thermal-spray-coating-ops execution"
