---
name: irrigation-management-systems
description: Manage smart irrigation systems including soil moisture monitoring, ET-based scheduling, and water use efficiency reporting.
---

## Overview
Manage smart irrigation systems including soil moisture monitoring, ET-based scheduling, and water use efficiency reporting.

## Core Framework
- Analyze requirements and constraints specific to irrigation-management-systems
...
## Key Prompts
- "Initiate irrigation-management-systems workflow for [context]"
- "Analyze current state of irrigation-management-systems and identify gaps"
- "Generate recommendations for irrigation-management-systems optimization"
- "Create detailed plan for irrigation-management-systems execution"
