---
name: wearable-sensor-development
description: Develop wearable biosensor solutions including PPG, ECG, SpO2, and EDA sensor integration with algorithm development.
---

## Overview
Develop wearable biosensor solutions including PPG, ECG, SpO2, and EDA sensor integration with algorithm development.

## Core Framework
- Analyze requirements and constraints specific to wearable-sensor-development
...
## Key Prompts
- "Initiate wearable-sensor-development workflow for [context]"
- "Analyze current state of wearable-sensor-development and identify gaps"
- "Generate recommendations for wearable-sensor-development optimization"
- "Create detailed plan for wearable-sensor-development execution"
