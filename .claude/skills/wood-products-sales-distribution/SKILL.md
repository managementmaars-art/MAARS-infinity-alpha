---
name: wood-products-sales-distribution
description: Manage wood products sales and distribution including dealer channel management, millwork program development, and price risk hedging.
---

## Overview
Manage wood products sales and distribution including dealer channel management, millwork program development, and price risk hedging.

## Core Framework
- Analyze requirements and constraints specific to wood-products-sales-distribution
...
## Key Prompts
- "Initiate wood-products-sales-distribution workflow for [context]"
- "Analyze current state of wood-products-sales-distribution and identify gaps"
- "Generate recommendations for wood-products-sales-distribution optimization"
- "Create detailed plan for wood-products-sales-distribution execution"
