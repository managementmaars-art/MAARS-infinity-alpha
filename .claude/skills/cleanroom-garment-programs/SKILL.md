---
name: cleanroom-garment-programs
description: Manage cleanroom garment programs including laundry service qualification, garment integrity testing, particle shed monitoring, and particle count compliance.
---

## Overview
Manage cleanroom garment programs including laundry service qualification, garment integrity testing, particle shed monitoring, and particle count compliance.

## Core Framework
- Analyze requirements and constraints specific to cleanroom-garment-programs
...
## Key Prompts
- "Initiate cleanroom-garment-programs workflow for [context]"
- "Analyze current state of cleanroom-garment-programs and identify gaps"
- "Generate recommendations for cleanroom-garment-programs optimization"
- "Create detailed plan for cleanroom-garment-programs execution"
