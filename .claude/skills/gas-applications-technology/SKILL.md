---
name: gas-applications-technology
description: Provide industrial gas application support including welding, cutting, heat treating, food processing, and semiconductor fab applications.
---

## Overview
Provide industrial gas application support including welding, cutting, heat treating, food processing, and semiconductor fab applications.

## Core Framework
- Analyze requirements and constraints specific to gas-applications-technology
...
## Key Prompts
- "Initiate gas-applications-technology workflow for [context]"
- "Analyze current state of gas-applications-technology and identify gaps"
- "Generate recommendations for gas-applications-technology optimization"
- "Create detailed plan for gas-applications-technology execution"
