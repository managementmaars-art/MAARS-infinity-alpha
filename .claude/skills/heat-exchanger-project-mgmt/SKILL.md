---
name: heat-exchanger-project-mgmt
description: Manage heat exchanger project execution including ASME U-stamp certification, inspection coordination, and delivery scheduling.
---

## Overview
Manage heat exchanger project execution including ASME U-stamp certification, inspection coordination, and delivery scheduling.

## Core Framework
- Analyze requirements and constraints specific to heat-exchanger-project-mgmt
...
## Key Prompts
- "Initiate heat-exchanger-project-mgmt workflow for [context]"
- "Analyze current state of heat-exchanger-project-mgmt and identify gaps"
- "Generate recommendations for heat-exchanger-project-mgmt optimization"
- "Create detailed plan for heat-exchanger-project-mgmt execution"
