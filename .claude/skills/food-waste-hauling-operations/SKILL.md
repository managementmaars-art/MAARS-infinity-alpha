---
name: food-waste-hauling-operations
description: Operate commercial food waste hauling services including scheduled collection, container management, routing, and diversion reporting.
---

## Overview
Operate commercial food waste hauling services including scheduled collection, container management, routing, and diversion reporting.

## Core Framework
- Analyze requirements and constraints specific to food-waste-hauling-operations
...
## Key Prompts
- "Initiate food-waste-hauling-operations workflow for [context]"
- "Analyze current state of food-waste-hauling-operations and identify gaps"
- "Generate recommendations for food-waste-hauling-operations optimization"
- "Create detailed plan for food-waste-hauling-operations execution"
