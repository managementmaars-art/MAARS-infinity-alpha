---
name: leather-sourcing-grading
description: Source and grade raw hides and skins including supplier qualification, hide grading standards, and traceability program management.
---

## Overview
Source and grade raw hides and skins including supplier qualification, hide grading standards, and traceability program management.

## Core Framework
- Analyze requirements and constraints specific to leather-sourcing-grading
...
## Key Prompts
- "Initiate leather-sourcing-grading workflow for [context]"
- "Analyze current state of leather-sourcing-grading and identify gaps"
- "Generate recommendations for leather-sourcing-grading optimization"
- "Create detailed plan for leather-sourcing-grading execution"
