---
name: sample-storage-system-manufacturing
description: Produce automated sample storage systems including cryogenic rack assembly, pick-and-place robot integration, and barcode tracking setup.
---

## Overview
Produce automated sample storage systems including cryogenic rack assembly, pick-and-place robot integration, and barcode tracking setup.

## Core Framework
- Analyze requirements and constraints specific to sample-storage-system-manufacturing
...
## Key Prompts
- "Initiate sample-storage-system-manufacturing workflow for [context]"
- "Analyze current state of sample-storage-system-manufacturing and identify gaps"
- "Generate recommendations for sample-storage-system-manufacturing optimization"
- "Create detailed plan for sample-storage-system-manufacturing execution"
