---
name: itad-asset-recovery-programs
description: Develop ITAD asset recovery programs including buy-back programs, lease return processing, corporate device collection, and remarketing.
---

## Overview
Develop ITAD asset recovery programs including buy-back programs, lease return processing, corporate device collection, and remarketing.

## Core Framework
- Analyze requirements and constraints specific to itad-asset-recovery-programs
...
## Key Prompts
- "Initiate itad-asset-recovery-programs workflow for [context]"
- "Analyze current state of itad-asset-recovery-programs and identify gaps"
- "Generate recommendations for itad-asset-recovery-programs optimization"
- "Create detailed plan for itad-asset-recovery-programs execution"
