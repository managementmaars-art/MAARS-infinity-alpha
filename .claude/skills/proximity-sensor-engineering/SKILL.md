---
name: proximity-sensor-engineering
description: Engineer proximity sensors including inductive, capacitive, and magnetic types with switching distance, frequency, and output configuration.
---

## Overview
Engineer proximity sensors including inductive, capacitive, and magnetic types with switching distance, frequency, and output configuration.

## Core Framework
- Analyze requirements and constraints specific to proximity-sensor-engineering
...
## Key Prompts
- "Initiate proximity-sensor-engineering workflow for [context]"
- "Analyze current state of proximity-sensor-engineering and identify gaps"
- "Generate recommendations for proximity-sensor-engineering optimization"
- "Create detailed plan for proximity-sensor-engineering execution"
