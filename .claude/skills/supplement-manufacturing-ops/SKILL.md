---
name: supplement-manufacturing-ops
description: Manage dietary supplement manufacturing operations including encapsulation, tableting, blending, and cGMP documentation.
---

## Overview
Manage dietary supplement manufacturing operations including encapsulation, tableting, blending, and cGMP documentation.

## Core Framework
- Analyze requirements and constraints specific to supplement-manufacturing-ops
...
## Key Prompts
- "Initiate supplement-manufacturing-ops workflow for [context]"
- "Analyze current state of supplement-manufacturing-ops and identify gaps"
- "Generate recommendations for supplement-manufacturing-ops optimization"
- "Create detailed plan for supplement-manufacturing-ops execution"
