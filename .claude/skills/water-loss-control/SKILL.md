---
name: water-loss-control
description: Implement water loss control programs including water audits, leak detection, pressure zone management, and NRW reduction.
---

## Overview
Implement water loss control programs including water audits, leak detection, pressure zone management, and NRW reduction.

## Core Framework
- Analyze requirements and constraints specific to water-loss-control
...
## Key Prompts
- "Initiate water-loss-control workflow for [context]"
- "Analyze current state of water-loss-control and identify gaps"
- "Generate recommendations for water-loss-control optimization"
- "Create detailed plan for water-loss-control execution"
