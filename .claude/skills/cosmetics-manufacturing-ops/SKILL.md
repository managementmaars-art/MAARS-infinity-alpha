---
name: cosmetics-manufacturing-ops
description: Manage cosmetics manufacturing operations including color grinding, lipstick molding, compaction, and primary packaging filling.
---

## Overview
Manage cosmetics manufacturing operations including color grinding, lipstick molding, compaction, and primary packaging filling.

## Core Framework
- Analyze requirements and constraints specific to cosmetics-manufacturing-ops
...
## Key Prompts
- "Initiate cosmetics-manufacturing-ops workflow for [context]"
- "Analyze current state of cosmetics-manufacturing-ops and identify gaps"
- "Generate recommendations for cosmetics-manufacturing-ops optimization"
- "Create detailed plan for cosmetics-manufacturing-ops execution"
