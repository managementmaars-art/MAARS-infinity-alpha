...
description: Implement EVMS on federal programs including WBS development, baseline control, variance analysis, and IBR preparation.
---

## Overview
Implement EVMS on federal programs including WBS development, baseline control, variance analysis, and IBR preparation.

## Core Framework
- Analyze requirements and constraints specific to earned-value-management
...
## Key Prompts
- "Initiate earned-value-management workflow for [context]"
- "Analyze current state of earned-value-management and identify gaps"
- "Generate recommendations for earned-value-management optimization"
- "Create detailed plan for earned-value-management execution"
