---
name: emi-emc-test-management
description: Manage EMI/EMC testing programs including pre-compliance screening, accredited test lab coordination, and certification documentation.
---

## Overview
Manage EMI/EMC testing programs including pre-compliance screening, accredited test lab coordination, and certification documentation.

## Core Framework
- Analyze requirements and constraints specific to emi-emc-test-management
...
## Key Prompts
- "Initiate emi-emc-test-management workflow for [context]"
- "Analyze current state of emi-emc-test-management and identify gaps"
- "Generate recommendations for emi-emc-test-management optimization"
- "Create detailed plan for emi-emc-test-management execution"
