---
name: ink-waste-management
description: Manage ink waste and byproduct programs including solvent recovery, waste ink reclaim, and hazardous waste disposal compliance.
---

## Overview
Manage ink waste and byproduct programs including solvent recovery, waste ink reclaim, and hazardous waste disposal compliance.

## Core Framework
- Analyze requirements and constraints specific to ink-waste-management
...
## Key Prompts
- "Initiate ink-waste-management workflow for [context]"
- "Analyze current state of ink-waste-management and identify gaps"
- "Generate recommendations for ink-waste-management optimization"
- "Create detailed plan for ink-waste-management execution"
