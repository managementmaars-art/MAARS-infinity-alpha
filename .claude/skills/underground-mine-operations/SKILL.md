---
name: underground-mine-operations
description: Operate underground mining operations including development advance scheduling, stope sequencing, ventilation management, and ground support programs.
---

## Overview
Operate underground mining operations including development advance scheduling, stope sequencing, ventilation management, and ground support programs.

## Core Framework
- Analyze requirements and constraints specific to underground-mine-operations
...
## Key Prompts
- "Initiate underground-mine-operations workflow for [context]"
- "Analyze current state of underground-mine-operations and identify gaps"
- "Generate recommendations for underground-mine-operations optimization"
- "Create detailed plan for underground-mine-operations execution"
