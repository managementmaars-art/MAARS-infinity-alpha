---
name: guided-wave-testing-ops
description: Deploy guided wave ultrasonic testing for long-range pipe screening including transducer ring setup, signal interpretation, and anomaly investigation.
---

## Overview
Deploy guided wave ultrasonic testing for long-range pipe screening including transducer ring setup, signal interpretation, and anomaly investigation.

## Core Framework
- Analyze requirements and constraints specific to guided-wave-testing-ops
...
## Key Prompts
- "Initiate guided-wave-testing-ops workflow for [context]"
- "Analyze current state of guided-wave-testing-ops and identify gaps"
- "Generate recommendations for guided-wave-testing-ops optimization"
- "Create detailed plan for guided-wave-testing-ops execution"
