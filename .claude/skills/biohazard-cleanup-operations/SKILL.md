---
name: biohazard-cleanup-operations
description: Operate biohazard cleanup services including scene assessment, personal protective equipment programs, regulated waste disposal, and decontamination verification.
---

## Overview
Operate biohazard cleanup services including scene assessment, personal protective equipment programs, regulated waste disposal, and decontamination verification.

## Core Framework
- Analyze requirements and constraints specific to biohazard-cleanup-operations
...
## Key Prompts
- "Initiate biohazard-cleanup-operations workflow for [context]"
- "Analyze current state of biohazard-cleanup-operations and identify gaps"
- "Generate recommendations for biohazard-cleanup-operations optimization"
- "Create detailed plan for biohazard-cleanup-operations execution"
