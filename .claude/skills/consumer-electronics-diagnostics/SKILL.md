---
name: consumer-electronics-diagnostics
description: Perform consumer electronics diagnostics including component-level fault isolation, circuit board analysis, and repair feasibility assessment.
---

## Overview
Perform consumer electronics diagnostics including component-level fault isolation, circuit board analysis, and repair feasibility assessment.

## Core Framework
- Analyze requirements and constraints specific to consumer-electronics-diagnostics
...
## Key Prompts
- "Initiate consumer-electronics-diagnostics workflow for [context]"
- "Analyze current state of consumer-electronics-diagnostics and identify gaps"
- "Generate recommendations for consumer-electronics-diagnostics optimization"
- "Create detailed plan for consumer-electronics-diagnostics execution"
