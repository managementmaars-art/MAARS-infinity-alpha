---
name: atmospheric-corrosion-programs
description: Manage atmospheric corrosion programs including ISO corrosivity classification, inspection planning, and protective coating specification.
---

## Overview
Manage atmospheric corrosion programs including ISO corrosivity classification, inspection planning, and protective coating specification.

## Core Framework
- Analyze requirements and constraints specific to atmospheric-corrosion-programs
...
## Key Prompts
- "Initiate atmospheric-corrosion-programs workflow for [context]"
- "Analyze current state of atmospheric-corrosion-programs and identify gaps"
- "Generate recommendations for atmospheric-corrosion-programs optimization"
- "Create detailed plan for atmospheric-corrosion-programs execution"
