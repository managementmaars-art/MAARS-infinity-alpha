---
name: metals-service-center-ops
description: Operate metals service center operations including inventory management, processing services, order fulfillment, and customer service.
---

## Overview
Operate metals service center operations including inventory management, processing services, order fulfillment, and customer service.

## Core Framework
- Analyze requirements and constraints specific to metals-service-center-ops
...
## Key Prompts
- "Initiate metals-service-center-ops workflow for [context]"
- "Analyze current state of metals-service-center-ops and identify gaps"
- "Generate recommendations for metals-service-center-ops optimization"
- "Create detailed plan for metals-service-center-ops execution"
