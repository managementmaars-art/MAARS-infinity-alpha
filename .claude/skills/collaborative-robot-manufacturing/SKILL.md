---
name: collaborative-robot-manufacturing
description: Produce collaborative robots including torque sensing joint assembly, collision detection calibration, and safety rated stop certification.
---

## Overview
Produce collaborative robots including torque sensing joint assembly, collision detection calibration, and safety rated stop certification.

## Core Framework
- Analyze requirements and constraints specific to collaborative-robot-manufacturing
...
## Key Prompts
- "Initiate collaborative-robot-manufacturing workflow for [context]"
- "Analyze current state of collaborative-robot-manufacturing and identify gaps"
- "Generate recommendations for collaborative-robot-manufacturing optimization"
- "Create detailed plan for collaborative-robot-manufacturing execution"
