---
name: emergency-spill-response-ops
description: Operate hazardous spill response services including 24-hour dispatch, containment deployment, remediation, and regulatory notification coordination.
---

## Overview
Operate hazardous spill response services including 24-hour dispatch, containment deployment, remediation, and regulatory notification coordination.

## Core Framework
- Analyze requirements and constraints specific to emergency-spill-response-ops
...
## Key Prompts
- "Initiate emergency-spill-response-ops workflow for [context]"
- "Analyze current state of emergency-spill-response-ops and identify gaps"
- "Generate recommendations for emergency-spill-response-ops optimization"
- "Create detailed plan for emergency-spill-response-ops execution"
