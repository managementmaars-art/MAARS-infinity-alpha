---
name: dairy-packaging-operations
description: Operate dairy packaging lines including fill weight control, seal integrity testing, date coding, and line changeover management.
---

## Overview
Operate dairy packaging lines including fill weight control, seal integrity testing, date coding, and line changeover management.

## Core Framework
- Analyze requirements and constraints specific to dairy-packaging-operations
...
## Key Prompts
- "Initiate dairy-packaging-operations workflow for [context]"
- "Analyze current state of dairy-packaging-operations and identify gaps"
- "Generate recommendations for dairy-packaging-operations optimization"
- "Create detailed plan for dairy-packaging-operations execution"
