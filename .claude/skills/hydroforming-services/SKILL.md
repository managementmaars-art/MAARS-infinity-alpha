---
name: hydroforming-services
description: Provide tube and sheet hydroforming services including pressure sequence development, tool design support, and complex geometry capability qualification.
---

## Overview
Provide tube and sheet hydroforming services including pressure sequence development, tool design support, and complex geometry capability qualification.

## Core Framework
- Analyze requirements and constraints specific to hydroforming-services
...
## Key Prompts
- "Initiate hydroforming-services workflow for [context]"
- "Analyze current state of hydroforming-services and identify gaps"
- "Generate recommendations for hydroforming-services optimization"
- "Create detailed plan for hydroforming-services execution"
