---
name: building-shm-systems
description: Deploy building structural health monitoring including seismic response capture, inter-story drift measurement, and post-event assessment.
---

## Overview
Deploy building structural health monitoring including seismic response capture, inter-story drift measurement, and post-event assessment.

## Core Framework
- Analyze requirements and constraints specific to building-shm-systems
...
## Key Prompts
- "Initiate building-shm-systems workflow for [context]"
- "Analyze current state of building-shm-systems and identify gaps"
- "Generate recommendations for building-shm-systems optimization"
- "Create detailed plan for building-shm-systems execution"
