---
name: rigging-hardware-management
description: Manage lifting and rigging hardware programs including sling inventory, load testing, inspection records, and equipment retirement criteria.
---

## Overview
Manage lifting and rigging hardware programs including sling inventory, load testing, inspection records, and equipment retirement criteria.

## Core Framework
- Analyze requirements and constraints specific to rigging-hardware-management
...
## Key Prompts
- "Initiate rigging-hardware-management workflow for [context]"
- "Analyze current state of rigging-hardware-management and identify gaps"
- "Generate recommendations for rigging-hardware-management optimization"
- "Create detailed plan for rigging-hardware-management execution"
