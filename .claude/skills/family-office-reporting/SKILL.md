...
description: Produce consolidated family office reporting across custodians, asset classes, and entity structures.
---

## Overview
Produce consolidated family office reporting across custodians, asset classes, and entity structures.

## Core Framework
- Analyze requirements and constraints specific to family-office-reporting
...
## Key Prompts
- "Initiate family-office-reporting workflow for [context]"
- "Analyze current state of family-office-reporting and identify gaps"
- "Generate recommendations for family-office-reporting optimization"
- "Create detailed plan for family-office-reporting execution"
