---
name: optical-encoder-manufacturing
description: Produce optical encoders including disk patterning, detector array alignment, interpolation electronics assembly, and accuracy and repeatability qualification.
---

## Overview
Produce optical encoders including disk patterning, detector array alignment, interpolation electronics assembly, and accuracy and repeatability qualification.

## Core Framework
- Analyze requirements and constraints specific to optical-encoder-manufacturing
...
## Key Prompts
- "Initiate optical-encoder-manufacturing workflow for [context]"
- "Analyze current state of optical-encoder-manufacturing and identify gaps"
- "Generate recommendations for optical-encoder-manufacturing optimization"
- "Create detailed plan for optical-encoder-manufacturing execution"
