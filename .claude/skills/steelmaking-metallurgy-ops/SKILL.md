---
name: steelmaking-metallurgy-ops
description: Manage steelmaking metallurgical programs including ladle metallurgy operations, alloy addition optimization, and inclusion cleanliness programs.
---

## Overview
Manage steelmaking metallurgical programs including ladle metallurgy operations, alloy addition optimization, and inclusion cleanliness programs.

## Core Framework
- Analyze requirements and constraints specific to steelmaking-metallurgy-ops
...
## Key Prompts
- "Initiate steelmaking-metallurgy-ops workflow for [context]"
- "Analyze current state of steelmaking-metallurgy-ops and identify gaps"
- "Generate recommendations for steelmaking-metallurgy-ops optimization"
- "Create detailed plan for steelmaking-metallurgy-ops execution"
