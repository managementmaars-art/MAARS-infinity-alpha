---
name: additive-production-mgmt
description: Manage additive manufacturing production including build scheduling, machine utilization optimization, and order fulfillment for on-demand manufacturing.
---

## Overview
Manage additive manufacturing production including build scheduling, machine utilization optimization, and order fulfillment for on-demand manufacturing.

## Core Framework
- Analyze requirements and constraints specific to additive-production-mgmt
...
## Key Prompts
- "Initiate additive-production-mgmt workflow for [context]"
- "Analyze current state of additive-production-mgmt and identify gaps"
- "Generate recommendations for additive-production-mgmt optimization"
- "Create detailed plan for additive-production-mgmt execution"
