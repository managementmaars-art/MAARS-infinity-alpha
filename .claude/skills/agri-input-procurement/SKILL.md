---
name: agri-input-procurement
description: Manage agricultural input procurement including seed, fertilizer, and chemical sourcing with contract management and market timing.
---

## Overview
Manage agricultural input procurement including seed, fertilizer, and chemical sourcing with contract management and market timing.

## Core Framework
- Analyze requirements and constraints specific to agri-input-procurement
...
## Key Prompts
- "Initiate agri-input-procurement workflow for [context]"
- "Analyze current state of agri-input-procurement and identify gaps"
- "Generate recommendations for agri-input-procurement optimization"
- "Create detailed plan for agri-input-procurement execution"
