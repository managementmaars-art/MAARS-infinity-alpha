---
name: tank-coating-application-services
description: Manage tank lining and coating services including surface preparation, lining materials, application, inspection, and holiday testing.
---

## Overview
Manage tank lining and coating services including surface preparation, lining materials, application, inspection, and holiday testing.

## Core Framework
- Analyze requirements and constraints specific to tank-coating-application-services
...
## Key Prompts
- "Initiate tank-coating-application-services workflow for [context]"
- "Analyze current state of tank-coating-application-services and identify gaps"
- "Generate recommendations for tank-coating-application-services optimization"
- "Create detailed plan for tank-coating-application-services execution"
