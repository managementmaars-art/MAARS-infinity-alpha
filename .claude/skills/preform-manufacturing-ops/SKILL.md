---
name: preform-manufacturing-ops
description: Manage optical fiber preform manufacturing including MCVD, OVD, and PCVD deposition processes with geometry and composition characterization.
---

## Overview
Manage optical fiber preform manufacturing including MCVD, OVD, and PCVD deposition processes with geometry and composition characterization.

## Core Framework
- Analyze requirements and constraints specific to preform-manufacturing-ops
...
## Key Prompts
- "Initiate preform-manufacturing-ops workflow for [context]"
- "Analyze current state of preform-manufacturing-ops and identify gaps"
- "Generate recommendations for preform-manufacturing-ops optimization"
- "Create detailed plan for preform-manufacturing-ops execution"
