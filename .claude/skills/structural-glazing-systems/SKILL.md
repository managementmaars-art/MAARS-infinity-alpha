...
description: Manage structural glazing system installation including silicone bonding, point-fixed glass, SSG facades, and engineering coordination.
---

## Overview
Manage structural glazing system installation including silicone bonding, point-fixed glass, SSG facades, and engineering coordination.

## Core Framework
- Analyze requirements and constraints specific to structural-glazing-systems
...
## Key Prompts
- "Initiate structural-glazing-systems workflow for [context]"
- "Analyze current state of structural-glazing-systems and identify gaps"
- "Generate recommendations for structural-glazing-systems optimization"
- "Create detailed plan for structural-glazing-systems execution"
