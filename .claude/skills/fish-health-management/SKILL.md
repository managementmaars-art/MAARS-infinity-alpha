...
description: Manage fish health programs including disease surveillance, vaccination protocols, biosecurity measures, and veterinary coordination.
---

## Overview
Manage fish health programs including disease surveillance, vaccination protocols, biosecurity measures, and veterinary coordination.

## Core Framework
- Analyze requirements and constraints specific to fish-health-management
...
## Key Prompts
- "Initiate fish-health-management workflow for [context]"
- "Analyze current state of fish-health-management and identify gaps"
- "Generate recommendations for fish-health-management optimization"
- "Create detailed plan for fish-health-management execution"
