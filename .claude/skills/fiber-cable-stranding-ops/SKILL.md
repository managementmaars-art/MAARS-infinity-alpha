---
name: fiber-cable-stranding-ops
description: Manage optical cable stranding operations including loose tube filling, stranding, core wrapping, armoring, and sheathing operations.
---

## Overview
Manage optical cable stranding operations including loose tube filling, stranding, core wrapping, armoring, and sheathing operations.

## Core Framework
- Analyze requirements and constraints specific to fiber-cable-stranding-ops
...
## Key Prompts
- "Initiate fiber-cable-stranding-ops workflow for [context]"
- "Analyze current state of fiber-cable-stranding-ops and identify gaps"
- "Generate recommendations for fiber-cable-stranding-ops optimization"
- "Create detailed plan for fiber-cable-stranding-ops execution"
