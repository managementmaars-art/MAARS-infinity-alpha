---
name: continuous-chemical-process-ops
description: Operate continuous chemical processes including reactor control, distillation column management, and real-time process analytics.
---

## Overview
Operate continuous chemical processes including reactor control, distillation column management, and real-time process analytics.

## Core Framework
- Analyze requirements and constraints specific to continuous-chemical-process-ops
...
## Key Prompts
- "Initiate continuous-chemical-process-ops workflow for [context]"
- "Analyze current state of continuous-chemical-process-ops and identify gaps"
- "Generate recommendations for continuous-chemical-process-ops optimization"
- "Create detailed plan for continuous-chemical-process-ops execution"
