---
name: event-power-rental-ops
description: Manage event power rental programs for concerts, festivals, and outdoor events including cable routing, silent generator selection, and power quality monitoring.
---

## Overview
Manage event power rental programs for concerts, festivals, and outdoor events including cable routing, silent generator selection, and power quality monitoring.

## Core Framework
- Analyze requirements and constraints specific to event-power-rental-ops
...
## Key Prompts
- "Initiate event-power-rental-ops workflow for [context]"
- "Analyze current state of event-power-rental-ops and identify gaps"
- "Generate recommendations for event-power-rental-ops optimization"
- "Create detailed plan for event-power-rental-ops execution"
