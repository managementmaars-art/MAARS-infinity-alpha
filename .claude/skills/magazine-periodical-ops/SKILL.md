---
name: magazine-periodical-ops
description: Manage magazine and periodical publishing operations including subscription fulfillment, advertising sales, and issue planning.
---

## Overview
Manage magazine and periodical publishing operations including subscription fulfillment, advertising sales, and issue planning.

## Core Framework
- Analyze requirements and constraints specific to magazine-periodical-ops
...
## Key Prompts
- "Initiate magazine-periodical-ops workflow for [context]"
- "Analyze current state of magazine-periodical-ops and identify gaps"
- "Generate recommendations for magazine-periodical-ops optimization"
- "Create detailed plan for magazine-periodical-ops execution"
