---
name: copper-rod-manufacturing-ops
description: Operate continuous copper rod production including shaft furnace management, Properzi casting wheel, rolling train control, and rod quality testing.
---

## Overview
Operate continuous copper rod production including shaft furnace management, Properzi casting wheel, rolling train control, and rod quality testing.

## Core Framework
- Analyze requirements and constraints specific to copper-rod-manufacturing-ops
...
## Key Prompts
- "Initiate copper-rod-manufacturing-ops workflow for [context]"
- "Analyze current state of copper-rod-manufacturing-ops and identify gaps"
- "Generate recommendations for copper-rod-manufacturing-ops optimization"
- "Create detailed plan for copper-rod-manufacturing-ops execution"
