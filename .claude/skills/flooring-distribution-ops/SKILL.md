---
name: flooring-distribution-ops
description: Operate flooring distribution including hardwood, LVP, tile, carpet, underlayment, and adhesives for flooring contractors and retailers.
---

## Overview
Operate flooring distribution including hardwood, LVP, tile, carpet, underlayment, and adhesives for flooring contractors and retailers.

## Core Framework
- Analyze requirements and constraints specific to flooring-distribution-ops
...
## Key Prompts
- "Initiate flooring-distribution-ops workflow for [context]"
- "Analyze current state of flooring-distribution-ops and identify gaps"
- "Generate recommendations for flooring-distribution-ops optimization"
- "Create detailed plan for flooring-distribution-ops execution"
