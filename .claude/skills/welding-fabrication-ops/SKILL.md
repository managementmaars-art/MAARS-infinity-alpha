---
name: welding-fabrication-ops
description: Manage welding fabrication operations including WPS development, welder qualification, distortion control, and weld inspection programs.
---

## Overview
Manage welding fabrication operations including WPS development, welder qualification, distortion control, and weld inspection programs.

## Core Framework
- Analyze requirements and constraints specific to welding-fabrication-ops
...
## Key Prompts
- "Initiate welding-fabrication-ops workflow for [context]"
- "Analyze current state of welding-fabrication-ops and identify gaps"
- "Generate recommendations for welding-fabrication-ops optimization"
- "Create detailed plan for welding-fabrication-ops execution"
