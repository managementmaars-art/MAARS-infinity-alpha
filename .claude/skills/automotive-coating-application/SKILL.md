---
name: automotive-coating-application
description: Optimize automotive coating application processes including spray equipment selection, film build control, and bake cure cycle management.
---

## Overview
Optimize automotive coating application processes including spray equipment selection, film build control, and bake cure cycle management.

## Core Framework
- Analyze requirements and constraints specific to automotive-coating-application
...
## Key Prompts
- "Initiate automotive-coating-application workflow for [context]"
- "Analyze current state of automotive-coating-application and identify gaps"
- "Generate recommendations for automotive-coating-application optimization"
- "Create detailed plan for automotive-coating-application execution"
