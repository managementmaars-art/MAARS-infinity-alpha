---
name: sprayer-application-equipment
description: Manage sprayer equipment manufacturing including boom fabrication, pump system integration, GPS section control, and NRCS compliance.
---

## Overview
Manage sprayer equipment manufacturing including boom fabrication, pump system integration, GPS section control, and NRCS compliance.

## Core Framework
- Analyze requirements and constraints specific to sprayer-application-equipment
...
## Key Prompts
- "Initiate sprayer-application-equipment workflow for [context]"
- "Analyze current state of sprayer-application-equipment and identify gaps"
- "Generate recommendations for sprayer-application-equipment optimization"
- "Create detailed plan for sprayer-application-equipment execution"
