---
name: freight-procurement-ops
description: Manage freight procurement programs including RFP execution, rate benchmarking, carrier contract management, and mode optimization.
---

## Overview
Manage freight procurement programs including RFP execution, rate benchmarking, carrier contract management, and mode optimization.

## Core Framework
- Analyze requirements and constraints specific to freight-procurement-ops
...
## Key Prompts
- "Initiate freight-procurement-ops workflow for [context]"
- "Analyze current state of freight-procurement-ops and identify gaps"
- "Generate recommendations for freight-procurement-ops optimization"
- "Create detailed plan for freight-procurement-ops execution"
