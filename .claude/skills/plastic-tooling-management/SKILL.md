---
name: plastic-tooling-management
description: Manage plastic tooling programs including mold design review, toolmaker coordination, qualification, and maintenance scheduling.
---

## Overview
Manage plastic tooling programs including mold design review, toolmaker coordination, qualification, and maintenance scheduling.

## Core Framework
- Analyze requirements and constraints specific to plastic-tooling-management
...
## Key Prompts
- "Initiate plastic-tooling-management workflow for [context]"
- "Analyze current state of plastic-tooling-management and identify gaps"
- "Generate recommendations for plastic-tooling-management optimization"
- "Create detailed plan for plastic-tooling-management execution"
