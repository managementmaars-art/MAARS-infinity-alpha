---
name: hydrogen-fueling-station-ops
description: Operate hydrogen fueling stations including compressor management, pre-cooling system maintenance, dispenser protocol compliance, and safety system testing.
---

## Overview
Operate hydrogen fueling stations including compressor management, pre-cooling system maintenance, dispenser protocol compliance, and safety system testing.

## Core Framework
- Analyze requirements and constraints specific to hydrogen-fueling-station-ops
...
## Key Prompts
- "Initiate hydrogen-fueling-station-ops workflow for [context]"
- "Analyze current state of hydrogen-fueling-station-ops and identify gaps"
- "Generate recommendations for hydrogen-fueling-station-ops optimization"
- "Create detailed plan for hydrogen-fueling-station-ops execution"
