...
description: Operate blood bank services including component inventory management, compatibility testing workflows, and transfusion reaction investigation.
---

## Overview
Operate blood bank services including component inventory management, compatibility testing workflows, and transfusion reaction investigation.

## Core Framework
- Analyze requirements and constraints specific to blood-bank-operations
...
## Key Prompts
- "Initiate blood-bank-operations workflow for [context]"
- "Analyze current state of blood-bank-operations and identify gaps"
- "Generate recommendations for blood-bank-operations optimization"
- "Create detailed plan for blood-bank-operations execution"
