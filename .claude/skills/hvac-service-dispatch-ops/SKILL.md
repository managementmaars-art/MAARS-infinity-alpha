---
name: hvac-service-dispatch-ops
description: Manage HVAC service dispatch operations including technician routing, call priority triage, parts van stocking, and customer communication.
---

## Overview
Manage HVAC service dispatch operations including technician routing, call priority triage, parts van stocking, and customer communication.

## Core Framework
- Analyze requirements and constraints specific to hvac-service-dispatch-ops
...
## Key Prompts
- "Initiate hvac-service-dispatch-ops workflow for [context]"
- "Analyze current state of hvac-service-dispatch-ops and identify gaps"
- "Generate recommendations for hvac-service-dispatch-ops optimization"
- "Create detailed plan for hvac-service-dispatch-ops execution"
