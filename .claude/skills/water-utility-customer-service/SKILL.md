---
name: water-utility-customer-service
description: Manage water utility customer service operations including billing system management, leak adjustment programs, and meter replacement workflows.
---

## Overview
Manage water utility customer service operations including billing system management, leak adjustment programs, and meter replacement workflows.

## Core Framework
- Analyze requirements and constraints specific to water-utility-customer-service
...
## Key Prompts
- "Initiate water-utility-customer-service workflow for [context]"
- "Analyze current state of water-utility-customer-service and identify gaps"
- "Generate recommendations for water-utility-customer-service optimization"
- "Create detailed plan for water-utility-customer-service execution"
