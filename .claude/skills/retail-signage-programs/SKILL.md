---
name: retail-signage-programs
description: Manage retail signage programs including prototype development, rollout coordination, brand standards, and multi-site installation management.
---

## Overview
Manage retail signage programs including prototype development, rollout coordination, brand standards, and multi-site installation management.

## Core Framework
- Analyze requirements and constraints specific to retail-signage-programs
...
## Key Prompts
- "Initiate retail-signage-programs workflow for [context]"
- "Analyze current state of retail-signage-programs and identify gaps"
- "Generate recommendations for retail-signage-programs optimization"
- "Create detailed plan for retail-signage-programs execution"
