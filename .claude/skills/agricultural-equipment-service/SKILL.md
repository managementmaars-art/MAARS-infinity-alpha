---
name: agricultural-equipment-service
description: Manage agricultural equipment dealer service operations including field service, warranty administration, and parts depot operations.
---

## Overview
Manage agricultural equipment dealer service operations including field service, warranty administration, and parts depot operations.

## Core Framework
- Analyze requirements and constraints specific to agricultural-equipment-service
...
## Key Prompts
- "Initiate agricultural-equipment-service workflow for [context]"
- "Analyze current state of agricultural-equipment-service and identify gaps"
- "Generate recommendations for agricultural-equipment-service optimization"
- "Create detailed plan for agricultural-equipment-service execution"
