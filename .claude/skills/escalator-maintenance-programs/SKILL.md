---
name: escalator-maintenance-programs
description: Develop escalator maintenance programs including daily inspections, combplate management, handrail inspections, and deep cleaning services.
---

## Overview
Develop escalator maintenance programs including daily inspections, combplate management, handrail inspections, and deep cleaning services.

## Core Framework
- Analyze requirements and constraints specific to escalator-maintenance-programs
...
## Key Prompts
- "Initiate escalator-maintenance-programs workflow for [context]"
- "Analyze current state of escalator-maintenance-programs and identify gaps"
- "Generate recommendations for escalator-maintenance-programs optimization"
- "Create detailed plan for escalator-maintenance-programs execution"
