...
description: Manage industrial pressure washing programs including equipment selection, detergent mixing ratios, wastewater containment, and operator safety protocols.
---

## Overview
Manage industrial pressure washing programs including equipment selection, detergent mixing ratios, wastewater containment, and operator safety protocols.

## Core Framework
- Analyze requirements and constraints specific to industrial-pressure-washing
...
## Key Prompts
- "Initiate industrial-pressure-washing workflow for [context]"
- "Analyze current state of industrial-pressure-washing and identify gaps"
- "Generate recommendations for industrial-pressure-washing optimization"
- "Create detailed plan for industrial-pressure-washing execution"
