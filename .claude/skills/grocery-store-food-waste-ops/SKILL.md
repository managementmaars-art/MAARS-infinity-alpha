---
name: grocery-store-food-waste-ops
description: Manage grocery store food waste operations including produce waste, bakery surplus, deli waste, donation programs, and diversion metrics.
---

## Overview
Manage grocery store food waste operations including produce waste, bakery surplus, deli waste, donation programs, and diversion metrics.

## Core Framework
- Analyze requirements and constraints specific to grocery-store-food-waste-ops
...
## Key Prompts
- "Initiate grocery-store-food-waste-ops workflow for [context]"
- "Analyze current state of grocery-store-food-waste-ops and identify gaps"
- "Generate recommendations for grocery-store-food-waste-ops optimization"
- "Create detailed plan for grocery-store-food-waste-ops execution"
