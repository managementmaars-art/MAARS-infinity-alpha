---
name: fire-alarm-monitoring-ops
description: Manage fire alarm monitoring center operations including signal receipt, dispatch procedures, false alarm reduction programs, and UL listing compliance.
---

## Overview
Manage fire alarm monitoring center operations including signal receipt, dispatch procedures, false alarm reduction programs, and UL listing compliance.

## Core Framework
- Analyze requirements and constraints specific to fire-alarm-monitoring-ops
...
## Key Prompts
- "Initiate fire-alarm-monitoring-ops workflow for [context]"
- "Analyze current state of fire-alarm-monitoring-ops and identify gaps"
- "Generate recommendations for fire-alarm-monitoring-ops optimization"
- "Create detailed plan for fire-alarm-monitoring-ops execution"
