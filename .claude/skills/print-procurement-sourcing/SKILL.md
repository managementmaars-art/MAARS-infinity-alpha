---
name: print-procurement-sourcing
description: Source and procure print production services including vendor qualification, RFQ management, and print buyer operations.
---

## Overview
Source and procure print production services including vendor qualification, RFQ management, and print buyer operations.

## Core Framework
- Analyze requirements and constraints specific to print-procurement-sourcing
...
## Key Prompts
- "Initiate print-procurement-sourcing workflow for [context]"
- "Analyze current state of print-procurement-sourcing and identify gaps"
- "Generate recommendations for print-procurement-sourcing optimization"
- "Create detailed plan for print-procurement-sourcing execution"
