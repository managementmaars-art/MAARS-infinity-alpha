---
name: seal-failure-investigation
description: Investigate seal failures including extrusion, spiral failure, chemical attack, and thermal degradation with corrective action recommendations.
---

## Overview
Investigate seal failures including extrusion, spiral failure, chemical attack, and thermal degradation with corrective action recommendations.

## Core Framework
- Analyze requirements and constraints specific to seal-failure-investigation
...
## Key Prompts
- "Initiate seal-failure-investigation workflow for [context]"
- "Analyze current state of seal-failure-investigation and identify gaps"
- "Generate recommendations for seal-failure-investigation optimization"
- "Create detailed plan for seal-failure-investigation execution"
