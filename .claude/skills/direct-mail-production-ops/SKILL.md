---
name: direct-mail-production-ops
description: Manage direct mail production operations including list processing, variable data printing, folding, inserting, USPS coordination, and postal optimization.
---

## Overview
Manage direct mail production operations including list processing, variable data printing, folding, inserting, USPS coordination, and postal optimization.

## Core Framework
- Analyze requirements and constraints specific to direct-mail-production-ops
...
## Key Prompts
- "Initiate direct-mail-production-ops workflow for [context]"
- "Analyze current state of direct-mail-production-ops and identify gaps"
- "Generate recommendations for direct-mail-production-ops optimization"
- "Create detailed plan for direct-mail-production-ops execution"
