...
description: Conduct acoustic emission testing for pressure vessel leak and crack detection, active corrosion monitoring, and structural integrity assessment.
---

## Overview
Conduct acoustic emission testing for pressure vessel leak and crack detection, active corrosion monitoring, and structural integrity assessment.

## Core Framework
- Analyze requirements and constraints specific to acoustic-emission-testing
...
## Key Prompts
- "Initiate acoustic-emission-testing workflow for [context]"
- "Analyze current state of acoustic-emission-testing and identify gaps"
- "Generate recommendations for acoustic-emission-testing optimization"
- "Create detailed plan for acoustic-emission-testing execution"
