---
name: smart-lighting-control-mfg
description: Manage smart lighting control device manufacturing including dimmer assembly, wireless protocol integration, and electrical safety testing.
---

## Overview
Manage smart lighting control device manufacturing including dimmer assembly, wireless protocol integration, and electrical safety testing.

## Core Framework
- Analyze requirements and constraints specific to smart-lighting-control-mfg
...
## Key Prompts
- "Initiate smart-lighting-control-mfg workflow for [context]"
- "Analyze current state of smart-lighting-control-mfg and identify gaps"
- "Generate recommendations for smart-lighting-control-mfg optimization"
- "Create detailed plan for smart-lighting-control-mfg execution"
