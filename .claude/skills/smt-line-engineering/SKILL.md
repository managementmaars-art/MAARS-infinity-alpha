---
name: smt-line-engineering
description: Engineer SMT production lines including component feeder management, stencil design, paste inspection, and placement accuracy optimization.
---

## Overview
Engineer SMT production lines including component feeder management, stencil design, paste inspection, and placement accuracy optimization.

## Core Framework
- Analyze requirements and constraints specific to smt-line-engineering
...
## Key Prompts
- "Initiate smt-line-engineering workflow for [context]"
- "Analyze current state of smt-line-engineering and identify gaps"
- "Generate recommendations for smt-line-engineering optimization"
- "Create detailed plan for smt-line-engineering execution"
