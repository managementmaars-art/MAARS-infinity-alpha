---
name: specialty-pharmacy-intake
description: Automate specialty pharmacy patient intake including benefit investigation, prior authorization, and hub enrollment.
---

## Overview
Automate specialty pharmacy patient intake including benefit investigation, prior authorization, and hub enrollment.

## Core Framework
- Analyze requirements and constraints specific to specialty-pharmacy-intake
...
## Key Prompts
- "Initiate specialty-pharmacy-intake workflow for [context]"
- "Analyze current state of specialty-pharmacy-intake and identify gaps"
- "Generate recommendations for specialty-pharmacy-intake optimization"
- "Create detailed plan for specialty-pharmacy-intake execution"
