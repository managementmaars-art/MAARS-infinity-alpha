---
name: noise-monitoring-equipment-mfg
description: Produce noise monitoring equipment including sound level meters, dosimeters, and noise mapping systems with IEC 61672 calibration and certification.
---

## Overview
Produce noise monitoring equipment including sound level meters, dosimeters, and noise mapping systems with IEC 61672 calibration and certification.

## Core Framework
- Analyze requirements and constraints specific to noise-monitoring-equipment-mfg
...
## Key Prompts
- "Initiate noise-monitoring-equipment-mfg workflow for [context]"
- "Analyze current state of noise-monitoring-equipment-mfg and identify gaps"
- "Generate recommendations for noise-monitoring-equipment-mfg optimization"
- "Create detailed plan for noise-monitoring-equipment-mfg execution"
