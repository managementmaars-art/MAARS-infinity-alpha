---
name: essential-oil-operations
description: Manage essential oil operations including botanical sourcing, steam distillation, GC-MS quality analysis, and aromatherapy application support.
---

## Overview
Manage essential oil operations including botanical sourcing, steam distillation, GC-MS quality analysis, and aromatherapy application support.

## Core Framework
- Analyze requirements and constraints specific to essential-oil-operations
...
## Key Prompts
- "Initiate essential-oil-operations workflow for [context]"
- "Analyze current state of essential-oil-operations and identify gaps"
- "Generate recommendations for essential-oil-operations optimization"
- "Create detailed plan for essential-oil-operations execution"
