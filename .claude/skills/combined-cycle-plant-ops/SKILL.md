---
name: combined-cycle-plant-ops
description: Operate combined cycle power plants including gas turbine management, heat recovery steam generator operations, and steam turbine control.
---

## Overview
Operate combined cycle power plants including gas turbine management, heat recovery steam generator operations, and steam turbine control.

## Core Framework
- Analyze requirements and constraints specific to combined-cycle-plant-ops
...
## Key Prompts
- "Initiate combined-cycle-plant-ops workflow for [context]"
- "Analyze current state of combined-cycle-plant-ops and identify gaps"
- "Generate recommendations for combined-cycle-plant-ops optimization"
- "Create detailed plan for combined-cycle-plant-ops execution"
