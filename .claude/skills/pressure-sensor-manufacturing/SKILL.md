---
name: pressure-sensor-manufacturing
description: Manufacture pressure sensors including piezoresistive, capacitive, and strain gauge types with accuracy, range, and process connection specifications.
---

## Overview
Manufacture pressure sensors including piezoresistive, capacitive, and strain gauge types with accuracy, range, and process connection specifications.

## Core Framework
- Analyze requirements and constraints specific to pressure-sensor-manufacturing
...
## Key Prompts
- "Initiate pressure-sensor-manufacturing workflow for [context]"
- "Analyze current state of pressure-sensor-manufacturing and identify gaps"
- "Generate recommendations for pressure-sensor-manufacturing optimization"
- "Create detailed plan for pressure-sensor-manufacturing execution"
