---
name: cleaning-formula-development
description: Develop cleaning product formulations including surfactant systems, builders, enzymes, and fragrance integration for household and industrial use.
---

## Overview
Develop cleaning product formulations including surfactant systems, builders, enzymes, and fragrance integration for household and industrial use.

## Core Framework
- Analyze requirements and constraints specific to cleaning-formula-development
...
## Key Prompts
- "Initiate cleaning-formula-development workflow for [context]"
- "Analyze current state of cleaning-formula-development and identify gaps"
- "Generate recommendations for cleaning-formula-development optimization"
- "Create detailed plan for cleaning-formula-development execution"
