---
name: hot-rolling-mill-operations
description: Operate hot strip rolling mills including slab reheating scheduling, rougher and finisher pass design, and coiler temperature control.
---

## Overview
Operate hot strip rolling mills including slab reheating scheduling, rougher and finisher pass design, and coiler temperature control.

## Core Framework
- Analyze requirements and constraints specific to hot-rolling-mill-operations
...
## Key Prompts
- "Initiate hot-rolling-mill-operations workflow for [context]"
- "Analyze current state of hot-rolling-mill-operations and identify gaps"
- "Generate recommendations for hot-rolling-mill-operations optimization"
- "Create detailed plan for hot-rolling-mill-operations execution"
