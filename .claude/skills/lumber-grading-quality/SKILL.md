---
name: lumber-grading-quality
description: Implement lumber grading quality programs including NHLA rules, machine stress rating, visual grade marking, and customer spec compliance.
---

## Overview
Implement lumber grading quality programs including NHLA rules, machine stress rating, visual grade marking, and customer spec compliance.

## Core Framework
- Analyze requirements and constraints specific to lumber-grading-quality
...
## Key Prompts
- "Initiate lumber-grading-quality workflow for [context]"
- "Analyze current state of lumber-grading-quality and identify gaps"
- "Generate recommendations for lumber-grading-quality optimization"
- "Create detailed plan for lumber-grading-quality execution"
