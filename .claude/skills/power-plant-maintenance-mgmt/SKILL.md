---
name: power-plant-maintenance-mgmt
description: Implement power plant maintenance programs including turbine inspection scheduling, boiler tube management, generator rewind planning, and CMMS operations.
---

## Overview
Implement power plant maintenance programs including turbine inspection scheduling, boiler tube management, generator rewind planning, and CMMS operations.

## Core Framework
- Analyze requirements and constraints specific to power-plant-maintenance-mgmt
...
## Key Prompts
- "Initiate power-plant-maintenance-mgmt workflow for [context]"
- "Analyze current state of power-plant-maintenance-mgmt and identify gaps"
- "Generate recommendations for power-plant-maintenance-mgmt optimization"
- "Create detailed plan for power-plant-maintenance-mgmt execution"
