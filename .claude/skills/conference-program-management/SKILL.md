---
name: conference-program-management
description: Develop conference programs including speaker recruitment, abstract review, session scheduling, and content track management.
---

## Overview
Develop conference programs including speaker recruitment, abstract review, session scheduling, and content track management.

## Core Framework
- Analyze requirements and constraints specific to conference-program-management
...
## Key Prompts
- "Initiate conference-program-management workflow for [context]"
- "Analyze current state of conference-program-management and identify gaps"
- "Generate recommendations for conference-program-management optimization"
- "Create detailed plan for conference-program-management execution"
