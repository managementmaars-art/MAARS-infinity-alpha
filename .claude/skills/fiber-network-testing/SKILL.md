---
name: fiber-network-testing
description: Test fiber optic networks including OTDR trace analysis, optical power budget verification, and reflectance measurement for acceptance and troubleshooting.
---

## Overview
Test fiber optic networks including OTDR trace analysis, optical power budget verification, and reflectance measurement for acceptance and troubleshooting.

## Core Framework
- Analyze requirements and constraints specific to fiber-network-testing
...
## Key Prompts
- "Initiate fiber-network-testing workflow for [context]"
- "Analyze current state of fiber-network-testing and identify gaps"
- "Generate recommendations for fiber-network-testing optimization"
- "Create detailed plan for fiber-network-testing execution"
