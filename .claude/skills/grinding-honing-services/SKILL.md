---
name: grinding-honing-services
description: Provide grinding and honing services including cylindrical, surface, and centerless grinding with geometric tolerance and surface texture control.
---

## Overview
Provide grinding and honing services including cylindrical, surface, and centerless grinding with geometric tolerance and surface texture control.

## Core Framework
- Analyze requirements and constraints specific to grinding-honing-services
...
## Key Prompts
- "Initiate grinding-honing-services workflow for [context]"
- "Analyze current state of grinding-honing-services and identify gaps"
- "Generate recommendations for grinding-honing-services optimization"
- "Create detailed plan for grinding-honing-services execution"
