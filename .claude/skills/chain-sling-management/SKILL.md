---
name: chain-sling-management
description: Manage chain sling programs including alloy grade verification, link inspection, proof testing, and annual thorough examination documentation.
---

## Overview
Manage chain sling programs including alloy grade verification, link inspection, proof testing, and annual thorough examination documentation.

## Core Framework
- Analyze requirements and constraints specific to chain-sling-management
...
## Key Prompts
- "Initiate chain-sling-management workflow for [context]"
- "Analyze current state of chain-sling-management and identify gaps"
- "Generate recommendations for chain-sling-management optimization"
- "Create detailed plan for chain-sling-management execution"
