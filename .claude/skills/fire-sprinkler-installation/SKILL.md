...
description: Manage fire sprinkler installation projects including pipe fabrication, hanger installation, head placement, and hydrostatic test documentation.
---

## Overview
Manage fire sprinkler installation projects including pipe fabrication, hanger installation, head placement, and hydrostatic test documentation.

## Core Framework
- Analyze requirements and constraints specific to fire-sprinkler-installation
...
## Key Prompts
- "Initiate fire-sprinkler-installation workflow for [context]"
- "Analyze current state of fire-sprinkler-installation and identify gaps"
- "Generate recommendations for fire-sprinkler-installation optimization"
- "Create detailed plan for fire-sprinkler-installation execution"
