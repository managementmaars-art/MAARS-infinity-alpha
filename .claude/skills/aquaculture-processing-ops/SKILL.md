---
name: aquaculture-processing-ops
description: Manage aquaculture processing operations including harvest handling, filleting, grading, blast freezing, and export documentation.
---

## Overview
Manage aquaculture processing operations including harvest handling, filleting, grading, blast freezing, and export documentation.

## Core Framework
- Analyze requirements and constraints specific to aquaculture-processing-ops
...
## Key Prompts
- "Initiate aquaculture-processing-ops workflow for [context]"
- "Analyze current state of aquaculture-processing-ops and identify gaps"
- "Generate recommendations for aquaculture-processing-ops optimization"
- "Create detailed plan for aquaculture-processing-ops execution"
