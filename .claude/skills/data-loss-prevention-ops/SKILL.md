---
name: data-loss-prevention-ops
description: Operate data loss prevention programs including policy configuration, endpoint and email controls, alert investigation, and exception management.
---

## Overview
Operate data loss prevention programs including policy configuration, endpoint and email controls, alert investigation, and exception management.

## Core Framework
- Analyze requirements and constraints specific to data-loss-prevention-ops
...
## Key Prompts
- "Initiate data-loss-prevention-ops workflow for [context]"
- "Analyze current state of data-loss-prevention-ops and identify gaps"
- "Generate recommendations for data-loss-prevention-ops optimization"
- "Create detailed plan for data-loss-prevention-ops execution"
