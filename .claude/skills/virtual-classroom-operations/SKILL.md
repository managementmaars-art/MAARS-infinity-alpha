---
name: virtual-classroom-operations
description: Operate virtual classroom environments including live session facilitation, breakout coordination, and synchronous learning support.
---

## Overview
Operate virtual classroom environments including live session facilitation, breakout coordination, and synchronous learning support.

## Core Framework
- Analyze requirements and constraints specific to virtual-classroom-operations
...
## Key Prompts
- "Initiate virtual-classroom-operations workflow for [context]"
- "Analyze current state of virtual-classroom-operations and identify gaps"
- "Generate recommendations for virtual-classroom-operations optimization"
- "Create detailed plan for virtual-classroom-operations execution"
