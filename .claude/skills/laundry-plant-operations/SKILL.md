---
name: laundry-plant-operations
description: Operate industrial laundry plant operations including tunnel washer management, dryer optimization, repair shop, and production scheduling.
---

## Overview
Operate industrial laundry plant operations including tunnel washer management, dryer optimization, repair shop, and production scheduling.

## Core Framework
- Analyze requirements and constraints specific to laundry-plant-operations
...
## Key Prompts
- "Initiate laundry-plant-operations workflow for [context]"
- "Analyze current state of laundry-plant-operations and identify gaps"
- "Generate recommendations for laundry-plant-operations optimization"
- "Create detailed plan for laundry-plant-operations execution"
