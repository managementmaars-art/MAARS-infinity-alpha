---
name: turnbuckle-tensioning-ops
description: Apply turnbuckles for rigging tension adjustment including load capacity selection, thread engagement verification, and locking safety requirements.
---

## Overview
Apply turnbuckles for rigging tension adjustment including load capacity selection, thread engagement verification, and locking safety requirements.

## Core Framework
- Analyze requirements and constraints specific to turnbuckle-tensioning-ops
...
## Key Prompts
- "Initiate turnbuckle-tensioning-ops workflow for [context]"
- "Analyze current state of turnbuckle-tensioning-ops and identify gaps"
- "Generate recommendations for turnbuckle-tensioning-ops optimization"
- "Create detailed plan for turnbuckle-tensioning-ops execution"
