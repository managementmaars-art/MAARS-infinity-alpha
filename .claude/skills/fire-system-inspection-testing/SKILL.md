---
name: fire-system-inspection-testing
description: Execute fire system inspection and testing programs including annual ITM schedules, deficiency tracking, and certification documentation.
---

## Overview
Execute fire system inspection and testing programs including annual ITM schedules, deficiency tracking, and certification documentation.

## Core Framework
- Analyze requirements and constraints specific to fire-system-inspection-testing
...
## Key Prompts
- "Initiate fire-system-inspection-testing workflow for [context]"
- "Analyze current state of fire-system-inspection-testing and identify gaps"
- "Generate recommendations for fire-system-inspection-testing optimization"
- "Create detailed plan for fire-system-inspection-testing execution"
