---
name: refinery-blending-operations
description: Manage refinery product blending including gasoline recipe management, cetane improvement blending, and aviation fuel certification workflows.
---

## Overview
Manage refinery product blending including gasoline recipe management, cetane improvement blending, and aviation fuel certification workflows.

## Core Framework
- Analyze requirements and constraints specific to refinery-blending-operations
...
## Key Prompts
- "Initiate refinery-blending-operations workflow for [context]"
- "Analyze current state of refinery-blending-operations and identify gaps"
- "Generate recommendations for refinery-blending-operations optimization"
- "Create detailed plan for refinery-blending-operations execution"
