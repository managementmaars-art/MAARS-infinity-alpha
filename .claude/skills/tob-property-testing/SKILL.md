...
description: Trail of Bits: property-based testing — Hypothesis, fuzzing, invariant testing for security
---

# Tob Property Testing — MAARS Security Reference

## Overview
Trail of Bits: property-based testing — Hypothesis, fuzzing, invariant testing for security
