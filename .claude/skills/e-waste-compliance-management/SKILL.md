---
name: e-waste-compliance-management
description: Manage e-waste regulatory compliance including state EPR programs, RIOS and R2 certification, export restrictions, and compliance documentation.
---

## Overview
Manage e-waste regulatory compliance including state EPR programs, RIOS and R2 certification, export restrictions, and compliance documentation.

## Core Framework
- Analyze requirements and constraints specific to e-waste-compliance-management
...
## Key Prompts
- "Initiate e-waste-compliance-management workflow for [context]"
- "Analyze current state of e-waste-compliance-management and identify gaps"
- "Generate recommendations for e-waste-compliance-management optimization"
- "Create detailed plan for e-waste-compliance-management execution"
