---
name: carburizing-nitriding-ops
description: Operate case hardening services including gas carburizing, nitriding, and ferritic nitrocarburizing with case depth verification programs.
---

## Overview
Operate case hardening services including gas carburizing, nitriding, and ferritic nitrocarburizing with case depth verification programs.

## Core Framework
- Analyze requirements and constraints specific to carburizing-nitriding-ops
...
## Key Prompts
- "Initiate carburizing-nitriding-ops workflow for [context]"
- "Analyze current state of carburizing-nitriding-ops and identify gaps"
- "Generate recommendations for carburizing-nitriding-ops optimization"
- "Create detailed plan for carburizing-nitriding-ops execution"
