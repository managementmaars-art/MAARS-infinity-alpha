---
name: mab-manufacturing-operations
description: Operate monoclonal antibody manufacturing including perfusion bioreactor management, Protein A chromatography operations, and in-process control execution.
---

## Overview
Operate monoclonal antibody manufacturing including perfusion bioreactor management, Protein A chromatography operations, and in-process control execution.

## Core Framework
- Analyze requirements and constraints specific to mab-manufacturing-operations
...
## Key Prompts
- "Initiate mab-manufacturing-operations workflow for [context]"
- "Analyze current state of mab-manufacturing-operations and identify gaps"
- "Generate recommendations for mab-manufacturing-operations optimization"
- "Create detailed plan for mab-manufacturing-operations execution"
