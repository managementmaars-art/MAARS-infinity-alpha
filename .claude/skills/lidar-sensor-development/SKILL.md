---
name: lidar-sensor-development
description: Develop LiDAR sensor solutions including mechanical spinning, solid-state, and FMCW architectures for automotive and industrial applications.
---

## Overview
Develop LiDAR sensor solutions including mechanical spinning, solid-state, and FMCW architectures for automotive and industrial applications.

## Core Framework
- Analyze requirements and constraints specific to lidar-sensor-development
...
## Key Prompts
- "Initiate lidar-sensor-development workflow for [context]"
- "Analyze current state of lidar-sensor-development and identify gaps"
- "Generate recommendations for lidar-sensor-development optimization"
- "Create detailed plan for lidar-sensor-development execution"
