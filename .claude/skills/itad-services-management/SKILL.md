---
name: itad-services-management
description: Manage IT asset disposition services including data destruction, asset valuation, remarketing, recycling, and certificate of destruction issuance.
---

## Overview
Manage IT asset disposition services including data destruction, asset valuation, remarketing, recycling, and certificate of destruction issuance.

## Core Framework
- Analyze requirements and constraints specific to itad-services-management
...
## Key Prompts
- "Initiate itad-services-management workflow for [context]"
- "Analyze current state of itad-services-management and identify gaps"
- "Generate recommendations for itad-services-management optimization"
- "Create detailed plan for itad-services-management execution"
