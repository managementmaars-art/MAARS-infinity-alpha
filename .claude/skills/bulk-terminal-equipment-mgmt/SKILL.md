---
name: bulk-terminal-equipment-mgmt
description: Maintain bulk terminal equipment including ship unloaders, stackers, reclaimers, and conveyor belts with predictive maintenance programs.
---

## Overview
Maintain bulk terminal equipment including ship unloaders, stackers, reclaimers, and conveyor belts with predictive maintenance programs.

## Core Framework
- Analyze requirements and constraints specific to bulk-terminal-equipment-mgmt
...
## Key Prompts
- "Initiate bulk-terminal-equipment-mgmt workflow for [context]"
- "Analyze current state of bulk-terminal-equipment-mgmt and identify gaps"
- "Generate recommendations for bulk-terminal-equipment-mgmt optimization"
- "Create detailed plan for bulk-terminal-equipment-mgmt execution"
