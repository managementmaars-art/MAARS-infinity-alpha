---
name: aromatics-complex-operations
description: Manage aromatics complex operations including catalytic reforming, xylene isomerization, paraxylene crystallization, and benzene extraction.
---

## Overview
Manage aromatics complex operations including catalytic reforming, xylene isomerization, paraxylene crystallization, and benzene extraction.

## Core Framework
- Analyze requirements and constraints specific to aromatics-complex-operations
...
## Key Prompts
- "Initiate aromatics-complex-operations workflow for [context]"
- "Analyze current state of aromatics-complex-operations and identify gaps"
- "Generate recommendations for aromatics-complex-operations optimization"
- "Create detailed plan for aromatics-complex-operations execution"
