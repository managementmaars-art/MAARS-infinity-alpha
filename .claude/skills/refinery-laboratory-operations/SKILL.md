---
name: refinery-laboratory-operations
description: Operate refinery quality control laboratories including crude assay program, product specification testing, and in-process quality monitoring.
---

## Overview
Operate refinery quality control laboratories including crude assay program, product specification testing, and in-process quality monitoring.

## Core Framework
- Analyze requirements and constraints specific to refinery-laboratory-operations
...
## Key Prompts
- "Initiate refinery-laboratory-operations workflow for [context]"
- "Analyze current state of refinery-laboratory-operations and identify gaps"
- "Generate recommendations for refinery-laboratory-operations optimization"
- "Create detailed plan for refinery-laboratory-operations execution"
