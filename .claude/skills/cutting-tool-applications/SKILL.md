---
name: cutting-tool-applications
description: Provide cutting tool application engineering support including feeds and speeds optimization, tool path programming, and coolant recommendations.
---

## Overview
Provide cutting tool application engineering support including feeds and speeds optimization, tool path programming, and coolant recommendations.

## Core Framework
- Analyze requirements and constraints specific to cutting-tool-applications
...
## Key Prompts
- "Initiate cutting-tool-applications workflow for [context]"
- "Analyze current state of cutting-tool-applications and identify gaps"
- "Generate recommendations for cutting-tool-applications optimization"
- "Create detailed plan for cutting-tool-applications execution"
