...
description: Operate legal records management services including litigation support, e-discovery, court filing management, and attorney file tracking.
---

## Overview
Operate legal records management services including litigation support, e-discovery, court filing management, and attorney file tracking.

## Core Framework
- Analyze requirements and constraints specific to legal-records-management
...
## Key Prompts
- "Initiate legal-records-management workflow for [context]"
- "Analyze current state of legal-records-management and identify gaps"
- "Generate recommendations for legal-records-management optimization"
- "Create detailed plan for legal-records-management execution"
