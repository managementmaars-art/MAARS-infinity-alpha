---
name: power-transmission-reliability
description: Implement reliability programs for power transmission components including MTBF tracking, failure mode libraries, and upgrade initiatives.
---

## Overview
Implement reliability programs for power transmission components including MTBF tracking, failure mode libraries, and upgrade initiatives.

## Core Framework
- Analyze requirements and constraints specific to power-transmission-reliability
...
## Key Prompts
- "Initiate power-transmission-reliability workflow for [context]"
- "Analyze current state of power-transmission-reliability and identify gaps"
- "Generate recommendations for power-transmission-reliability optimization"
- "Create detailed plan for power-transmission-reliability execution"
