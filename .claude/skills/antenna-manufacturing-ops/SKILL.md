---
name: antenna-manufacturing-ops
description: Manufacture antenna products including element fabrication, impedance matching, VSWR testing, and pattern measurement for wireless applications.
---

## Overview
Manufacture antenna products including element fabrication, impedance matching, VSWR testing, and pattern measurement for wireless applications.

## Core Framework
- Analyze requirements and constraints specific to antenna-manufacturing-ops
...
## Key Prompts
- "Initiate antenna-manufacturing-ops workflow for [context]"
- "Analyze current state of antenna-manufacturing-ops and identify gaps"
- "Generate recommendations for antenna-manufacturing-ops optimization"
- "Create detailed plan for antenna-manufacturing-ops execution"
