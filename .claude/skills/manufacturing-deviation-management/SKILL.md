---
name: manufacturing-deviation-management
description: Investigate and resolve manufacturing deviations using root cause analysis, CAPA development, and effectiveness checks.
---

## Overview
Investigate and resolve manufacturing deviations using root cause analysis, CAPA development, and effectiveness checks.

## Core Framework
- Analyze requirements and constraints specific to manufacturing-deviation-management
...
## Key Prompts
- "Initiate manufacturing-deviation-management workflow for [context]"
- "Analyze current state of manufacturing-deviation-management and identify gaps"
- "Generate recommendations for manufacturing-deviation-management optimization"
- "Create detailed plan for manufacturing-deviation-management execution"
