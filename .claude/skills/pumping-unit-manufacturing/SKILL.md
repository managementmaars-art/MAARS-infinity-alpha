---
name: pumping-unit-manufacturing
description: Manage rod pumping unit manufacturing including gear reducer assembly, structural fabrication, dynamic balance, and API 11E compliance.
---

## Overview
Manage rod pumping unit manufacturing including gear reducer assembly, structural fabrication, dynamic balance, and API 11E compliance.

## Core Framework
- Analyze requirements and constraints specific to pumping-unit-manufacturing
...
## Key Prompts
- "Initiate pumping-unit-manufacturing workflow for [context]"
- "Analyze current state of pumping-unit-manufacturing and identify gaps"
- "Generate recommendations for pumping-unit-manufacturing optimization"
- "Create detailed plan for pumping-unit-manufacturing execution"
