---
name: rotary-dryer-manufacturing
description: Design and manufacture rotary drum dryers including shell design, flight configuration, inlet temperature management, particle residence time modeling, and moisture control.
---

## Overview
Design and manufacture rotary drum dryers including shell design, flight configuration, inlet temperature management, particle residence time modeling, and moisture control.

## Core Framework
- Analyze requirements and constraints specific to rotary-dryer-manufacturing
...
## Key Prompts
- "Initiate rotary-dryer-manufacturing workflow for [context]"
- "Analyze current state of rotary-dryer-manufacturing and identify gaps"
- "Generate recommendations for rotary-dryer-manufacturing optimization"
- "Create detailed plan for rotary-dryer-manufacturing execution"
