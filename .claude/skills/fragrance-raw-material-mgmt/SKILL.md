---
name: fragrance-raw-material-mgmt
description: Manage fragrance raw material supply including naturals sourcing, aroma chemical procurement, and IFRA compliance verification.
---

## Overview
Manage fragrance raw material supply including naturals sourcing, aroma chemical procurement, and IFRA compliance verification.

## Core Framework
- Analyze requirements and constraints specific to fragrance-raw-material-mgmt
...
## Key Prompts
- "Initiate fragrance-raw-material-mgmt workflow for [context]"
- "Analyze current state of fragrance-raw-material-mgmt and identify gaps"
- "Generate recommendations for fragrance-raw-material-mgmt optimization"
- "Create detailed plan for fragrance-raw-material-mgmt execution"
