---
name: chemical-plant-turnaround
description: Plan and execute chemical plant turnarounds including scope development, contractor management, critical path scheduling, and startup readiness.
---

## Overview
Plan and execute chemical plant turnarounds including scope development, contractor management, critical path scheduling, and startup readiness.

## Core Framework
- Analyze requirements and constraints specific to chemical-plant-turnaround
...
## Key Prompts
- "Initiate chemical-plant-turnaround workflow for [context]"
- "Analyze current state of chemical-plant-turnaround and identify gaps"
- "Generate recommendations for chemical-plant-turnaround optimization"
- "Create detailed plan for chemical-plant-turnaround execution"
