---
name: reservoir-management-ops
description: Implement reservoir management programs including production surveillance, pressure transient analysis, water injection management, and EOR programs.
---

## Overview
Implement reservoir management programs including production surveillance, pressure transient analysis, water injection management, and EOR programs.

## Core Framework
- Analyze requirements and constraints specific to reservoir-management-ops
...
## Key Prompts
- "Initiate reservoir-management-ops workflow for [context]"
- "Analyze current state of reservoir-management-ops and identify gaps"
- "Generate recommendations for reservoir-management-ops optimization"
- "Create detailed plan for reservoir-management-ops execution"
