---
name: venue-operations-management
description: Manage sports venue operations including event-day logistics, concessions, security, ADA compliance, and fan experience.
---

## Overview
Manage sports venue operations including event-day logistics, concessions, security, ADA compliance, and fan experience.

## Core Framework
- Analyze requirements and constraints specific to venue-operations-management
...
## Key Prompts
- "Initiate venue-operations-management workflow for [context]"
- "Analyze current state of venue-operations-management and identify gaps"
- "Generate recommendations for venue-operations-management optimization"
- "Create detailed plan for venue-operations-management execution"
