---
name: paint-formulation-development
description: Develop paint and coating formulations including binder selection, pigment grinding, additive optimization, and performance testing.
---

## Overview
Develop paint and coating formulations including binder selection, pigment grinding, additive optimization, and performance testing.

## Core Framework
- Analyze requirements and constraints specific to paint-formulation-development
...
## Key Prompts
- "Initiate paint-formulation-development workflow for [context]"
- "Analyze current state of paint-formulation-development and identify gaps"
- "Generate recommendations for paint-formulation-development optimization"
- "Create detailed plan for paint-formulation-development execution"
