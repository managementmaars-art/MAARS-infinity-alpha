---
name: stamping-material-procurement
description: Manage stamping material procurement including coil specification, service center qualification, incoming yield strength tracking, and scrap reconciliation.
---

## Overview
Manage stamping material procurement including coil specification, service center qualification, incoming yield strength tracking, and scrap reconciliation.

## Core Framework
- Analyze requirements and constraints specific to stamping-material-procurement
...
## Key Prompts
- "Initiate stamping-material-procurement workflow for [context]"
- "Analyze current state of stamping-material-procurement and identify gaps"
- "Generate recommendations for stamping-material-procurement optimization"
- "Create detailed plan for stamping-material-procurement execution"
