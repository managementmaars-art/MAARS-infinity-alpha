...
description: Manage industrial cooling system programs including process chillers, cooling towers, and data center cooling solutions.
---

## Overview
Manage industrial cooling system programs including process chillers, cooling towers, and data center cooling solutions.

## Core Framework
- Analyze requirements and constraints specific to industrial-cooling-systems
...
## Key Prompts
- "Initiate industrial-cooling-systems workflow for [context]"
- "Analyze current state of industrial-cooling-systems and identify gaps"
- "Generate recommendations for industrial-cooling-systems optimization"
- "Create detailed plan for industrial-cooling-systems execution"
