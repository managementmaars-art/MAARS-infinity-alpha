...
description: Provide fire protection engineering support including hydraulic calculations, hazard classification, and NFPA code compliance review.
---

## Overview
Provide fire protection engineering support including hydraulic calculations, hazard classification, and NFPA code compliance review.

## Core Framework
- Analyze requirements and constraints specific to fire-protection-engineering
...
## Key Prompts
- "Initiate fire-protection-engineering workflow for [context]"
- "Analyze current state of fire-protection-engineering and identify gaps"
- "Generate recommendations for fire-protection-engineering optimization"
- "Create detailed plan for fire-protection-engineering execution"
