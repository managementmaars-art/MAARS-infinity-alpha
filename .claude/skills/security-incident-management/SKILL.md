...
description: Manage security incident response programs including on-site response protocols, stakeholder notification, investigation coordination, and after-action reporting.
---

## Overview
Manage security incident response programs including on-site response protocols, stakeholder notification, investigation coordination, and after-action reporting.

## Core Framework
- Analyze requirements and constraints specific to security-incident-management
...
## Key Prompts
- "Initiate security-incident-management workflow for [context]"
- "Analyze current state of security-incident-management and identify gaps"
- "Generate recommendations for security-incident-management optimization"
- "Create detailed plan for security-incident-management execution"
