...
description: Manage commercial vessel operations including voyage planning, port scheduling, crew management, and flag state compliance.
---

## Overview
Manage commercial vessel operations including voyage planning, port scheduling, crew management, and flag state compliance.

## Core Framework
- Analyze requirements and constraints specific to vessel-operations-management
...
## Key Prompts
- "Initiate vessel-operations-management workflow for [context]"
- "Analyze current state of vessel-operations-management and identify gaps"
- "Generate recommendations for vessel-operations-management optimization"
- "Create detailed plan for vessel-operations-management execution"
