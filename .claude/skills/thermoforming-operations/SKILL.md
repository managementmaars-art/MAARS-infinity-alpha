---
name: thermoforming-operations
description: Operate thermoforming lines including sheet forming, trim tooling, stacking automation, and packaging line integration.
---

## Overview
Operate thermoforming lines including sheet forming, trim tooling, stacking automation, and packaging line integration.

## Core Framework
- Analyze requirements and constraints specific to thermoforming-operations
...
## Key Prompts
- "Initiate thermoforming-operations workflow for [context]"
- "Analyze current state of thermoforming-operations and identify gaps"
- "Generate recommendations for thermoforming-operations optimization"
- "Create detailed plan for thermoforming-operations execution"
