---
name: automotive-recall-management
description: Coordinate safety recall campaigns including NHTSA/regulatory notifications, remedy part production, and dealer repair completion.
---

## Overview
Coordinate safety recall campaigns including NHTSA/regulatory notifications, remedy part production, and dealer repair completion.

## Core Framework
- Analyze requirements and constraints specific to automotive-recall-management
...
## Key Prompts
- "Initiate automotive-recall-management workflow for [context]"
- "Analyze current state of automotive-recall-management and identify gaps"
- "Generate recommendations for automotive-recall-management optimization"
- "Create detailed plan for automotive-recall-management execution"
