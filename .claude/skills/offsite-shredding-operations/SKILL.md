---
name: offsite-shredding-operations
description: Manage off-site shredding plant operations including console pickup routing, inbound volume management, shred process throughput, and bale output.
---

## Overview
Manage off-site shredding plant operations including console pickup routing, inbound volume management, shred process throughput, and bale output.

## Core Framework
- Analyze requirements and constraints specific to offsite-shredding-operations
...
## Key Prompts
- "Initiate offsite-shredding-operations workflow for [context]"
- "Analyze current state of offsite-shredding-operations and identify gaps"
- "Generate recommendations for offsite-shredding-operations optimization"
- "Create detailed plan for offsite-shredding-operations execution"
