---
name: laser-tracker-manufacturing
description: Produce laser tracker measurement systems including interferometer assembly, retroreflector target manufacturing, and workspace accuracy certification.
---

## Overview
Produce laser tracker measurement systems including interferometer assembly, retroreflector target manufacturing, and workspace accuracy certification.

## Core Framework
- Analyze requirements and constraints specific to laser-tracker-manufacturing
...
## Key Prompts
- "Initiate laser-tracker-manufacturing workflow for [context]"
- "Analyze current state of laser-tracker-manufacturing and identify gaps"
- "Generate recommendations for laser-tracker-manufacturing optimization"
- "Create detailed plan for laser-tracker-manufacturing execution"
