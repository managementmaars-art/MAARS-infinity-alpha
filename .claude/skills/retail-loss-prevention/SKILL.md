...
description: Manage retail loss prevention programs including shrinkage audits, exception reporting, CCTV oversight, and employee awareness training.
---

## Overview
Manage retail loss prevention programs including shrinkage audits, exception reporting, CCTV oversight, and employee awareness training.

## Core Framework
- Analyze requirements and constraints specific to retail-loss-prevention
...
## Key Prompts
- "Initiate retail-loss-prevention workflow for [context]"
- "Analyze current state of retail-loss-prevention and identify gaps"
- "Generate recommendations for retail-loss-prevention optimization"
- "Create detailed plan for retail-loss-prevention execution"
