---
name: glazing-contractor-ops
description: Manage glazing contractor operations including storefront installation, curtain wall erection, glass replacement scheduling, and field crew coordination.
---

## Overview
Manage glazing contractor operations including storefront installation, curtain wall erection, glass replacement scheduling, and field crew coordination.

## Core Framework
- Analyze requirements and constraints specific to glazing-contractor-ops
...
## Key Prompts
- "Initiate glazing-contractor-ops workflow for [context]"
- "Analyze current state of glazing-contractor-ops and identify gaps"
- "Generate recommendations for glazing-contractor-ops optimization"
- "Create detailed plan for glazing-contractor-ops execution"
