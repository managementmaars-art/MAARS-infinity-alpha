---
name: gold-refinery-operations
description: Operate gold refinery operations including Wohlwill or Miller process management, assay laboratory, melt and pour operations, and chain of custody.
---

## Overview
Operate gold refinery operations including Wohlwill or Miller process management, assay laboratory, melt and pour operations, and chain of custody.

## Core Framework
- Analyze requirements and constraints specific to gold-refinery-operations
...
## Key Prompts
- "Initiate gold-refinery-operations workflow for [context]"
- "Analyze current state of gold-refinery-operations and identify gaps"
- "Generate recommendations for gold-refinery-operations optimization"
- "Create detailed plan for gold-refinery-operations execution"
