---
name: sports-prosthetics-programs
description: Develop sports and activity-specific prosthetic programs including running prostheses, swimming adaptations, and adaptive sports partnerships.
---

## Overview
Develop sports and activity-specific prosthetic programs including running prostheses, swimming adaptations, and adaptive sports partnerships.

## Core Framework
- Analyze requirements and constraints specific to sports-prosthetics-programs
...
## Key Prompts
- "Initiate sports-prosthetics-programs workflow for [context]"
- "Analyze current state of sports-prosthetics-programs and identify gaps"
- "Generate recommendations for sports-prosthetics-programs optimization"
- "Create detailed plan for sports-prosthetics-programs execution"
