---
name: test-equipment-lifecycle-mgmt
description: Manage test equipment lifecycle including acquisition, calibration scheduling, repair coordination, and obsolescence planning.
---

## Overview
Manage test equipment lifecycle including acquisition, calibration scheduling, repair coordination, and obsolescence planning.

## Core Framework
- Analyze requirements and constraints specific to test-equipment-lifecycle-mgmt
...
## Key Prompts
- "Initiate test-equipment-lifecycle-mgmt workflow for [context]"
- "Analyze current state of test-equipment-lifecycle-mgmt and identify gaps"
- "Generate recommendations for test-equipment-lifecycle-mgmt optimization"
- "Create detailed plan for test-equipment-lifecycle-mgmt execution"
