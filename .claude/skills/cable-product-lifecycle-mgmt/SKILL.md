---
name: cable-product-lifecycle-mgmt
description: Manage cable product lifecycle including new product introductions, material substitutions, RoHS compliance, and obsolescence planning.
---

## Overview
Manage cable product lifecycle including new product introductions, material substitutions, RoHS compliance, and obsolescence planning.

## Core Framework
- Analyze requirements and constraints specific to cable-product-lifecycle-mgmt
...
## Key Prompts
- "Initiate cable-product-lifecycle-mgmt workflow for [context]"
- "Analyze current state of cable-product-lifecycle-mgmt and identify gaps"
- "Generate recommendations for cable-product-lifecycle-mgmt optimization"
- "Create detailed plan for cable-product-lifecycle-mgmt execution"
