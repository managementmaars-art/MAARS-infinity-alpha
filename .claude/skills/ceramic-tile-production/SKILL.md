---
name: ceramic-tile-production
description: Manage ceramic tile manufacturing including body formulation, pressing, glazing, kiln firing, and surface quality inspection.
---

## Overview
Manage ceramic tile manufacturing including body formulation, pressing, glazing, kiln firing, and surface quality inspection.

## Core Framework
- Analyze requirements and constraints specific to ceramic-tile-production
...
## Key Prompts
- "Initiate ceramic-tile-production workflow for [context]"
- "Analyze current state of ceramic-tile-production and identify gaps"
- "Generate recommendations for ceramic-tile-production optimization"
- "Create detailed plan for ceramic-tile-production execution"
