---
name: motor-starter-manufacturing
description: Produce soft starters and direct-on-line starters including thyristor stack assembly, bypass contactor integration, and locked rotor protection testing.
---

## Overview
Produce soft starters and direct-on-line starters including thyristor stack assembly, bypass contactor integration, and locked rotor protection testing.

## Core Framework
- Analyze requirements and constraints specific to motor-starter-manufacturing
...
## Key Prompts
- "Initiate motor-starter-manufacturing workflow for [context]"
- "Analyze current state of motor-starter-manufacturing and identify gaps"
- "Generate recommendations for motor-starter-manufacturing optimization"
- "Create detailed plan for motor-starter-manufacturing execution"
