---
name: fiber-characterization-testing
description: Characterize optical fibers including attenuation, bandwidth, cut-off wavelength, mode field diameter, and chromatic dispersion measurement.
---

## Overview
Characterize optical fibers including attenuation, bandwidth, cut-off wavelength, mode field diameter, and chromatic dispersion measurement.

## Core Framework
- Analyze requirements and constraints specific to fiber-characterization-testing
...
## Key Prompts
- "Initiate fiber-characterization-testing workflow for [context]"
- "Analyze current state of fiber-characterization-testing and identify gaps"
- "Generate recommendations for fiber-characterization-testing optimization"
- "Create detailed plan for fiber-characterization-testing execution"
