---
name: scaffold-rental-operations
description: Operate scaffold rental programs including rental agreement management, delivery logistics, on-hire inspection, and off-hire reconciliation.
---

## Overview
Operate scaffold rental programs including rental agreement management, delivery logistics, on-hire inspection, and off-hire reconciliation.

## Core Framework
- Analyze requirements and constraints specific to scaffold-rental-operations
...
## Key Prompts
- "Initiate scaffold-rental-operations workflow for [context]"
- "Analyze current state of scaffold-rental-operations and identify gaps"
- "Generate recommendations for scaffold-rental-operations optimization"
- "Create detailed plan for scaffold-rental-operations execution"
