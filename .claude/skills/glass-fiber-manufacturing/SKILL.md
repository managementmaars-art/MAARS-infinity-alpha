---
name: glass-fiber-manufacturing
description: Manage glass fiber production including bushing operations, sizing application, forming package management, and tensile testing.
---

## Overview
Manage glass fiber production including bushing operations, sizing application, forming package management, and tensile testing.

## Core Framework
- Analyze requirements and constraints specific to glass-fiber-manufacturing
...
## Key Prompts
- "Initiate glass-fiber-manufacturing workflow for [context]"
- "Analyze current state of glass-fiber-manufacturing and identify gaps"
- "Generate recommendations for glass-fiber-manufacturing optimization"
- "Create detailed plan for glass-fiber-manufacturing execution"
