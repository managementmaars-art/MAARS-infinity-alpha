---
name: waste-contract-management
description: Manage waste service contracts including municipal solid waste franchise agreements, industrial service contracts, and disposal manifesting.
---

## Overview
Manage waste service contracts including municipal solid waste franchise agreements, industrial service contracts, and disposal manifesting.

## Core Framework
- Analyze requirements and constraints specific to waste-contract-management
...
## Key Prompts
- "Initiate waste-contract-management workflow for [context]"
- "Analyze current state of waste-contract-management and identify gaps"
- "Generate recommendations for waste-contract-management optimization"
- "Create detailed plan for waste-contract-management execution"
