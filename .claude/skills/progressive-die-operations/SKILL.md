---
name: progressive-die-operations
description: Operate progressive die stamping including strip layout management, die maintenance, lubricant selection, and in-die sensor monitoring.
---

## Overview
Operate progressive die stamping including strip layout management, die maintenance, lubricant selection, and in-die sensor monitoring.

## Core Framework
- Analyze requirements and constraints specific to progressive-die-operations
...
## Key Prompts
- "Initiate progressive-die-operations workflow for [context]"
- "Analyze current state of progressive-die-operations and identify gaps"
- "Generate recommendations for progressive-die-operations optimization"
- "Create detailed plan for progressive-die-operations execution"
