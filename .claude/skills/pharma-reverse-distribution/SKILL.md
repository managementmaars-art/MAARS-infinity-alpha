---
name: pharma-reverse-distribution
description: Manage pharmaceutical reverse distribution programs including expired drug return services, DEA reverse distributor compliance, and credit reconciliation.
---

## Overview
Manage pharmaceutical reverse distribution programs including expired drug return services, DEA reverse distributor compliance, and credit reconciliation.

## Core Framework
- Analyze requirements and constraints specific to pharma-reverse-distribution
...
## Key Prompts
- "Initiate pharma-reverse-distribution workflow for [context]"
- "Analyze current state of pharma-reverse-distribution and identify gaps"
- "Generate recommendations for pharma-reverse-distribution optimization"
- "Create detailed plan for pharma-reverse-distribution execution"
