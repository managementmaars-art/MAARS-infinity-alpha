---
name: pressure-transmitter-manufacturing
description: Manufacture pressure transmitters including piezoresistive cell fabrication, 4-20mA signal conditioning assembly, and HART protocol certification.
---

## Overview
Manufacture pressure transmitters including piezoresistive cell fabrication, 4-20mA signal conditioning assembly, and HART protocol certification.

## Core Framework
- Analyze requirements and constraints specific to pressure-transmitter-manufacturing
...
## Key Prompts
- "Initiate pressure-transmitter-manufacturing workflow for [context]"
- "Analyze current state of pressure-transmitter-manufacturing and identify gaps"
- "Generate recommendations for pressure-transmitter-manufacturing optimization"
- "Create detailed plan for pressure-transmitter-manufacturing execution"
