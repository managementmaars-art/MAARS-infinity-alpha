...
description: Design fire alarm systems including detector placement, notification appliance circuits, panel programming, and NFPA 72 code compliance.
---

## Overview
Design fire alarm systems including detector placement, notification appliance circuits, panel programming, and NFPA 72 code compliance.

## Core Framework
- Analyze requirements and constraints specific to fire-alarm-system-design
...
## Key Prompts
- "Initiate fire-alarm-system-design workflow for [context]"
- "Analyze current state of fire-alarm-system-design and identify gaps"
- "Generate recommendations for fire-alarm-system-design optimization"
- "Create detailed plan for fire-alarm-system-design execution"
