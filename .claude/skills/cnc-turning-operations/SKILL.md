---
name: cnc-turning-operations
description: Manage CNC turning operations including turning program creation, insert grade selection, bar feeder operations, and dimensional quality control.
---

## Overview
Manage CNC turning operations including turning program creation, insert grade selection, bar feeder operations, and dimensional quality control.

## Core Framework
- Analyze requirements and constraints specific to cnc-turning-operations
...
## Key Prompts
- "Initiate cnc-turning-operations workflow for [context]"
- "Analyze current state of cnc-turning-operations and identify gaps"
- "Generate recommendations for cnc-turning-operations optimization"
- "Create detailed plan for cnc-turning-operations execution"
