...
description: Manage underground mining equipment including load-haul-dump machines, bolter rigs, and continuous miner manufacturing operations.
---

## Overview
Manage underground mining equipment including load-haul-dump machines, bolter rigs, and continuous miner manufacturing operations.

## Core Framework
- Analyze requirements and constraints specific to underground-mining-equipment
...
## Key Prompts
- "Initiate underground-mining-equipment workflow for [context]"
- "Analyze current state of underground-mining-equipment and identify gaps"
- "Generate recommendations for underground-mining-equipment optimization"
- "Create detailed plan for underground-mining-equipment execution"
