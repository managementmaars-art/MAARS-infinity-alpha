---
name: water-distribution-system-ops
description: Operate water distribution systems including pressure zone management, storage tank turnover, booster pump scheduling, and main break response.
---

## Overview
Operate water distribution systems including pressure zone management, storage tank turnover, booster pump scheduling, and main break response.

## Core Framework
- Analyze requirements and constraints specific to water-distribution-system-ops
...
## Key Prompts
- "Initiate water-distribution-system-ops workflow for [context]"
- "Analyze current state of water-distribution-system-ops and identify gaps"
- "Generate recommendations for water-distribution-system-ops optimization"
- "Create detailed plan for water-distribution-system-ops execution"
