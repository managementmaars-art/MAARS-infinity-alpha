---
name: filter-media-selection
description: Select filter media including woven, nonwoven, and membrane types for particle retention rating, flow resistance, and chemical compatibility.
---

## Overview
Select filter media including woven, nonwoven, and membrane types for particle retention rating, flow resistance, and chemical compatibility.

## Core Framework
- Analyze requirements and constraints specific to filter-media-selection
...
## Key Prompts
- "Initiate filter-media-selection workflow for [context]"
- "Analyze current state of filter-media-selection and identify gaps"
- "Generate recommendations for filter-media-selection optimization"
- "Create detailed plan for filter-media-selection execution"
