---
name: security-clearance-management
description: Administer facility and personnel security clearance programs including e-QIP submissions, visit authorizations, and FSO duties.
---

## Overview
Administer facility and personnel security clearance programs including e-QIP submissions, visit authorizations, and FSO duties.

## Core Framework
- Analyze requirements and constraints specific to security-clearance-management
...
## Key Prompts
- "Initiate security-clearance-management workflow for [context]"
- "Analyze current state of security-clearance-management and identify gaps"
- "Generate recommendations for security-clearance-management optimization"
- "Create detailed plan for security-clearance-management execution"
