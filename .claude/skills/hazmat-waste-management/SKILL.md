---
name: hazmat-waste-management
description: Manage hazardous waste programs including waste characterization, manifest tracking, transporter qualification, and TSDF compliance.
---

## Overview
Manage hazardous waste programs including waste characterization, manifest tracking, transporter qualification, and TSDF compliance.

## Core Framework
- Analyze requirements and constraints specific to hazmat-waste-management
...
## Key Prompts
- "Initiate hazmat-waste-management workflow for [context]"
- "Analyze current state of hazmat-waste-management and identify gaps"
- "Generate recommendations for hazmat-waste-management optimization"
- "Create detailed plan for hazmat-waste-management execution"
