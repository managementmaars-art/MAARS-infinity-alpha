---
name: bearing-lubrication-management
description: Manage bearing lubrication programs including grease specification, re-lubrication intervals, oil mist systems, and contamination control.
---

## Overview
Manage bearing lubrication programs including grease specification, re-lubrication intervals, oil mist systems, and contamination control.

## Core Framework
- Analyze requirements and constraints specific to bearing-lubrication-management
...
## Key Prompts
- "Initiate bearing-lubrication-management workflow for [context]"
- "Analyze current state of bearing-lubrication-management and identify gaps"
- "Generate recommendations for bearing-lubrication-management optimization"
- "Create detailed plan for bearing-lubrication-management execution"
