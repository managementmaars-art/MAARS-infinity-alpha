---
name: cnc-lathe-manufacturing
description: Produce CNC turning centers including headstock assembly, turret fabrication, tailstock integration, and cylindricity accuracy qualification.
---

## Overview
Produce CNC turning centers including headstock assembly, turret fabrication, tailstock integration, and cylindricity accuracy qualification.

## Core Framework
- Analyze requirements and constraints specific to cnc-lathe-manufacturing
...
## Key Prompts
- "Initiate cnc-lathe-manufacturing workflow for [context]"
- "Analyze current state of cnc-lathe-manufacturing and identify gaps"
- "Generate recommendations for cnc-lathe-manufacturing optimization"
- "Create detailed plan for cnc-lathe-manufacturing execution"
