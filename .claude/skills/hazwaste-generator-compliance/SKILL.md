---
name: hazwaste-generator-compliance
description: Maintain hazardous waste generator compliance programs including accumulation time limits, container labeling, and biennial report preparation.
---

## Overview
Maintain hazardous waste generator compliance programs including accumulation time limits, container labeling, and biennial report preparation.

## Core Framework
- Analyze requirements and constraints specific to hazwaste-generator-compliance
...
## Key Prompts
- "Initiate hazwaste-generator-compliance workflow for [context]"
- "Analyze current state of hazwaste-generator-compliance and identify gaps"
- "Generate recommendations for hazwaste-generator-compliance optimization"
- "Create detailed plan for hazwaste-generator-compliance execution"
