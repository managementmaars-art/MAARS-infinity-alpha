---
name: liquidation-merchandise-sourcing
description: Manage liquidation merchandise sourcing including retailer overstock purchasing, pallet bidding, manifest management, and resale channel optimization.
---

## Overview
Manage liquidation merchandise sourcing including retailer overstock purchasing, pallet bidding, manifest management, and resale channel optimization.

## Core Framework
- Analyze requirements and constraints specific to liquidation-merchandise-sourcing
...
## Key Prompts
- "Initiate liquidation-merchandise-sourcing workflow for [context]"
- "Analyze current state of liquidation-merchandise-sourcing and identify gaps"
- "Generate recommendations for liquidation-merchandise-sourcing optimization"
- "Create detailed plan for liquidation-merchandise-sourcing execution"
