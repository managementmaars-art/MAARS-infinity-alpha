---
name: marine-protective-coatings
description: Manage marine and protective coatings programs including surface preparation specifications, application guidelines, and warranty inspection.
---

## Overview
Manage marine and protective coatings programs including surface preparation specifications, application guidelines, and warranty inspection.

## Core Framework
- Analyze requirements and constraints specific to marine-protective-coatings
...
## Key Prompts
- "Initiate marine-protective-coatings workflow for [context]"
- "Analyze current state of marine-protective-coatings and identify gaps"
- "Generate recommendations for marine-protective-coatings optimization"
- "Create detailed plan for marine-protective-coatings execution"
