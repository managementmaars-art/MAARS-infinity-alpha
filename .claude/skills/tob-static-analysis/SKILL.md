...
description: Trail of Bits: static analysis — configure and run SAST tools, triage findings, reduce false positives
---

# Tob Static Analysis — MAARS Security Reference

## Overview
Trail of Bits: static analysis — configure and run SAST tools, triage findings, reduce false positives
