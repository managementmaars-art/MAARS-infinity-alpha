---
name: masonry-contractor-operations
description: Operate masonry contractor businesses including brick, block, stone, and tuck-pointing for residential and commercial construction projects.
---

## Overview
Operate masonry contractor businesses including brick, block, stone, and tuck-pointing for residential and commercial construction projects.

## Core Framework
- Analyze requirements and constraints specific to masonry-contractor-operations
...
## Key Prompts
- "Initiate masonry-contractor-operations workflow for [context]"
- "Analyze current state of masonry-contractor-operations and identify gaps"
- "Generate recommendations for masonry-contractor-operations optimization"
- "Create detailed plan for masonry-contractor-operations execution"
