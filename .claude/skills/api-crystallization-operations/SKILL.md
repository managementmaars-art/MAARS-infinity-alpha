---
name: api-crystallization-operations
description: Manage API crystallization processes including polymorph control, particle size distribution targeting, and mother liquor recycling programs.
---

## Overview
Manage API crystallization processes including polymorph control, particle size distribution targeting, and mother liquor recycling programs.

## Core Framework
- Analyze requirements and constraints specific to api-crystallization-operations
...
## Key Prompts
- "Initiate api-crystallization-operations workflow for [context]"
- "Analyze current state of api-crystallization-operations and identify gaps"
- "Generate recommendations for api-crystallization-operations optimization"
- "Create detailed plan for api-crystallization-operations execution"
