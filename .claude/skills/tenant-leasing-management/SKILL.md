---
name: tenant-leasing-management
description: Manage commercial tenant leasing from LOI through lease execution including deal tracking and commission management.
---

## Overview
Manage commercial tenant leasing from LOI through lease execution including deal tracking and commission management.

## Core Framework
- Analyze requirements and constraints specific to tenant-leasing-management
...
## Key Prompts
- "Initiate tenant-leasing-management workflow for [context]"
- "Analyze current state of tenant-leasing-management and identify gaps"
- "Generate recommendations for tenant-leasing-management optimization"
- "Create detailed plan for tenant-leasing-management execution"
