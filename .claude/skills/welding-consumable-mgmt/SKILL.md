---
name: welding-consumable-mgmt
description: Manage welding consumable programs including electrode classification, lot traceability, storage requirements, and low-hydrogen protocols.
---

## Overview
Manage welding consumable programs including electrode classification, lot traceability, storage requirements, and low-hydrogen protocols.

## Core Framework
- Analyze requirements and constraints specific to welding-consumable-mgmt
...
## Key Prompts
- "Initiate welding-consumable-mgmt workflow for [context]"
- "Analyze current state of welding-consumable-mgmt and identify gaps"
- "Generate recommendations for welding-consumable-mgmt optimization"
- "Create detailed plan for welding-consumable-mgmt execution"
