---
name: decorative-concrete-services
description: Manage decorative concrete services including stamped concrete, exposed aggregate, staining, polishing, overlays, and epoxy floor systems.
---

## Overview
Manage decorative concrete services including stamped concrete, exposed aggregate, staining, polishing, overlays, and epoxy floor systems.

## Core Framework
- Analyze requirements and constraints specific to decorative-concrete-services
...
## Key Prompts
- "Initiate decorative-concrete-services workflow for [context]"
- "Analyze current state of decorative-concrete-services and identify gaps"
- "Generate recommendations for decorative-concrete-services optimization"
- "Create detailed plan for decorative-concrete-services execution"
