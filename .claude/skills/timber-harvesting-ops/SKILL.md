---
name: timber-harvesting-ops
description: Plan and execute timber harvesting operations including logging system selection, contractor management, and environmental compliance.
---

## Overview
Plan and execute timber harvesting operations including logging system selection, contractor management, and environmental compliance.

## Core Framework
- Analyze requirements and constraints specific to timber-harvesting-ops
...
## Key Prompts
- "Initiate timber-harvesting-ops workflow for [context]"
- "Analyze current state of timber-harvesting-ops and identify gaps"
- "Generate recommendations for timber-harvesting-ops optimization"
- "Create detailed plan for timber-harvesting-ops execution"
