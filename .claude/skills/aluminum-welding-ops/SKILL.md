---
name: aluminum-welding-ops
description: Operate aluminum welding fabrication services including oxide removal, filler selection, distortion control, and post-weld heat treat programs.
---

## Overview
Operate aluminum welding fabrication services including oxide removal, filler selection, distortion control, and post-weld heat treat programs.

## Core Framework
- Analyze requirements and constraints specific to aluminum-welding-ops
...
## Key Prompts
- "Initiate aluminum-welding-ops workflow for [context]"
- "Analyze current state of aluminum-welding-ops and identify gaps"
- "Generate recommendations for aluminum-welding-ops optimization"
- "Create detailed plan for aluminum-welding-ops execution"
