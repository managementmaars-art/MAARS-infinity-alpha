---
name: silviculture-program-mgmt
description: Manage silvicultural treatment programs including thinning, fertilization, herbicide applications, and treatment effectiveness monitoring.
---

## Overview
Manage silvicultural treatment programs including thinning, fertilization, herbicide applications, and treatment effectiveness monitoring.

## Core Framework
- Analyze requirements and constraints specific to silviculture-program-mgmt
...
## Key Prompts
- "Initiate silviculture-program-mgmt workflow for [context]"
- "Analyze current state of silviculture-program-mgmt and identify gaps"
- "Generate recommendations for silviculture-program-mgmt optimization"
- "Create detailed plan for silviculture-program-mgmt execution"
