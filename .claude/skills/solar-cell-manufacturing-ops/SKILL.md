---
name: solar-cell-manufacturing-ops
description: Manage solar cell manufacturing including silicon wafer processing, diffusion furnace operations, anti-reflective coating, and screen printing.
---

## Overview
Manage solar cell manufacturing including silicon wafer processing, diffusion furnace operations, anti-reflective coating, and screen printing.

## Core Framework
- Analyze requirements and constraints specific to solar-cell-manufacturing-ops
...
## Key Prompts
- "Initiate solar-cell-manufacturing-ops workflow for [context]"
- "Analyze current state of solar-cell-manufacturing-ops and identify gaps"
- "Generate recommendations for solar-cell-manufacturing-ops optimization"
- "Create detailed plan for solar-cell-manufacturing-ops execution"
