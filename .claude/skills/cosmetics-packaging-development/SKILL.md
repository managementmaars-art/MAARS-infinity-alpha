---
name: cosmetics-packaging-development
description: Develop cosmetics packaging including primary component design, decoration specifications, and tooling qualification with brand alignment.
---

## Overview
Develop cosmetics packaging including primary component design, decoration specifications, and tooling qualification with brand alignment.

## Core Framework
- Analyze requirements and constraints specific to cosmetics-packaging-development
...
## Key Prompts
- "Initiate cosmetics-packaging-development workflow for [context]"
- "Analyze current state of cosmetics-packaging-development and identify gaps"
- "Generate recommendations for cosmetics-packaging-development optimization"
- "Create detailed plan for cosmetics-packaging-development execution"
