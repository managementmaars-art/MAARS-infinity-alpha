...
description: Engineer thermal management in semiconductor packages including thermal resistance modeling, heat slug design, and junction temperature verification.
---

## Overview
Engineer thermal management in semiconductor packages including thermal resistance modeling, heat slug design, and junction temperature verification.

## Core Framework
- Analyze requirements and constraints specific to thermal-management-packaging
...
## Key Prompts
- "Initiate thermal-management-packaging workflow for [context]"
- "Analyze current state of thermal-management-packaging and identify gaps"
- "Generate recommendations for thermal-management-packaging optimization"
- "Create detailed plan for thermal-management-packaging execution"
