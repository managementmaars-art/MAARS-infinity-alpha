---
name: grain-storage-management
description: Manage grain storage operations including bin aeration management, moisture monitoring, temperature cabling, and fumigation programs.
---

## Overview
Manage grain storage operations including bin aeration management, moisture monitoring, temperature cabling, and fumigation programs.

## Core Framework
- Analyze requirements and constraints specific to grain-storage-management
...
## Key Prompts
- "Initiate grain-storage-management workflow for [context]"
- "Analyze current state of grain-storage-management and identify gaps"
- "Generate recommendations for grain-storage-management optimization"
- "Create detailed plan for grain-storage-management execution"
