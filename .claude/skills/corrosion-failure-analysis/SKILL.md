---
name: corrosion-failure-analysis
description: Conduct corrosion failure analysis including specimen examination, root cause determination, metallurgical testing, and corrective action recommendations.
---

## Overview
Conduct corrosion failure analysis including specimen examination, root cause determination, metallurgical testing, and corrective action recommendations.

## Core Framework
- Analyze requirements and constraints specific to corrosion-failure-analysis
...
## Key Prompts
- "Initiate corrosion-failure-analysis workflow for [context]"
- "Analyze current state of corrosion-failure-analysis and identify gaps"
- "Generate recommendations for corrosion-failure-analysis optimization"
- "Create detailed plan for corrosion-failure-analysis execution"
