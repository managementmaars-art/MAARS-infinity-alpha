---
name: architectural-glass-sales
description: Manage architectural glass sales and project coordination including specification work, fabricator networks, and glazing contractor support.
---

## Overview
Manage architectural glass sales and project coordination including specification work, fabricator networks, and glazing contractor support.

## Core Framework
- Analyze requirements and constraints specific to architectural-glass-sales
...
## Key Prompts
- "Initiate architectural-glass-sales workflow for [context]"
- "Analyze current state of architectural-glass-sales and identify gaps"
- "Generate recommendations for architectural-glass-sales optimization"
- "Create detailed plan for architectural-glass-sales execution"
