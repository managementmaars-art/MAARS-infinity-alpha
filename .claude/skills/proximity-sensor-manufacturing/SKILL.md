---
name: proximity-sensor-manufacturing
description: Manufacture inductive and capacitive proximity sensors including oscillator coil winding, ASIC integration, and switching distance certification.
---

## Overview
Manufacture inductive and capacitive proximity sensors including oscillator coil winding, ASIC integration, and switching distance certification.

## Core Framework
- Analyze requirements and constraints specific to proximity-sensor-manufacturing
...
## Key Prompts
- "Initiate proximity-sensor-manufacturing workflow for [context]"
- "Analyze current state of proximity-sensor-manufacturing and identify gaps"
- "Generate recommendations for proximity-sensor-manufacturing optimization"
- "Create detailed plan for proximity-sensor-manufacturing execution"
