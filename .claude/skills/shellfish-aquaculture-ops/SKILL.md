---
name: shellfish-aquaculture-ops
description: Operate shellfish aquaculture facilities including oyster, clam, and mussel production, gear maintenance, harvest compliance, and lease management.
---

## Overview
Operate shellfish aquaculture facilities including oyster, clam, and mussel production, gear maintenance, harvest compliance, and lease management.

## Core Framework
- Analyze requirements and constraints specific to shellfish-aquaculture-ops
...
## Key Prompts
- "Initiate shellfish-aquaculture-ops workflow for [context]"
- "Analyze current state of shellfish-aquaculture-ops and identify gaps"
- "Generate recommendations for shellfish-aquaculture-ops optimization"
- "Create detailed plan for shellfish-aquaculture-ops execution"
