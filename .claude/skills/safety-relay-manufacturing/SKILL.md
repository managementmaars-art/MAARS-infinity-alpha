---
name: safety-relay-manufacturing
description: Manufacture safety relays and safety PLCs including dual-channel input assembly, self-monitoring circuit fabrication, and SIL certification testing.
---

## Overview
Manufacture safety relays and safety PLCs including dual-channel input assembly, self-monitoring circuit fabrication, and SIL certification testing.

## Core Framework
- Analyze requirements and constraints specific to safety-relay-manufacturing
...
## Key Prompts
- "Initiate safety-relay-manufacturing workflow for [context]"
- "Analyze current state of safety-relay-manufacturing and identify gaps"
- "Generate recommendations for safety-relay-manufacturing optimization"
- "Create detailed plan for safety-relay-manufacturing execution"
