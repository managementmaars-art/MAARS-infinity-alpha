---
name: permanent-magnet-motor-ops
description: Manage permanent magnet motor programs including rare earth magnet sourcing, rotor assembly, demagnetization testing, and EV traction applications.
---

## Overview
Manage permanent magnet motor programs including rare earth magnet sourcing, rotor assembly, demagnetization testing, and EV traction applications.

## Core Framework
- Analyze requirements and constraints specific to permanent-magnet-motor-ops
...
## Key Prompts
- "Initiate permanent-magnet-motor-ops workflow for [context]"
- "Analyze current state of permanent-magnet-motor-ops and identify gaps"
- "Generate recommendations for permanent-magnet-motor-ops optimization"
- "Create detailed plan for permanent-magnet-motor-ops execution"
