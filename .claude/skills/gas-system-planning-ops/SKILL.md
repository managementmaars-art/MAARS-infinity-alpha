---
name: gas-system-planning-ops
description: Manage gas distribution system planning including load forecasting, pipe replacement prioritization, and capacity expansion analysis.
---

## Overview
Manage gas distribution system planning including load forecasting, pipe replacement prioritization, and capacity expansion analysis.

## Core Framework
- Analyze requirements and constraints specific to gas-system-planning-ops
...
## Key Prompts
- "Initiate gas-system-planning-ops workflow for [context]"
- "Analyze current state of gas-system-planning-ops and identify gaps"
- "Generate recommendations for gas-system-planning-ops optimization"
- "Create detailed plan for gas-system-planning-ops execution"
