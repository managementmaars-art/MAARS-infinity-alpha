---
name: horticulture-lighting-systems
description: Develop horticultural lighting systems including grow light design, PPFD optimization, spectrum selection, and controlled environment applications.
---

## Overview
Develop horticultural lighting systems including grow light design, PPFD optimization, spectrum selection, and controlled environment applications.

## Core Framework
- Analyze requirements and constraints specific to horticulture-lighting-systems
...
## Key Prompts
- "Initiate horticulture-lighting-systems workflow for [context]"
- "Analyze current state of horticulture-lighting-systems and identify gaps"
- "Generate recommendations for horticulture-lighting-systems optimization"
- "Create detailed plan for horticulture-lighting-systems execution"
