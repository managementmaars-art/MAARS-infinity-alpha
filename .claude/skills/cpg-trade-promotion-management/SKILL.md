---
name: cpg-trade-promotion-management
description: Plan and execute CPG trade promotion programs including retailer negotiations, fund management, and post-event ROI analysis.
---

## Overview
Plan and execute CPG trade promotion programs including retailer negotiations, fund management, and post-event ROI analysis.

## Core Framework
- Analyze requirements and constraints specific to cpg-trade-promotion-management
...
## Key Prompts
- "Initiate cpg-trade-promotion-management workflow for [context]"
- "Analyze current state of cpg-trade-promotion-management and identify gaps"
- "Generate recommendations for cpg-trade-promotion-management optimization"
- "Create detailed plan for cpg-trade-promotion-management execution"
