---
name: aluminum-scrap-management
description: Manage aluminum scrap operations including scrap classification, alloy sorting, delacquering, and secondary melting quality assurance.
---

## Overview
Manage aluminum scrap operations including scrap classification, alloy sorting, delacquering, and secondary melting quality assurance.

## Core Framework
- Analyze requirements and constraints specific to aluminum-scrap-management
...
## Key Prompts
- "Initiate aluminum-scrap-management workflow for [context]"
- "Analyze current state of aluminum-scrap-management and identify gaps"
- "Generate recommendations for aluminum-scrap-management optimization"
- "Create detailed plan for aluminum-scrap-management execution"
