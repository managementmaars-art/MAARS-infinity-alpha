---
name: electric-motor-manufacturing
description: Manage electric motor manufacturing operations including stator winding, rotor assembly, bearing housing, and performance testing.
---

## Overview
Manage electric motor manufacturing operations including stator winding, rotor assembly, bearing housing, and performance testing.

## Core Framework
- Analyze requirements and constraints specific to electric-motor-manufacturing
...
## Key Prompts
- "Initiate electric-motor-manufacturing workflow for [context]"
- "Analyze current state of electric-motor-manufacturing and identify gaps"
- "Generate recommendations for electric-motor-manufacturing optimization"
- "Create detailed plan for electric-motor-manufacturing execution"
