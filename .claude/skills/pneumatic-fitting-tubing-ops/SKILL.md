---
name: pneumatic-fitting-tubing-ops
description: Specify pneumatic fittings and tubing including push-to-connect, compression, and barb types with pressure rating and material selection.
---

## Overview
Specify pneumatic fittings and tubing including push-to-connect, compression, and barb types with pressure rating and material selection.

## Core Framework
- Analyze requirements and constraints specific to pneumatic-fitting-tubing-ops
...
## Key Prompts
- "Initiate pneumatic-fitting-tubing-ops workflow for [context]"
- "Analyze current state of pneumatic-fitting-tubing-ops and identify gaps"
- "Generate recommendations for pneumatic-fitting-tubing-ops optimization"
- "Create detailed plan for pneumatic-fitting-tubing-ops execution"
