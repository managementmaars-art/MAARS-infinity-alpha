---
name: laser-application-development
description: Develop laser application solutions including materials processing, medical, and scientific applications with parameter optimization.
---

## Overview
Develop laser application solutions including materials processing, medical, and scientific applications with parameter optimization.

## Core Framework
- Analyze requirements and constraints specific to laser-application-development
...
## Key Prompts
- "Initiate laser-application-development workflow for [context]"
- "Analyze current state of laser-application-development and identify gaps"
- "Generate recommendations for laser-application-development optimization"
- "Create detailed plan for laser-application-development execution"
