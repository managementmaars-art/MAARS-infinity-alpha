---
name: water-loss-control-programs
description: Develop water loss control programs including pressure management, leak detection surveys, meter accuracy testing, and NRW reduction targets.
---

## Overview
Develop water loss control programs including pressure management, leak detection surveys, meter accuracy testing, and NRW reduction targets.

## Core Framework
- Analyze requirements and constraints specific to water-loss-control-programs
...
## Key Prompts
- "Initiate water-loss-control-programs workflow for [context]"
- "Analyze current state of water-loss-control-programs and identify gaps"
- "Generate recommendations for water-loss-control-programs optimization"
- "Create detailed plan for water-loss-control-programs execution"
