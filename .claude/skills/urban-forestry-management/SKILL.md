---
name: urban-forestry-management
description: Manage urban forestry programs including tree inventory, canopy assessment, pruning cycles, removal prioritization, and planting programs.
---

## Overview
Manage urban forestry programs including tree inventory, canopy assessment, pruning cycles, removal prioritization, and planting programs.

## Core Framework
- Analyze requirements and constraints specific to urban-forestry-management
...
## Key Prompts
- "Initiate urban-forestry-management workflow for [context]"
- "Analyze current state of urban-forestry-management and identify gaps"
- "Generate recommendations for urban-forestry-management optimization"
- "Create detailed plan for urban-forestry-management execution"
