---
name: cpg-co-manufacturing
description: Manage co-manufacturing partnerships including capacity planning, quality oversight, contract compliance, and performance scorecards.
---

## Overview
Manage co-manufacturing partnerships including capacity planning, quality oversight, contract compliance, and performance scorecards.

## Core Framework
- Analyze requirements and constraints specific to cpg-co-manufacturing
...
## Key Prompts
- "Initiate cpg-co-manufacturing workflow for [context]"
- "Analyze current state of cpg-co-manufacturing and identify gaps"
- "Generate recommendations for cpg-co-manufacturing optimization"
- "Create detailed plan for cpg-co-manufacturing execution"
