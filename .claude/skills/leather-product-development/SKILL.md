---
name: leather-product-development
description: Develop leather product lines including design collaboration, prototype sampling, material testing, and production handover.
---

## Overview
Develop leather product lines including design collaboration, prototype sampling, material testing, and production handover.

## Core Framework
- Analyze requirements and constraints specific to leather-product-development
...
## Key Prompts
- "Initiate leather-product-development workflow for [context]"
- "Analyze current state of leather-product-development and identify gaps"
- "Generate recommendations for leather-product-development optimization"
- "Create detailed plan for leather-product-development execution"
