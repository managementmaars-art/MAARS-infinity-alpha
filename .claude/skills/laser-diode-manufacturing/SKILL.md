---
name: laser-diode-manufacturing
description: Manufacture laser diodes including MOCVD epitaxy, cleaving, facet coating, chip bonding, and reliability burn-in screening for telecom and industrial use.
---

## Overview
Manufacture laser diodes including MOCVD epitaxy, cleaving, facet coating, chip bonding, and reliability burn-in screening for telecom and industrial use.

## Core Framework
- Analyze requirements and constraints specific to laser-diode-manufacturing
...
## Key Prompts
- "Initiate laser-diode-manufacturing workflow for [context]"
- "Analyze current state of laser-diode-manufacturing and identify gaps"
- "Generate recommendations for laser-diode-manufacturing optimization"
- "Create detailed plan for laser-diode-manufacturing execution"
