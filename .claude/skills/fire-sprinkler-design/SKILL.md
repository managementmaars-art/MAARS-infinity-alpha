---
name: fire-sprinkler-design
description: Design automatic fire sprinkler systems including hydraulic calculations, pipe schedule design, NFPA 13 compliance, and authority having jurisdiction coordination.
---

## Overview
Design automatic fire sprinkler systems including hydraulic calculations, pipe schedule design, NFPA 13 compliance, and authority having jurisdiction coordination.

## Core Framework
- Analyze requirements and constraints specific to fire-sprinkler-design
...
## Key Prompts
- "Initiate fire-sprinkler-design workflow for [context]"
- "Analyze current state of fire-sprinkler-design and identify gaps"
- "Generate recommendations for fire-sprinkler-design optimization"
- "Create detailed plan for fire-sprinkler-design execution"
