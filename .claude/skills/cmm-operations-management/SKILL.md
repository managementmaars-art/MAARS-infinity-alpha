---
name: cmm-operations-management
description: Manage coordinate measuring machine operations including fixture design, program development, GR&R studies, and measurement system validation.
---

## Overview
Manage coordinate measuring machine operations including fixture design, program development, GR&R studies, and measurement system validation.

## Core Framework
- Analyze requirements and constraints specific to cmm-operations-management
...
## Key Prompts
- "Initiate cmm-operations-management workflow for [context]"
- "Analyze current state of cmm-operations-management and identify gaps"
- "Generate recommendations for cmm-operations-management optimization"
- "Create detailed plan for cmm-operations-management execution"
