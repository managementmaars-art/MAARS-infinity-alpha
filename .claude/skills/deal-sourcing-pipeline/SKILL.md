...
description: Build and manage deal sourcing pipelines including intermediary relationships, proprietary outreach, and CRM funnel management.
---

## Overview
Build and manage deal sourcing pipelines including intermediary relationships, proprietary outreach, and CRM funnel management.

## Core Framework
- Analyze requirements and constraints specific to deal-sourcing-pipeline
...
## Key Prompts
- "Initiate deal-sourcing-pipeline workflow for [context]"
- "Analyze current state of deal-sourcing-pipeline and identify gaps"
- "Generate recommendations for deal-sourcing-pipeline optimization"
- "Create detailed plan for deal-sourcing-pipeline execution"
