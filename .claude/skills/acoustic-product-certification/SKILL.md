---
name: acoustic-product-certification
description: Navigate acoustic product certifications including UL fire ratings, STC and IIC ratings, and environmental product declarations for sustainable construction.
---

## Overview
Navigate acoustic product certifications including UL fire ratings, STC and IIC ratings, and environmental product declarations for sustainable construction.

## Core Framework
- Analyze requirements and constraints specific to acoustic-product-certification
...
## Key Prompts
- "Initiate acoustic-product-certification workflow for [context]"
- "Analyze current state of acoustic-product-certification and identify gaps"
- "Generate recommendations for acoustic-product-certification optimization"
- "Create detailed plan for acoustic-product-certification execution"
