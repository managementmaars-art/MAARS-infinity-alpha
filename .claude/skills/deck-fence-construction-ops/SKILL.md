---
name: deck-fence-construction-ops
description: Manage deck and fence construction operations including design consultation, material selection, permit management, installation, and post-installation maintenance.
---

## Overview
Manage deck and fence construction operations including design consultation, material selection, permit management, installation, and post-installation maintenance.

## Core Framework
- Analyze requirements and constraints specific to deck-fence-construction-ops
...
## Key Prompts
- "Initiate deck-fence-construction-ops workflow for [context]"
- "Analyze current state of deck-fence-construction-ops and identify gaps"
- "Generate recommendations for deck-fence-construction-ops optimization"
- "Create detailed plan for deck-fence-construction-ops execution"
