---
name: dental-practice-technology
description: Manage dental practice technology programs including practice management software integration, digital impression systems, and workflow consulting.
---

## Overview
Manage dental practice technology programs including practice management software integration, digital impression systems, and workflow consulting.

## Core Framework
- Analyze requirements and constraints specific to dental-practice-technology
...
## Key Prompts
- "Initiate dental-practice-technology workflow for [context]"
- "Analyze current state of dental-practice-technology and identify gaps"
- "Generate recommendations for dental-practice-technology optimization"
- "Create detailed plan for dental-practice-technology execution"
