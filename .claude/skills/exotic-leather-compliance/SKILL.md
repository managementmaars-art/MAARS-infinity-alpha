---
name: exotic-leather-compliance
description: Navigate exotic leather compliance programs including CITES permitting, import documentation, species verification, and customs coordination.
---

## Overview
Navigate exotic leather compliance programs including CITES permitting, import documentation, species verification, and customs coordination.

## Core Framework
- Analyze requirements and constraints specific to exotic-leather-compliance
...
## Key Prompts
- "Initiate exotic-leather-compliance workflow for [context]"
- "Analyze current state of exotic-leather-compliance and identify gaps"
- "Generate recommendations for exotic-leather-compliance optimization"
- "Create detailed plan for exotic-leather-compliance execution"
