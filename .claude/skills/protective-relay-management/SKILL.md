---
name: protective-relay-management
description: Manage protective relay programs including settings calculations, coordination studies, testing procedures, and event record analysis.
---

## Overview
Manage protective relay programs including settings calculations, coordination studies, testing procedures, and event record analysis.

## Core Framework
- Analyze requirements and constraints specific to protective-relay-management
...
## Key Prompts
- "Initiate protective-relay-management workflow for [context]"
- "Analyze current state of protective-relay-management and identify gaps"
- "Generate recommendations for protective-relay-management optimization"
- "Create detailed plan for protective-relay-management execution"
