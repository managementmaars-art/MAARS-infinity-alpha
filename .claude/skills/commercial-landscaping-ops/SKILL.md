---
name: commercial-landscaping-ops
description: Manage commercial landscaping operations including maintenance contracts, enhancement programs, irrigation management, and seasonal programs.
---

## Overview
Manage commercial landscaping operations including maintenance contracts, enhancement programs, irrigation management, and seasonal programs.

## Core Framework
- Analyze requirements and constraints specific to commercial-landscaping-ops
...
## Key Prompts
- "Initiate commercial-landscaping-ops workflow for [context]"
- "Analyze current state of commercial-landscaping-ops and identify gaps"
- "Generate recommendations for commercial-landscaping-ops optimization"
- "Create detailed plan for commercial-landscaping-ops execution"
