---
name: vacuum-coating-system-manufacturing
description: Manufacture vacuum deposition systems including PVD, CVD, and ALD reactor chamber fabrication and process kit assembly.
---

## Overview
Manufacture vacuum deposition systems including PVD, CVD, and ALD reactor chamber fabrication and process kit assembly.

## Core Framework
- Analyze requirements and constraints specific to vacuum-coating-system-manufacturing
...
## Key Prompts
- "Initiate vacuum-coating-system-manufacturing workflow for [context]"
- "Analyze current state of vacuum-coating-system-manufacturing and identify gaps"
- "Generate recommendations for vacuum-coating-system-manufacturing optimization"
- "Create detailed plan for vacuum-coating-system-manufacturing execution"
