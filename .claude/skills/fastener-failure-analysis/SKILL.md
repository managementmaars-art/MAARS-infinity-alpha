---
name: fastener-failure-analysis
description: Analyze fastener failures including hydrogen embrittlement, stress corrosion, fatigue fracture, and improper installation with corrective action.
---

## Overview
Analyze fastener failures including hydrogen embrittlement, stress corrosion, fatigue fracture, and improper installation with corrective action.

## Core Framework
- Analyze requirements and constraints specific to fastener-failure-analysis
...
## Key Prompts
- "Initiate fastener-failure-analysis workflow for [context]"
- "Analyze current state of fastener-failure-analysis and identify gaps"
- "Generate recommendations for fastener-failure-analysis optimization"
- "Create detailed plan for fastener-failure-analysis execution"
