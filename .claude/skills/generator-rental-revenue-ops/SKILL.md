---
name: generator-rental-revenue-ops
description: Optimize generator rental revenue including rate management, utilization analysis, fleet rebalancing, and peak demand surge pricing.
---

## Overview
Optimize generator rental revenue including rate management, utilization analysis, fleet rebalancing, and peak demand surge pricing.

## Core Framework
- Analyze requirements and constraints specific to generator-rental-revenue-ops
...
## Key Prompts
- "Initiate generator-rental-revenue-ops workflow for [context]"
- "Analyze current state of generator-rental-revenue-ops and identify gaps"
- "Generate recommendations for generator-rental-revenue-ops optimization"
- "Create detailed plan for generator-rental-revenue-ops execution"
