---
name: immersion-cooling-ops
description: Operate immersion cooling systems for high-density electronics including dielectric fluid management, maintenance procedures, and capacity scaling.
---

## Overview
Operate immersion cooling systems for high-density electronics including dielectric fluid management, maintenance procedures, and capacity scaling.

## Core Framework
- Analyze requirements and constraints specific to immersion-cooling-ops
...
## Key Prompts
- "Initiate immersion-cooling-ops workflow for [context]"
- "Analyze current state of immersion-cooling-ops and identify gaps"
- "Generate recommendations for immersion-cooling-ops optimization"
- "Create detailed plan for immersion-cooling-ops execution"
