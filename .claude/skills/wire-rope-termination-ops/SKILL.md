---
name: wire-rope-termination-ops
description: Fabricate wire rope terminations including swaged sockets, spelter sockets, wedge sockets, and mechanical splices with proof load testing.
---

## Overview
Fabricate wire rope terminations including swaged sockets, spelter sockets, wedge sockets, and mechanical splices with proof load testing.

## Core Framework
- Analyze requirements and constraints specific to wire-rope-termination-ops
...
## Key Prompts
- "Initiate wire-rope-termination-ops workflow for [context]"
- "Analyze current state of wire-rope-termination-ops and identify gaps"
- "Generate recommendations for wire-rope-termination-ops optimization"
- "Create detailed plan for wire-rope-termination-ops execution"
