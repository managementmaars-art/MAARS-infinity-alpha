---
name: substation-operations-mgmt
description: Manage substation operations including equipment inspection scheduling, relay testing coordination, transformer oil management, and switching programs.
---

## Overview
Manage substation operations including equipment inspection scheduling, relay testing coordination, transformer oil management, and switching programs.

## Core Framework
- Analyze requirements and constraints specific to substation-operations-mgmt
...
## Key Prompts
- "Initiate substation-operations-mgmt workflow for [context]"
- "Analyze current state of substation-operations-mgmt and identify gaps"
- "Generate recommendations for substation-operations-mgmt optimization"
- "Create detailed plan for substation-operations-mgmt execution"
