---
name: environmental-drilling-services
description: Provide environmental drilling services including soil boring programs, monitoring well installation, soil vapor extraction, and regulatory sampling.
---

## Overview
Provide environmental drilling services including soil boring programs, monitoring well installation, soil vapor extraction, and regulatory sampling.

## Core Framework
- Analyze requirements and constraints specific to environmental-drilling-services
...
## Key Prompts
- "Initiate environmental-drilling-services workflow for [context]"
- "Analyze current state of environmental-drilling-services and identify gaps"
- "Generate recommendations for environmental-drilling-services optimization"
- "Create detailed plan for environmental-drilling-services execution"
