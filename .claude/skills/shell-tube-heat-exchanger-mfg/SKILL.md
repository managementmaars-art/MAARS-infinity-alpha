---
name: shell-tube-heat-exchanger-mfg
description: Manage shell-and-tube heat exchanger manufacturing including TEMA standard compliance, tube bundle assembly, and hydrostatic testing.
---

## Overview
Manage shell-and-tube heat exchanger manufacturing including TEMA standard compliance, tube bundle assembly, and hydrostatic testing.

## Core Framework
- Analyze requirements and constraints specific to shell-tube-heat-exchanger-mfg
...
## Key Prompts
- "Initiate shell-tube-heat-exchanger-mfg workflow for [context]"
- "Analyze current state of shell-tube-heat-exchanger-mfg and identify gaps"
- "Generate recommendations for shell-tube-heat-exchanger-mfg optimization"
- "Create detailed plan for shell-tube-heat-exchanger-mfg execution"
