---
name: load-cell-manufacturing
description: Produce strain gauge load cells including beam element machining, full-bridge circuit bonding, and OIML accuracy class verification.
---

## Overview
Produce strain gauge load cells including beam element machining, full-bridge circuit bonding, and OIML accuracy class verification.

## Core Framework
- Analyze requirements and constraints specific to load-cell-manufacturing
...
## Key Prompts
- "Initiate load-cell-manufacturing workflow for [context]"
- "Analyze current state of load-cell-manufacturing and identify gaps"
- "Generate recommendations for load-cell-manufacturing optimization"
- "Create detailed plan for load-cell-manufacturing execution"
