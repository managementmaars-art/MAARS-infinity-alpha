---
name: paper-product-converting
description: Manage paper converting operations including sheeting, slitting, rewinding, folio cutting, and specialty product conversion.
---

## Overview
Manage paper converting operations including sheeting, slitting, rewinding, folio cutting, and specialty product conversion.

## Core Framework
- Analyze requirements and constraints specific to paper-product-converting
...
## Key Prompts
- "Initiate paper-product-converting workflow for [context]"
- "Analyze current state of paper-product-converting and identify gaps"
- "Generate recommendations for paper-product-converting optimization"
- "Create detailed plan for paper-product-converting execution"
