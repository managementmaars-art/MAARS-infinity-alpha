---
name: construction-procurement-ops
description: Manage construction procurement including subcontractor bidding, scope of work development, contract execution, and lien waiver collection.
---

## Overview
Manage construction procurement including subcontractor bidding, scope of work development, contract execution, and lien waiver collection.

## Core Framework
- Analyze requirements and constraints specific to construction-procurement-ops
...
## Key Prompts
- "Initiate construction-procurement-ops workflow for [context]"
- "Analyze current state of construction-procurement-ops and identify gaps"
- "Generate recommendations for construction-procurement-ops optimization"
- "Create detailed plan for construction-procurement-ops execution"
