---
name: lab-instrument-service-ops
description: Manage laboratory instrument service operations including field service, depot repair, preventive maintenance, and calibration programs.
---

## Overview
Manage laboratory instrument service operations including field service, depot repair, preventive maintenance, and calibration programs.

## Core Framework
- Analyze requirements and constraints specific to lab-instrument-service-ops
...
## Key Prompts
- "Initiate lab-instrument-service-ops workflow for [context]"
- "Analyze current state of lab-instrument-service-ops and identify gaps"
- "Generate recommendations for lab-instrument-service-ops optimization"
- "Create detailed plan for lab-instrument-service-ops execution"
