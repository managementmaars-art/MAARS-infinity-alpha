---
name: glass-hardware-distribution
description: Operate glass hardware distribution including door hardware, frameless fittings, hinges, patches, and shower door hardware sales.
---

## Overview
Operate glass hardware distribution including door hardware, frameless fittings, hinges, patches, and shower door hardware sales.

## Core Framework
- Analyze requirements and constraints specific to glass-hardware-distribution
...
## Key Prompts
- "Initiate glass-hardware-distribution workflow for [context]"
- "Analyze current state of glass-hardware-distribution and identify gaps"
- "Generate recommendations for glass-hardware-distribution optimization"
- "Create detailed plan for glass-hardware-distribution execution"
