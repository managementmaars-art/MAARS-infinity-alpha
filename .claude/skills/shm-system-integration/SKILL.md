---
name: shm-system-integration
description: Integrate SHM systems with asset management platforms including IoT connectivity, cloud data storage, and dashboard visualization for operators.
---

## Overview
Integrate SHM systems with asset management platforms including IoT connectivity, cloud data storage, and dashboard visualization for operators.

## Core Framework
- Analyze requirements and constraints specific to shm-system-integration
...
## Key Prompts
- "Initiate shm-system-integration workflow for [context]"
- "Analyze current state of shm-system-integration and identify gaps"
- "Generate recommendations for shm-system-integration optimization"
- "Create detailed plan for shm-system-integration execution"
