---
name: fire-pump-installation-service
description: Install and service fire pumps including driver and controller selection, performance testing, weekly churn test programs, and NFPA 20 compliance.
---

## Overview
Install and service fire pumps including driver and controller selection, performance testing, weekly churn test programs, and NFPA 20 compliance.

## Core Framework
- Analyze requirements and constraints specific to fire-pump-installation-service
...
## Key Prompts
- "Initiate fire-pump-installation-service workflow for [context]"
- "Analyze current state of fire-pump-installation-service and identify gaps"
- "Generate recommendations for fire-pump-installation-service optimization"
- "Create detailed plan for fire-pump-installation-service execution"
