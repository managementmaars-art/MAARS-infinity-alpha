---
name: machining-shop-scheduling
description: Schedule CNC machine shop production including job routing, machine load balancing, priority management, and on-time delivery performance.
---

## Overview
Schedule CNC machine shop production including job routing, machine load balancing, priority management, and on-time delivery performance.

## Core Framework
- Analyze requirements and constraints specific to machining-shop-scheduling
...
## Key Prompts
- "Initiate machining-shop-scheduling workflow for [context]"
- "Analyze current state of machining-shop-scheduling and identify gaps"
- "Generate recommendations for machining-shop-scheduling optimization"
- "Create detailed plan for machining-shop-scheduling execution"
