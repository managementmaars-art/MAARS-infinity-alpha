---
name: semiconductor-metrology-equipment-mfg
description: Produce semiconductor metrology instruments including ellipsometers, profilometers, and overlay measurement system manufacturing.
---

## Overview
Produce semiconductor metrology instruments including ellipsometers, profilometers, and overlay measurement system manufacturing.

## Core Framework
- Analyze requirements and constraints specific to semiconductor-metrology-equipment-mfg
...
## Key Prompts
- "Initiate semiconductor-metrology-equipment-mfg workflow for [context]"
- "Analyze current state of semiconductor-metrology-equipment-mfg and identify gaps"
- "Generate recommendations for semiconductor-metrology-equipment-mfg optimization"
- "Create detailed plan for semiconductor-metrology-equipment-mfg execution"
