---
name: hydrogen-storage-operations
description: Operate hydrogen storage facilities including compressed tank management, liquid hydrogen vessel operations, and metal hydride storage systems.
---

## Overview
Operate hydrogen storage facilities including compressed tank management, liquid hydrogen vessel operations, and metal hydride storage systems.

## Core Framework
- Analyze requirements and constraints specific to hydrogen-storage-operations
...
## Key Prompts
- "Initiate hydrogen-storage-operations workflow for [context]"
- "Analyze current state of hydrogen-storage-operations and identify gaps"
- "Generate recommendations for hydrogen-storage-operations optimization"
- "Create detailed plan for hydrogen-storage-operations execution"
