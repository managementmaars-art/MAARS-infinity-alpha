---
name: powder-coating-shop-ops
description: Operate powder coating shop operations including pretreatment, application, oven scheduling, color management, and quality inspection.
---

## Overview
Operate powder coating shop operations including pretreatment, application, oven scheduling, color management, and quality inspection.

## Core Framework
- Analyze requirements and constraints specific to powder-coating-shop-ops
...
## Key Prompts
- "Initiate powder-coating-shop-ops workflow for [context]"
- "Analyze current state of powder-coating-shop-ops and identify gaps"
- "Generate recommendations for powder-coating-shop-ops optimization"
- "Create detailed plan for powder-coating-shop-ops execution"
