...
description: Manage reverse logistics operations including returns intake, disposition routing, refurbishment workflows, and recovery value tracking.
---

## Overview
Manage reverse logistics operations including returns intake, disposition routing, refurbishment workflows, and recovery value tracking.

## Core Framework
- Analyze requirements and constraints specific to reverse-logistics-management
...
## Key Prompts
- "Initiate reverse-logistics-management workflow for [context]"
- "Analyze current state of reverse-logistics-management and identify gaps"
- "Generate recommendations for reverse-logistics-management optimization"
- "Create detailed plan for reverse-logistics-management execution"
