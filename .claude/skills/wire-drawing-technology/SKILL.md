---
name: wire-drawing-technology
description: Operate wire drawing production including die selection, lubricant management, annealing schedules, dimensional tolerance control, and surface quality programs.
---

## Overview
Operate wire drawing production including die selection, lubricant management, annealing schedules, dimensional tolerance control, and surface quality programs.

## Core Framework
- Analyze requirements and constraints specific to wire-drawing-technology
...
## Key Prompts
- "Initiate wire-drawing-technology workflow for [context]"
- "Analyze current state of wire-drawing-technology and identify gaps"
- "Generate recommendations for wire-drawing-technology optimization"
- "Create detailed plan for wire-drawing-technology execution"
