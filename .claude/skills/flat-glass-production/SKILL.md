---
name: flat-glass-production
description: Manage flat glass manufacturing operations including float line operations, cutting optimization, and quality inspection.
---

## Overview
Manage flat glass manufacturing operations including float line operations, cutting optimization, and quality inspection.

## Core Framework
- Analyze requirements and constraints specific to flat-glass-production
...
## Key Prompts
- "Initiate flat-glass-production workflow for [context]"
- "Analyze current state of flat-glass-production and identify gaps"
- "Generate recommendations for flat-glass-production optimization"
- "Create detailed plan for flat-glass-production execution"
