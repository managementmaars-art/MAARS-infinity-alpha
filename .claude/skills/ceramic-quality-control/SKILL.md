---
name: ceramic-quality-control
description: Execute ceramic quality control programs including physical testing, dimensional inspection, thermal analysis, and customer complaint resolution.
---

## Overview
Execute ceramic quality control programs including physical testing, dimensional inspection, thermal analysis, and customer complaint resolution.

## Core Framework
- Analyze requirements and constraints specific to ceramic-quality-control
...
## Key Prompts
- "Initiate ceramic-quality-control workflow for [context]"
- "Analyze current state of ceramic-quality-control and identify gaps"
- "Generate recommendations for ceramic-quality-control optimization"
- "Create detailed plan for ceramic-quality-control execution"
