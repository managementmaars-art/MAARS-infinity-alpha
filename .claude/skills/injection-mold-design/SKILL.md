...
description: Design injection molds including gate system design, cooling channel layout, ejector system, and draft angle specification for production quality.
---

## Overview
Design injection molds including gate system design, cooling channel layout, ejector system, and draft angle specification for production quality.

## Core Framework
- Analyze requirements and constraints specific to injection-mold-design
...
## Key Prompts
- "Initiate injection-mold-design workflow for [context]"
- "Analyze current state of injection-mold-design and identify gaps"
- "Generate recommendations for injection-mold-design optimization"
- "Create detailed plan for injection-mold-design execution"
