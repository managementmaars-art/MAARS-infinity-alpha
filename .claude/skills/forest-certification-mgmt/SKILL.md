---
name: forest-certification-mgmt
description: Manage forest sustainability certifications including FSC and SFI chain-of-custody, annual audit preparation, and claim management.
---

## Overview
Manage forest sustainability certifications including FSC and SFI chain-of-custody, annual audit preparation, and claim management.

## Core Framework
- Analyze requirements and constraints specific to forest-certification-mgmt
...
## Key Prompts
- "Initiate forest-certification-mgmt workflow for [context]"
- "Analyze current state of forest-certification-mgmt and identify gaps"
- "Generate recommendations for forest-certification-mgmt optimization"
- "Create detailed plan for forest-certification-mgmt execution"
