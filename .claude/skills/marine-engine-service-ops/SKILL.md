---
name: marine-engine-service-ops
description: Manage marine engine service operations including outboard and inboard engine repair, winterization, propeller service, and boat systems diagnostics.
---

## Overview
Manage marine engine service operations including outboard and inboard engine repair, winterization, propeller service, and boat systems diagnostics.

## Core Framework
- Analyze requirements and constraints specific to marine-engine-service-ops
...
## Key Prompts
- "Initiate marine-engine-service-ops workflow for [context]"
- "Analyze current state of marine-engine-service-ops and identify gaps"
- "Generate recommendations for marine-engine-service-ops optimization"
- "Create detailed plan for marine-engine-service-ops execution"
