---
name: residential-lawn-care-ops
description: Operate residential lawn care services including mowing routes, fertilization programs, weed control, aeration, overseeding, and customer communication.
---

## Overview
Operate residential lawn care services including mowing routes, fertilization programs, weed control, aeration, overseeding, and customer communication.

## Core Framework
- Analyze requirements and constraints specific to residential-lawn-care-ops
...
## Key Prompts
- "Initiate residential-lawn-care-ops workflow for [context]"
- "Analyze current state of residential-lawn-care-ops and identify gaps"
- "Generate recommendations for residential-lawn-care-ops optimization"
- "Create detailed plan for residential-lawn-care-ops execution"
