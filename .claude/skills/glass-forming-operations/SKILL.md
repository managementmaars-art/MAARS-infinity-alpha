---
name: glass-forming-operations
description: Manage glass forming operations including mold design, gob weight control, and annealing lehr management.
---

## Overview
Manage glass forming operations including mold design, gob weight control, and annealing lehr management.

## Core Framework
- Analyze requirements and constraints specific to glass-forming-operations
...
## Key Prompts
- "Initiate glass-forming-operations workflow for [context]"
- "Analyze current state of glass-forming-operations and identify gaps"
- "Generate recommendations for glass-forming-operations optimization"
- "Create detailed plan for glass-forming-operations execution"
