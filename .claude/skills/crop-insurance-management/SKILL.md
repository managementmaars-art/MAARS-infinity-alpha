---
name: crop-insurance-management
description: Manage crop insurance programs including policy selection, acreage reporting, loss adjustment preparation, and indemnity tracking.
---

## Overview
Manage crop insurance programs including policy selection, acreage reporting, loss adjustment preparation, and indemnity tracking.

## Core Framework
- Analyze requirements and constraints specific to crop-insurance-management
...
## Key Prompts
- "Initiate crop-insurance-management workflow for [context]"
- "Analyze current state of crop-insurance-management and identify gaps"
- "Generate recommendations for crop-insurance-management optimization"
- "Create detailed plan for crop-insurance-management execution"
