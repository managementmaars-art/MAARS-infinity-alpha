---
name: consumer-repair-refurb-ops
description: Operate consumer electronics repair and refurbishment centers including triage, component-level repair, cosmetic restoration, and graded resale.
---

## Overview
Operate consumer electronics repair and refurbishment centers including triage, component-level repair, cosmetic restoration, and graded resale.

## Core Framework
- Analyze requirements and constraints specific to consumer-repair-refurb-ops
...
## Key Prompts
- "Initiate consumer-repair-refurb-ops workflow for [context]"
- "Analyze current state of consumer-repair-refurb-ops and identify gaps"
- "Generate recommendations for consumer-repair-refurb-ops optimization"
- "Create detailed plan for consumer-repair-refurb-ops execution"
