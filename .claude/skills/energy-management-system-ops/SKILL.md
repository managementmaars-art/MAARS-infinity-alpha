---
name: energy-management-system-ops
description: Operate utility energy management systems including state estimator management, automatic generation control, and contingency analysis.
---

## Overview
Operate utility energy management systems including state estimator management, automatic generation control, and contingency analysis.

## Core Framework
- Analyze requirements and constraints specific to energy-management-system-ops
...
## Key Prompts
- "Initiate energy-management-system-ops workflow for [context]"
- "Analyze current state of energy-management-system-ops and identify gaps"
- "Generate recommendations for energy-management-system-ops optimization"
- "Create detailed plan for energy-management-system-ops execution"
