---
name: paintless-dent-removal-ops
description: Operate paintless dent removal services including hail damage assessment, repair technique training, fleet and dealership contracts, and insurance billing.
---

## Overview
Operate paintless dent removal services including hail damage assessment, repair technique training, fleet and dealership contracts, and insurance billing.

## Core Framework
- Analyze requirements and constraints specific to paintless-dent-removal-ops
...
## Key Prompts
- "Initiate paintless-dent-removal-ops workflow for [context]"
- "Analyze current state of paintless-dent-removal-ops and identify gaps"
- "Generate recommendations for paintless-dent-removal-ops optimization"
- "Create detailed plan for paintless-dent-removal-ops execution"
