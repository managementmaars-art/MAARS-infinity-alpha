---
name: wafer-fab-operations
description: Manage semiconductor wafer fabrication operations including photolithography scheduling, yield monitoring, and equipment utilization.
---

## Overview
Manage semiconductor wafer fabrication operations including photolithography scheduling, yield monitoring, and equipment utilization.

## Core Framework
- Analyze requirements and constraints specific to wafer-fab-operations
...
## Key Prompts
- "Initiate wafer-fab-operations workflow for [context]"
- "Analyze current state of wafer-fab-operations and identify gaps"
- "Generate recommendations for wafer-fab-operations optimization"
- "Create detailed plan for wafer-fab-operations execution"
