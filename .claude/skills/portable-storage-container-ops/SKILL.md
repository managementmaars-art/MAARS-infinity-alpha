---
name: portable-storage-container-ops
description: Manage portable storage container operations including container fleet tracking, delivery scheduling, placement coordination, and retrieval logistics.
---

## Overview
Manage portable storage container operations including container fleet tracking, delivery scheduling, placement coordination, and retrieval logistics.

## Core Framework
- Analyze requirements and constraints specific to portable-storage-container-ops
...
## Key Prompts
- "Initiate portable-storage-container-ops workflow for [context]"
- "Analyze current state of portable-storage-container-ops and identify gaps"
- "Generate recommendations for portable-storage-container-ops optimization"
- "Create detailed plan for portable-storage-container-ops execution"
