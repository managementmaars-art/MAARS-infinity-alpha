...
description: Analyze vibration spectra for fault detection including bearing defect frequencies, gear mesh harmonics, imbalance, and misalignment signatures.
---

## Overview
Analyze vibration spectra for fault detection including bearing defect frequencies, gear mesh harmonics, imbalance, and misalignment signatures.

## Core Framework
- Analyze requirements and constraints specific to vibration-spectrum-analysis
...
## Key Prompts
- "Initiate vibration-spectrum-analysis workflow for [context]"
- "Analyze current state of vibration-spectrum-analysis and identify gaps"
- "Generate recommendations for vibration-spectrum-analysis optimization"
- "Create detailed plan for vibration-spectrum-analysis execution"
