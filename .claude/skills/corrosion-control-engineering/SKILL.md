---
name: corrosion-control-engineering
description: Develop corrosion control programs including material selection, coating specifications, cathodic protection, and inhibitor treatment programs.
---

## Overview
Develop corrosion control programs including material selection, coating specifications, cathodic protection, and inhibitor treatment programs.

## Core Framework
- Analyze requirements and constraints specific to corrosion-control-engineering
...
## Key Prompts
- "Initiate corrosion-control-engineering workflow for [context]"
- "Analyze current state of corrosion-control-engineering and identify gaps"
- "Generate recommendations for corrosion-control-engineering optimization"
- "Create detailed plan for corrosion-control-engineering execution"
