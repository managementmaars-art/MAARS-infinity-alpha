---
name: gas-detector-manufacturing
description: Manufacture gas detection instruments including electrochemical cell fabrication, infrared detector assembly, and cross-sensitivity calibration workflows.
---

## Overview
Manufacture gas detection instruments including electrochemical cell fabrication, infrared detector assembly, and cross-sensitivity calibration workflows.

## Core Framework
- Analyze requirements and constraints specific to gas-detector-manufacturing
...
## Key Prompts
- "Initiate gas-detector-manufacturing workflow for [context]"
- "Analyze current state of gas-detector-manufacturing and identify gaps"
- "Generate recommendations for gas-detector-manufacturing optimization"
- "Create detailed plan for gas-detector-manufacturing execution"
