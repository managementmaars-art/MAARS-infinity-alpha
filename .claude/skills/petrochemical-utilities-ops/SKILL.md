---
name: petrochemical-utilities-ops
description: Operate petrochemical plant utility systems including steam and condensate management, cooling water system operations, and nitrogen generation.
---

## Overview
Operate petrochemical plant utility systems including steam and condensate management, cooling water system operations, and nitrogen generation.

## Core Framework
- Analyze requirements and constraints specific to petrochemical-utilities-ops
...
## Key Prompts
- "Initiate petrochemical-utilities-ops workflow for [context]"
- "Analyze current state of petrochemical-utilities-ops and identify gaps"
- "Generate recommendations for petrochemical-utilities-ops optimization"
- "Create detailed plan for petrochemical-utilities-ops execution"
