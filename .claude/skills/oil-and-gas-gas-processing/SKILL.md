---
name: oil-and-gas-gas-processing
description: Operate oil and gas processing facilities including amine sweetening, glycol dehydration, NGL extraction, and compression management.
---

## Overview
Operate oil and gas processing facilities including amine sweetening, glycol dehydration, NGL extraction, and compression management.

## Core Framework
- Analyze requirements and constraints specific to oil-and-gas-gas-processing
...
## Key Prompts
- "Initiate oil-and-gas-gas-processing workflow for [context]"
- "Analyze current state of oil-and-gas-gas-processing and identify gaps"
- "Generate recommendations for oil-and-gas-gas-processing optimization"
- "Create detailed plan for oil-and-gas-gas-processing execution"
