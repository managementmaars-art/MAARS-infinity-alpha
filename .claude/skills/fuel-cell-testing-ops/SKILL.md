---
name: fuel-cell-testing-ops
description: Operate fuel cell testing stations including polarization curve characterization, accelerated stress testing, and electrochemical impedance spectroscopy.
---

## Overview
Operate fuel cell testing stations including polarization curve characterization, accelerated stress testing, and electrochemical impedance spectroscopy.

## Core Framework
- Analyze requirements and constraints specific to fuel-cell-testing-ops
...
## Key Prompts
- "Initiate fuel-cell-testing-ops workflow for [context]"
- "Analyze current state of fuel-cell-testing-ops and identify gaps"
- "Generate recommendations for fuel-cell-testing-ops optimization"
- "Create detailed plan for fuel-cell-testing-ops execution"
