---
name: insert-overmolding-services
description: Provide insert and overmolding services including metal insert handling, two-shot process development, and adhesion testing programs.
---

## Overview
Provide insert and overmolding services including metal insert handling, two-shot process development, and adhesion testing programs.

## Core Framework
- Analyze requirements and constraints specific to insert-overmolding-services
...
## Key Prompts
- "Initiate insert-overmolding-services workflow for [context]"
- "Analyze current state of insert-overmolding-services and identify gaps"
- "Generate recommendations for insert-overmolding-services optimization"
- "Create detailed plan for insert-overmolding-services execution"
