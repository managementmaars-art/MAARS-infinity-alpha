---
name: alumina-refinery-operations
description: Operate alumina refineries including digestion circuit management, liquor clarification, precipitation crystallization, and calcination kiln operations.
---

## Overview
Operate alumina refineries including digestion circuit management, liquor clarification, precipitation crystallization, and calcination kiln operations.

## Core Framework
- Analyze requirements and constraints specific to alumina-refinery-operations
...
## Key Prompts
- "Initiate alumina-refinery-operations workflow for [context]"
- "Analyze current state of alumina-refinery-operations and identify gaps"
- "Generate recommendations for alumina-refinery-operations optimization"
- "Create detailed plan for alumina-refinery-operations execution"
