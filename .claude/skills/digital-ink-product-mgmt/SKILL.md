---
name: digital-ink-product-mgmt
description: Manage digital printing ink product lines including inkjet fluid development, printhead compatibility testing, and OEM certification management.
---

## Overview
Manage digital printing ink product lines including inkjet fluid development, printhead compatibility testing, and OEM certification management.

## Core Framework
- Analyze requirements and constraints specific to digital-ink-product-mgmt
...
## Key Prompts
- "Initiate digital-ink-product-mgmt workflow for [context]"
- "Analyze current state of digital-ink-product-mgmt and identify gaps"
- "Generate recommendations for digital-ink-product-mgmt optimization"
- "Create detailed plan for digital-ink-product-mgmt execution"
