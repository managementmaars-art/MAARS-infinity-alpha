---
name: robot-maintenance-programs
description: Manage industrial robot maintenance programs including preventive maintenance, battery replacement, axis calibration, and overhaul management.
---

## Overview
Manage industrial robot maintenance programs including preventive maintenance, battery replacement, axis calibration, and overhaul management.

## Core Framework
- Analyze requirements and constraints specific to robot-maintenance-programs
...
## Key Prompts
- "Initiate robot-maintenance-programs workflow for [context]"
- "Analyze current state of robot-maintenance-programs and identify gaps"
- "Generate recommendations for robot-maintenance-programs optimization"
- "Create detailed plan for robot-maintenance-programs execution"
