---
name: smart-home-cloud-platform-ops
description: Operate smart home cloud platforms including device provisioning, firmware OTA management, API gateway scaling, and data privacy compliance.
---

## Overview
Operate smart home cloud platforms including device provisioning, firmware OTA management, API gateway scaling, and data privacy compliance.

## Core Framework
- Analyze requirements and constraints specific to smart-home-cloud-platform-ops
...
## Key Prompts
- "Initiate smart-home-cloud-platform-ops workflow for [context]"
- "Analyze current state of smart-home-cloud-platform-ops and identify gaps"
- "Generate recommendations for smart-home-cloud-platform-ops optimization"
- "Create detailed plan for smart-home-cloud-platform-ops execution"
