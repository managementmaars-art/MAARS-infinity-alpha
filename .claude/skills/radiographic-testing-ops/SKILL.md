---
name: radiographic-testing-ops
description: Manage radiographic testing programs including X-ray and gamma ray procedures, film and digital radiography, and source management compliance.
---

## Overview
Manage radiographic testing programs including X-ray and gamma ray procedures, film and digital radiography, and source management compliance.

## Core Framework
- Analyze requirements and constraints specific to radiographic-testing-ops
...
## Key Prompts
- "Initiate radiographic-testing-ops workflow for [context]"
- "Analyze current state of radiographic-testing-ops and identify gaps"
- "Generate recommendations for radiographic-testing-ops optimization"
- "Create detailed plan for radiographic-testing-ops execution"
