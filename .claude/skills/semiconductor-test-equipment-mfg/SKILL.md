---
name: semiconductor-test-equipment-mfg
description: Manufacture automatic test equipment for semiconductor devices including ATE platform assembly, probe card integration, and handler qualification.
---

## Overview
Manufacture automatic test equipment for semiconductor devices including ATE platform assembly, probe card integration, and handler qualification.

## Core Framework
- Analyze requirements and constraints specific to semiconductor-test-equipment-mfg
...
## Key Prompts
- "Initiate semiconductor-test-equipment-mfg workflow for [context]"
- "Analyze current state of semiconductor-test-equipment-mfg and identify gaps"
- "Generate recommendations for semiconductor-test-equipment-mfg optimization"
- "Create detailed plan for semiconductor-test-equipment-mfg execution"
