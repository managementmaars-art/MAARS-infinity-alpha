---
name: shredding-vendor-management
description: Manage shredding subcontractor vendor programs including downstream vendor audits, AAA NAID certification compliance, and chain-of-custody verification.
---

## Overview
Manage shredding subcontractor vendor programs including downstream vendor audits, AAA NAID certification compliance, and chain-of-custody verification.

## Core Framework
- Analyze requirements and constraints specific to shredding-vendor-management
...
## Key Prompts
- "Initiate shredding-vendor-management workflow for [context]"
- "Analyze current state of shredding-vendor-management and identify gaps"
- "Generate recommendations for shredding-vendor-management optimization"
- "Create detailed plan for shredding-vendor-management execution"
