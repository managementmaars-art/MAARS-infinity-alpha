---
name: thermal-management-testing
description: Conduct thermal management testing including thermal resistance measurement, junction temperature verification, and accelerated thermal cycling.
---

## Overview
Conduct thermal management testing including thermal resistance measurement, junction temperature verification, and accelerated thermal cycling.

## Core Framework
- Analyze requirements and constraints specific to thermal-management-testing
...
## Key Prompts
- "Initiate thermal-management-testing workflow for [context]"
- "Analyze current state of thermal-management-testing and identify gaps"
- "Generate recommendations for thermal-management-testing optimization"
- "Create detailed plan for thermal-management-testing execution"
