---
name: dcs-system-operations
description: Operate distributed control systems including controller configuration, alarm management, control loop tuning, and historian integration.
---

## Overview
Operate distributed control systems including controller configuration, alarm management, control loop tuning, and historian integration.

## Core Framework
- Analyze requirements and constraints specific to dcs-system-operations
...
## Key Prompts
- "Initiate dcs-system-operations workflow for [context]"
- "Analyze current state of dcs-system-operations and identify gaps"
- "Generate recommendations for dcs-system-operations optimization"
- "Create detailed plan for dcs-system-operations execution"
