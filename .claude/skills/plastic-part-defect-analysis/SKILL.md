---
name: plastic-part-defect-analysis
description: Analyze plastic part defects including sink marks, warpage, short shots, flash, and weld lines with process parameter correction recommendations.
---

## Overview
Analyze plastic part defects including sink marks, warpage, short shots, flash, and weld lines with process parameter correction recommendations.

## Core Framework
- Analyze requirements and constraints specific to plastic-part-defect-analysis
...
## Key Prompts
- "Initiate plastic-part-defect-analysis workflow for [context]"
- "Analyze current state of plastic-part-defect-analysis and identify gaps"
- "Generate recommendations for plastic-part-defect-analysis optimization"
- "Create detailed plan for plastic-part-defect-analysis execution"
