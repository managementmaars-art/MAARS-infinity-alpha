---
name: structural-adhesive-selection
description: Select structural adhesives including epoxy, acrylic, polyurethane, and methyl methacrylate types for substrate compatibility and load requirements.
---

## Overview
Select structural adhesives including epoxy, acrylic, polyurethane, and methyl methacrylate types for substrate compatibility and load requirements.

## Core Framework
- Analyze requirements and constraints specific to structural-adhesive-selection
...
## Key Prompts
- "Initiate structural-adhesive-selection workflow for [context]"
- "Analyze current state of structural-adhesive-selection and identify gaps"
- "Generate recommendations for structural-adhesive-selection optimization"
- "Create detailed plan for structural-adhesive-selection execution"
