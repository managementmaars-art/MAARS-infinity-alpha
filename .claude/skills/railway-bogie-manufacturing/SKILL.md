---
name: railway-bogie-manufacturing
description: Manufacture railway bogies including frame welding, wheelset assembly, suspension spring and damper integration, brake rigging, and dynamic load testing.
---

## Overview
Manufacture railway bogies including frame welding, wheelset assembly, suspension spring and damper integration, brake rigging, and dynamic load testing.

## Core Framework
- Analyze requirements and constraints specific to railway-bogie-manufacturing
...
## Key Prompts
- "Initiate railway-bogie-manufacturing workflow for [context]"
- "Analyze current state of railway-bogie-manufacturing and identify gaps"
- "Generate recommendations for railway-bogie-manufacturing optimization"
- "Create detailed plan for railway-bogie-manufacturing execution"
