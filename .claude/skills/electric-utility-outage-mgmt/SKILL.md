---
name: electric-utility-outage-mgmt
description: Manage electric utility outage management including OMS operations, storm response coordination, crew dispatch, and customer notification workflows.
---

## Overview
Manage electric utility outage management including OMS operations, storm response coordination, crew dispatch, and customer notification workflows.

## Core Framework
- Analyze requirements and constraints specific to electric-utility-outage-mgmt
...
## Key Prompts
- "Initiate electric-utility-outage-mgmt workflow for [context]"
- "Analyze current state of electric-utility-outage-mgmt and identify gaps"
- "Generate recommendations for electric-utility-outage-mgmt optimization"
- "Create detailed plan for electric-utility-outage-mgmt execution"
