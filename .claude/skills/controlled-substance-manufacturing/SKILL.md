---
name: controlled-substance-manufacturing
description: Manage controlled substance API manufacturing including DEA quota management, vault security compliance, and chain of custody documentation.
---

## Overview
Manage controlled substance API manufacturing including DEA quota management, vault security compliance, and chain of custody documentation.

## Core Framework
- Analyze requirements and constraints specific to controlled-substance-manufacturing
...
## Key Prompts
- "Initiate controlled-substance-manufacturing workflow for [context]"
- "Analyze current state of controlled-substance-manufacturing and identify gaps"
- "Generate recommendations for controlled-substance-manufacturing optimization"
- "Create detailed plan for controlled-substance-manufacturing execution"
