---
name: coating-regulatory-compliance
description: Navigate coating regulatory compliance including VOC limits, ROHS restrictions, REACH substance declarations, and environmental permit management.
---

## Overview
Navigate coating regulatory compliance including VOC limits, ROHS restrictions, REACH substance declarations, and environmental permit management.

## Core Framework
- Analyze requirements and constraints specific to coating-regulatory-compliance
...
## Key Prompts
- "Initiate coating-regulatory-compliance workflow for [context]"
- "Analyze current state of coating-regulatory-compliance and identify gaps"
- "Generate recommendations for coating-regulatory-compliance optimization"
- "Create detailed plan for coating-regulatory-compliance execution"
