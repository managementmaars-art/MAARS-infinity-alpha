---
name: pharma-340b-program-ops
description: Manage 340B drug pricing program operations including covered entity eligibility, split billing, accumulator programs, and audit documentation.
---

## Overview
Manage 340B drug pricing program operations including covered entity eligibility, split billing, accumulator programs, and audit documentation.

## Core Framework
- Analyze requirements and constraints specific to pharma-340b-program-ops
...
## Key Prompts
- "Initiate pharma-340b-program-ops workflow for [context]"
- "Analyze current state of pharma-340b-program-ops and identify gaps"
- "Generate recommendations for pharma-340b-program-ops optimization"
- "Create detailed plan for pharma-340b-program-ops execution"
