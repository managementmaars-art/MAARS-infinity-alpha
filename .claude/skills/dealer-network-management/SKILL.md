---
name: dealer-network-management
description: Manage dealer network performance including sales targets, training compliance, facility standards, and franchise agreements.
---

## Overview
Manage dealer network performance including sales targets, training compliance, facility standards, and franchise agreements.

## Core Framework
- Analyze requirements and constraints specific to dealer-network-management
...
## Key Prompts
- "Initiate dealer-network-management workflow for [context]"
- "Analyze current state of dealer-network-management and identify gaps"
- "Generate recommendations for dealer-network-management optimization"
- "Create detailed plan for dealer-network-management execution"
