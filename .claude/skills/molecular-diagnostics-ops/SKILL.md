---
name: molecular-diagnostics-ops
description: Manage molecular diagnostics laboratory operations including PCR assay management, NGS workflow coordination, and result interpretation workflows.
---

## Overview
Manage molecular diagnostics laboratory operations including PCR assay management, NGS workflow coordination, and result interpretation workflows.

## Core Framework
- Analyze requirements and constraints specific to molecular-diagnostics-ops
...
## Key Prompts
- "Initiate molecular-diagnostics-ops workflow for [context]"
- "Analyze current state of molecular-diagnostics-ops and identify gaps"
- "Generate recommendations for molecular-diagnostics-ops optimization"
- "Create detailed plan for molecular-diagnostics-ops execution"
