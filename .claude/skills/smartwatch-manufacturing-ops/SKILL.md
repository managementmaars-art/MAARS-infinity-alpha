---
name: smartwatch-manufacturing-ops
description: Manage smartwatch manufacturing operations including display module assembly, crown mechanism, speaker receiver, and water resistance testing.
---

## Overview
Manage smartwatch manufacturing operations including display module assembly, crown mechanism, speaker receiver, and water resistance testing.

## Core Framework
- Analyze requirements and constraints specific to smartwatch-manufacturing-ops
...
## Key Prompts
- "Initiate smartwatch-manufacturing-ops workflow for [context]"
- "Analyze current state of smartwatch-manufacturing-ops and identify gaps"
- "Generate recommendations for smartwatch-manufacturing-ops optimization"
- "Create detailed plan for smartwatch-manufacturing-ops execution"
