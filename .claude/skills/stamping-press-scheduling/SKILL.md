---
name: stamping-press-scheduling
description: Schedule metal stamping press operations including tonnage matching, die changeover optimization, coil staging, and production run planning.
---

## Overview
Schedule metal stamping press operations including tonnage matching, die changeover optimization, coil staging, and production run planning.

## Core Framework
- Analyze requirements and constraints specific to stamping-press-scheduling
...
## Key Prompts
- "Initiate stamping-press-scheduling workflow for [context]"
- "Analyze current state of stamping-press-scheduling and identify gaps"
- "Generate recommendations for stamping-press-scheduling optimization"
- "Create detailed plan for stamping-press-scheduling execution"
