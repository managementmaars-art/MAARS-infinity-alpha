---
name: autonomous-mobile-robot-mfg
description: Manufacture autonomous mobile robots including LIDAR integration, differential drive assembly, battery management system fabrication, and navigation software qualification.
---

## Overview
Manufacture autonomous mobile robots including LIDAR integration, differential drive assembly, battery management system fabrication, and navigation software qualification.

## Core Framework
- Analyze requirements and constraints specific to autonomous-mobile-robot-mfg
...
## Key Prompts
- "Initiate autonomous-mobile-robot-mfg workflow for [context]"
- "Analyze current state of autonomous-mobile-robot-mfg and identify gaps"
- "Generate recommendations for autonomous-mobile-robot-mfg optimization"
- "Create detailed plan for autonomous-mobile-robot-mfg execution"
