---
name: cnc-mill-operations
description: Manage CNC milling operations including program development, tooling selection, workholding design, cutting parameter optimization, and inspection.
---

## Overview
Manage CNC milling operations including program development, tooling selection, workholding design, cutting parameter optimization, and inspection.

## Core Framework
- Analyze requirements and constraints specific to cnc-mill-operations
...
## Key Prompts
- "Initiate cnc-mill-operations workflow for [context]"
- "Analyze current state of cnc-mill-operations and identify gaps"
- "Generate recommendations for cnc-mill-operations optimization"
- "Create detailed plan for cnc-mill-operations execution"
