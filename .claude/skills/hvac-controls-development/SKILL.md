---
name: hvac-controls-development
description: Develop HVAC controls solutions including thermostat firmware, building automation integration, and smart home protocol compatibility.
---

## Overview
Develop HVAC controls solutions including thermostat firmware, building automation integration, and smart home protocol compatibility.

## Core Framework
- Analyze requirements and constraints specific to hvac-controls-development
...
## Key Prompts
- "Initiate hvac-controls-development workflow for [context]"
- "Analyze current state of hvac-controls-development and identify gaps"
- "Generate recommendations for hvac-controls-development optimization"
- "Create detailed plan for hvac-controls-development execution"
