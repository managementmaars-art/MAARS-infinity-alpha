---
name: smart-city-iot-ops
description: Operate smart city IoT infrastructure including sensor networks, data platform integration, and city operations center management.
---

## Overview
Operate smart city IoT infrastructure including sensor networks, data platform integration, and city operations center management.

## Core Framework
- Analyze requirements and constraints specific to smart-city-iot-ops
...
## Key Prompts
- "Initiate smart-city-iot-ops workflow for [context]"
- "Analyze current state of smart-city-iot-ops and identify gaps"
- "Generate recommendations for smart-city-iot-ops optimization"
- "Create detailed plan for smart-city-iot-ops execution"
