---
name: smart-home-manufacturing-ops
description: Manage smart home device manufacturing including PCB assembly, firmware flash programming, functional test development, and packaging operations.
---

## Overview
Manage smart home device manufacturing including PCB assembly, firmware flash programming, functional test development, and packaging operations.

## Core Framework
- Analyze requirements and constraints specific to smart-home-manufacturing-ops
...
## Key Prompts
- "Initiate smart-home-manufacturing-ops workflow for [context]"
- "Analyze current state of smart-home-manufacturing-ops and identify gaps"
- "Generate recommendations for smart-home-manufacturing-ops optimization"
- "Create detailed plan for smart-home-manufacturing-ops execution"
