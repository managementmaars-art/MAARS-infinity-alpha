---
name: retail-franchise-management
description: Manage retail franchise networks including franchisee onboarding, brand standards enforcement, royalty tracking, and field support.
---

## Overview
Manage retail franchise networks including franchisee onboarding, brand standards enforcement, royalty tracking, and field support.

## Core Framework
- Analyze requirements and constraints specific to retail-franchise-management
...
## Key Prompts
- "Initiate retail-franchise-management workflow for [context]"
- "Analyze current state of retail-franchise-management and identify gaps"
- "Generate recommendations for retail-franchise-management optimization"
- "Create detailed plan for retail-franchise-management execution"
