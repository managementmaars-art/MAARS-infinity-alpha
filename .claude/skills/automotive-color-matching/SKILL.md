---
name: automotive-color-matching
description: Manage automotive color matching programs including spectrophotometer analysis, formula databases, and OEM color library maintenance.
---

## Overview
Manage automotive color matching programs including spectrophotometer analysis, formula databases, and OEM color library maintenance.

## Core Framework
- Analyze requirements and constraints specific to automotive-color-matching
...
## Key Prompts
- "Initiate automotive-color-matching workflow for [context]"
- "Analyze current state of automotive-color-matching and identify gaps"
- "Generate recommendations for automotive-color-matching optimization"
- "Create detailed plan for automotive-color-matching execution"
