---
name: edm-operations
description: Operate EDM processes including wire EDM, sinker EDM, electrode manufacturing, dielectric management, and surface finish verification.
---

## Overview
Operate EDM processes including wire EDM, sinker EDM, electrode manufacturing, dielectric management, and surface finish verification.

## Core Framework
- Analyze requirements and constraints specific to edm-operations
...
## Key Prompts
- "Initiate edm-operations workflow for [context]"
- "Analyze current state of edm-operations and identify gaps"
- "Generate recommendations for edm-operations optimization"
- "Create detailed plan for edm-operations execution"
