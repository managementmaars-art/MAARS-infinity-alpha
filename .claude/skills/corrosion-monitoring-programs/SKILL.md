---
name: corrosion-monitoring-programs
description: Deploy corrosion monitoring programs including coupon installation, ER probe networks, and inhibitor injection optimization.
---

## Overview
Deploy corrosion monitoring programs including coupon installation, ER probe networks, and inhibitor injection optimization.

## Core Framework
- Analyze requirements and constraints specific to corrosion-monitoring-programs
...
## Key Prompts
- "Initiate corrosion-monitoring-programs workflow for [context]"
- "Analyze current state of corrosion-monitoring-programs and identify gaps"
- "Generate recommendations for corrosion-monitoring-programs optimization"
- "Create detailed plan for corrosion-monitoring-programs execution"
