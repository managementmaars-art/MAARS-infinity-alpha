---
name: tob-spec-compliance
description: Trail of Bits: specification compliance — verify implementation matches spec, find deviations
---

# Tob Spec Compliance — MAARS Security Reference

## Overview
Trail of Bits: specification compliance — verify implementation matches spec, find deviations
