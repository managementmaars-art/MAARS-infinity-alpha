---
name: transformer-testing-programs
description: Execute transformer testing programs including routine, type, and special tests including impedance, losses, and dielectric withstand.
---

## Overview
Execute transformer testing programs including routine, type, and special tests including impedance, losses, and dielectric withstand.

## Core Framework
- Analyze requirements and constraints specific to transformer-testing-programs
...
## Key Prompts
- "Initiate transformer-testing-programs workflow for [context]"
- "Analyze current state of transformer-testing-programs and identify gaps"
- "Generate recommendations for transformer-testing-programs optimization"
- "Create detailed plan for transformer-testing-programs execution"
