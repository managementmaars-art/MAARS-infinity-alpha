---
name: automotive-paint-booth-ops
description: Operate automotive paint booth facilities including airflow validation, temperature control, contamination management, and regulatory compliance.
---

## Overview
Operate automotive paint booth facilities including airflow validation, temperature control, contamination management, and regulatory compliance.

## Core Framework
- Analyze requirements and constraints specific to automotive-paint-booth-ops
...
## Key Prompts
- "Initiate automotive-paint-booth-ops workflow for [context]"
- "Analyze current state of automotive-paint-booth-ops and identify gaps"
- "Generate recommendations for automotive-paint-booth-ops optimization"
- "Create detailed plan for automotive-paint-booth-ops execution"
