---
name: fire-protection-project-mgmt
description: Manage fire protection contracting projects including drawing submittal, inspection coordination, permit close-out, and as-built documentation.
---

## Overview
Manage fire protection contracting projects including drawing submittal, inspection coordination, permit close-out, and as-built documentation.

## Core Framework
- Analyze requirements and constraints specific to fire-protection-project-mgmt
...
## Key Prompts
- "Initiate fire-protection-project-mgmt workflow for [context]"
- "Analyze current state of fire-protection-project-mgmt and identify gaps"
- "Generate recommendations for fire-protection-project-mgmt optimization"
- "Create detailed plan for fire-protection-project-mgmt execution"
