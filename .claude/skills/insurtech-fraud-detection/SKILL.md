---
name: insurtech-fraud-detection
description: Deploy fraud detection analytics for insurance including network link analysis, claim anomaly scoring, and SIU referral workflows.
---

## Overview
Deploy fraud detection analytics for insurance including network link analysis, claim anomaly scoring, and SIU referral workflows.

## Core Framework
- Analyze requirements and constraints specific to insurtech-fraud-detection
...
## Key Prompts
- "Initiate insurtech-fraud-detection workflow for [context]"
- "Analyze current state of insurtech-fraud-detection and identify gaps"
- "Generate recommendations for insurtech-fraud-detection optimization"
- "Create detailed plan for insurtech-fraud-detection execution"
