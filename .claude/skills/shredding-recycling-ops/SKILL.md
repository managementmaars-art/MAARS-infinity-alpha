---
name: shredding-recycling-ops
description: Manage shredded paper recycling operations including bale marketing, fiber grade separation, and sustainability reporting for client programs.
---

## Overview
Manage shredded paper recycling operations including bale marketing, fiber grade separation, and sustainability reporting for client programs.

## Core Framework
- Analyze requirements and constraints specific to shredding-recycling-ops
...
## Key Prompts
- "Initiate shredding-recycling-ops workflow for [context]"
- "Analyze current state of shredding-recycling-ops and identify gaps"
- "Generate recommendations for shredding-recycling-ops optimization"
- "Create detailed plan for shredding-recycling-ops execution"
