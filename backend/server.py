...
# ============== KNOWLEDGE BASE ENDPOINTS (on api_router) ==============
...
@api_router.delete("/agents/{agent_id}/knowledge/{doc_id}")
...
@api_router.get("/agents/{agent_id}/knowledge/{doc_id}")
...
@api_router.post("/agents/{agent_id}/knowledge/search")
async def search_agent_knowledge(
    agent_id: str,
    request: Request,
    current_user: User = Depends(get_current_user)
):
    """Search an agent's knowledge base (for testing/preview)."""
    body = await request.json()
...
# Re-include router after knowledge endpoints are added
# (The original include is above, these endpoints are added dynamically)
