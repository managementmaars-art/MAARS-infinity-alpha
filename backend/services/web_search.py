...
def format_web_context(search_data: Dict) -> str:
    ...
    lines.append("")
    lines.append("YOU JUST BROWSED THE INTERNET. The data above is REAL and CURRENT.")
    lines.append("Rules for this response:")
    lines.append("- Answer the user's question using the web data above")
    lines.append("- Synthesize the information clearly and confidently")
    lines.append("- Cite sources: \"According to [Title](URL)\" or \"(Source: URL)\"")
    lines.append("- If data is partial, share what you found and note gaps")
    lines.append("- Do NOT say you cannot access the internet or lack data — you have it above")
    lines.append("- Do NOT ask the user to check sources themselves — YOU are the source")
    lines.append("")
