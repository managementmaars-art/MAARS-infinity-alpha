...
async def download_summary_pdf(current_user: User = Depends(get_current_user)):
    ...
    pdf.multi_cell(pdf.w - pdf.l_margin - pdf.r_margin - 4, 4.5, _s(
        "MAARS Command deploys a workforce of 41 specialized AI agents organized across 8 organizational layers. "
        "It merges the power of preset specialist business agents with autonomous execution, persistent memory, "
        "and real-world action capabilities. Users set high-level business goals, and the AI workforce "
        "autonomously plans, delegates, executes, collaborates, and delivers -- with quality control, "
        "failure recovery, and human oversight at every step."
    ))
    pdf.ln(5)
    ...
    toc_items = [
        ...
        ("2", "The 41-Agent AI Workforce (8 Layers)", AMBER),
    ...
    # ===== SECTION 2: AGENTS =====
    pdf.add_page()
    pdf.section_title("2. The 41-Agent AI Workforce", AMBER)
